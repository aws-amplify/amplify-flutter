...
class DescribeConformancePacksOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<ConformancePackDetail>> {
  /// Returns a list of one or more conformance packs.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeConformancePacksRequest,
          DescribeConformancePacksResponse,
          DescribeConformancePacksResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeConformancePacksRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeConformancePacksResponse? output]) => 200;
  @override
  DescribeConformancePacksResponse buildOutput(
    DescribeConformancePacksResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeConformancePacksResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeConformancePacksResponse> run(
  ...
  @override
  String? getToken(DescribeConformancePacksResponse output) => output.nextToken;
  @override
  _i2.BuiltList<ConformancePackDetail> getItems(
          DescribeConformancePacksResponse output) =>
      output.conformancePackDetails ?? _i2.BuiltList();
  @override
  DescribeConformancePacksRequest rebuildInput(
    DescribeConformancePacksRequest input,
    String token,
    int? pageSize,
  ) =>
