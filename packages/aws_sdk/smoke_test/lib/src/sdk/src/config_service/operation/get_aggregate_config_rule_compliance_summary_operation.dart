...
class GetAggregateConfigRuleComplianceSummaryOperation extends _i1
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetAggregateConfigRuleComplianceSummaryRequest,
          GetAggregateConfigRuleComplianceSummaryResponse,
          GetAggregateConfigRuleComplianceSummaryResponse>> protocols = [
  ...
  @override
  int successCode([GetAggregateConfigRuleComplianceSummaryResponse? output]) =>
      200;
  @override
  GetAggregateConfigRuleComplianceSummaryResponse buildOutput(
    GetAggregateConfigRuleComplianceSummaryResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetAggregateConfigRuleComplianceSummaryResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetAggregateConfigRuleComplianceSummaryResponse> run(
    GetAggregateConfigRuleComplianceSummaryRequest input, {
  ...
  @override
  String? getToken(GetAggregateConfigRuleComplianceSummaryResponse output) =>
      output.nextToken;
  @override
  GetAggregateConfigRuleComplianceSummaryResponse getItems(
          GetAggregateConfigRuleComplianceSummaryResponse output) =>
      output;
  @override
  GetAggregateConfigRuleComplianceSummaryRequest rebuildInput(
    GetAggregateConfigRuleComplianceSummaryRequest input,
    String token,
    int? pageSize,
  ) =>
