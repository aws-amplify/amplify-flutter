...
library smoke_test.config_service.operation.delete_organization_conformance_pack; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteOrganizationConformancePackOperation extends _i1.HttpOperation<
    _i2.DeleteOrganizationConformancePackRequest,
    _i2.DeleteOrganizationConformancePackRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Deletes the specified organization conformance pack and all of the Config rules and remediation actions from all member accounts in that organization.
  ...
  _i1.HttpRequest buildRequest(
          _i2.DeleteOrganizationConformancePackRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteOrganizationConformancePack';
  @override
