...
abstract class DescribeOrganizationConformancePacksResponse
  ...
  static const List<
          _i3.SmithySerializer<DescribeOrganizationConformancePacksResponse>>
      serializers = [
    DescribeOrganizationConformancePacksResponseAwsJson11Serializer()
  ];

  /// Returns a list of OrganizationConformancePacks objects.
  _i2.BuiltList<OrganizationConformancePack>? get organizationConformancePacks;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'OrganizationConformancePacks':
          ...
          ) as _i2.BuiltList<OrganizationConformancePack>));
        case 'NextToken':
