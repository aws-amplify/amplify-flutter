...
class ListStoredQueriesOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListStoredQueriesRequest, ListStoredQueriesRequest,
          ListStoredQueriesResponse, ListStoredQueriesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListStoredQueriesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListStoredQueriesResponse? output]) => 200;
  @override
  ListStoredQueriesResponse buildOutput(
    ListStoredQueriesResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ListStoredQueriesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListStoredQueriesResponse> run(
  ...
  @override
  String? getToken(ListStoredQueriesResponse output) => output.nextToken;
  @override
  ListStoredQueriesResponse getItems(ListStoredQueriesResponse output) =>
      output;
  @override
  ListStoredQueriesRequest rebuildInput(
    ListStoredQueriesRequest input,
    String token,
    int? pageSize,
  ) =>
