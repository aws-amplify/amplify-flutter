...
library smoke_test.config_service.operation.describe_delivery_channels; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeDeliveryChannelsOperation extends _i1.HttpOperation<
    _i2.DescribeDeliveryChannelsRequest,
    _i2.DescribeDeliveryChannelsRequest,
    _i3.DescribeDeliveryChannelsResponse,
    _i3.DescribeDeliveryChannelsResponse> {
  /// Returns details about the specified delivery channel. If a delivery channel is not specified, this action returns the details of all delivery channels associated with the account.
  ///
  /// Currently, you can specify only one delivery channel per region in your account.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeDeliveryChannelsRequest,
          _i3.DescribeDeliveryChannelsResponse,
          _i3.DescribeDeliveryChannelsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeDeliveryChannelsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeDeliveryChannelsResponse? output]) => 200;
  @override
