...
library smoke_test.config_service.operation.describe_delivery_channel_status; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeDeliveryChannelStatusOperation extends _i1.HttpOperation<
    _i2.DescribeDeliveryChannelStatusRequest,
    _i2.DescribeDeliveryChannelStatusRequest,
    _i3.DescribeDeliveryChannelStatusResponse,
    _i3.DescribeDeliveryChannelStatusResponse> {
  /// Returns the current status of the specified delivery channel. If a delivery channel is not specified, this action returns the current status of all delivery channels associated with the account.
  ///
  /// Currently, you can specify only one delivery channel per region in your account.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeDeliveryChannelStatusRequest,
          _i3.DescribeDeliveryChannelStatusResponse,
          _i3.DescribeDeliveryChannelStatusResponse>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.DescribeDeliveryChannelStatusRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeDeliveryChannelStatusResponse? output]) => 200;
  @override
  _i3.DescribeDeliveryChannelStatusResponse buildOutput(
    _i3.DescribeDeliveryChannelStatusResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeDeliveryChannelStatusResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeDeliveryChannelStatusResponse> run(
    _i2.DescribeDeliveryChannelStatusRequest input, {
