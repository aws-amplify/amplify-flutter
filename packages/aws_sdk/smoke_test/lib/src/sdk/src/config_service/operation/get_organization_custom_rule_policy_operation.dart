...
class GetOrganizationCustomRulePolicyOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetOrganizationCustomRulePolicyRequest,
          GetOrganizationCustomRulePolicyResponse,
          GetOrganizationCustomRulePolicyResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetOrganizationCustomRulePolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetOrganizationCustomRulePolicyResponse? output]) => 200;
  @override
  GetOrganizationCustomRulePolicyResponse buildOutput(
    GetOrganizationCustomRulePolicyResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetOrganizationCustomRulePolicyResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetOrganizationCustomRulePolicyResponse> run(
