...
library smoke_test.config_service.operation.get_aggregate_resource_config; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetAggregateResourceConfigOperation extends _i1.HttpOperation<
    _i2.GetAggregateResourceConfigRequest,
    _i2.GetAggregateResourceConfigRequest,
    _i3.GetAggregateResourceConfigResponse,
    _i3.GetAggregateResourceConfigResponse> {
  /// Returns configuration item that is aggregated for your specific resource in a specific source account and region.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetAggregateResourceConfigRequest,
          _i3.GetAggregateResourceConfigResponse,
          _i3.GetAggregateResourceConfigResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetAggregateResourceConfigRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.GetAggregateResourceConfigResponse? output]) => 200;
  @override
  _i3.GetAggregateResourceConfigResponse buildOutput(
    _i3.GetAggregateResourceConfigResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.GetAggregateResourceConfigResponse.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError(
          ...
          _i1.ErrorKind.client,
          _i10.OversizedConfigurationItemException,
          builder: _i10.OversizedConfigurationItemException.fromResponse,
        ),
        _i1.SmithyError(
          _i1.ShapeId(
            namespace: 'com.amazonaws.configservice',
          ...
          _i1.ErrorKind.client,
          _i11.ResourceNotDiscoveredException,
          builder: _i11.ResourceNotDiscoveredException.fromResponse,
        ),
        _i1.SmithyError(
          _i1.ShapeId(
            namespace: 'com.amazonaws.configservice',
  ...
  @override
  _i1.SmithyOperation<_i3.GetAggregateResourceConfigResponse> run(
    _i2.GetAggregateResourceConfigRequest input, {
