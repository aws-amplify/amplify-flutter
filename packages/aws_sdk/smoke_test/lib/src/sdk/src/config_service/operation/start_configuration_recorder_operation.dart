...
class StartConfigurationRecorderOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<StartConfigurationRecorderRequest,
          StartConfigurationRecorderRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(StartConfigurationRecorderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  List<_i1.SmithyError> get errorTypes => const [
        _i1.SmithyError<NoAvailableDeliveryChannelException,
          ...
          NoAvailableDeliveryChannelException,
          builder: NoAvailableDeliveryChannelException.fromResponse,
        ),
