...
library smoke_test.config_service.operation.get_organization_config_rule_detailed_status; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetOrganizationConfigRuleDetailedStatusOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i4.BuiltList<_i5.MemberAccountStatus>> {
  /// Returns detailed status for each member account within an organization for a given organization Config rule.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetOrganizationConfigRuleDetailedStatusRequest,
          _i3.GetOrganizationConfigRuleDetailedStatusResponse,
          _i3.GetOrganizationConfigRuleDetailedStatusResponse>> protocols = [
  ...
  @override
  int successCode(
          [_i3.GetOrganizationConfigRuleDetailedStatusResponse? output]) =>
      200;
  @override
  ...
  String? getToken(
      ...
      output.nextToken;
  @override
  _i4.BuiltList<_i5.MemberAccountStatus> getItems(
          _i3.GetOrganizationConfigRuleDetailedStatusResponse output) =>
      output.organizationConfigRuleDetailedStatus ?? _i4.BuiltList();
  @override
  _i2.GetOrganizationConfigRuleDetailedStatusRequest rebuildInput(
    _i2.GetOrganizationConfigRuleDetailedStatusRequest input,
    String token,
    int? pageSize,
  ) =>
