...
class DescribeConformancePackStatusOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<ConformancePackStatusDetail>> {
  /// Provides one or more conformance packs deployment status.
  ///
  /// If there are no conformance packs then you will see an empty result.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeConformancePackStatusRequest,
          DescribeConformancePackStatusResponse,
          DescribeConformancePackStatusResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeConformancePackStatusRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeConformancePackStatusResponse? output]) => 200;
  @override
  DescribeConformancePackStatusResponse buildOutput(
    DescribeConformancePackStatusResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeConformancePackStatusResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeConformancePackStatusResponse> run(
  ...
  @override
  String? getToken(DescribeConformancePackStatusResponse output) =>
      output.nextToken;
  @override
  _i2.BuiltList<ConformancePackStatusDetail> getItems(
          DescribeConformancePackStatusResponse output) =>
      output.conformancePackStatusDetails ?? _i2.BuiltList();
  @override
  DescribeConformancePackStatusRequest rebuildInput(
    DescribeConformancePackStatusRequest input,
    String token,
    int? pageSize,
  ) =>
