...
library smoke_test.config_service.operation.untag_resource_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagResourceOperation extends _i1.HttpOperation<UntagResourceRequest,
    UntagResourceRequest, _i1.Unit, _i1.Unit> {
  /// Deletes specified tags from a resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UntagResourceRequest, UntagResourceRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UntagResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UntagResource';
  @override
