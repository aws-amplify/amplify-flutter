...
abstract class OrganizationAllFeaturesNotEnabledException
  ...
  static const List<
          _i2.SmithySerializer<OrganizationAllFeaturesNotEnabledException>>
      serializers = [
...
class OrganizationAllFeaturesNotEnabledExceptionAwsJson11Serializer extends _i2
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    OrganizationAllFeaturesNotEnabledException object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result$ = <Object?>[];
    final OrganizationAllFeaturesNotEnabledException(:message) = object;
    if (message != null) {
      result$
        ..add('message')
