...
class GetAggregateDiscoveredResourceCountsOperation extends _i1
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetAggregateDiscoveredResourceCountsRequest,
          GetAggregateDiscoveredResourceCountsResponse,
          GetAggregateDiscoveredResourceCountsResponse>> protocols = [
  ...
  @override
  int successCode([GetAggregateDiscoveredResourceCountsResponse? output]) =>
      200;
  @override
  GetAggregateDiscoveredResourceCountsResponse buildOutput(
    GetAggregateDiscoveredResourceCountsResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetAggregateDiscoveredResourceCountsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetAggregateDiscoveredResourceCountsResponse> run(
    GetAggregateDiscoveredResourceCountsRequest input, {
  ...
  @override
  String? getToken(GetAggregateDiscoveredResourceCountsResponse output) =>
      output.nextToken;
  @override
  GetAggregateDiscoveredResourceCountsResponse getItems(
          GetAggregateDiscoveredResourceCountsResponse output) =>
      output;
  @override
  GetAggregateDiscoveredResourceCountsRequest rebuildInput(
    GetAggregateDiscoveredResourceCountsRequest input,
    String token,
    int? pageSize,
  ) =>
