...
class GetComplianceSummaryByConfigRuleOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i1.Unit,
          GetComplianceSummaryByConfigRuleResponse,
          GetComplianceSummaryByConfigRuleResponse>> protocols = [
  ...
  @override
  int successCode([GetComplianceSummaryByConfigRuleResponse? output]) => 200;
  @override
  GetComplianceSummaryByConfigRuleResponse buildOutput(
    GetComplianceSummaryByConfigRuleResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetComplianceSummaryByConfigRuleResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetComplianceSummaryByConfigRuleResponse> run(
    _i1.Unit input, {
