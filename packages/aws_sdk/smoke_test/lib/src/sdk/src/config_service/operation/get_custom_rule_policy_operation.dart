...
class GetCustomRulePolicyOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetCustomRulePolicyRequest,
          GetCustomRulePolicyResponse,
          GetCustomRulePolicyResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetCustomRulePolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetCustomRulePolicyResponse? output]) => 200;
  @override
  GetCustomRulePolicyResponse buildOutput(
    GetCustomRulePolicyResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetCustomRulePolicyResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetCustomRulePolicyResponse> run(
