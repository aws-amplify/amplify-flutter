...
class DescribeRemediationConfigurationsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeRemediationConfigurationsRequest,
          DescribeRemediationConfigurationsResponse,
          DescribeRemediationConfigurationsResponse>> protocols = [
  ...
  @override
  int successCode([DescribeRemediationConfigurationsResponse? output]) => 200;
  @override
  DescribeRemediationConfigurationsResponse buildOutput(
    DescribeRemediationConfigurationsResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeRemediationConfigurationsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeRemediationConfigurationsResponse> run(
    DescribeRemediationConfigurationsRequest input, {
