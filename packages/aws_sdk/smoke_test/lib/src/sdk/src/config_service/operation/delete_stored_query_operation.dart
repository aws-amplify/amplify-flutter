...
class DeleteStoredQueryOperation extends _i1.HttpOperation<
    _i2.DeleteStoredQueryRequest,
    _i2.DeleteStoredQueryRequest,
    _i3.DeleteStoredQueryResponse,
    _i3.DeleteStoredQueryResponse> {
  /// Deletes the stored query for a single Amazon Web Services account and a single Amazon Web Services Region.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DeleteStoredQueryRequest,
          _i3.DeleteStoredQueryResponse,
          _i3.DeleteStoredQueryResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteStoredQueryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DeleteStoredQueryResponse? output]) => 200;
  @override
