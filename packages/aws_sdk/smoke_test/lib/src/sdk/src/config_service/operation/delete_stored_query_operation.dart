...
library smoke_test.config_service.operation.delete_stored_query_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteStoredQueryOperation extends _i1.HttpOperation<
    DeleteStoredQueryRequest,
    DeleteStoredQueryRequest,
    DeleteStoredQueryResponse,
    DeleteStoredQueryResponse> {
  /// Deletes the stored query for a single Amazon Web Services account and a single Amazon Web Services Region.
  DeleteStoredQueryOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteStoredQueryRequest, DeleteStoredQueryRequest,
          DeleteStoredQueryResponse, DeleteStoredQueryResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteStoredQueryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeleteStoredQueryResponse? output]) => 200;
  @override
  DeleteStoredQueryResponse buildOutput(
    DeleteStoredQueryResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeleteStoredQueryResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DeleteStoredQueryResponse> run(
