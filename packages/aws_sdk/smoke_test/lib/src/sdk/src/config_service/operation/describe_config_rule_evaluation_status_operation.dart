...
class DescribeConfigRuleEvaluationStatusOperation extends _i1
    .PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<ConfigRuleEvaluationStatus>> {
  /// Returns status information for each of your Config managed rules. The status includes information such as the last time Config invoked the rule, the last time Config failed to invoke the rule, and the related error for the last failure.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeConfigRuleEvaluationStatusRequest,
          DescribeConfigRuleEvaluationStatusResponse,
          DescribeConfigRuleEvaluationStatusResponse>> protocols = [
  ...
  @override
  int successCode([DescribeConfigRuleEvaluationStatusResponse? output]) => 200;
  @override
  DescribeConfigRuleEvaluationStatusResponse buildOutput(
    DescribeConfigRuleEvaluationStatusResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeConfigRuleEvaluationStatusResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeConfigRuleEvaluationStatusResponse> run(
    DescribeConfigRuleEvaluationStatusRequest input, {
  ...
  @override
  String? getToken(DescribeConfigRuleEvaluationStatusResponse output) =>
      output.nextToken;
  @override
  _i2.BuiltList<ConfigRuleEvaluationStatus> getItems(
          DescribeConfigRuleEvaluationStatusResponse output) =>
      output.configRulesEvaluationStatus ?? _i2.BuiltList();
  @override
  DescribeConfigRuleEvaluationStatusRequest rebuildInput(
    DescribeConfigRuleEvaluationStatusRequest input,
    String token,
    int? pageSize,
  ) =>
