...
library smoke_test.config_service.operation.put_remediation_exceptions; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutRemediationExceptionsOperation extends _i1.HttpOperation<
    _i2.PutRemediationExceptionsRequest,
    _i2.PutRemediationExceptionsRequest,
    _i3.PutRemediationExceptionsResponse,
    _i3.PutRemediationExceptionsResponse> {
  /// A remediation exception is when a specified resource is no longer considered for auto-remediation. This API adds a new exception or updates an existing exception for a specified resource with a specified Config rule.
  ///
  /// Config generates a remediation exception when a problem occurs running a remediation action for a specified resource. Remediation exceptions blocks auto-remediation until the exception is cleared.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.PutRemediationExceptionsRequest,
          _i3.PutRemediationExceptionsResponse,
          _i3.PutRemediationExceptionsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutRemediationExceptionsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.PutRemediationExceptionsResponse? output]) => 200;
  @override
  _i3.PutRemediationExceptionsResponse buildOutput(
    _i3.PutRemediationExceptionsResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.PutRemediationExceptionsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.PutRemediationExceptionsResponse> run(
    _i2.PutRemediationExceptionsRequest input, {
