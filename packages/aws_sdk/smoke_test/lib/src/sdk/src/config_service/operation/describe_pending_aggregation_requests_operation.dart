...
library smoke_test.config_service.operation.describe_pending_aggregation_requests_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribePendingAggregationRequestsOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i4.BuiltList<_i5.PendingAggregationRequest>> {
  /// Returns a list of all pending aggregation requests.
  DescribePendingAggregationRequestsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribePendingAggregationRequestsRequest,
          _i3.DescribePendingAggregationRequestsResponse,
          _i3.DescribePendingAggregationRequestsResponse>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.DescribePendingAggregationRequestsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribePendingAggregationRequestsResponse? output]) =>
      200;
  @override
  _i3.DescribePendingAggregationRequestsResponse buildOutput(
    _i3.DescribePendingAggregationRequestsResponse payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribePendingAggregationRequestsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DescribePendingAggregationRequests';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribePendingAggregationRequestsResponse> run(
    _i2.DescribePendingAggregationRequestsRequest input, {
  ...
  @override
  String? getToken(_i3.DescribePendingAggregationRequestsResponse output) =>
      output.nextToken;
  @override
  _i4.BuiltList<_i5.PendingAggregationRequest> getItems(
          _i3.DescribePendingAggregationRequestsResponse output) =>
      output.pendingAggregationRequests ?? _i4.BuiltList();
  @override
  _i2.DescribePendingAggregationRequestsRequest rebuildInput(
    _i2.DescribePendingAggregationRequestsRequest input,
    String token,
    int? pageSize,
  ) =>
