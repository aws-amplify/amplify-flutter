...
class DescribePendingAggregationRequestsOperation extends _i1
    .PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<PendingAggregationRequest>> {
  /// Returns a list of all pending aggregation requests.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribePendingAggregationRequestsRequest,
          DescribePendingAggregationRequestsResponse,
          DescribePendingAggregationRequestsResponse>> protocols = [
  ...
  @override
  int successCode([DescribePendingAggregationRequestsResponse? output]) => 200;
  @override
  DescribePendingAggregationRequestsResponse buildOutput(
    DescribePendingAggregationRequestsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribePendingAggregationRequestsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribePendingAggregationRequestsResponse> run(
    DescribePendingAggregationRequestsRequest input, {
  ...
  @override
  String? getToken(DescribePendingAggregationRequestsResponse output) =>
      output.nextToken;
  @override
  _i2.BuiltList<PendingAggregationRequest> getItems(
          DescribePendingAggregationRequestsResponse output) =>
      output.pendingAggregationRequests ?? _i2.BuiltList();
  @override
  DescribePendingAggregationRequestsRequest rebuildInput(
    DescribePendingAggregationRequestsRequest input,
    String token,
    int? pageSize,
  ) =>
