...
class GetResourcesOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetResourcesRequestPayload, GetResourcesRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(GetResourcesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Resources? output]) => 200;
  @override
  Resources buildOutput(
    Resources payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      Resources.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<Resources> run(
  ...
  @override
  String? getToken(Resources output) => output.position;
  @override
  _i2.BuiltList<Resource> getItems(Resources output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetResourcesRequest rebuildInput(
    GetResourcesRequest input,
    String token,
    int? pageSize,
  ) =>
