...
class GetDeploymentsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetDeploymentsRequestPayload, GetDeploymentsRequest,
          Deployments, Deployments>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetDeploymentsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Deployments? output]) => 200;
  @override
  Deployments buildOutput(
    Deployments payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      Deployments.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<Deployments> run(
  ...
  @override
  String? getToken(Deployments output) => output.position;
  @override
  _i2.BuiltList<Deployment> getItems(Deployments output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetDeploymentsRequest rebuildInput(
    GetDeploymentsRequest input,
    String token,
    int? pageSize,
  ) =>
