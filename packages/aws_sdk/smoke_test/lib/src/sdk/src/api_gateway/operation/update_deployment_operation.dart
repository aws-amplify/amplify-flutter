...
library smoke_test.api_gateway.operation.update_deployment_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateDeploymentOperation extends _i1.HttpOperation<
    _i2.UpdateDeploymentRequestPayload,
    _i2.UpdateDeploymentRequest,
    _i3.Deployment,
    _i3.Deployment> {
  /// Changes information about a Deployment resource.
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateDeploymentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
  ...
  @override
  String get runtimeTypeName => 'UpdateDeployment';
  @override
  ...
  _i1.SmithyOperation<_i3.Deployment> run(
    _i2.UpdateDeploymentRequest input, {
