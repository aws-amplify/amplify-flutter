...
class GetDomainNameOperation extends _i1.HttpOperation<
    GetDomainNameRequestPayload, GetDomainNameRequest, DomainName, DomainName> {
  /// Represents a domain name that is contained in a simpler, more intuitive URL that can be called.
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetDomainNameRequestPayload, GetDomainNameRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(GetDomainNameRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
