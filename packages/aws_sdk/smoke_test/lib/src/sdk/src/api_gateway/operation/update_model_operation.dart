...
class UpdateModelOperation extends _i1.HttpOperation<UpdateModelRequestPayload,
    UpdateModelRequest, Model, Model> {
  /// Changes information about a model.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateModelRequestPayload, UpdateModelRequest, Model,
          Model>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateModelRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
