...
library smoke_test.api_gateway.operation.get_documentation_part_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetDocumentationPartOperation extends _i1.HttpOperation<
    GetDocumentationPartRequestPayload,
    GetDocumentationPartRequest,
    DocumentationPart,
    DocumentationPart> {
  /// Gets a documentation part.
  GetDocumentationPartOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(GetDocumentationPartRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
  ...
  @override
  int successCode([DocumentationPart? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'GetDocumentationPart';
  @override
