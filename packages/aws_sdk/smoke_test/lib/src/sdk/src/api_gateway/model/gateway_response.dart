...
abstract class GatewayResponse
  ...
  static const List<_i3.SmithySerializer<GatewayResponse>> serializers = [
...
class GatewayResponseRestJson1Serializer
    extends _i3.StructuredSmithySerializer<GatewayResponse> {
      ...
      switch (key) {
        ...
        case 'responseType':
          result.responseType = (serializers.deserialize(
            value,
            specifiedType: const FullType(GatewayResponseType),
          ) as GatewayResponseType);
        case 'statusCode':
