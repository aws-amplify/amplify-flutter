...
class UpdateStageOperation extends _i1.HttpOperation<UpdateStageRequestPayload,
    UpdateStageRequest, Stage, Stage> {
  /// Changes information about a Stage resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateStageRequestPayload, UpdateStageRequest, Stage,
          Stage>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateStageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/restapis/{restApiId}/stages/{stageName}';
      });
  @override
  int successCode([Stage? output]) => 200;
  @override
  Stage buildOutput(
    Stage payload,
