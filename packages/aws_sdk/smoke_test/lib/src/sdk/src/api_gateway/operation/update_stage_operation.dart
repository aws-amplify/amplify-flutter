...
library smoke_test.api_gateway.operation.update_stage_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/not_found_exception.dart'
    as _i12;
import 'package:smoke_test/src/sdk/src/api_gateway/model/stage.dart' as _i3;
...
class UpdateStageOperation extends _i1.HttpOperation<
    _i2.UpdateStageRequestPayload,
    _i2.UpdateStageRequest,
    _i3.Stage,
    _i3.Stage> {
  /// Changes information about a Stage resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateStageRequestPayload, _i2.UpdateStageRequest,
          _i3.Stage, _i3.Stage>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateStageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/restapis/{restApiId}/stages/{stageName}';
      });
  @override
  int successCode([_i3.Stage? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateStage';
  @override
