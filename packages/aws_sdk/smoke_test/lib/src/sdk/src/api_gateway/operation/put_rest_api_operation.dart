...
class PutRestApiOperation extends _i1
    .HttpOperation<_i2.Uint8List, PutRestApiRequest, RestApi, RestApi> {
  /// A feature of the API Gateway control service for updating an existing API with an input of external API definitions. The update can take the form of merging the supplied definition into the existing API or overwriting the existing API.
  PutRestApiOperation({
  ...
  @override
  late final List<
          _i1.HttpProtocol<_i2.Uint8List, PutRestApiRequest, RestApi, RestApi>>
      protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(PutRestApiRequest input) => _i1.HttpRequest((b) {
        b.method = 'PUT';
