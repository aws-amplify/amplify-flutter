...
library smoke_test.api_gateway.operation.put_gateway_response_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutGatewayResponseOperation extends _i1.HttpOperation<
    _i2.PutGatewayResponseRequestPayload,
    _i2.PutGatewayResponseRequest,
    _i3.GatewayResponse,
    _i3.GatewayResponse> {
  /// Creates a customization of a GatewayResponse of a specified response type and status code on the given RestApi.
  PutGatewayResponseOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutGatewayResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path = r'/restapis/{restApiId}/gatewayresponses/{responseType}';
      });
  @override
  int successCode([_i3.GatewayResponse? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'PutGatewayResponse';
  @override
  ...
  _i1.SmithyOperation<_i3.GatewayResponse> run(
    _i2.PutGatewayResponseRequest input, {
