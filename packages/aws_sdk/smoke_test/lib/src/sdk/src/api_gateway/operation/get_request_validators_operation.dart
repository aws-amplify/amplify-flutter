...
library smoke_test.api_gateway.operation.get_request_validators_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetRequestValidatorsOperation extends _i1.HttpOperation<
    _i2.GetRequestValidatorsRequestPayload,
    _i2.GetRequestValidatorsRequest,
    _i3.RequestValidators,
    _i3.RequestValidators> {
  /// Gets the RequestValidators collection of a given RestApi.
  GetRequestValidatorsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetRequestValidatorsRequest,
          _i3.RequestValidators,
          _i3.RequestValidators>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetRequestValidatorsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([_i3.RequestValidators? output]) => 200;
  @override
