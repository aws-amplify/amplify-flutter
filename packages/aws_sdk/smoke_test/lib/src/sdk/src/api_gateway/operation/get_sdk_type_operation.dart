...
/// Gets an SDK type.
class GetSdkTypeOperation extends _i1.HttpOperation<GetSdkTypeRequestPayload,
    GetSdkTypeRequest, SdkType, SdkType> {
  /// Gets an SDK type.
  GetSdkTypeOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetSdkTypeRequestPayload, GetSdkTypeRequest, SdkType,
          SdkType>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetSdkTypeRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/sdktypes/{id}';
      });
  @override
  int successCode([SdkType? output]) => 200;
  @override
  SdkType buildOutput(
    SdkType payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      SdkType.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<SdkType> run(
