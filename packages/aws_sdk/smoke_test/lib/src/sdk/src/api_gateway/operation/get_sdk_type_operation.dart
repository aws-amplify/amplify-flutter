...
library smoke_test.api_gateway.operation.get_sdk_type_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/not_found_exception.dart'
    as _i10;
import 'package:smoke_test/src/sdk/src/api_gateway/model/sdk_type.dart' as _i3;
...
/// Gets an SDK type.
class GetSdkTypeOperation extends _i1.HttpOperation<
    _i2.GetSdkTypeRequestPayload,
    _i2.GetSdkTypeRequest,
    _i3.SdkType,
    _i3.SdkType> {
  /// Gets an SDK type.
  GetSdkTypeOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetSdkTypeRequestPayload, _i2.GetSdkTypeRequest,
          _i3.SdkType, _i3.SdkType>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetSdkTypeRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/sdktypes/{id}';
      });
  @override
  int successCode([_i3.SdkType? output]) => 200;
  @override
  _i3.SdkType buildOutput(
    _i3.SdkType payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.SdkType.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetSdkType';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.SdkType> run(
    _i2.GetSdkTypeRequest input, {
