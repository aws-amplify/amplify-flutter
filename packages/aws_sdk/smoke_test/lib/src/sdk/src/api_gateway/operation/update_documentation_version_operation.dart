...
class UpdateDocumentationVersionOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          UpdateDocumentationVersionRequest,
          DocumentationVersion,
          DocumentationVersion>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateDocumentationVersionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([DocumentationVersion? output]) => 200;
  @override
  DocumentationVersion buildOutput(
    DocumentationVersion payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DocumentationVersion.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DocumentationVersion> run(
