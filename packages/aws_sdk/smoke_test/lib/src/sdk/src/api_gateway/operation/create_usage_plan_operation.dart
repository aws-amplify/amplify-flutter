...
class CreateUsagePlanOperation extends _i1.HttpOperation<CreateUsagePlanRequest,
    CreateUsagePlanRequest, UsagePlan, UsagePlan> {
  /// Creates a usage plan with the throttle and quota limits, as well as the associated API stages, specified in the payload.
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateUsagePlanRequest, CreateUsagePlanRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(CreateUsagePlanRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/usageplans';
      });
  @override
  int successCode([UsagePlan? output]) => 201;
  @override
