...
/// Gets SDK types
class GetSdkTypesOperation extends _i1.HttpOperation<GetSdkTypesRequestPayload,
    GetSdkTypesRequest, SdkTypes, SdkTypes> {
  /// Gets SDK types
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetSdkTypesRequestPayload, GetSdkTypesRequest, SdkTypes,
          SdkTypes>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetSdkTypesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/sdktypes';
  ...
  @override
  int successCode([SdkTypes? output]) => 200;
  @override
  SdkTypes buildOutput(
    SdkTypes payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      SdkTypes.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<SdkTypes> run(
