...
class PutIntegrationOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<PutIntegrationRequestPayload, PutIntegrationRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(PutIntegrationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path =
  ...
  @override
  int successCode([Integration? output]) => 201;
  @override
