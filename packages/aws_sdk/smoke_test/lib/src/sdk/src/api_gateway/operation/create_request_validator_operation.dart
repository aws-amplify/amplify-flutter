...
library smoke_test.api_gateway.operation.create_request_validator_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateRequestValidatorOperation extends _i1.HttpOperation<
    _i2.CreateRequestValidatorRequestPayload,
    _i2.CreateRequestValidatorRequest,
    _i3.RequestValidator,
    _i3.RequestValidator> {
  /// Creates a RequestValidator of a given RestApi.
  CreateRequestValidatorOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateRequestValidatorRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/requestvalidators';
      });
  @override
  int successCode([_i3.RequestValidator? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateRequestValidator';
  @override
  ...
  _i1.SmithyOperation<_i3.RequestValidator> run(
    _i2.CreateRequestValidatorRequest input, {
