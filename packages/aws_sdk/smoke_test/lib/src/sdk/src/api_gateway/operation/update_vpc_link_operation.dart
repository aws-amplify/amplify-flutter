...
class UpdateVpcLinkOperation extends _i1.HttpOperation<
    UpdateVpcLinkRequestPayload, UpdateVpcLinkRequest, VpcLink, VpcLink> {
  /// Updates an existing VpcLink of a specified identifier.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateVpcLinkRequestPayload, UpdateVpcLinkRequest,
          VpcLink, VpcLink>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateVpcLinkRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/vpclinks/{vpcLinkId}';
      });
  @override
  int successCode([VpcLink? output]) => 200;
  @override
  VpcLink buildOutput(
    VpcLink payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      VpcLink.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<VpcLink> run(
