...
library smoke_test.api_gateway.operation.get_deployment_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetDeploymentOperation extends _i1.HttpOperation<
    GetDeploymentRequestPayload, GetDeploymentRequest, Deployment, Deployment> {
  /// Gets information about a Deployment resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetDeploymentRequestPayload, GetDeploymentRequest,
          Deployment, Deployment>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetDeploymentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/restapis/{restApiId}/deployments/{deploymentId}';
        if (input.embed != null) {
  ...
  @override
  int successCode([Deployment? output]) => 200;
  @override
  Deployment buildOutput(
    Deployment payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      Deployment.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError<ServiceUnavailableExceptionPayload,
  ...
  @override
  String get runtimeTypeName => 'GetDeployment';
  @override
  ...
  @override
  _i1.SmithyOperation<Deployment> run(
