...
class GetDocumentationPartsOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(GetDocumentationPartsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([DocumentationParts? output]) => 200;
  @override
  DocumentationParts buildOutput(
    DocumentationParts payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DocumentationParts.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DocumentationParts> run(
