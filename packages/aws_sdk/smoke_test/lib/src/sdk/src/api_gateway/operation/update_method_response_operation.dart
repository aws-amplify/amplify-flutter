...
class UpdateMethodResponseOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateMethodResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([MethodResponse? output]) => 201;
  @override
  MethodResponse buildOutput(
    MethodResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      MethodResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<MethodResponse> run(
