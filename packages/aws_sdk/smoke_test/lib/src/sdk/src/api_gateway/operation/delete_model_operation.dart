...
/// Deletes a model.
class DeleteModelOperation extends _i1.HttpOperation<DeleteModelRequestPayload,
    DeleteModelRequest, _i1.Unit, _i1.Unit> {
  /// Deletes a model.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteModelRequestPayload, DeleteModelRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteModelRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
  ...
  @override
  String get runtimeTypeName => 'DeleteModel';
  @override
