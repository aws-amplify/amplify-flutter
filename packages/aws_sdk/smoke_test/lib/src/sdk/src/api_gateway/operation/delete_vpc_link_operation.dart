...
class DeleteVpcLinkOperation extends _i1.HttpOperation<
    DeleteVpcLinkRequestPayload, DeleteVpcLinkRequest, _i1.Unit, _i1.Unit> {
  /// Deletes an existing VpcLink of a specified identifier.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteVpcLinkRequestPayload, DeleteVpcLinkRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteVpcLinkRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
