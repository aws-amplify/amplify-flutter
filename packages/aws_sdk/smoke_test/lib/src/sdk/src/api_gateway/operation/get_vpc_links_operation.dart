...
class GetVpcLinksOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetVpcLinksRequestPayload, GetVpcLinksRequest, VpcLinks,
          VpcLinks>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetVpcLinksRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/vpclinks';
  ...
  @override
  int successCode([VpcLinks? output]) => 200;
  @override
  VpcLinks buildOutput(
    VpcLinks payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      VpcLinks.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<VpcLinks> run(
  ...
  @override
  String? getToken(VpcLinks output) => output.position;
  @override
  _i2.BuiltList<VpcLink> getItems(VpcLinks output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetVpcLinksRequest rebuildInput(
    GetVpcLinksRequest input,
    String token,
    int? pageSize,
  ) =>
