...
library smoke_test.api_gateway.operation.update_usage_plan_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateUsagePlanOperation extends _i1.HttpOperation<
    UpdateUsagePlanRequestPayload,
    UpdateUsagePlanRequest,
    UsagePlan,
    UsagePlan> {
  /// Updates a usage plan of a given plan Id.
  UpdateUsagePlanOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateUsagePlanRequestPayload, UpdateUsagePlanRequest,
          UsagePlan, UsagePlan>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateUsagePlanRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/usageplans/{usagePlanId}';
      });
  @override
  int successCode([UsagePlan? output]) => 200;
  @override
  UsagePlan buildOutput(
    UsagePlan payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UsagePlan.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateUsagePlan';
  @override
  ...
  @override
  _i1.SmithyOperation<UsagePlan> run(
