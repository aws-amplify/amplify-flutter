...
library smoke_test.api_gateway.operation.create_stage_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateStageOperation extends _i1.HttpOperation<
    _i2.CreateStageRequestPayload,
    _i2.CreateStageRequest,
    _i3.Stage,
    _i3.Stage> {
  /// Creates a new Stage resource that references a pre-existing Deployment for the API.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateStageRequestPayload, _i2.CreateStageRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateStageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/stages';
      });
  @override
  int successCode([_i3.Stage? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateStage';
  @override
