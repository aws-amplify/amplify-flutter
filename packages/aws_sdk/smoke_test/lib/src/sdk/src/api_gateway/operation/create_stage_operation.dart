...
class CreateStageOperation extends _i1.HttpOperation<CreateStageRequestPayload,
    CreateStageRequest, Stage, Stage> {
  /// Creates a new Stage resource that references a pre-existing Deployment for the API.
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateStageRequestPayload, CreateStageRequest, Stage,
          Stage>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateStageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/stages';
      });
  @override
  int successCode([Stage? output]) => 201;
  @override
  Stage buildOutput(
    Stage payload,
