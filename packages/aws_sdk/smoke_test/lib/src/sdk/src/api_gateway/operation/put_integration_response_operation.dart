...
library smoke_test.api_gateway.operation.put_integration_response_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutIntegrationResponseOperation extends _i1.HttpOperation<
    PutIntegrationResponseRequestPayload,
    PutIntegrationResponseRequest,
    IntegrationResponse,
    IntegrationResponse> {
  /// Represents a put integration.
  PutIntegrationResponseOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(PutIntegrationResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path =
  ...
  @override
  int successCode([IntegrationResponse? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'PutIntegrationResponse';
  @override
