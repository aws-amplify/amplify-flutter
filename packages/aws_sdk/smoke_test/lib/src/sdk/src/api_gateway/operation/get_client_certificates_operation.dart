...
class GetClientCertificatesOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<ClientCertificate>> {
  /// Gets a collection of ClientCertificate resources.
  ...
  @override
  _i1.HttpRequest buildRequest(GetClientCertificatesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([ClientCertificates? output]) => 200;
  @override
  ClientCertificates buildOutput(
    ClientCertificates payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ClientCertificates.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ClientCertificates> run(
  ...
  @override
  String? getToken(ClientCertificates output) => output.position;
  @override
  _i2.BuiltList<ClientCertificate> getItems(ClientCertificates output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetClientCertificatesRequest rebuildInput(
    GetClientCertificatesRequest input,
    String token,
    int? pageSize,
  ) =>
