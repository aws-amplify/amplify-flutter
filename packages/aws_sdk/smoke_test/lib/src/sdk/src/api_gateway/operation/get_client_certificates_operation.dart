...
library smoke_test.api_gateway.operation.get_client_certificates_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetClientCertificatesOperation extends _i1.PaginatedHttpOperation<
    _i2.GetClientCertificatesRequestPayload,
    _i2.GetClientCertificatesRequest,
    _i3.ClientCertificates,
    _i3.ClientCertificates,
    String,
    int,
    _i4.BuiltList<_i5.ClientCertificate>> {
  /// Gets a collection of ClientCertificate resources.
  GetClientCertificatesOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetClientCertificatesRequest,
          _i3.ClientCertificates,
          _i3.ClientCertificates>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetClientCertificatesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/clientcertificates';
  ...
  @override
  int successCode([_i3.ClientCertificates? output]) => 200;
  @override
  _i3.ClientCertificates buildOutput(
    _i3.ClientCertificates payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ClientCertificates.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetClientCertificates';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ClientCertificates> run(
    _i2.GetClientCertificatesRequest input, {
  ...
  @override
  String? getToken(_i3.ClientCertificates output) => output.position;
  @override
  _i4.BuiltList<_i5.ClientCertificate> getItems(
          _i3.ClientCertificates output) =>
      output.items ?? _i4.BuiltList();
  @override
  _i2.GetClientCertificatesRequest rebuildInput(
    _i2.GetClientCertificatesRequest input,
    String token,
    int? pageSize,
  ) =>
