...
library smoke_test.api_gateway.operation.get_sdk; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetSdkOperation extends _i1.HttpOperation<_i2.GetSdkRequestPayload,
    _i2.GetSdkRequest, _i3.Uint8List, _i4.SdkResponse> {
  /// Generates a client SDK for a RestApi and Stage.
  GetSdkOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetSdkRequestPayload, _i2.GetSdkRequest,
          _i3.Uint8List, _i4.SdkResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetSdkRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([_i4.SdkResponse? output]) => 200;
  @override
  _i4.SdkResponse buildOutput(
    _i3.Uint8List? payload,
    _i8.AWSBaseHttpResponse response,
  ) =>
      _i4.SdkResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i4.SdkResponse> run(
    _i2.GetSdkRequest input, {
