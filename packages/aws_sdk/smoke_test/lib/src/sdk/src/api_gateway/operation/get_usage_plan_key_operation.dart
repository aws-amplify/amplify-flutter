...
class GetUsagePlanKeyOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetUsagePlanKeyRequestPayload, GetUsagePlanKeyRequest,
          UsagePlanKey, UsagePlanKey>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetUsagePlanKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/usageplans/{usagePlanId}/keys/{keyId}';
      });
  @override
  int successCode([UsagePlanKey? output]) => 200;
  @override
  UsagePlanKey buildOutput(
    UsagePlanKey payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UsagePlanKey.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UsagePlanKey> run(
