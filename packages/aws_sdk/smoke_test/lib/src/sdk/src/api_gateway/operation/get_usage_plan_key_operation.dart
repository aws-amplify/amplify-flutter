...
library smoke_test.api_gateway.operation.get_usage_plan_key_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetUsagePlanKeyOperation extends _i1.HttpOperation<
    _i2.GetUsagePlanKeyRequestPayload,
    _i2.GetUsagePlanKeyRequest,
    _i3.UsagePlanKey,
    _i3.UsagePlanKey> {
  /// Gets a usage plan key of a given key identifier.
  GetUsagePlanKeyOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetUsagePlanKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/usageplans/{usagePlanId}/keys/{keyId}';
      });
  @override
  int successCode([_i3.UsagePlanKey? output]) => 200;
  @override
  _i3.UsagePlanKey buildOutput(
    _i3.UsagePlanKey payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.UsagePlanKey.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetUsagePlanKey';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.UsagePlanKey> run(
    _i2.GetUsagePlanKeyRequest input, {
