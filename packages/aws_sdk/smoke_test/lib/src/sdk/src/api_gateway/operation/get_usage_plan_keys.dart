...
library smoke_test.api_gateway.operation.get_usage_plan_keys; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetUsagePlanKeysOperation extends _i1.PaginatedHttpOperation<
    _i2.GetUsagePlanKeysRequestPayload,
    _i2.GetUsagePlanKeysRequest,
    _i3.UsagePlanKeys,
    _i3.UsagePlanKeys,
    String,
    int,
    _i4.BuiltList<_i5.UsagePlanKey>> {
  /// Gets all the usage plan keys representing the API keys added to a specified usage plan.
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetUsagePlanKeysRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([_i3.UsagePlanKeys? output]) => 200;
  @override
  _i3.UsagePlanKeys buildOutput(
    _i3.UsagePlanKeys payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.UsagePlanKeys.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.UsagePlanKeys> run(
    _i2.GetUsagePlanKeysRequest input, {
  ...
  @override
  String? getToken(_i3.UsagePlanKeys output) => output.position;
  @override
  _i4.BuiltList<_i5.UsagePlanKey> getItems(_i3.UsagePlanKeys output) =>
      output.items ?? _i4.BuiltList();
  @override
  _i2.GetUsagePlanKeysRequest rebuildInput(
    _i2.GetUsagePlanKeysRequest input,
    String token,
    int? pageSize,
  ) =>
