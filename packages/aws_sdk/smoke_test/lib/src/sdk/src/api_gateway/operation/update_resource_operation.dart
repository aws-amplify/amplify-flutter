...
library smoke_test.api_gateway.operation.update_resource_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateResourceOperation extends _i1.HttpOperation<
    _i2.UpdateResourceRequestPayload,
    _i2.UpdateResourceRequest,
    _i3.Resource,
    _i3.Resource> {
  /// Changes information about a Resource resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateResourceRequestPayload,
          _i2.UpdateResourceRequest, _i3.Resource, _i3.Resource>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
