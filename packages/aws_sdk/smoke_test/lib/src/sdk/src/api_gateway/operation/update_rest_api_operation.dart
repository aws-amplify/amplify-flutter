...
class UpdateRestApiOperation extends _i1.HttpOperation<
    UpdateRestApiRequestPayload, UpdateRestApiRequest, RestApi, RestApi> {
  /// Changes information about the specified API.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateRestApiRequestPayload, UpdateRestApiRequest,
          RestApi, RestApi>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateRestApiRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/restapis/{restApiId}';
      });
  @override
  int successCode([RestApi? output]) => 200;
  @override
  RestApi buildOutput(
    RestApi payload,
