...
library smoke_test.api_gateway.operation.update_rest_api_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateRestApiOperation extends _i1.HttpOperation<
    _i2.UpdateRestApiRequestPayload,
    _i2.UpdateRestApiRequest,
    _i3.RestApi,
    _i3.RestApi> {
  /// Changes information about the specified API.
  UpdateRestApiOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateRestApiRequestPayload,
          _i2.UpdateRestApiRequest, _i3.RestApi, _i3.RestApi>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateRestApiRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/restapis/{restApiId}';
      });
  @override
  int successCode([_i3.RestApi? output]) => 200;
  @override
