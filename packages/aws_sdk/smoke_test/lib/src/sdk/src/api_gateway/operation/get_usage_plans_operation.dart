...
class GetUsagePlansOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetUsagePlansRequestPayload, GetUsagePlansRequest,
          UsagePlans, UsagePlans>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetUsagePlansRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/usageplans';
  ...
  @override
  int successCode([UsagePlans? output]) => 200;
  @override
  UsagePlans buildOutput(
    UsagePlans payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      UsagePlans.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UsagePlans> run(
  ...
  @override
  String? getToken(UsagePlans output) => output.position;
  @override
  _i2.BuiltList<UsagePlan> getItems(UsagePlans output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetUsagePlansRequest rebuildInput(
    GetUsagePlansRequest input,
    String token,
    int? pageSize,
  ) =>
