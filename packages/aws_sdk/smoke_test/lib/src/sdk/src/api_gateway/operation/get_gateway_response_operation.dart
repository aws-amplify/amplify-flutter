...
library smoke_test.api_gateway.operation.get_gateway_response_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetGatewayResponseOperation extends _i1.HttpOperation<
    _i2.GetGatewayResponseRequestPayload,
    _i2.GetGatewayResponseRequest,
    _i3.GatewayResponse,
    _i3.GatewayResponse> {
  /// Gets a GatewayResponse of a specified response type on the given RestApi.
  GetGatewayResponseOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetGatewayResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  String get runtimeTypeName => 'GetGatewayResponse';
  @override
  ...
  _i1.SmithyOperation<_i3.GatewayResponse> run(
    _i2.GetGatewayResponseRequest input, {
