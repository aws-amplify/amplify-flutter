...
library smoke_test.api_gateway.operation.get_base_path_mappings_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetBasePathMappingsOperation extends _i1.PaginatedHttpOperation<
    _i2.GetBasePathMappingsRequestPayload,
    _i2.GetBasePathMappingsRequest,
    _i3.BasePathMappings,
    _i3.BasePathMappings,
    String,
    int,
    _i4.BuiltList<_i5.BasePathMapping>> {
  /// Represents a collection of BasePathMapping resources.
  GetBasePathMappingsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetBasePathMappingsRequest,
          _i3.BasePathMappings,
          _i3.BasePathMappings>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetBasePathMappingsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/domainnames/{domainName}/basepathmappings';
  ...
  @override
  int successCode([_i3.BasePathMappings? output]) => 200;
  @override
  ...
  @override
  String? getToken(_i3.BasePathMappings output) => output.position;
  @override
  _i4.BuiltList<_i5.BasePathMapping> getItems(_i3.BasePathMappings output) =>
      output.items ?? _i4.BuiltList();
  @override
  _i2.GetBasePathMappingsRequest rebuildInput(
    _i2.GetBasePathMappingsRequest input,
    String token,
    int? pageSize,
  ) =>
