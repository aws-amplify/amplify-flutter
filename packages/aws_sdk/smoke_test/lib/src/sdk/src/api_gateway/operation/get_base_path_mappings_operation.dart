...
class GetBasePathMappingsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(GetBasePathMappingsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([BasePathMappings? output]) => 200;
  @override
  BasePathMappings buildOutput(
    BasePathMappings payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      BasePathMappings.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<BasePathMappings> run(
  ...
  @override
  String? getToken(BasePathMappings output) => output.position;
  @override
  _i2.BuiltList<BasePathMapping> getItems(BasePathMappings output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetBasePathMappingsRequest rebuildInput(
    GetBasePathMappingsRequest input,
    String token,
    int? pageSize,
  ) =>
