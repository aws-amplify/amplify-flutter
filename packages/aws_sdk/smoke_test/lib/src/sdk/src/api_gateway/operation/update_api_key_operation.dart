...
class UpdateApiKeyOperation extends _i1.HttpOperation<
    UpdateApiKeyRequestPayload, UpdateApiKeyRequest, ApiKey, ApiKey> {
  /// Changes information about an ApiKey resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateApiKeyRequestPayload, UpdateApiKeyRequest, ApiKey,
          ApiKey>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateApiKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
