...
library smoke_test.api_gateway.operation.put_method_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutMethodOperation extends _i1.HttpOperation<_i2.PutMethodRequestPayload,
    _i2.PutMethodRequest, _i3.Method, _i3.Method> {
  /// Add a method to an existing Resource resource.
  PutMethodOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.PutMethodRequestPayload, _i2.PutMethodRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutMethodRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path =
  ...
  @override
  int successCode([_i3.Method? output]) => 201;
  @override
