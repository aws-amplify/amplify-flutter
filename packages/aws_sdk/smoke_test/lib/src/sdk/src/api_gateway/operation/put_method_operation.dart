...
class PutMethodOperation extends _i1
    .HttpOperation<PutMethodRequestPayload, PutMethodRequest, Method, Method> {
  /// Add a method to an existing Resource resource.
  PutMethodOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<PutMethodRequestPayload, PutMethodRequest, Method,
          Method>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(PutMethodRequest input) => _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path =
            r'/restapis/{restApiId}/resources/{resourceId}/methods/{httpMethod}';
      });
  @override
  int successCode([Method? output]) => 201;
  @override
  Method buildOutput(
    Method payload,
