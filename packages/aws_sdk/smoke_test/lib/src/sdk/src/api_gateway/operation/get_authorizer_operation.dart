...
library smoke_test.api_gateway.operation.get_authorizer_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetAuthorizerOperation extends _i1.HttpOperation<
    GetAuthorizerRequestPayload, GetAuthorizerRequest, Authorizer, Authorizer> {
  /// Describe an existing Authorizer resource.
  GetAuthorizerOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetAuthorizerRequestPayload, GetAuthorizerRequest,
          Authorizer, Authorizer>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetAuthorizerRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/restapis/{restApiId}/authorizers/{authorizerId}';
      });
  @override
  int successCode([Authorizer? output]) => 200;
  @override
  Authorizer buildOutput(
    Authorizer payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      Authorizer.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetAuthorizer';
  @override
  ...
  @override
  _i1.SmithyOperation<Authorizer> run(
