...
library smoke_test.api_gateway.operation.generate_client_certificate_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GenerateClientCertificateOperation extends _i1.HttpOperation<
    GenerateClientCertificateRequest,
    GenerateClientCertificateRequest,
    ClientCertificate,
    ClientCertificate> {
  /// Generates a ClientCertificate resource.
  GenerateClientCertificateOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(GenerateClientCertificateRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/clientcertificates';
      });
  @override
  int successCode([ClientCertificate? output]) => 201;
  @override
  ClientCertificate buildOutput(
    ClientCertificate payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ClientCertificate.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ClientCertificate> run(
