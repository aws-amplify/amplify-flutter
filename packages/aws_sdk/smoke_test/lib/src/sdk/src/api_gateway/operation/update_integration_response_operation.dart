...
library smoke_test.api_gateway.operation.update_integration_response_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateIntegrationResponseOperation extends _i1.HttpOperation<
    UpdateIntegrationResponseRequestPayload,
    UpdateIntegrationResponseRequest,
    IntegrationResponse,
    IntegrationResponse> {
  /// Represents an update integration response.
  UpdateIntegrationResponseOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateIntegrationResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([IntegrationResponse? output]) => 200;
  @override
  IntegrationResponse buildOutput(
    IntegrationResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      IntegrationResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateIntegrationResponse';
  @override
  ...
  @override
  _i1.SmithyOperation<IntegrationResponse> run(
