...
class GetStageOperation extends _i1
    .HttpOperation<GetStageRequestPayload, GetStageRequest, Stage, Stage> {
  /// Gets information about a Stage resource.
  GetStageOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(GetStageRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
