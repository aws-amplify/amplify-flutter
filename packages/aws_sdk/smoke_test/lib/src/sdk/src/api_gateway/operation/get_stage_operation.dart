...
library smoke_test.api_gateway.operation.get_stage_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetStageOperation extends _i1.HttpOperation<_i2.GetStageRequestPayload,
    _i2.GetStageRequest, _i3.Stage, _i3.Stage> {
  /// Gets information about a Stage resource.
  GetStageOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetStageRequestPayload, _i2.GetStageRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetStageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
