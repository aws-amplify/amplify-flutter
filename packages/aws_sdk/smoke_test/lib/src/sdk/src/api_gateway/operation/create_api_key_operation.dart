...
library smoke_test.api_gateway.operation.create_api_key_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateApiKeyOperation extends _i1.HttpOperation<_i2.CreateApiKeyRequest,
    _i2.CreateApiKeyRequest, _i3.ApiKey, _i3.ApiKey> {
  /// Create an ApiKey resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateApiKeyRequest, _i2.CreateApiKeyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateApiKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/apikeys';
      });
  @override
  int successCode([_i3.ApiKey? output]) => 201;
  @override
