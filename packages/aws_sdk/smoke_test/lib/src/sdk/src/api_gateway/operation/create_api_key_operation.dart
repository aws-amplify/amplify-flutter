...
class CreateApiKeyOperation extends _i1
    .HttpOperation<CreateApiKeyRequest, CreateApiKeyRequest, ApiKey, ApiKey> {
  /// Create an ApiKey resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateApiKeyRequest, CreateApiKeyRequest, ApiKey,
          ApiKey>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateApiKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/apikeys';
      });
  @override
  int successCode([ApiKey? output]) => 201;
  @override
  ApiKey buildOutput(
    ApiKey payload,
