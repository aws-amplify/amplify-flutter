...
class CreateAuthorizerOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateAuthorizerRequestPayload, CreateAuthorizerRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(CreateAuthorizerRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/authorizers';
      });
  @override
  int successCode([Authorizer? output]) => 201;
  @override
