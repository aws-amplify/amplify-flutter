...
library smoke_test.api_gateway.operation.create_authorizer_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateAuthorizerOperation extends _i1.HttpOperation<
    _i2.CreateAuthorizerRequestPayload,
    _i2.CreateAuthorizerRequest,
    _i3.Authorizer,
    _i3.Authorizer> {
  /// Adds a new Authorizer resource to an existing RestApi resource.
  CreateAuthorizerOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateAuthorizerRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/authorizers';
      });
  @override
  int successCode([_i3.Authorizer? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateAuthorizer';
  @override
  ...
  _i1.SmithyOperation<_i3.Authorizer> run(
    _i2.CreateAuthorizerRequest input, {
