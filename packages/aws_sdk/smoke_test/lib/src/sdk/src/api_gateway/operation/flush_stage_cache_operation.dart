...
library smoke_test.api_gateway.operation.flush_stage_cache_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class FlushStageCacheOperation extends _i1.HttpOperation<
    _i2.FlushStageCacheRequestPayload,
    _i2.FlushStageCacheRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Flushes a stage's cache.
  FlushStageCacheOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.FlushStageCacheRequestPayload,
          _i2.FlushStageCacheRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.FlushStageCacheRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
        b.path = r'/restapis/{restApiId}/stages/{stageName}/cache/data';
      });
  @override
  ...
  @override
  String get runtimeTypeName => 'FlushStageCache';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.FlushStageCacheRequest input, {
