...
class FlushStageCacheOperation extends _i1.HttpOperation<
    FlushStageCacheRequestPayload, FlushStageCacheRequest, _i1.Unit, _i1.Unit> {
  /// Flushes a stage's cache.
  ...
  @override
  late final List<
      _i1.HttpProtocol<FlushStageCacheRequestPayload, FlushStageCacheRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(FlushStageCacheRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
