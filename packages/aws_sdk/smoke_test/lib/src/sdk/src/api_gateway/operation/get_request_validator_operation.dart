...
library smoke_test.api_gateway.operation.get_request_validator_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetRequestValidatorOperation extends _i1.HttpOperation<
    _i2.GetRequestValidatorRequestPayload,
    _i2.GetRequestValidatorRequest,
    _i3.RequestValidator,
    _i3.RequestValidator> {
  /// Gets a RequestValidator of a given RestApi.
  GetRequestValidatorOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetRequestValidatorRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
  ...
  @override
  String get runtimeTypeName => 'GetRequestValidator';
  @override
  ...
  _i1.SmithyOperation<_i3.RequestValidator> run(
    _i2.GetRequestValidatorRequest input, {
