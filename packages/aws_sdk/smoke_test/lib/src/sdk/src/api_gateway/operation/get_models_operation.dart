...
class GetModelsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetModelsRequestPayload, GetModelsRequest, Models,
          Models>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetModelsRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Models? output]) => 200;
  @override
  Models buildOutput(
    Models payload,
  ...
  @override
  _i1.SmithyOperation<Models> run(
  ...
  @override
  String? getToken(Models output) => output.position;
  @override
  _i2.BuiltList<Model> getItems(Models output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetModelsRequest rebuildInput(
    GetModelsRequest input,
    String token,
    int? pageSize,
  ) =>
