...
class GetResourceOperation extends _i1.HttpOperation<GetResourceRequestPayload,
    GetResourceRequest, Resource, Resource> {
  /// Lists information about a resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetResourceRequestPayload, GetResourceRequest, Resource,
          Resource>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Resource? output]) => 200;
  @override
