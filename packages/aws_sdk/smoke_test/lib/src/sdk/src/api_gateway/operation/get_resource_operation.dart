...
library smoke_test.api_gateway.operation.get_resource_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetResourceOperation extends _i1.HttpOperation<
    _i2.GetResourceRequestPayload,
    _i2.GetResourceRequest,
    _i3.Resource,
    _i3.Resource> {
  /// Lists information about a resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetResourceRequestPayload, _i2.GetResourceRequest,
          _i3.Resource, _i3.Resource>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/restapis/{restApiId}/resources/{resourceId}';
        if (input.embed != null) {
  ...
  @override
  int successCode([_i3.Resource? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'GetResource';
  @override
