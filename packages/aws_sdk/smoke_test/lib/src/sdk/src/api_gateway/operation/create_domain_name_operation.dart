...
class CreateDomainNameOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateDomainNameRequest, _i2.CreateDomainNameRequest,
          _i3.DomainName, _i3.DomainName>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateDomainNameRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/domainnames';
      });
  @override
  int successCode([_i3.DomainName? output]) => 201;
  @override
  ...
  _i1.SmithyOperation<_i3.DomainName> run(
    _i2.CreateDomainNameRequest input, {
