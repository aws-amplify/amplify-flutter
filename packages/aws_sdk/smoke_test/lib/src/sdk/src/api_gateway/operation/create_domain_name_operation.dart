...
library smoke_test.api_gateway.operation.create_domain_name_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateDomainNameOperation extends _i1.HttpOperation<
    CreateDomainNameRequest, CreateDomainNameRequest, DomainName, DomainName> {
  /// Creates a new domain name.
  CreateDomainNameOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateDomainNameRequest, CreateDomainNameRequest,
          DomainName, DomainName>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateDomainNameRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/domainnames';
      });
  @override
  int successCode([DomainName? output]) => 201;
  @override
  DomainName buildOutput(
    DomainName payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DomainName.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateDomainName';
  @override
  ...
  @override
  _i1.SmithyOperation<DomainName> run(
