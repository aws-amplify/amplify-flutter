...
library smoke_test.api_gateway.operation.test_invoke_authorizer_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TestInvokeAuthorizerOperation extends _i1.HttpOperation<
    TestInvokeAuthorizerRequestPayload,
    TestInvokeAuthorizerRequest,
    TestInvokeAuthorizerResponse,
    TestInvokeAuthorizerResponse> {
  /// Simulate the execution of an Authorizer in your RestApi with headers, parameters, and an incoming request body.
  TestInvokeAuthorizerOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          TestInvokeAuthorizerRequest,
          TestInvokeAuthorizerResponse,
          TestInvokeAuthorizerResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(TestInvokeAuthorizerRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/authorizers/{authorizerId}';
      });
  @override
  int successCode([TestInvokeAuthorizerResponse? output]) => 200;
  @override
  TestInvokeAuthorizerResponse buildOutput(
    TestInvokeAuthorizerResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      TestInvokeAuthorizerResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<TestInvokeAuthorizerResponse> run(
