...
class TestInvokeAuthorizerOperation extends _i1.HttpOperation<
    _i2.TestInvokeAuthorizerRequestPayload,
    _i2.TestInvokeAuthorizerRequest,
    _i3.TestInvokeAuthorizerResponse,
    _i3.TestInvokeAuthorizerResponse> {
  /// Simulate the execution of an Authorizer in your RestApi with headers, parameters, and an incoming request body.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.TestInvokeAuthorizerRequest,
          _i3.TestInvokeAuthorizerResponse,
          _i3.TestInvokeAuthorizerResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.TestInvokeAuthorizerRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/authorizers/{authorizerId}';
      });
  @override
  int successCode([_i3.TestInvokeAuthorizerResponse? output]) => 200;
  @override
