...
library smoke_test.api_gateway.operation.flush_stage_authorizers_cache_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class FlushStageAuthorizersCacheOperation extends _i1.HttpOperation<
    _i2.FlushStageAuthorizersCacheRequestPayload,
    _i2.FlushStageAuthorizersCacheRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Flushes all authorizer cache entries on a stage.
  FlushStageAuthorizersCacheOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.FlushStageAuthorizersCacheRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
        b.path = r'/restapis/{restApiId}/stages/{stageName}/cache/authorizers';
      });
  @override
  ...
  @override
  String get runtimeTypeName => 'FlushStageAuthorizersCache';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.FlushStageAuthorizersCacheRequest input, {
