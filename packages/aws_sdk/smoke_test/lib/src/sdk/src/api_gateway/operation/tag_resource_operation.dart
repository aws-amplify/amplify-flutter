...
class TagResourceOperation extends _i1.HttpOperation<TagResourceRequestPayload,
    TagResourceRequest, _i1.Unit, _i1.Unit> {
  /// Adds or updates a tag on a given resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<TagResourceRequestPayload, TagResourceRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(TagResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
