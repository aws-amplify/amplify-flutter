...
library smoke_test.api_gateway.operation.create_usage_plan_key_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateUsagePlanKeyOperation extends _i1.HttpOperation<
    _i2.CreateUsagePlanKeyRequestPayload,
    _i2.CreateUsagePlanKeyRequest,
    _i3.UsagePlanKey,
    _i3.UsagePlanKey> {
  /// Creates a usage plan key for adding an existing API key to a usage plan.
  CreateUsagePlanKeyOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateUsagePlanKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/usageplans/{usagePlanId}/keys';
      });
  @override
  int successCode([_i3.UsagePlanKey? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateUsagePlanKey';
  @override
  ...
  _i1.SmithyOperation<_i3.UsagePlanKey> run(
    _i2.CreateUsagePlanKeyRequest input, {
