...
class CreateUsagePlanKeyOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateUsagePlanKeyRequestPayload,
          CreateUsagePlanKeyRequest, UsagePlanKey, UsagePlanKey>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateUsagePlanKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/usageplans/{usagePlanId}/keys';
      });
  @override
  int successCode([UsagePlanKey? output]) => 201;
  @override
