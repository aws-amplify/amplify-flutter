...
class UpdateUsageOperation extends _i1.HttpOperation<UpdateUsageRequestPayload,
    UpdateUsageRequest, Usage, Usage> {
  /// Grants a temporary extension to the remaining quota of a usage plan associated with a specified API key.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateUsageRequestPayload, UpdateUsageRequest, Usage,
          Usage>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateUsageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
