...
library smoke_test.api_gateway.operation.update_usage_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateUsageOperation extends _i1.HttpOperation<
    _i2.UpdateUsageRequestPayload,
    _i2.UpdateUsageRequest,
    _i3.Usage,
    _i3.Usage> {
  /// Grants a temporary extension to the remaining quota of a usage plan associated with a specified API key.
  UpdateUsageOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateUsageRequestPayload, _i2.UpdateUsageRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateUsageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/usageplans/{usagePlanId}/keys/{keyId}/usage';
      });
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateUsage';
  @override
