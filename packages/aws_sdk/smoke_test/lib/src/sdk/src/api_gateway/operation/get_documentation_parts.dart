...
library smoke_test.api_gateway.operation.get_documentation_parts; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetDocumentationPartsOperation extends _i1.HttpOperation<
    _i2.GetDocumentationPartsRequestPayload,
    _i2.GetDocumentationPartsRequest,
    _i3.DocumentationParts,
    _i3.DocumentationParts> {
  /// Gets documentation parts.
  GetDocumentationPartsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetDocumentationPartsRequest,
          _i3.DocumentationParts,
          _i3.DocumentationParts>> protocols = [
  ...
  _i1.HttpRequest buildRequest(_i2.GetDocumentationPartsRequest input) =>
      _i1.HttpRequest((b) {
        ...
        if (input.locationStatus != null) {
          b.queryParameters.add(
            'locationStatus',
            input.locationStatus!.value,
          );
        }
      });
  @override
  int successCode([_i3.DocumentationParts? output]) => 200;
  @override
  _i3.DocumentationParts buildOutput(
    _i3.DocumentationParts payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DocumentationParts.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetDocumentationParts';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DocumentationParts> run(
    _i2.GetDocumentationPartsRequest input, {
