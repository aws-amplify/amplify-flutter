...
library smoke_test.api_gateway.operation.update_method_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/conflict_exception.dart'
    as _i10;
import 'package:smoke_test/src/sdk/src/api_gateway/model/method.dart' as _i3;
...
class UpdateMethodOperation extends _i1.HttpOperation<
    _i2.UpdateMethodRequestPayload,
    _i2.UpdateMethodRequest,
    _i3.Method,
    _i3.Method> {
  /// Updates an existing Method resource.
  UpdateMethodOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateMethodRequestPayload, _i2.UpdateMethodRequest,
          _i3.Method, _i3.Method>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateMethodRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([_i3.Method? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateMethod';
  @override
