...
class UpdateMethodOperation extends _i1.HttpOperation<
    UpdateMethodRequestPayload, UpdateMethodRequest, Method, Method> {
  /// Updates an existing Method resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateMethodRequestPayload, UpdateMethodRequest, Method,
          Method>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateMethodRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([Method? output]) => 200;
  @override
  Method buildOutput(
    Method payload,
  ...
  @override
  _i1.SmithyOperation<Method> run(
