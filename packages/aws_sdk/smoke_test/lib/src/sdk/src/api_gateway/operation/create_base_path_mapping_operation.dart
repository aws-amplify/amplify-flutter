...
library smoke_test.api_gateway.operation.create_base_path_mapping_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateBasePathMappingOperation extends _i1.HttpOperation<
    CreateBasePathMappingRequestPayload,
    CreateBasePathMappingRequest,
    BasePathMapping,
    BasePathMapping> {
  /// Creates a new BasePathMapping resource.
  CreateBasePathMappingOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(CreateBasePathMappingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/domainnames/{domainName}/basepathmappings';
      });
  @override
  int successCode([BasePathMapping? output]) => 201;
  @override
  BasePathMapping buildOutput(
    BasePathMapping payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      BasePathMapping.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateBasePathMapping';
  @override
  ...
  @override
  _i1.SmithyOperation<BasePathMapping> run(
