...
class CreateBasePathMappingOperation extends _i1.HttpOperation<
    _i2.CreateBasePathMappingRequestPayload,
    _i2.CreateBasePathMappingRequest,
    _i3.BasePathMapping,
    _i3.BasePathMapping> {
  /// Creates a new BasePathMapping resource.
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateBasePathMappingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/domainnames/{domainName}/basepathmappings';
      });
  @override
  int successCode([_i3.BasePathMapping? output]) => 201;
  @override
  ...
  _i1.SmithyOperation<_i3.BasePathMapping> run(
    _i2.CreateBasePathMappingRequest input, {
