...
class ImportApiKeysOperation extends _i1
    .HttpOperation<_i2.Uint8List, ImportApiKeysRequest, ApiKeyIds, ApiKeyIds> {
  /// Import API keys from an external source, such as a CSV-formatted file.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.Uint8List, ImportApiKeysRequest, ApiKeyIds,
          ApiKeyIds>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ImportApiKeysRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  int successCode([ApiKeyIds? output]) => 201;
  @override
  ApiKeyIds buildOutput(
    ApiKeyIds payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ApiKeyIds.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ApiKeyIds> run(
