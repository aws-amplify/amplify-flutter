...
class GetUsagePlanOperation extends _i1.HttpOperation<
    GetUsagePlanRequestPayload, GetUsagePlanRequest, UsagePlan, UsagePlan> {
  /// Gets a usage plan of a given plan identifier.
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetUsagePlanRequestPayload, GetUsagePlanRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(GetUsagePlanRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
