...
class DeleteGatewayResponseOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteGatewayResponseRequestPayload,
          DeleteGatewayResponseRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteGatewayResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
