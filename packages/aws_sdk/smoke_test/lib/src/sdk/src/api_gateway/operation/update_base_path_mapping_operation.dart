...
library smoke_test.api_gateway.operation.update_base_path_mapping_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateBasePathMappingOperation extends _i1.HttpOperation<
    UpdateBasePathMappingRequestPayload,
    UpdateBasePathMappingRequest,
    BasePathMapping,
    BasePathMapping> {
  /// Changes information about the BasePathMapping resource.
  UpdateBasePathMappingOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateBasePathMappingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/domainnames/{domainName}/basepathmappings/{basePath}';
      });
  @override
  int successCode([BasePathMapping? output]) => 200;
  @override
