...
library smoke_test.api_gateway.operation.get_rest_api_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetRestApiOperation extends _i1.HttpOperation<
    _i2.GetRestApiRequestPayload,
    _i2.GetRestApiRequest,
    _i3.RestApi,
    _i3.RestApi> {
  /// Lists the RestApi resource in the collection.
  GetRestApiOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetRestApiRequestPayload, _i2.GetRestApiRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetRestApiRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  String get runtimeTypeName => 'GetRestApi';
  @override
