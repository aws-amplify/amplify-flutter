...
class GetRestApiOperation extends _i1.HttpOperation<GetRestApiRequestPayload,
    GetRestApiRequest, RestApi, RestApi> {
  /// Lists the RestApi resource in the collection.
  GetRestApiOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetRestApiRequestPayload, GetRestApiRequest, RestApi,
          RestApi>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetRestApiRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
