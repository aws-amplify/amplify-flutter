...
class TestInvokeMethodOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<TestInvokeMethodRequestPayload, TestInvokeMethodRequest,
          TestInvokeMethodResponse, TestInvokeMethodResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(TestInvokeMethodRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path =
  ...
  @override
  int successCode([TestInvokeMethodResponse? output]) => 200;
  @override
  TestInvokeMethodResponse buildOutput(
    TestInvokeMethodResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      TestInvokeMethodResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<TestInvokeMethodResponse> run(
