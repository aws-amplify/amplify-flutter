...
class DeleteStageOperation extends _i1.HttpOperation<DeleteStageRequestPayload,
    DeleteStageRequest, _i1.Unit, _i1.Unit> {
  /// Deletes a Stage resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteStageRequestPayload, DeleteStageRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteStageRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
