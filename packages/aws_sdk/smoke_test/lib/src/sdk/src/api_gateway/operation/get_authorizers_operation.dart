...
library smoke_test.api_gateway.operation.get_authorizers_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetAuthorizersOperation extends _i1.HttpOperation<
    GetAuthorizersRequestPayload,
    GetAuthorizersRequest,
    Authorizers,
    Authorizers> {
  /// Describe an existing Authorizers resource.
  GetAuthorizersOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetAuthorizersRequestPayload, GetAuthorizersRequest,
          Authorizers, Authorizers>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetAuthorizersRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Authorizers? output]) => 200;
  @override
  Authorizers buildOutput(
    Authorizers payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      Authorizers.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<Authorizers> run(
