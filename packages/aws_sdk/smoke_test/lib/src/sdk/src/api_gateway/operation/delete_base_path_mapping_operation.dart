...
class DeleteBasePathMappingOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteBasePathMappingRequestPayload,
          DeleteBasePathMappingRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteBasePathMappingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
