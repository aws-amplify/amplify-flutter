...
library smoke_test.api_gateway.model.unauthorized_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UnauthorizedExceptionRestJson1Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final UnauthorizedException(:message) = payload;
    if (message != null) {
      result
        ..add('message')
