...
library smoke_test.api_gateway.operation.import_api_keys; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ImportApiKeysOperation extends _i1.HttpOperation<_i2.Uint8List,
    _i3.ImportApiKeysRequest, _i4.ApiKeyIds, _i4.ApiKeyIds> {
  /// Import API keys from an external source, such as a CSV-formatted file.
  ImportApiKeysOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.Uint8List, _i3.ImportApiKeysRequest, _i4.ApiKeyIds,
          _i4.ApiKeyIds>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i3.ImportApiKeysRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/apikeys?mode=import';
