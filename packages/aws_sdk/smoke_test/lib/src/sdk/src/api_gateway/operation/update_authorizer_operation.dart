...
library smoke_test.api_gateway.operation.update_authorizer_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateAuthorizerOperation extends _i1.HttpOperation<
    _i2.UpdateAuthorizerRequestPayload,
    _i2.UpdateAuthorizerRequest,
    _i3.Authorizer,
    _i3.Authorizer> {
  /// Updates an existing Authorizer resource.
  UpdateAuthorizerOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateAuthorizerRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/restapis/{restApiId}/authorizers/{authorizerId}';
      });
  @override
  int successCode([_i3.Authorizer? output]) => 200;
  @override
  _i3.Authorizer buildOutput(
    _i3.Authorizer payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.Authorizer.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateAuthorizer';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.Authorizer> run(
    _i2.UpdateAuthorizerRequest input, {
