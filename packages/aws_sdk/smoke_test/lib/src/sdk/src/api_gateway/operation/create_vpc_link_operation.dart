...
class CreateVpcLinkOperation extends _i1.HttpOperation<CreateVpcLinkRequest,
    CreateVpcLinkRequest, VpcLink, VpcLink> {
  /// Creates a VPC link, under the caller's account in a selected region, in an asynchronous operation that typically takes 2-4 minutes to complete and become operational. The caller must have permissions to create and update VPC Endpoint services.
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateVpcLinkRequest, CreateVpcLinkRequest, VpcLink,
          VpcLink>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateVpcLinkRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/vpclinks';
      });
  @override
  int successCode([VpcLink? output]) => 202;
  @override
  VpcLink buildOutput(
    VpcLink payload,
