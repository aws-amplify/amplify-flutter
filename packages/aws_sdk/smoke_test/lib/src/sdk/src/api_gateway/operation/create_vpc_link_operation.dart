...
library smoke_test.api_gateway.operation.create_vpc_link_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateVpcLinkOperation extends _i1.HttpOperation<_i2.CreateVpcLinkRequest,
    _i2.CreateVpcLinkRequest, _i3.VpcLink, _i3.VpcLink> {
  /// Creates a VPC link, under the caller's account in a selected region, in an asynchronous operation that typically takes 2-4 minutes to complete and become operational. The caller must have permissions to create and update VPC Endpoint services.
  CreateVpcLinkOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateVpcLinkRequest, _i2.CreateVpcLinkRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateVpcLinkRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/vpclinks';
      });
  @override
  int successCode([_i3.VpcLink? output]) => 202;
  @override
