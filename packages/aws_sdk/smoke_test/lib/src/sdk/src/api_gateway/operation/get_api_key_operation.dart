...
class GetApiKeyOperation extends _i1
    .HttpOperation<GetApiKeyRequestPayload, GetApiKeyRequest, ApiKey, ApiKey> {
  /// Gets information about the current ApiKey resource.
  GetApiKeyOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetApiKeyRequestPayload, GetApiKeyRequest, ApiKey,
          ApiKey>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetApiKeyRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([ApiKey? output]) => 200;
  @override
  ApiKey buildOutput(
    ApiKey payload,
  ...
  @override
  _i1.SmithyOperation<ApiKey> run(
