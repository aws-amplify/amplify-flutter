...
library smoke_test.api_gateway.operation.get_api_key_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/common/serializers.dart'
    as _i6;
import 'package:smoke_test/src/sdk/src/api_gateway/model/api_key.dart' as _i3;
...
class GetApiKeyOperation extends _i1.HttpOperation<_i2.GetApiKeyRequestPayload,
    _i2.GetApiKeyRequest, _i3.ApiKey, _i3.ApiKey> {
  /// Gets information about the current ApiKey resource.
  GetApiKeyOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetApiKeyRequestPayload, _i2.GetApiKeyRequest,
          _i3.ApiKey, _i3.ApiKey>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetApiKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/apikeys/{apiKey}';
        if (input.includeValue != null) {
          b.queryParameters.add(
            'includeValue',
            input.includeValue!.toString(),
          );
        }
      });
  @override
  int successCode([_i3.ApiKey? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'GetApiKey';
  @override
