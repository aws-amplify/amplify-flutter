...
class GetStagesOperation extends _i1
    .HttpOperation<GetStagesRequestPayload, GetStagesRequest, Stages, Stages> {
  /// Gets information about one or more Stage resources.
  GetStagesOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetStagesRequestPayload, GetStagesRequest, Stages,
          Stages>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetStagesRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Stages? output]) => 200;
  @override
  Stages buildOutput(
    Stages payload,
  ...
  @override
  _i1.SmithyOperation<Stages> run(
