...
library smoke_test.api_gateway.operation.get_stages_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/not_found_exception.dart'
    as _i12;
import 'package:smoke_test/src/sdk/src/api_gateway/model/stages.dart' as _i3;
...
class GetStagesOperation extends _i1.HttpOperation<_i2.GetStagesRequestPayload,
    _i2.GetStagesRequest, _i3.Stages, _i3.Stages> {
  /// Gets information about one or more Stage resources.
  GetStagesOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetStagesRequestPayload, _i2.GetStagesRequest,
          _i3.Stages, _i3.Stages>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetStagesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/restapis/{restApiId}/stages';
  ...
  @override
  int successCode([_i3.Stages? output]) => 200;
  @override
  _i3.Stages buildOutput(
    _i3.Stages payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.Stages.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetStages';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.Stages> run(
    _i2.GetStagesRequest input, {
