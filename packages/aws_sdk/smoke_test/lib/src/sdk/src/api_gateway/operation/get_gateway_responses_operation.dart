...
library smoke_test.api_gateway.operation.get_gateway_responses_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetGatewayResponsesOperation extends _i1.HttpOperation<
    _i2.GetGatewayResponsesRequestPayload,
    _i2.GetGatewayResponsesRequest,
    _i3.GatewayResponses,
    _i3.GatewayResponses> {
  /// Gets the GatewayResponses collection on the given RestApi. If an API developer has not added any definitions for gateway responses, the result will be the API Gateway-generated default GatewayResponses collection for the supported response types.
  GetGatewayResponsesOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetGatewayResponsesRequest,
          _i3.GatewayResponses,
          _i3.GatewayResponses>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetGatewayResponsesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/restapis/{restApiId}/gatewayresponses';
  ...
  @override
  int successCode([_i3.GatewayResponses? output]) => 200;
  @override
