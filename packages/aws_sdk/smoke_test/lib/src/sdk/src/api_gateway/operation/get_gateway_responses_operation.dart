...
class GetGatewayResponsesOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(GetGatewayResponsesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([GatewayResponses? output]) => 200;
  @override
  GatewayResponses buildOutput(
    GatewayResponses payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GatewayResponses.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GatewayResponses> run(
