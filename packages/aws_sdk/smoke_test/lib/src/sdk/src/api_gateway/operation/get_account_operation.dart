...
library smoke_test.api_gateway.operation.get_account_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetAccountOperation extends _i1.HttpOperation<_i2.GetAccountRequest,
    _i2.GetAccountRequest, _i3.Account, _i3.Account> {
  /// Gets information about the current Account resource.
  GetAccountOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetAccountRequest, _i2.GetAccountRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetAccountRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/account';
      });
