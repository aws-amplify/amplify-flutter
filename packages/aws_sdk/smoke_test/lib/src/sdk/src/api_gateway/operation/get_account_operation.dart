...
class GetAccountOperation extends _i1
    .HttpOperation<GetAccountRequest, GetAccountRequest, Account, Account> {
  /// Gets information about the current Account resource.
  GetAccountOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(GetAccountRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/account';
      });
  @override
