...
library smoke_test.api_gateway.operation.create_model_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/limit_exceeded_exception.dart'
    as _i11;
import 'package:smoke_test/src/sdk/src/api_gateway/model/model.dart' as _i3;
...
class CreateModelOperation extends _i1.HttpOperation<
    _i2.CreateModelRequestPayload,
    _i2.CreateModelRequest,
    _i3.Model,
    _i3.Model> {
  /// Adds a new Model resource to an existing RestApi resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateModelRequestPayload, _i2.CreateModelRequest,
          _i3.Model, _i3.Model>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateModelRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/models';
      });
  @override
  int successCode([_i3.Model? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateModel';
  @override
