...
class CreateModelOperation extends _i1.HttpOperation<CreateModelRequestPayload,
    CreateModelRequest, Model, Model> {
  /// Adds a new Model resource to an existing RestApi resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateModelRequestPayload, CreateModelRequest, Model,
          Model>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateModelRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/models';
      });
  @override
  int successCode([Model? output]) => 201;
  @override
  Model buildOutput(
    Model payload,
