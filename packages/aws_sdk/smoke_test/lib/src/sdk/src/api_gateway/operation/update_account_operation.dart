...
class UpdateAccountOperation extends _i1.HttpOperation<UpdateAccountRequest,
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateAccountRequest, UpdateAccountRequest, Account,
          Account>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateAccountRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/account';
      });
  @override
  int successCode([Account? output]) => 200;
  @override
  Account buildOutput(
    Account payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      Account.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<Account> run(
