...
library smoke_test.api_gateway.operation.update_account_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/common/serializers.dart'
    as _i6;
import 'package:smoke_test/src/sdk/src/api_gateway/model/account.dart' as _i3;
...
class UpdateAccountOperation extends _i1.HttpOperation<_i2.UpdateAccountRequest,
    _i2.UpdateAccountRequest, _i3.Account, _i3.Account> {
  /// Changes information about the current Account resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateAccountRequest, _i2.UpdateAccountRequest,
          _i3.Account, _i3.Account>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateAccountRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/account';
      });
  @override
  int successCode([_i3.Account? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateAccount';
  @override
  ...
  _i1.SmithyOperation<_i3.Account> run(
    _i2.UpdateAccountRequest input, {
