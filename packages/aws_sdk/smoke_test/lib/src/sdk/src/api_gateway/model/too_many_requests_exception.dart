...
library smoke_test.api_gateway.model.too_many_requests_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TooManyRequestsExceptionRestJson1Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final TooManyRequestsExceptionPayload(:message) = payload;
    if (message != null) {
      result
        ..add('message')
