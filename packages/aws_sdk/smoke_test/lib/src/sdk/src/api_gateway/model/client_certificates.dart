...
abstract class ClientCertificates
  ...
  static const List<_i3.SmithySerializer<ClientCertificates>> serializers = [
    ClientCertificatesRestJson1Serializer()
  ];

  /// The current page of elements from this collection.
  _i2.BuiltList<ClientCertificate>? get items;
...
class ClientCertificatesRestJson1Serializer
    extends _i3.StructuredSmithySerializer<ClientCertificates> {
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'item':
          ...
          ) as _i2.BuiltList<ClientCertificate>));
        case 'position':
