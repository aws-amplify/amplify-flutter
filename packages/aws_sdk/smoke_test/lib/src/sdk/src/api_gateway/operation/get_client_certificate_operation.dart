...
library smoke_test.api_gateway.operation.get_client_certificate_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetClientCertificateOperation extends _i1.HttpOperation<
    GetClientCertificateRequestPayload,
    GetClientCertificateRequest,
    ClientCertificate,
    ClientCertificate> {
  /// Gets information about the current ClientCertificate resource.
  GetClientCertificateOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(GetClientCertificateRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/clientcertificates/{clientCertificateId}';
      });
  @override
  int successCode([ClientCertificate? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'GetClientCertificate';
  @override
