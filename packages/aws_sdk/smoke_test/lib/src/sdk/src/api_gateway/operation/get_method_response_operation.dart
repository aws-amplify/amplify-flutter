...
library smoke_test.api_gateway.operation.get_method_response_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetMethodResponseOperation extends _i1.HttpOperation<
    _i2.GetMethodResponseRequestPayload,
    _i2.GetMethodResponseRequest,
    _i3.MethodResponse,
    _i3.MethodResponse> {
  /// Describes a MethodResponse resource.
  GetMethodResponseOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetMethodResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
  ...
  @override
  int successCode([_i3.MethodResponse? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'GetMethodResponse';
  @override
  ...
  _i1.SmithyOperation<_i3.MethodResponse> run(
    _i2.GetMethodResponseRequest input, {
