...
class CreateDeploymentOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateDeploymentRequestPayload, CreateDeploymentRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(CreateDeploymentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/deployments';
      });
  @override
  int successCode([Deployment? output]) => 201;
  @override
