...
library smoke_test.api_gateway.operation.create_deployment_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateDeploymentOperation extends _i1.HttpOperation<
    _i2.CreateDeploymentRequestPayload,
    _i2.CreateDeploymentRequest,
    _i3.Deployment,
    _i3.Deployment> {
  /// Creates a Deployment resource, which makes a specified RestApi callable over the internet.
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateDeploymentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/deployments';
      });
  @override
  int successCode([_i3.Deployment? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateDeployment';
  @override
  ...
  _i1.SmithyOperation<_i3.Deployment> run(
    _i2.CreateDeploymentRequest input, {
