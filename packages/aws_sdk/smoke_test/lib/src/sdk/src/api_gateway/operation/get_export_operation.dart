...
class GetExportOperation extends _i1.HttpOperation<GetExportRequestPayload,
    GetExportRequest, _i2.Uint8List, ExportResponse> {
  /// Exports a deployed version of a RestApi in a specified format.
  GetExportOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetExportRequestPayload, GetExportRequest, _i2.Uint8List,
          ExportResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetExportRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
  ...
  @override
  int successCode([ExportResponse? output]) => 200;
  @override
  ExportResponse buildOutput(
    _i2.Uint8List? payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ExportResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ExportResponse> run(
