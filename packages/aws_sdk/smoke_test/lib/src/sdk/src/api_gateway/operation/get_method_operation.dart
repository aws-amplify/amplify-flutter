...
library smoke_test.api_gateway.operation.get_method_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetMethodOperation extends _i1.HttpOperation<_i2.GetMethodRequestPayload,
    _i2.GetMethodRequest, _i3.Method, _i3.Method> {
  /// Describe an existing Method resource.
  GetMethodOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetMethodRequestPayload, _i2.GetMethodRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetMethodRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
  ...
  @override
  String get runtimeTypeName => 'GetMethod';
  @override
