...
class GetMethodOperation extends _i1
    .HttpOperation<GetMethodRequestPayload, GetMethodRequest, Method, Method> {
  /// Describe an existing Method resource.
  GetMethodOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetMethodRequestPayload, GetMethodRequest, Method,
          Method>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetMethodRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
