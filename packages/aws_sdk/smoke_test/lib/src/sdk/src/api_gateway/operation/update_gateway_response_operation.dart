...
class UpdateGatewayResponseOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateGatewayResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/restapis/{restApiId}/gatewayresponses/{responseType}';
      });
  @override
  int successCode([GatewayResponse? output]) => 200;
  @override
  GatewayResponse buildOutput(
    GatewayResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GatewayResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GatewayResponse> run(
