...
class DeleteRestApiOperation extends _i1.HttpOperation<
    DeleteRestApiRequestPayload, DeleteRestApiRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the specified API.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteRestApiRequestPayload, DeleteRestApiRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteRestApiRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
