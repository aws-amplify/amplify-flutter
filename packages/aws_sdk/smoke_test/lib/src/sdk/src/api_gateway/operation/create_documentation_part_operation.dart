...
library smoke_test.api_gateway.operation.create_documentation_part_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateDocumentationPartOperation extends _i1.HttpOperation<
    CreateDocumentationPartRequestPayload,
    CreateDocumentationPartRequest,
    DocumentationPart,
    DocumentationPart> {
  /// Creates a documentation part.
  CreateDocumentationPartOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(CreateDocumentationPartRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/documentation/parts';
      });
  @override
  int successCode([DocumentationPart? output]) => 201;
  @override
  DocumentationPart buildOutput(
    DocumentationPart payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DocumentationPart.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateDocumentationPart';
  @override
  ...
  @override
  _i1.SmithyOperation<DocumentationPart> run(
