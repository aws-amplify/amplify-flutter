...
library smoke_test.api_gateway.operation.get_vpc_link_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetVpcLinkOperation extends _i1.HttpOperation<
    _i2.GetVpcLinkRequestPayload,
    _i2.GetVpcLinkRequest,
    _i3.VpcLink,
    _i3.VpcLink> {
  /// Gets a specified VPC link under the caller's account in a region.
  GetVpcLinkOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetVpcLinkRequestPayload, _i2.GetVpcLinkRequest,
          _i3.VpcLink, _i3.VpcLink>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetVpcLinkRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  String get runtimeTypeName => 'GetVpcLink';
  @override
