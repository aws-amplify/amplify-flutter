...
class GetVpcLinkOperation extends _i1.HttpOperation<GetVpcLinkRequestPayload,
    GetVpcLinkRequest, VpcLink, VpcLink> {
  /// Gets a specified VPC link under the caller's account in a region.
  GetVpcLinkOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetVpcLinkRequestPayload, GetVpcLinkRequest, VpcLink,
          VpcLink>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetVpcLinkRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
