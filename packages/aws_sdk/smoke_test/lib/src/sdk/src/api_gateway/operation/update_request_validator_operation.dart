...
class UpdateRequestValidatorOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateRequestValidatorRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([RequestValidator? output]) => 200;
  @override
  RequestValidator buildOutput(
    RequestValidator payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RequestValidator.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<RequestValidator> run(
