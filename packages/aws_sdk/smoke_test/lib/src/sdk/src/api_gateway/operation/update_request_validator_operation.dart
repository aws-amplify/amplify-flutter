...
library smoke_test.api_gateway.operation.update_request_validator_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateRequestValidatorOperation extends _i1.HttpOperation<
    _i2.UpdateRequestValidatorRequestPayload,
    _i2.UpdateRequestValidatorRequest,
    _i3.RequestValidator,
    _i3.RequestValidator> {
  /// Updates a RequestValidator of a given RestApi.
  UpdateRequestValidatorOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.UpdateRequestValidatorRequest,
          _i3.RequestValidator,
          _i3.RequestValidator>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateRequestValidatorRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
            r'/restapis/{restApiId}/requestvalidators/{requestValidatorId}';
      });
  @override
  int successCode([_i3.RequestValidator? output]) => 200;
  @override
  _i3.RequestValidator buildOutput(
    _i3.RequestValidator payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.RequestValidator.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateRequestValidator';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.RequestValidator> run(
    _i2.UpdateRequestValidatorRequest input, {
