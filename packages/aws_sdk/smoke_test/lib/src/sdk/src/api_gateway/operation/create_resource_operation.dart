...
library smoke_test.api_gateway.operation.create_resource_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/not_found_exception.dart'
    as _i12;
import 'package:smoke_test/src/sdk/src/api_gateway/model/resource.dart' as _i3;
...
class CreateResourceOperation extends _i1.HttpOperation<
    _i2.CreateResourceRequestPayload,
    _i2.CreateResourceRequest,
    _i3.Resource,
    _i3.Resource> {
  /// Creates a Resource resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.CreateResourceRequestPayload,
          _i2.CreateResourceRequest, _i3.Resource, _i3.Resource>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/resources/{parentId}';
      });
  @override
  int successCode([_i3.Resource? output]) => 201;
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateResource';
  @override
  ...
  _i1.SmithyOperation<_i3.Resource> run(
    _i2.CreateResourceRequest input, {
