...
class CreateResourceOperation extends _i1.HttpOperation<
    CreateResourceRequestPayload, CreateResourceRequest, Resource, Resource> {
  /// Creates a Resource resource.
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateResourceRequestPayload, CreateResourceRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(CreateResourceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/restapis/{restApiId}/resources/{parentId}';
      });
  @override
  int successCode([Resource? output]) => 201;
  @override
  Resource buildOutput(
    Resource payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      Resource.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<Resource> run(
