...
library smoke_test.api_gateway.operation.get_model; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetModelOperation extends _i1.HttpOperation<_i2.GetModelRequestPayload,
    _i2.GetModelRequest, _i3.Model, _i3.Model> {
  /// Describes an existing model defined for a RestApi resource.
  GetModelOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetModelRequestPayload, _i2.GetModelRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetModelRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
