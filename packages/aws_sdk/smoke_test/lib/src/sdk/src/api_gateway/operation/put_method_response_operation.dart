...
library smoke_test.api_gateway.operation.put_method_response_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutMethodResponseOperation extends _i1.HttpOperation<
    _i2.PutMethodResponseRequestPayload,
    _i2.PutMethodResponseRequest,
    _i3.MethodResponse,
    _i3.MethodResponse> {
  /// Adds a MethodResponse to an existing Method resource.
  PutMethodResponseOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutMethodResponseRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path =
  ...
  @override
  String get runtimeTypeName => 'PutMethodResponse';
  @override
  ...
  _i1.SmithyOperation<_i3.MethodResponse> run(
    _i2.PutMethodResponseRequest input, {
