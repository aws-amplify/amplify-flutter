...
class GetDomainNamesOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetDomainNamesRequestPayload, GetDomainNamesRequest,
          DomainNames, DomainNames>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetDomainNamesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([DomainNames? output]) => 200;
  @override
  DomainNames buildOutput(
    DomainNames payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DomainNames.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DomainNames> run(
  ...
  @override
  String? getToken(DomainNames output) => output.position;
  @override
  _i2.BuiltList<DomainName> getItems(DomainNames output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetDomainNamesRequest rebuildInput(
    GetDomainNamesRequest input,
    String token,
    int? pageSize,
  ) =>
