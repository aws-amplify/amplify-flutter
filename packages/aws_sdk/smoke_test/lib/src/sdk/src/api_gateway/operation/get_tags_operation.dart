...
library smoke_test.api_gateway.operation.get_tags_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/model/not_found_exception.dart'
    as _i10;
import 'package:smoke_test/src/sdk/src/api_gateway/model/tags.dart' as _i3;
...
class GetTagsOperation extends _i1.HttpOperation<_i2.GetTagsRequestPayload,
    _i2.GetTagsRequest, _i3.Tags, _i3.Tags> {
  /// Gets the Tags collection for a given resource.
  GetTagsOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetTagsRequestPayload, _i2.GetTagsRequest, _i3.Tags,
          _i3.Tags>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([_i3.Tags? output]) => 200;
  @override
  _i3.Tags buildOutput(
    _i3.Tags payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.Tags.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetTags';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.Tags> run(
    _i2.GetTagsRequest input, {
