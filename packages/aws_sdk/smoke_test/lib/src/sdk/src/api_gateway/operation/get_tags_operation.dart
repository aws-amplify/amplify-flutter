...
class GetTagsOperation extends _i1
    .HttpOperation<GetTagsRequestPayload, GetTagsRequest, Tags, Tags> {
  /// Gets the Tags collection for a given resource.
  GetTagsOperation({
  ...
  @override
  late final List<
          _i1.HttpProtocol<GetTagsRequestPayload, GetTagsRequest, Tags, Tags>>
      protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetTagsRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([Tags? output]) => 200;
  @override
  Tags buildOutput(
    Tags payload,
