...
library smoke_test.api_gateway.operation.get_api_keys_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/api_gateway/common/serializers.dart'
    as _i8;
import 'package:smoke_test/src/sdk/src/api_gateway/model/api_key.dart' as _i5;
import 'package:smoke_test/src/sdk/src/api_gateway/model/api_keys.dart' as _i3;
...
class GetApiKeysOperation extends _i1.PaginatedHttpOperation<
    _i2.GetApiKeysRequestPayload,
    _i2.GetApiKeysRequest,
    _i3.ApiKeys,
    _i3.ApiKeys,
    String,
    int,
    _i4.BuiltList<_i5.ApiKey>> {
  /// Gets information about the current ApiKeys resource.
  GetApiKeysOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetApiKeysRequestPayload, _i2.GetApiKeysRequest,
          _i3.ApiKeys, _i3.ApiKeys>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetApiKeysRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/apikeys';
        ...
        if (input.includeValues != null) {
          b.queryParameters.add(
            'includeValues',
            input.includeValues!.toString(),
          );
        }
      });
  @override
  int successCode([_i3.ApiKeys? output]) => 200;
  @override
  ...
  @override
  String? getToken(_i3.ApiKeys output) => output.position;
  @override
  _i4.BuiltList<_i5.ApiKey> getItems(_i3.ApiKeys output) =>
      output.items ?? _i4.BuiltList();
  @override
  _i2.GetApiKeysRequest rebuildInput(
    _i2.GetApiKeysRequest input,
    String token,
    int? pageSize,
  ) =>
