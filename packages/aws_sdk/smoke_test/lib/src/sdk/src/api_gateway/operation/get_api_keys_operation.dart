...
class GetApiKeysOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetApiKeysRequestPayload, GetApiKeysRequest, ApiKeys,
          ApiKeys>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetApiKeysRequest input) => _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path = r'/apikeys';
  ...
  @override
  int successCode([ApiKeys? output]) => 200;
  @override
  ApiKeys buildOutput(
    ApiKeys payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ApiKeys.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ApiKeys> run(
  ...
  @override
  String? getToken(ApiKeys output) => output.position;
  @override
  _i2.BuiltList<ApiKey> getItems(ApiKeys output) =>
      output.items ?? _i2.BuiltList();
  @override
  GetApiKeysRequest rebuildInput(
    GetApiKeysRequest input,
    String token,
    int? pageSize,
  ) =>
