...
library smoke_test.api_gateway.operation.update_domain_name_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateDomainNameOperation extends _i1.HttpOperation<
    UpdateDomainNameRequestPayload,
    UpdateDomainNameRequest,
    DomainName,
    DomainName> {
  /// Changes information about the DomainName resource.
  UpdateDomainNameOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateDomainNameRequestPayload, UpdateDomainNameRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateDomainNameRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path = r'/domainnames/{domainName}';
      });
  @override
  int successCode([DomainName? output]) => 200;
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateDomainName';
  @override
