...
library smoke_test.api_gateway.operation.update_integration_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateIntegrationOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateIntegrationRequestPayload,
          UpdateIntegrationRequest, Integration, Integration>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateIntegrationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PATCH';
        b.path =
  ...
  @override
  int successCode([Integration? output]) => 200;
  @override
  Integration buildOutput(
    Integration payload,
  ...
  @override
  String get runtimeTypeName => 'UpdateIntegration';
  @override
  ...
  @override
  _i1.SmithyOperation<Integration> run(
