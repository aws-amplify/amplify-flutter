...
class ModifyVpcEndpointServicePermissionsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ModifyVpcEndpointServicePermissionsRequest,
          ModifyVpcEndpointServicePermissionsResult,
          ModifyVpcEndpointServicePermissionsResult>> protocols = [
  ...
  @override
  int successCode([ModifyVpcEndpointServicePermissionsResult? output]) => 200;
  @override
  ModifyVpcEndpointServicePermissionsResult buildOutput(
    ModifyVpcEndpointServicePermissionsResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ModifyVpcEndpointServicePermissionsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ModifyVpcEndpointServicePermissionsResult> run(
    ModifyVpcEndpointServicePermissionsRequest input, {
