...
class DescribeScheduledInstanceAvailabilityOperation extends _i1
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeScheduledInstanceAvailabilityRequest,
          DescribeScheduledInstanceAvailabilityResult,
          DescribeScheduledInstanceAvailabilityResult>> protocols = [
  ...
  @override
  int successCode([DescribeScheduledInstanceAvailabilityResult? output]) => 200;
  @override
  DescribeScheduledInstanceAvailabilityResult buildOutput(
    DescribeScheduledInstanceAvailabilityResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeScheduledInstanceAvailabilityResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeScheduledInstanceAvailabilityResult> run(
    DescribeScheduledInstanceAvailabilityRequest input, {
  ...
  @override
  String? getToken(DescribeScheduledInstanceAvailabilityResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<ScheduledInstanceAvailability> getItems(
          DescribeScheduledInstanceAvailabilityResult output) =>
      output.scheduledInstanceAvailabilitySet ?? _i2.BuiltList();
  @override
  DescribeScheduledInstanceAvailabilityRequest rebuildInput(
    DescribeScheduledInstanceAvailabilityRequest input,
    String token,
    int? pageSize,
  ) =>
