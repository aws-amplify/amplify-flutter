...
library smoke_test.ec2.operation.modify_ipam_resource_cidr_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ModifyIpamResourceCidrOperation extends _i1.HttpOperation<
  ...
  ///
  /// For more information, see [Move resource CIDRs between scopes](https://docs.aws.amazon.com/vpc/latest/ipam/move-resource-ipam.html) and [Change the monitoring state of resource CIDRs](https://docs.aws.amazon.com/vpc/latest/ipam/change-monitoring-state-ipam.html) in the _Amazon VPC IPAM User Guide_.
  ModifyIpamResourceCidrOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ModifyIpamResourceCidrRequest,
          ModifyIpamResourceCidrResult,
          ModifyIpamResourceCidrResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ModifyIpamResourceCidrRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ModifyIpamResourceCidrResult? output]) => 200;
  @override
  ModifyIpamResourceCidrResult buildOutput(
    ModifyIpamResourceCidrResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ModifyIpamResourceCidrResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ModifyIpamResourceCidr';
  @override
  ...
  @override
  _i1.SmithyOperation<ModifyIpamResourceCidrResult> run(
