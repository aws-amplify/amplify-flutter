...
class DescribeInstanceEventWindowsOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<InstanceEventWindow>> {
  /// Describes the specified event windows or all event windows.
  ///
  /// If you specify event window IDs, the output includes information for only the specified event windows. If you specify filters, the output includes information for only those event windows that meet the filter criteria. If you do not specify event windows IDs or filters, the output includes information for all event windows, which can affect performance. We recommend that you use pagination to ensure that the operation returns quickly and successfully.
  ///
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeInstanceEventWindowsRequest,
          DescribeInstanceEventWindowsResult,
          DescribeInstanceEventWindowsResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeInstanceEventWindowsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeInstanceEventWindowsResult? output]) => 200;
  @override
  DescribeInstanceEventWindowsResult buildOutput(
    DescribeInstanceEventWindowsResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeInstanceEventWindowsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeInstanceEventWindowsResult> run(
  ...
  @override
  String? getToken(DescribeInstanceEventWindowsResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<InstanceEventWindow> getItems(
          DescribeInstanceEventWindowsResult output) =>
      output.instanceEventWindows ?? _i2.BuiltList();
  @override
  DescribeInstanceEventWindowsRequest rebuildInput(
    DescribeInstanceEventWindowsRequest input,
    String token,
    int? pageSize,
  ) =>
