...
abstract class DescribeTransitGatewayPolicyTablesRequest
  ...
  factory DescribeTransitGatewayPolicyTablesRequest({
    ...
    return _$DescribeTransitGatewayPolicyTablesRequest._(
      transitGatewayPolicyTableIds: transitGatewayPolicyTableIds == null
          ? null
          : _i3.BuiltList(transitGatewayPolicyTableIds),
  ...
  static const List<
          _i1.SmithySerializer<DescribeTransitGatewayPolicyTablesRequest>>
      serializers = [
  ...
  _i3.BuiltList<String>? get transitGatewayPolicyTableIds;
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper('DescribeTransitGatewayPolicyTablesRequest')
          ..add(
            'transitGatewayPolicyTableIds',
            transitGatewayPolicyTableIds,
          )
...
class DescribeTransitGatewayPolicyTablesRequestEc2QuerySerializer extends _i1
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    DescribeTransitGatewayPolicyTablesRequest object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result$ = <Object?>[
    ...
    final DescribeTransitGatewayPolicyTablesRequest(
      :transitGatewayPolicyTableIds,
      :filters,
      :maxResults,
      :nextToken,
