...
library smoke_test.ec2.operation.describe_verified_access_instance_logging_configurations_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeVerifiedAccessInstanceLoggingConfigurationsOperation extends _i1
  ...
  /// Describes the specified Amazon Web Services Verified Access instances.
  DescribeVerifiedAccessInstanceLoggingConfigurationsOperation({
  ...
  int successCode(
      ...
      200;
  @override
  DescribeVerifiedAccessInstanceLoggingConfigurationsResult buildOutput(
    DescribeVerifiedAccessInstanceLoggingConfigurationsResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeVerifiedAccessInstanceLoggingConfigurationsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeVerifiedAccessInstanceLoggingConfigurationsResult>
      run(
    DescribeVerifiedAccessInstanceLoggingConfigurationsRequest input, {
  ...
  @override
  String? getToken(
          DescribeVerifiedAccessInstanceLoggingConfigurationsResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<VerifiedAccessInstanceLoggingConfiguration> getItems(
          DescribeVerifiedAccessInstanceLoggingConfigurationsResult output) =>
      output.loggingConfigurations ?? _i2.BuiltList();
  @override
  DescribeVerifiedAccessInstanceLoggingConfigurationsRequest rebuildInput(
    DescribeVerifiedAccessInstanceLoggingConfigurationsRequest input,
    String token,
    int? pageSize,
  ) =>
