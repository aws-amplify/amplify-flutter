...
library smoke_test.ec2.operation.create_local_gateway_route_table_virtual_interface_group_association_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperation
    extends _i1.HttpOperation<
        ...
        CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult> {
  /// Creates a local gateway route table virtual interface group association.
  CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperation({
  ...
  @override
  _i1.SmithyOperation<
      CreateLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult> run(
