...
library smoke_test.ec2.operation.reset_ebs_default_kms_key_id_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ResetEbsDefaultKmsKeyIdOperation extends _i1.HttpOperation<
  ...
  ///
  /// After resetting the default KMS key to the Amazon Web Services managed KMS key, you can continue to encrypt by a customer managed KMS key by specifying it when you create the volume. For more information, see [Amazon EBS encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html) in the _Amazon Elastic Compute Cloud User Guide_.
  ResetEbsDefaultKmsKeyIdOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ResetEbsDefaultKmsKeyIdRequest,
          ResetEbsDefaultKmsKeyIdResult,
          ResetEbsDefaultKmsKeyIdResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ResetEbsDefaultKmsKeyIdRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ResetEbsDefaultKmsKeyIdResult? output]) => 200;
  @override
  ResetEbsDefaultKmsKeyIdResult buildOutput(
    ResetEbsDefaultKmsKeyIdResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ResetEbsDefaultKmsKeyIdResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ResetEbsDefaultKmsKeyId';
  @override
  ...
  @override
  _i1.SmithyOperation<ResetEbsDefaultKmsKeyIdResult> run(
