...
class DescribeTrunkInterfaceAssociationsOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<TrunkInterfaceAssociation>> {
  /// This API action is currently in **limited preview only**. If you are interested in using this feature, contact your account manager.
  ///
  /// Describes one or more network interface trunk associations.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeTrunkInterfaceAssociationsRequest,
          DescribeTrunkInterfaceAssociationsResult,
          DescribeTrunkInterfaceAssociationsResult>> protocols = [
  ...
  @override
  int successCode([DescribeTrunkInterfaceAssociationsResult? output]) => 200;
  @override
  DescribeTrunkInterfaceAssociationsResult buildOutput(
    DescribeTrunkInterfaceAssociationsResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeTrunkInterfaceAssociationsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeTrunkInterfaceAssociationsResult> run(
    DescribeTrunkInterfaceAssociationsRequest input, {
  ...
  @override
  String? getToken(DescribeTrunkInterfaceAssociationsResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<TrunkInterfaceAssociation> getItems(
          DescribeTrunkInterfaceAssociationsResult output) =>
      output.interfaceAssociations ?? _i2.BuiltList();
  @override
  DescribeTrunkInterfaceAssociationsRequest rebuildInput(
    DescribeTrunkInterfaceAssociationsRequest input,
    String token,
    int? pageSize,
  ) =>
