...
library smoke_test.ec2.operation.create_fleet_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateFleetOperation extends _i1.HttpOperation<CreateFleetRequest,
    CreateFleetRequest, CreateFleetResult, CreateFleetResult> {
  /// Creates an EC2 Fleet that contains the configuration information for On-Demand Instances and Spot Instances. Instances are launched immediately if there is available capacity.
  ///
  /// A single EC2 Fleet can include multiple launch specifications that vary by instance type, AMI, Availability Zone, or subnet.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateFleetRequest, CreateFleetRequest,
          CreateFleetResult, CreateFleetResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateFleetRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateFleetResult? output]) => 200;
  @override
  CreateFleetResult buildOutput(
    CreateFleetResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateFleetResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateFleet';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateFleetResult> run(
