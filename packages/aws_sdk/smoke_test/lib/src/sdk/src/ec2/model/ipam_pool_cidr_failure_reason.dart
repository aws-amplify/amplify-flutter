...
abstract class IpamPoolCidrFailureReason
  ...
  static const List<_i2.SmithySerializer<IpamPoolCidrFailureReason>>
      serializers = [IpamPoolCidrFailureReasonEc2QuerySerializer()];

  /// An error code related to why an IPAM pool CIDR failed to be provisioned.
  IpamPoolCidrFailureCode? get code;
...
class IpamPoolCidrFailureReasonEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<IpamPoolCidrFailureReason> {
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    IpamPoolCidrFailureReason object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result$ = <Object?>[
    ...
    final IpamPoolCidrFailureReason(:code, :message) = object;
    if (code != null) {
      result$
