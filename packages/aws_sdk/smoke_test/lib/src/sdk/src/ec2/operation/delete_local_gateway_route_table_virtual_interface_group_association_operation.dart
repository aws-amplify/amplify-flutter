...
library smoke_test.ec2.operation.delete_local_gateway_route_table_virtual_interface_group_association_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperation
    extends _i1.HttpOperation<
        ...
        DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult> {
  /// Deletes a local gateway route table virtual interface group association.
  DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationOperation({
  ...
  @override
  _i1.SmithyOperation<
      DeleteLocalGatewayRouteTableVirtualInterfaceGroupAssociationResult> run(
