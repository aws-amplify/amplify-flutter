...
library smoke_test.ec2.operation.describe_conversion_tasks_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeConversionTasksOperation extends _i1.HttpOperation<
  ...
  ///
  /// For information about the import manifest referenced by this API action, see [VM Import Manifest](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/manifest.html).
  DescribeConversionTasksOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeConversionTasksRequest,
          DescribeConversionTasksResult,
          DescribeConversionTasksResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeConversionTasksRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeConversionTasksResult? output]) => 200;
  @override
  DescribeConversionTasksResult buildOutput(
    DescribeConversionTasksResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeConversionTasksResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DescribeConversionTasks';
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeConversionTasksResult> run(
