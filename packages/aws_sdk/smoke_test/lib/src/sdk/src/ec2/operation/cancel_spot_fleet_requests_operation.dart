...
class CancelSpotFleetRequestsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CancelSpotFleetRequestsRequest,
          CancelSpotFleetRequestsResponse,
          CancelSpotFleetRequestsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CancelSpotFleetRequestsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CancelSpotFleetRequestsResponse? output]) => 200;
  @override
  CancelSpotFleetRequestsResponse buildOutput(
    CancelSpotFleetRequestsResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CancelSpotFleetRequestsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CancelSpotFleetRequestsResponse> run(
