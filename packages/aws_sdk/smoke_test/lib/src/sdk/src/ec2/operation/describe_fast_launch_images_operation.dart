...
class DescribeFastLaunchImagesOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<DescribeFastLaunchImagesSuccessItem>> {
  /// Describe details for Windows AMIs that are configured for faster launching.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeFastLaunchImagesRequest,
          DescribeFastLaunchImagesResult,
          DescribeFastLaunchImagesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeFastLaunchImagesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeFastLaunchImagesResult? output]) => 200;
  @override
  DescribeFastLaunchImagesResult buildOutput(
    DescribeFastLaunchImagesResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeFastLaunchImagesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeFastLaunchImagesResult> run(
  ...
  @override
  String? getToken(DescribeFastLaunchImagesResult output) => output.nextToken;
  @override
  _i2.BuiltList<DescribeFastLaunchImagesSuccessItem> getItems(
          DescribeFastLaunchImagesResult output) =>
      output.fastLaunchImages ?? _i2.BuiltList();
  @override
  DescribeFastLaunchImagesRequest rebuildInput(
    DescribeFastLaunchImagesRequest input,
    String token,
    int? pageSize,
  ) =>
