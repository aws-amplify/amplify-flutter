...
library smoke_test.ec2.operation.create_launch_template_version_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateLaunchTemplateVersionOperation extends _i1.HttpOperation<
  ...
  ///
  /// For more information, see [Modify a launch template (manage launch template versions)](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-templates.html#manage-launch-template-versions) in the _Amazon Elastic Compute Cloud User Guide_.
  CreateLaunchTemplateVersionOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateLaunchTemplateVersionRequest,
          CreateLaunchTemplateVersionResult,
          CreateLaunchTemplateVersionResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateLaunchTemplateVersionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateLaunchTemplateVersionResult? output]) => 200;
  @override
  CreateLaunchTemplateVersionResult buildOutput(
    CreateLaunchTemplateVersionResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateLaunchTemplateVersionResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateLaunchTemplateVersion';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateLaunchTemplateVersionResult> run(
