...
library smoke_test.ec2.operation.modify_default_credit_specification_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ModifyDefaultCreditSpecificationOperation extends _i1.HttpOperation<
  ...
  ///
  /// For more information, see [Burstable performance instances](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html) in the _Amazon EC2 User Guide_.
  ModifyDefaultCreditSpecificationOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ModifyDefaultCreditSpecificationRequest,
          ModifyDefaultCreditSpecificationResult,
          ModifyDefaultCreditSpecificationResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ModifyDefaultCreditSpecificationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ModifyDefaultCreditSpecificationResult? output]) => 200;
  @override
  ModifyDefaultCreditSpecificationResult buildOutput(
    ModifyDefaultCreditSpecificationResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ModifyDefaultCreditSpecificationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ModifyDefaultCreditSpecification';
  @override
  ...
  @override
  _i1.SmithyOperation<ModifyDefaultCreditSpecificationResult> run(
