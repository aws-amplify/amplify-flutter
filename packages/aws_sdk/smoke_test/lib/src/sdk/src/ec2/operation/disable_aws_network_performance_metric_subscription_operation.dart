...
library smoke_test.ec2.operation.disable_aws_network_performance_metric_subscription_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DisableAwsNetworkPerformanceMetricSubscriptionOperation extends _i1
    .HttpOperation<
        ...
        DisableAwsNetworkPerformanceMetricSubscriptionResult> {
  /// Disables Infrastructure Performance metric subscriptions.
  DisableAwsNetworkPerformanceMetricSubscriptionOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DisableAwsNetworkPerformanceMetricSubscriptionRequest,
          DisableAwsNetworkPerformanceMetricSubscriptionResult,
          DisableAwsNetworkPerformanceMetricSubscriptionResult>> protocols = [
  ...
  int successCode(
      ...
      200;
  @override
  DisableAwsNetworkPerformanceMetricSubscriptionResult buildOutput(
    DisableAwsNetworkPerformanceMetricSubscriptionResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DisableAwsNetworkPerformanceMetricSubscriptionResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DisableAwsNetworkPerformanceMetricSubscriptionResult> run(
    DisableAwsNetworkPerformanceMetricSubscriptionRequest input, {
