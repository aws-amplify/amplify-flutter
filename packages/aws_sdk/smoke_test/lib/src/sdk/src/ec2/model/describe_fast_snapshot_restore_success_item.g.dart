...
part of 'describe_fast_snapshot_restore_success_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DescribeFastSnapshotRestoreSuccessItem
    extends DescribeFastSnapshotRestoreSuccessItem {
  @override
  ...
  factory _$DescribeFastSnapshotRestoreSuccessItem(
          [void Function(DescribeFastSnapshotRestoreSuccessItemBuilder)?
              updates]) =>
      (new DescribeFastSnapshotRestoreSuccessItemBuilder()..update(updates))
          ._build();

  _$DescribeFastSnapshotRestoreSuccessItem._(
      {this.snapshotId,
  ...
  @override
  DescribeFastSnapshotRestoreSuccessItem rebuild(
          void Function(DescribeFastSnapshotRestoreSuccessItemBuilder)
              updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DescribeFastSnapshotRestoreSuccessItemBuilder toBuilder() =>
      new DescribeFastSnapshotRestoreSuccessItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DescribeFastSnapshotRestoreSuccessItem &&
...
class DescribeFastSnapshotRestoreSuccessItemBuilder
    implements
        Builder<DescribeFastSnapshotRestoreSuccessItem,
            DescribeFastSnapshotRestoreSuccessItemBuilder> {
  _$DescribeFastSnapshotRestoreSuccessItem? _$v;
  ...
  DescribeFastSnapshotRestoreSuccessItemBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(DescribeFastSnapshotRestoreSuccessItem other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DescribeFastSnapshotRestoreSuccessItem;
  }

  @override
  void update(
      void Function(DescribeFastSnapshotRestoreSuccessItemBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  DescribeFastSnapshotRestoreSuccessItem build() => _build();

  _$DescribeFastSnapshotRestoreSuccessItem _build() {
    final _$result = _$v ??
        new _$DescribeFastSnapshotRestoreSuccessItem._(
