...
class GetIpamAddressHistoryOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<IpamAddressHistoryRecord>> {
  /// Retrieve historical information about a CIDR within an IPAM scope. For more information, see [View the history of IP addresses](https://docs.aws.amazon.com/vpc/latest/ipam/view-history-cidr-ipam.html) in the _Amazon VPC IPAM User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetIpamAddressHistoryRequest,
          GetIpamAddressHistoryResult,
          GetIpamAddressHistoryResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetIpamAddressHistoryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetIpamAddressHistoryResult? output]) => 200;
  @override
  GetIpamAddressHistoryResult buildOutput(
    GetIpamAddressHistoryResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      GetIpamAddressHistoryResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetIpamAddressHistoryResult> run(
  ...
  @override
  String? getToken(GetIpamAddressHistoryResult output) => output.nextToken;
  @override
  _i2.BuiltList<IpamAddressHistoryRecord> getItems(
          GetIpamAddressHistoryResult output) =>
      output.historyRecords ?? _i2.BuiltList();
  @override
  GetIpamAddressHistoryRequest rebuildInput(
    GetIpamAddressHistoryRequest input,
    String token,
    int? pageSize,
  ) =>
