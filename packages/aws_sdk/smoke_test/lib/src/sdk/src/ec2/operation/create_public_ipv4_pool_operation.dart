...
class CreatePublicIpv4PoolOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreatePublicIpv4PoolRequest, CreatePublicIpv4PoolRequest,
          CreatePublicIpv4PoolResult, CreatePublicIpv4PoolResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreatePublicIpv4PoolRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreatePublicIpv4PoolResult? output]) => 200;
  @override
  CreatePublicIpv4PoolResult buildOutput(
    CreatePublicIpv4PoolResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreatePublicIpv4PoolResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreatePublicIpv4PoolResult> run(
