...
class PurchaseReservedInstancesOfferingOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          PurchaseReservedInstancesOfferingRequest,
          PurchaseReservedInstancesOfferingResult,
          PurchaseReservedInstancesOfferingResult>> protocols = [
  ...
  @override
  int successCode([PurchaseReservedInstancesOfferingResult? output]) => 200;
  @override
  PurchaseReservedInstancesOfferingResult buildOutput(
    PurchaseReservedInstancesOfferingResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      PurchaseReservedInstancesOfferingResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<PurchaseReservedInstancesOfferingResult> run(
    PurchaseReservedInstancesOfferingRequest input, {
