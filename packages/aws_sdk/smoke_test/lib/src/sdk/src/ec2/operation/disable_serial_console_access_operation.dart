...
library smoke_test.ec2.operation.disable_serial_console_access_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DisableSerialConsoleAccessOperation extends _i1.HttpOperation<
    DisableSerialConsoleAccessRequest,
    DisableSerialConsoleAccessRequest,
    DisableSerialConsoleAccessResult,
    DisableSerialConsoleAccessResult> {
  /// Disables access to the EC2 serial console of all instances for your account. By default, access to the EC2 serial console is disabled for your account. For more information, see [Manage account access to the EC2 serial console](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/configure-access-to-serial-console.html#serial-console-account-access) in the _Amazon EC2 User Guide_.
  DisableSerialConsoleAccessOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DisableSerialConsoleAccessRequest,
          DisableSerialConsoleAccessResult,
          DisableSerialConsoleAccessResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DisableSerialConsoleAccessRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DisableSerialConsoleAccessResult? output]) => 200;
  @override
  DisableSerialConsoleAccessResult buildOutput(
    DisableSerialConsoleAccessResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DisableSerialConsoleAccessResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DisableSerialConsoleAccess';
  @override
  ...
  @override
  _i1.SmithyOperation<DisableSerialConsoleAccessResult> run(
