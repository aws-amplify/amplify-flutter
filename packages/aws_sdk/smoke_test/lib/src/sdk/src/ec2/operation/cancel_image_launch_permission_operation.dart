...
library smoke_test.ec2.operation.cancel_image_launch_permission_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CancelImageLaunchPermissionOperation extends _i1.HttpOperation<
    CancelImageLaunchPermissionRequest,
    CancelImageLaunchPermissionRequest,
    CancelImageLaunchPermissionResult,
    CancelImageLaunchPermissionResult> {
  /// Removes your Amazon Web Services account from the launch permissions for the specified AMI. For more information, see [Cancel having an AMI shared with your Amazon Web Services account](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/cancel-sharing-an-AMI.html) in the _Amazon EC2 User Guide_.
  CancelImageLaunchPermissionOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CancelImageLaunchPermissionRequest,
          CancelImageLaunchPermissionResult,
          CancelImageLaunchPermissionResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CancelImageLaunchPermissionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CancelImageLaunchPermissionResult? output]) => 200;
  @override
  CancelImageLaunchPermissionResult buildOutput(
    CancelImageLaunchPermissionResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CancelImageLaunchPermissionResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CancelImageLaunchPermission';
  @override
  ...
  @override
  _i1.SmithyOperation<CancelImageLaunchPermissionResult> run(
