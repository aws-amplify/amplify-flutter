...
part of 'describe_fast_launch_images_success_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$DescribeFastLaunchImagesSuccessItem
    extends DescribeFastLaunchImagesSuccessItem {
  @override
  ...
  factory _$DescribeFastLaunchImagesSuccessItem(
          [void Function(DescribeFastLaunchImagesSuccessItemBuilder)?
              updates]) =>
      (new DescribeFastLaunchImagesSuccessItemBuilder()..update(updates))
          ._build();

  _$DescribeFastLaunchImagesSuccessItem._(
      {this.imageId,
      this.resourceType,
      ...
      : super._() {
    BuiltValueNullFieldError.checkNotNull(maxParallelLaunches,
        r'DescribeFastLaunchImagesSuccessItem', 'maxParallelLaunches');
  }

  @override
  DescribeFastLaunchImagesSuccessItem rebuild(
          void Function(DescribeFastLaunchImagesSuccessItemBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  DescribeFastLaunchImagesSuccessItemBuilder toBuilder() =>
      new DescribeFastLaunchImagesSuccessItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is DescribeFastLaunchImagesSuccessItem &&
...
class DescribeFastLaunchImagesSuccessItemBuilder
    implements
        Builder<DescribeFastLaunchImagesSuccessItem,
            DescribeFastLaunchImagesSuccessItemBuilder> {
  _$DescribeFastLaunchImagesSuccessItem? _$v;
  ...
  DescribeFastLaunchImagesSuccessItemBuilder() {
    DescribeFastLaunchImagesSuccessItem._init(this);
  }

  DescribeFastLaunchImagesSuccessItemBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _imageId = $v.imageId;
  ...
  @override
  void replace(DescribeFastLaunchImagesSuccessItem other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$DescribeFastLaunchImagesSuccessItem;
  }
  ...
  @override
  DescribeFastLaunchImagesSuccessItem build() => _build();

  _$DescribeFastLaunchImagesSuccessItem _build() {
    _$DescribeFastLaunchImagesSuccessItem _$result;
    try {
      _$result = _$v ??
          new _$DescribeFastLaunchImagesSuccessItem._(
              imageId: imageId,
              ...
              maxParallelLaunches: BuiltValueNullFieldError.checkNotNull(
                  maxParallelLaunches,
                  r'DescribeFastLaunchImagesSuccessItem',
                  'maxParallelLaunches'),
              ownerId: ownerId,
              state: state,
