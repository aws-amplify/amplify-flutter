...
library smoke_test.ec2.operation.register_transit_gateway_multicast_group_sources_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class RegisterTransitGatewayMulticastGroupSourcesOperation
  ...
  ///
  /// After you add the source, use [SearchTransitGatewayMulticastGroups](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SearchTransitGatewayMulticastGroups.html) to verify that the source was added to the multicast group.
  RegisterTransitGatewayMulticastGroupSourcesOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          RegisterTransitGatewayMulticastGroupSourcesRequest,
          RegisterTransitGatewayMulticastGroupSourcesResult,
          RegisterTransitGatewayMulticastGroupSourcesResult>> protocols = [
  ...
  @override
  int successCode(
          [RegisterTransitGatewayMulticastGroupSourcesResult? output]) =>
      200;
  @override
  RegisterTransitGatewayMulticastGroupSourcesResult buildOutput(
    RegisterTransitGatewayMulticastGroupSourcesResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RegisterTransitGatewayMulticastGroupSourcesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'RegisterTransitGatewayMulticastGroupSources';
  @override
  ...
  @override
  _i1.SmithyOperation<RegisterTransitGatewayMulticastGroupSourcesResult> run(
    RegisterTransitGatewayMulticastGroupSourcesRequest input, {
