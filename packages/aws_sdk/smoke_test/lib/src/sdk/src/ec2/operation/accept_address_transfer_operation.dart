...
library smoke_test.ec2.operation.accept_address_transfer_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class AcceptAddressTransferOperation extends _i1.HttpOperation<
    AcceptAddressTransferRequest,
    AcceptAddressTransferRequest,
    AcceptAddressTransferResult,
    AcceptAddressTransferResult> {
  /// Accepts an Elastic IP address transfer. For more information, see [Accept a transferred Elastic IP address](https://docs.aws.amazon.com/vpc/latest/userguide/vpc-eips.html#using-instance-addressing-eips-transfer-accept) in the _Amazon Virtual Private Cloud User Guide_.
  AcceptAddressTransferOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          AcceptAddressTransferRequest,
          AcceptAddressTransferResult,
          AcceptAddressTransferResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(AcceptAddressTransferRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([AcceptAddressTransferResult? output]) => 200;
  @override
  AcceptAddressTransferResult buildOutput(
    AcceptAddressTransferResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      AcceptAddressTransferResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'AcceptAddressTransfer';
  @override
  ...
  @override
  _i1.SmithyOperation<AcceptAddressTransferResult> run(
