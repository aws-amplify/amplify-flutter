...
library smoke_test.ec2.operation.register_instance_event_notification_attributes_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class RegisterInstanceEventNotificationAttributesOperation extends _i1
  ...
  ///
  /// To remove tags, use [DeregisterInstanceEventNotificationAttributes](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DeregisterInstanceEventNotificationAttributes.html).
  RegisterInstanceEventNotificationAttributesOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          RegisterInstanceEventNotificationAttributesRequest,
          RegisterInstanceEventNotificationAttributesResult,
          RegisterInstanceEventNotificationAttributesResult>> protocols = [
  ...
  @override
  int successCode(
          [RegisterInstanceEventNotificationAttributesResult? output]) =>
      200;
  @override
  RegisterInstanceEventNotificationAttributesResult buildOutput(
    RegisterInstanceEventNotificationAttributesResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RegisterInstanceEventNotificationAttributesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'RegisterInstanceEventNotificationAttributes';
  @override
  ...
  @override
  _i1.SmithyOperation<RegisterInstanceEventNotificationAttributesResult> run(
    RegisterInstanceEventNotificationAttributesRequest input, {
