...
class CreateTrafficMirrorFilterRuleOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateTrafficMirrorFilterRuleRequest,
          CreateTrafficMirrorFilterRuleResult,
          CreateTrafficMirrorFilterRuleResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateTrafficMirrorFilterRuleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateTrafficMirrorFilterRuleResult? output]) => 200;
  @override
  CreateTrafficMirrorFilterRuleResult buildOutput(
    CreateTrafficMirrorFilterRuleResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateTrafficMirrorFilterRuleResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreateTrafficMirrorFilterRuleResult> run(
