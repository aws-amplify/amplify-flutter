...
abstract class CreateIpamResult
  ...
  factory CreateIpamResult({Ipam? ipam}) {
  ...
  static const List<_i2.SmithySerializer<CreateIpamResult>> serializers = [
...
class CreateIpamResultEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<CreateIpamResult> {
  ...
  Iterable<Object?> serialize(
    ...
    final CreateIpamResult(:ipam) = object;
    if (ipam != null) {
      result$
