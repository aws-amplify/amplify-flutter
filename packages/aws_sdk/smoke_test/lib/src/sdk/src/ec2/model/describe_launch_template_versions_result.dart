...
abstract class DescribeLaunchTemplateVersionsResult
  ...
  static const List<_i3.SmithySerializer<DescribeLaunchTemplateVersionsResult>>
      serializers = [DescribeLaunchTemplateVersionsResultEc2QuerySerializer()];

  /// Information about the launch template versions.
  _i2.BuiltList<LaunchTemplateVersion>? get launchTemplateVersions;
...
class DescribeLaunchTemplateVersionsResultEc2QuerySerializer extends _i3
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'launchTemplateVersionSet':
          ...
          ) as _i2.BuiltList<LaunchTemplateVersion>));
        case 'nextToken':
  ...
  Iterable<Object?> serialize(
    ...
    final DescribeLaunchTemplateVersionsResult(
      :launchTemplateVersions,
      :nextToken
    ) = object;
    if (launchTemplateVersions != null) {
      result$
        ..add(const _i3.XmlElementName('LaunchTemplateVersionSet'))
