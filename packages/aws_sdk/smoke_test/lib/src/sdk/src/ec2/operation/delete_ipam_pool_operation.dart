...
class DeleteIpamPoolOperation extends _i1.HttpOperation<DeleteIpamPoolRequest,
    DeleteIpamPoolRequest, DeleteIpamPoolResult, DeleteIpamPoolResult> {
  /// Delete an IPAM pool.
  ///
  /// You cannot delete an IPAM pool if there are allocations in it or CIDRs provisioned to it. To release allocations, see [ReleaseIpamPoolAllocation](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ReleaseIpamPoolAllocation.html). To deprovision pool CIDRs, see [DeprovisionIpamPoolCidr](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_DeprovisionIpamPoolCidr.html).
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteIpamPoolRequest, DeleteIpamPoolRequest,
          DeleteIpamPoolResult, DeleteIpamPoolResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteIpamPoolRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeleteIpamPoolResult? output]) => 200;
  @override
  DeleteIpamPoolResult buildOutput(
    DeleteIpamPoolResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeleteIpamPoolResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DeleteIpamPoolResult> run(
