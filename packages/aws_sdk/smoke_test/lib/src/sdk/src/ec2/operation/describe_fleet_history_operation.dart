...
class DescribeFleetHistoryOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeFleetHistoryRequest, DescribeFleetHistoryRequest,
          DescribeFleetHistoryResult, DescribeFleetHistoryResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeFleetHistoryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeFleetHistoryResult? output]) => 200;
  @override
  DescribeFleetHistoryResult buildOutput(
    DescribeFleetHistoryResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeFleetHistoryResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeFleetHistoryResult> run(
