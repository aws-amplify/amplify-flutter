...
abstract class CancelSpotFleetRequestsError
  ...
  static const List<_i2.SmithySerializer<CancelSpotFleetRequestsError>>
      serializers = [CancelSpotFleetRequestsErrorEc2QuerySerializer()];

  /// The error code.
  CancelBatchErrorCode? get code;
...
class CancelSpotFleetRequestsErrorEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<CancelSpotFleetRequestsError> {
