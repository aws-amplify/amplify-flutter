...
library smoke_test.ec2.operation.delete_placement_group_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeletePlacementGroupOperation extends _i1.HttpOperation<
    DeletePlacementGroupRequest,
    DeletePlacementGroupRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Deletes the specified placement group. You must terminate all instances in the placement group before you can delete the placement group. For more information, see [Placement groups](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html) in the _Amazon EC2 User Guide_.
  DeletePlacementGroupOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeletePlacementGroupRequest, DeletePlacementGroupRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeletePlacementGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeletePlacementGroup';
  @override
