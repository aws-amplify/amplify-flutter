...
library smoke_test.ec2.operation.describe_identity_id_format_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeIdentityIdFormatOperation extends _i1.HttpOperation<
  ...
  ///
  /// These settings apply to the principal specified in the request. They do not apply to the principal that makes the request.
  DescribeIdentityIdFormatOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeIdentityIdFormatRequest,
          DescribeIdentityIdFormatResult,
          DescribeIdentityIdFormatResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeIdentityIdFormatRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeIdentityIdFormatResult? output]) => 200;
  @override
  DescribeIdentityIdFormatResult buildOutput(
    DescribeIdentityIdFormatResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeIdentityIdFormatResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DescribeIdentityIdFormat';
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeIdentityIdFormatResult> run(
