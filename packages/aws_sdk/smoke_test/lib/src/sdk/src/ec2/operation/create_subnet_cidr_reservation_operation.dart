...
library smoke_test.ec2.operation.create_subnet_cidr_reservation_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateSubnetCidrReservationOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateSubnetCidrReservationRequest,
          CreateSubnetCidrReservationResult,
          CreateSubnetCidrReservationResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateSubnetCidrReservationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateSubnetCidrReservationResult? output]) => 200;
  @override
  CreateSubnetCidrReservationResult buildOutput(
    CreateSubnetCidrReservationResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateSubnetCidrReservationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateSubnetCidrReservation';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateSubnetCidrReservationResult> run(
