...
class GetConsoleOutputOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetConsoleOutputRequest, GetConsoleOutputRequest,
          GetConsoleOutputResult, GetConsoleOutputResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetConsoleOutputRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetConsoleOutputResult? output]) => 200;
  @override
  GetConsoleOutputResult buildOutput(
    GetConsoleOutputResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetConsoleOutputResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetConsoleOutputResult> run(
