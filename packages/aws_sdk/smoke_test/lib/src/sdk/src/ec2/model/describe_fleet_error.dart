...
library smoke_test.ec2.model.describe_fleet_error; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
part 'describe_fleet_error.g.dart';

/// Describes the instances that could not be launched by the fleet.
abstract class DescribeFleetError
    with _i1.AWSEquatable<DescribeFleetError>
    implements Built<DescribeFleetError, DescribeFleetErrorBuilder> {
  /// Describes the instances that could not be launched by the fleet.
  factory DescribeFleetError({
    LaunchTemplateAndOverridesResponse? launchTemplateAndOverrides,
    InstanceLifecycle? lifecycle,
    String? errorCode,
    String? errorMessage,
  }) {
    return _$DescribeFleetError._(
  ...
  /// Describes the instances that could not be launched by the fleet.
  factory DescribeFleetError.build(
          [void Function(DescribeFleetErrorBuilder) updates]) =
      _$DescribeFleetError;

  const DescribeFleetError._();

  static const List<_i2.SmithySerializer<DescribeFleetError>> serializers = [
    DescribeFleetErrorEc2QuerySerializer()
  ];
  ...
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper('DescribeFleetError')
      ..add(
        'launchTemplateAndOverrides',
        launchTemplateAndOverrides,
      )
...
class DescribeFleetErrorEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<DescribeFleetError> {
  const DescribeFleetErrorEc2QuerySerializer() : super('DescribeFleetError');
  ...
  @override
  DescribeFleetError deserialize(
    Serializers serializers,
    Iterable<Object?> serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = DescribeFleetErrorBuilder();
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    DescribeFleetError object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result$ = <Object?>[
      const _i2.XmlElementName(
        'DescribeFleetErrorResponse',
        _i2.XmlNamespace('http://ec2.amazonaws.com/doc/2016-11-15'),
      )
    ];
    final DescribeFleetError(
      :launchTemplateAndOverrides,
      :lifecycle,
      :errorCode,
      :errorMessage
