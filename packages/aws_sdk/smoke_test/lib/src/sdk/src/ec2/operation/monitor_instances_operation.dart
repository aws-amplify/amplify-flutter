...
library smoke_test.ec2.operation.monitor_instances_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MonitorInstancesOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<MonitorInstancesRequest, MonitorInstancesRequest,
          MonitorInstancesResult, MonitorInstancesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MonitorInstancesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([MonitorInstancesResult? output]) => 200;
  @override
  MonitorInstancesResult buildOutput(
    MonitorInstancesResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      MonitorInstancesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'MonitorInstances';
  @override
  ...
  @override
  _i1.SmithyOperation<MonitorInstancesResult> run(
