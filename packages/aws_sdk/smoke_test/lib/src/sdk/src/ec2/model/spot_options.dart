...
abstract class SpotOptions
  ...
  static const List<_i2.SmithySerializer<SpotOptions>> serializers = [
  ...
  FleetSpotMaintenanceStrategies? get maintenanceStrategies;
...
class SpotOptionsEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<SpotOptions> {
      ...
      switch (key) {
        ...
        case 'maintenanceStrategies':
          result.maintenanceStrategies.replace((serializers.deserialize(
            value,
            specifiedType: const FullType(FleetSpotMaintenanceStrategies),
          ) as FleetSpotMaintenanceStrategies));
