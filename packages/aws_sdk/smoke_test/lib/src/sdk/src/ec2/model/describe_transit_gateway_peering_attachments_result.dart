...
abstract class DescribeTransitGatewayPeeringAttachmentsResult
  ...
  factory DescribeTransitGatewayPeeringAttachmentsResult({
    List<TransitGatewayPeeringAttachment>? transitGatewayPeeringAttachments,
    String? nextToken,
  }) {
    return _$DescribeTransitGatewayPeeringAttachmentsResult._(
      transitGatewayPeeringAttachments: transitGatewayPeeringAttachments == null
          ? null
          : _i2.BuiltList(transitGatewayPeeringAttachments),
      nextToken: nextToken,
    );
  }
  ...
  static const List<
          _i3.SmithySerializer<DescribeTransitGatewayPeeringAttachmentsResult>>
      serializers = [
...
class DescribeTransitGatewayPeeringAttachmentsResultEc2QuerySerializer
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'transitGatewayPeeringAttachments':
          ...
          ) as _i2.BuiltList<TransitGatewayPeeringAttachment>));
        case 'nextToken':
  ...
  Iterable<Object?> serialize(
    ...
    final DescribeTransitGatewayPeeringAttachmentsResult(
      :transitGatewayPeeringAttachments,
      :nextToken
    ) = object;
    if (transitGatewayPeeringAttachments != null) {
      result$
        ..add(const _i3.XmlElementName('TransitGatewayPeeringAttachments'))
