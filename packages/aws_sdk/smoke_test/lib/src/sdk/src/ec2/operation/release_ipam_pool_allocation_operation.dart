...
library smoke_test.ec2.operation.release_ipam_pool_allocation_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ReleaseIpamPoolAllocationOperation extends _i1.HttpOperation<
  ...
  ///
  /// All EC2 API actions follow an [eventual consistency](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/query-api-troubleshooting.html#eventual-consistency) model.
  ReleaseIpamPoolAllocationOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ReleaseIpamPoolAllocationRequest,
          ReleaseIpamPoolAllocationResult,
          ReleaseIpamPoolAllocationResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ReleaseIpamPoolAllocationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ReleaseIpamPoolAllocationResult? output]) => 200;
  @override
  ReleaseIpamPoolAllocationResult buildOutput(
    ReleaseIpamPoolAllocationResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ReleaseIpamPoolAllocationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ReleaseIpamPoolAllocation';
  @override
  ...
  @override
  _i1.SmithyOperation<ReleaseIpamPoolAllocationResult> run(
