...
class RejectTransitGatewayVpcAttachmentOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          RejectTransitGatewayVpcAttachmentRequest,
          RejectTransitGatewayVpcAttachmentResult,
          RejectTransitGatewayVpcAttachmentResult>> protocols = [
  ...
  @override
  int successCode([RejectTransitGatewayVpcAttachmentResult? output]) => 200;
  @override
  RejectTransitGatewayVpcAttachmentResult buildOutput(
    RejectTransitGatewayVpcAttachmentResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RejectTransitGatewayVpcAttachmentResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<RejectTransitGatewayVpcAttachmentResult> run(
    RejectTransitGatewayVpcAttachmentRequest input, {
