...
class GetSerialConsoleAccessStatusOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetSerialConsoleAccessStatusRequest,
          GetSerialConsoleAccessStatusResult,
          GetSerialConsoleAccessStatusResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetSerialConsoleAccessStatusRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetSerialConsoleAccessStatusResult? output]) => 200;
  @override
  GetSerialConsoleAccessStatusResult buildOutput(
    GetSerialConsoleAccessStatusResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetSerialConsoleAccessStatusResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetSerialConsoleAccessStatusResult> run(
