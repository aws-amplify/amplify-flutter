...
class DescribeVpcClassicLinkDnsSupportOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<ClassicLinkDnsSupport>> {
  /// This action is deprecated.
  ///
  /// Describes the ClassicLink DNS support status of one or more VPCs. If enabled, the DNS hostname of a linked EC2-Classic instance resolves to its private IP address when addressed from an instance in the VPC to which it's linked. Similarly, the DNS hostname of an instance in a VPC resolves to its private IP address when addressed from a linked EC2-Classic instance.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeVpcClassicLinkDnsSupportRequest,
          DescribeVpcClassicLinkDnsSupportResult,
          DescribeVpcClassicLinkDnsSupportResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeVpcClassicLinkDnsSupportRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeVpcClassicLinkDnsSupportResult? output]) => 200;
  @override
  DescribeVpcClassicLinkDnsSupportResult buildOutput(
    DescribeVpcClassicLinkDnsSupportResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeVpcClassicLinkDnsSupportResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeVpcClassicLinkDnsSupportResult> run(
  ...
  @override
  String? getToken(DescribeVpcClassicLinkDnsSupportResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<ClassicLinkDnsSupport> getItems(
          DescribeVpcClassicLinkDnsSupportResult output) =>
      output.vpcs ?? _i2.BuiltList();
  @override
  DescribeVpcClassicLinkDnsSupportRequest rebuildInput(
    DescribeVpcClassicLinkDnsSupportRequest input,
    String token,
    int? pageSize,
  ) =>
