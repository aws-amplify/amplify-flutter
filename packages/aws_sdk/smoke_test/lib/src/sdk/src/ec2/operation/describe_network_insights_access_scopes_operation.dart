...
class DescribeNetworkInsightsAccessScopesOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<NetworkInsightsAccessScope>> {
  /// Describes the specified Network Access Scopes.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeNetworkInsightsAccessScopesRequest,
          DescribeNetworkInsightsAccessScopesResult,
          DescribeNetworkInsightsAccessScopesResult>> protocols = [
  ...
  @override
  int successCode([DescribeNetworkInsightsAccessScopesResult? output]) => 200;
  @override
  DescribeNetworkInsightsAccessScopesResult buildOutput(
    DescribeNetworkInsightsAccessScopesResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeNetworkInsightsAccessScopesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeNetworkInsightsAccessScopesResult> run(
    DescribeNetworkInsightsAccessScopesRequest input, {
  ...
  @override
  String? getToken(DescribeNetworkInsightsAccessScopesResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<NetworkInsightsAccessScope> getItems(
          DescribeNetworkInsightsAccessScopesResult output) =>
      output.networkInsightsAccessScopes ?? _i2.BuiltList();
  @override
  DescribeNetworkInsightsAccessScopesRequest rebuildInput(
    DescribeNetworkInsightsAccessScopesRequest input,
    String token,
    int? pageSize,
  ) =>
