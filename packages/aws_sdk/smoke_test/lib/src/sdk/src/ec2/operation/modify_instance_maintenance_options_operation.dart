...
library smoke_test.ec2.operation.modify_instance_maintenance_options_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ModifyInstanceMaintenanceOptionsOperation extends _i1.HttpOperation<
    ModifyInstanceMaintenanceOptionsRequest,
    ModifyInstanceMaintenanceOptionsRequest,
    ModifyInstanceMaintenanceOptionsResult,
    ModifyInstanceMaintenanceOptionsResult> {
  /// Modifies the recovery behavior of your instance to disable simplified automatic recovery or set the recovery behavior to default. The default configuration will not enable simplified automatic recovery for an unsupported instance type. For more information, see [Simplified automatic recovery](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-recover.html#instance-configuration-recovery).
  ModifyInstanceMaintenanceOptionsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ModifyInstanceMaintenanceOptionsRequest,
          ModifyInstanceMaintenanceOptionsResult,
          ModifyInstanceMaintenanceOptionsResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ModifyInstanceMaintenanceOptionsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ModifyInstanceMaintenanceOptionsResult? output]) => 200;
  @override
  ModifyInstanceMaintenanceOptionsResult buildOutput(
    ModifyInstanceMaintenanceOptionsResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ModifyInstanceMaintenanceOptionsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ModifyInstanceMaintenanceOptions';
  @override
  ...
  @override
  _i1.SmithyOperation<ModifyInstanceMaintenanceOptionsResult> run(
