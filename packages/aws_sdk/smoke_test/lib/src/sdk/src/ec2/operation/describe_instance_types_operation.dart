...
class DescribeInstanceTypesOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<InstanceTypeInfo>> {
  /// Describes the details of the instance types that are offered in a location. The results can be filtered by the attributes of the instance types.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeInstanceTypesRequest,
          DescribeInstanceTypesResult,
          DescribeInstanceTypesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeInstanceTypesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeInstanceTypesResult? output]) => 200;
  @override
  DescribeInstanceTypesResult buildOutput(
    DescribeInstanceTypesResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeInstanceTypesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeInstanceTypesResult> run(
  ...
  @override
  String? getToken(DescribeInstanceTypesResult output) => output.nextToken;
  @override
  _i2.BuiltList<InstanceTypeInfo> getItems(
          DescribeInstanceTypesResult output) =>
      output.instanceTypes ?? _i2.BuiltList();
  @override
  DescribeInstanceTypesRequest rebuildInput(
    DescribeInstanceTypesRequest input,
    String token,
    int? pageSize,
  ) =>
