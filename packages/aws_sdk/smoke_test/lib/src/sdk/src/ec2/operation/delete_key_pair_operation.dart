...
library smoke_test.ec2.operation.delete_key_pair_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteKeyPairOperation extends _i1.HttpOperation<DeleteKeyPairRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteKeyPairRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteKeyPair';
  @override
