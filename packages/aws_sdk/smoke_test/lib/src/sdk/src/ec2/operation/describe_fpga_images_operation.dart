...
class DescribeFpgaImagesOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeFpgaImagesRequest, DescribeFpgaImagesRequest,
          DescribeFpgaImagesResult, DescribeFpgaImagesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeFpgaImagesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeFpgaImagesResult? output]) => 200;
  @override
  DescribeFpgaImagesResult buildOutput(
    DescribeFpgaImagesResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeFpgaImagesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeFpgaImagesResult> run(
  ...
  @override
  String? getToken(DescribeFpgaImagesResult output) => output.nextToken;
  @override
  _i2.BuiltList<FpgaImage> getItems(DescribeFpgaImagesResult output) =>
      output.fpgaImages ?? _i2.BuiltList();
  @override
  DescribeFpgaImagesRequest rebuildInput(
    DescribeFpgaImagesRequest input,
    String token,
    int? pageSize,
  ) =>
