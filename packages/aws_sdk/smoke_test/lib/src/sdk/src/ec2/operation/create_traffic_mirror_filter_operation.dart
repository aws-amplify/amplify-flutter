...
library smoke_test.ec2.operation.create_traffic_mirror_filter_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateTrafficMirrorFilterOperation extends _i1.HttpOperation<
  ...
  ///
  /// By default, no traffic is mirrored. To mirror traffic, use [CreateTrafficMirrorFilterRule](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateTrafficMirrorFilterRule.htm) to add Traffic Mirror rules to the filter. The rules you add define what traffic gets mirrored. You can also use [ModifyTrafficMirrorFilterNetworkServices](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_ModifyTrafficMirrorFilterNetworkServices.html) to mirror supported network services.
  CreateTrafficMirrorFilterOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateTrafficMirrorFilterRequest,
          CreateTrafficMirrorFilterResult,
          CreateTrafficMirrorFilterResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateTrafficMirrorFilterRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateTrafficMirrorFilterResult? output]) => 200;
  @override
  CreateTrafficMirrorFilterResult buildOutput(
    CreateTrafficMirrorFilterResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateTrafficMirrorFilterResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateTrafficMirrorFilter';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateTrafficMirrorFilterResult> run(
