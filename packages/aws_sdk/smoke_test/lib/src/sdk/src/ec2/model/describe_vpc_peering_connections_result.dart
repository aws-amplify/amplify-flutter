...
abstract class DescribeVpcPeeringConnectionsResult
  ...
  static const List<_i3.SmithySerializer<DescribeVpcPeeringConnectionsResult>>
      serializers = [DescribeVpcPeeringConnectionsResultEc2QuerySerializer()];

  /// Information about the VPC peering connections.
  _i2.BuiltList<VpcPeeringConnection>? get vpcPeeringConnections;
...
class DescribeVpcPeeringConnectionsResultEc2QuerySerializer extends _i3
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'vpcPeeringConnectionSet':
          ...
          ) as _i2.BuiltList<VpcPeeringConnection>));
        case 'nextToken':
  ...
  Iterable<Object?> serialize(
    ...
    if (vpcPeeringConnections != null) {
      result$
        ..add(const _i3.XmlElementName('VpcPeeringConnectionSet'))
