...
abstract class CreateLocalGatewayRouteRequest
  ...
  static const List<_i1.SmithySerializer<CreateLocalGatewayRouteRequest>>
      serializers = [CreateLocalGatewayRouteRequestEc2QuerySerializer()];
  ...
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper('CreateLocalGatewayRouteRequest')
      ..add(
        'destinationCidrBlock',
        destinationCidrBlock,
      )
