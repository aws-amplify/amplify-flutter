...
abstract class DescribeNetworkInsightsAnalysesResult
  ...
  static const List<_i3.SmithySerializer<DescribeNetworkInsightsAnalysesResult>>
      serializers = [DescribeNetworkInsightsAnalysesResultEc2QuerySerializer()];

  /// Information about the network insights analyses.
  _i2.BuiltList<NetworkInsightsAnalysis>? get networkInsightsAnalyses;
...
class DescribeNetworkInsightsAnalysesResultEc2QuerySerializer extends _i3
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'networkInsightsAnalysisSet':
          ...
          ) as _i2.BuiltList<NetworkInsightsAnalysis>));
        case 'nextToken':
  ...
  Iterable<Object?> serialize(
    ...
    if (networkInsightsAnalyses != null) {
      result$
        ..add(const _i3.XmlElementName('NetworkInsightsAnalysisSet'))
