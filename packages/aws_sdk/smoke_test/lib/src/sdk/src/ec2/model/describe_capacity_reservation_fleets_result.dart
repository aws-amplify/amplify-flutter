...
abstract class DescribeCapacityReservationFleetsResult
  ...
  static const List<
          _i3.SmithySerializer<DescribeCapacityReservationFleetsResult>>
      serializers = [
    DescribeCapacityReservationFleetsResultEc2QuerySerializer()
  ];

  /// Information about the Capacity Reservation Fleets.
  _i2.BuiltList<CapacityReservationFleet>? get capacityReservationFleets;
...
class DescribeCapacityReservationFleetsResultEc2QuerySerializer extends _i3
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'capacityReservationFleetSet':
          ...
          ) as _i2.BuiltList<CapacityReservationFleet>));
        case 'nextToken':
  ...
  Iterable<Object?> serialize(
    ...
    if (capacityReservationFleets != null) {
      result$
        ..add(const _i3.XmlElementName('CapacityReservationFleetSet'))
