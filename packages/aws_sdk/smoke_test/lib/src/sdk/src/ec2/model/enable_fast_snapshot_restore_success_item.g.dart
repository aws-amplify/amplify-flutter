...
part of 'enable_fast_snapshot_restore_success_item.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$EnableFastSnapshotRestoreSuccessItem
    extends EnableFastSnapshotRestoreSuccessItem {
  @override
  ...
  factory _$EnableFastSnapshotRestoreSuccessItem(
          [void Function(EnableFastSnapshotRestoreSuccessItemBuilder)?
              updates]) =>
      (new EnableFastSnapshotRestoreSuccessItemBuilder()..update(updates))
          ._build();

  _$EnableFastSnapshotRestoreSuccessItem._(
      {this.snapshotId,
  ...
  @override
  EnableFastSnapshotRestoreSuccessItem rebuild(
          void Function(EnableFastSnapshotRestoreSuccessItemBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  EnableFastSnapshotRestoreSuccessItemBuilder toBuilder() =>
      new EnableFastSnapshotRestoreSuccessItemBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is EnableFastSnapshotRestoreSuccessItem &&
...
class EnableFastSnapshotRestoreSuccessItemBuilder
    implements
        Builder<EnableFastSnapshotRestoreSuccessItem,
            EnableFastSnapshotRestoreSuccessItemBuilder> {
  _$EnableFastSnapshotRestoreSuccessItem? _$v;
  ...
  EnableFastSnapshotRestoreSuccessItemBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(EnableFastSnapshotRestoreSuccessItem other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$EnableFastSnapshotRestoreSuccessItem;
  }
  ...
  @override
  EnableFastSnapshotRestoreSuccessItem build() => _build();

  _$EnableFastSnapshotRestoreSuccessItem _build() {
    final _$result = _$v ??
        new _$EnableFastSnapshotRestoreSuccessItem._(
