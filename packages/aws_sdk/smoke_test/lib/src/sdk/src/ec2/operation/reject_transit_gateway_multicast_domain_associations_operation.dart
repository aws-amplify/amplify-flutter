...
class RejectTransitGatewayMulticastDomainAssociationsOperation
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          RejectTransitGatewayMulticastDomainAssociationsRequest,
          RejectTransitGatewayMulticastDomainAssociationsResult,
          RejectTransitGatewayMulticastDomainAssociationsResult>> protocols = [
  ...
  @override
  int successCode(
          [RejectTransitGatewayMulticastDomainAssociationsResult? output]) =>
      200;
  @override
  RejectTransitGatewayMulticastDomainAssociationsResult buildOutput(
    RejectTransitGatewayMulticastDomainAssociationsResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RejectTransitGatewayMulticastDomainAssociationsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<RejectTransitGatewayMulticastDomainAssociationsResult>
      run(
    RejectTransitGatewayMulticastDomainAssociationsRequest input, {
