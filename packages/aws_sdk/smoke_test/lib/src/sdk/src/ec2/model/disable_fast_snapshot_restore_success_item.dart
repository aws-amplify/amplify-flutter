...
abstract class DisableFastSnapshotRestoreSuccessItem
  ...
  static const List<_i2.SmithySerializer<DisableFastSnapshotRestoreSuccessItem>>
      serializers = [DisableFastSnapshotRestoreSuccessItemEc2QuerySerializer()];
...
class DisableFastSnapshotRestoreSuccessItemEc2QuerySerializer extends _i2
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    DisableFastSnapshotRestoreSuccessItem object, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result$ = <Object?>[
    ...
    final DisableFastSnapshotRestoreSuccessItem(
      :snapshotId,
      :availabilityZone,
      :state,
      :stateTransitionReason,
