...
library smoke_test.ec2.operation.associate_trunk_interface_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class AssociateTrunkInterfaceOperation extends _i1.HttpOperation<
  ...
  ///
  /// Before you create the association, run the [create-network-interface](https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_CreateNetworkInterface.html) command and set `--interface-type` to `trunk`. You must also create a network interface for each branch network interface that you want to associate with the trunk network interface.
  AssociateTrunkInterfaceOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          AssociateTrunkInterfaceRequest,
          AssociateTrunkInterfaceResult,
          AssociateTrunkInterfaceResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(AssociateTrunkInterfaceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([AssociateTrunkInterfaceResult? output]) => 200;
  @override
  AssociateTrunkInterfaceResult buildOutput(
    AssociateTrunkInterfaceResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      AssociateTrunkInterfaceResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'AssociateTrunkInterface';
  @override
  ...
  @override
  _i1.SmithyOperation<AssociateTrunkInterfaceResult> run(
