...
class CreateLaunchTemplateOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateLaunchTemplateRequest, CreateLaunchTemplateRequest,
          CreateLaunchTemplateResult, CreateLaunchTemplateResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateLaunchTemplateRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateLaunchTemplateResult? output]) => 200;
  @override
  CreateLaunchTemplateResult buildOutput(
    CreateLaunchTemplateResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateLaunchTemplateResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreateLaunchTemplateResult> run(
