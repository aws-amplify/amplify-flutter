...
library smoke_test.ec2.operation.delete_launch_template_versions_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteLaunchTemplateVersionsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DeleteLaunchTemplateVersionsRequest,
          DeleteLaunchTemplateVersionsResult,
          DeleteLaunchTemplateVersionsResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteLaunchTemplateVersionsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeleteLaunchTemplateVersionsResult? output]) => 200;
  @override
  DeleteLaunchTemplateVersionsResult buildOutput(
    DeleteLaunchTemplateVersionsResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeleteLaunchTemplateVersionsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DeleteLaunchTemplateVersions';
  @override
  ...
  @override
  _i1.SmithyOperation<DeleteLaunchTemplateVersionsResult> run(
