...
library smoke_test.ec2.operation.get_ebs_default_kms_key_id_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetEbsDefaultKmsKeyIdOperation extends _i1.HttpOperation<
  ...
  ///
  /// For more information, see [Amazon EBS encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html) in the _Amazon Elastic Compute Cloud User Guide_.
  GetEbsDefaultKmsKeyIdOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetEbsDefaultKmsKeyIdRequest,
          GetEbsDefaultKmsKeyIdResult,
          GetEbsDefaultKmsKeyIdResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetEbsDefaultKmsKeyIdRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetEbsDefaultKmsKeyIdResult? output]) => 200;
  @override
  GetEbsDefaultKmsKeyIdResult buildOutput(
    GetEbsDefaultKmsKeyIdResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetEbsDefaultKmsKeyIdResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetEbsDefaultKmsKeyId';
  @override
  ...
  @override
  _i1.SmithyOperation<GetEbsDefaultKmsKeyIdResult> run(
