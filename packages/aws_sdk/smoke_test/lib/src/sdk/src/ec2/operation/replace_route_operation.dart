...
library smoke_test.ec2.operation.replace_route_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ReplaceRouteOperation extends _i1.HttpOperation<ReplaceRouteRequest,
    ReplaceRouteRequest, _i1.Unit, _i1.Unit> {
  /// Replaces an existing route within a route table in a VPC.
  ///
  /// You must specify either a destination CIDR block or a prefix list ID. You must also specify exactly one of the resources from the parameter list, or reset the local route to its default target.
  ///
  /// For more information, see [Route tables](https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html) in the _Amazon VPC User Guide_.
  ReplaceRouteOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<ReplaceRouteRequest, ReplaceRouteRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ReplaceRouteRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'ReplaceRoute';
  @override
