...
library smoke_test.ec2.operation.enable_aws_network_performance_metric_subscription_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class EnableAwsNetworkPerformanceMetricSubscriptionOperation
    extends _i1.HttpOperation<
        ...
        EnableAwsNetworkPerformanceMetricSubscriptionResult> {
  /// Enables Infrastructure Performance subscriptions.
  EnableAwsNetworkPerformanceMetricSubscriptionOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          EnableAwsNetworkPerformanceMetricSubscriptionRequest,
          EnableAwsNetworkPerformanceMetricSubscriptionResult,
          EnableAwsNetworkPerformanceMetricSubscriptionResult>> protocols = [
  ...
  int successCode(
      ...
      200;
  @override
  EnableAwsNetworkPerformanceMetricSubscriptionResult buildOutput(
    EnableAwsNetworkPerformanceMetricSubscriptionResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      EnableAwsNetworkPerformanceMetricSubscriptionResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'EnableAwsNetworkPerformanceMetricSubscription';
  @override
  ...
  @override
  _i1.SmithyOperation<EnableAwsNetworkPerformanceMetricSubscriptionResult> run(
    EnableAwsNetworkPerformanceMetricSubscriptionRequest input, {
