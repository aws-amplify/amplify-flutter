...
abstract class DeleteQueuedReservedInstancesResult
  ...
  factory DeleteQueuedReservedInstancesResult({
    List<SuccessfulQueuedPurchaseDeletion>? successfulQueuedPurchaseDeletions,
    List<FailedQueuedPurchaseDeletion>? failedQueuedPurchaseDeletions,
  }) {
    return _$DeleteQueuedReservedInstancesResult._(
      successfulQueuedPurchaseDeletions:
          successfulQueuedPurchaseDeletions == null
              ? null
              : _i2.BuiltList(successfulQueuedPurchaseDeletions),
      failedQueuedPurchaseDeletions: failedQueuedPurchaseDeletions == null
          ? null
          : _i2.BuiltList(failedQueuedPurchaseDeletions),
    );
  }
  ...
  static const List<_i3.SmithySerializer<DeleteQueuedReservedInstancesResult>>
      serializers = [DeleteQueuedReservedInstancesResultEc2QuerySerializer()];

  /// Information about the queued purchases that were successfully deleted.
  _i2.BuiltList<SuccessfulQueuedPurchaseDeletion>?
      get successfulQueuedPurchaseDeletions;

  /// Information about the queued purchases that could not be deleted.
  _i2.BuiltList<FailedQueuedPurchaseDeletion>?
...
class DeleteQueuedReservedInstancesResultEc2QuerySerializer extends _i3
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'successfulQueuedPurchaseDeletionSet':
          ...
          ) as _i2.BuiltList<SuccessfulQueuedPurchaseDeletion>));
        case 'failedQueuedPurchaseDeletionSet':
          ...
          ) as _i2.BuiltList<FailedQueuedPurchaseDeletion>));
      }
    }
  ...
  Iterable<Object?> serialize(
    ...
    if (successfulQueuedPurchaseDeletions != null) {
      result$
        ..add(const _i3.XmlElementName('SuccessfulQueuedPurchaseDeletionSet'))
    ...
    if (failedQueuedPurchaseDeletions != null) {
      result$
        ..add(const _i3.XmlElementName('FailedQueuedPurchaseDeletionSet'))
        ..add(const _i3.XmlBuiltListSerializer(
          memberName: 'item',
          indexer: _i3.XmlIndexer.ec2QueryList,
        ).serialize(
