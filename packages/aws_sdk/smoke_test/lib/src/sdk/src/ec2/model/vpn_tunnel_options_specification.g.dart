...
part of 'vpn_tunnel_options_specification.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

class _$VpnTunnelOptionsSpecification extends VpnTunnelOptionsSpecification {
  @override
  ...
  factory _$VpnTunnelOptionsSpecification(
          [void Function(VpnTunnelOptionsSpecificationBuilder)? updates]) =>
      (new VpnTunnelOptionsSpecificationBuilder()..update(updates))._build();

  _$VpnTunnelOptionsSpecification._(
    ...
    BuiltValueNullFieldError.checkNotNull(phase1LifetimeSeconds,
        r'VpnTunnelOptionsSpecification', 'phase1LifetimeSeconds');
    BuiltValueNullFieldError.checkNotNull(phase2LifetimeSeconds,
        r'VpnTunnelOptionsSpecification', 'phase2LifetimeSeconds');
    BuiltValueNullFieldError.checkNotNull(rekeyMarginTimeSeconds,
        r'VpnTunnelOptionsSpecification', 'rekeyMarginTimeSeconds');
    BuiltValueNullFieldError.checkNotNull(rekeyFuzzPercentage,
        r'VpnTunnelOptionsSpecification', 'rekeyFuzzPercentage');
    BuiltValueNullFieldError.checkNotNull(
        replayWindowSize, r'VpnTunnelOptionsSpecification', 'replayWindowSize');
    BuiltValueNullFieldError.checkNotNull(dpdTimeoutSeconds,
        r'VpnTunnelOptionsSpecification', 'dpdTimeoutSeconds');
    BuiltValueNullFieldError.checkNotNull(enableTunnelLifecycleControl,
        r'VpnTunnelOptionsSpecification', 'enableTunnelLifecycleControl');
  }

  @override
  VpnTunnelOptionsSpecification rebuild(
          void Function(VpnTunnelOptionsSpecificationBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  VpnTunnelOptionsSpecificationBuilder toBuilder() =>
      new VpnTunnelOptionsSpecificationBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is VpnTunnelOptionsSpecification &&
...
class VpnTunnelOptionsSpecificationBuilder
    implements
        Builder<VpnTunnelOptionsSpecification,
            VpnTunnelOptionsSpecificationBuilder> {
  _$VpnTunnelOptionsSpecification? _$v;
  ...
  VpnTunnelOptionsSpecificationBuilder() {
    VpnTunnelOptionsSpecification._init(this);
  }

  VpnTunnelOptionsSpecificationBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(VpnTunnelOptionsSpecification other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$VpnTunnelOptionsSpecification;
  }

  @override
  void update(void Function(VpnTunnelOptionsSpecificationBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  VpnTunnelOptionsSpecification build() => _build();

  _$VpnTunnelOptionsSpecification _build() {
    _$VpnTunnelOptionsSpecification _$result;
    try {
      _$result = _$v ??
          new _$VpnTunnelOptionsSpecification._(
              tunnelInsideCidr: tunnelInsideCidr,
              tunnelInsideIpv6Cidr: tunnelInsideIpv6Cidr,
              preSharedKey: preSharedKey,
              phase1LifetimeSeconds: BuiltValueNullFieldError.checkNotNull(
                  phase1LifetimeSeconds, r'VpnTunnelOptionsSpecification', 'phase1LifetimeSeconds'),
              phase2LifetimeSeconds: BuiltValueNullFieldError.checkNotNull(
                  phase2LifetimeSeconds, r'VpnTunnelOptionsSpecification', 'phase2LifetimeSeconds'),
              rekeyMarginTimeSeconds: BuiltValueNullFieldError.checkNotNull(
                  rekeyMarginTimeSeconds, r'VpnTunnelOptionsSpecification', 'rekeyMarginTimeSeconds'),
              rekeyFuzzPercentage: BuiltValueNullFieldError.checkNotNull(
                  rekeyFuzzPercentage, r'VpnTunnelOptionsSpecification', 'rekeyFuzzPercentage'),
              replayWindowSize: BuiltValueNullFieldError.checkNotNull(
                  replayWindowSize, r'VpnTunnelOptionsSpecification', 'replayWindowSize'),
              dpdTimeoutSeconds: BuiltValueNullFieldError.checkNotNull(
                  dpdTimeoutSeconds, r'VpnTunnelOptionsSpecification', 'dpdTimeoutSeconds'),
              ...
              enableTunnelLifecycleControl: BuiltValueNullFieldError.checkNotNull(
                  enableTunnelLifecycleControl, r'VpnTunnelOptionsSpecification', 'enableTunnelLifecycleControl'));
    } catch (_) {
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'VpnTunnelOptionsSpecification', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
