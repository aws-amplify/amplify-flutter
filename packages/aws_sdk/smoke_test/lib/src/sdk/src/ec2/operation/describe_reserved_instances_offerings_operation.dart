...
class DescribeReservedInstancesOfferingsOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<ReservedInstancesOffering>> {
  /// Describes Reserved Instance offerings that are available for purchase. With Reserved Instances, you purchase the right to launch instances for a period of time. During that time period, you do not receive insufficient capacity errors, and you pay a lower usage rate than the rate charged for On-Demand instances for the actual time used.
  ///
  /// If you have listed your own Reserved Instances for sale in the Reserved Instance Marketplace, they will be excluded from these results. This is to ensure that you do not purchase your own Reserved Instances.
  ///
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeReservedInstancesOfferingsRequest,
          DescribeReservedInstancesOfferingsResult,
          DescribeReservedInstancesOfferingsResult>> protocols = [
  ...
  @override
  int successCode([DescribeReservedInstancesOfferingsResult? output]) => 200;
  @override
  DescribeReservedInstancesOfferingsResult buildOutput(
    DescribeReservedInstancesOfferingsResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeReservedInstancesOfferingsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeReservedInstancesOfferingsResult> run(
    DescribeReservedInstancesOfferingsRequest input, {
  ...
  @override
  String? getToken(DescribeReservedInstancesOfferingsResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<ReservedInstancesOffering> getItems(
          DescribeReservedInstancesOfferingsResult output) =>
      output.reservedInstancesOfferings ?? _i2.BuiltList();
  @override
  DescribeReservedInstancesOfferingsRequest rebuildInput(
    DescribeReservedInstancesOfferingsRequest input,
    String token,
    int? pageSize,
  ) =>
