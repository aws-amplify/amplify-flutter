...
class DescribeTransitGatewayRouteTablesOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<TransitGatewayRouteTable>> {
  /// Describes one or more transit gateway route tables. By default, all transit gateway route tables are described. Alternatively, you can filter the results.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeTransitGatewayRouteTablesRequest,
          DescribeTransitGatewayRouteTablesResult,
          DescribeTransitGatewayRouteTablesResult>> protocols = [
  ...
  @override
  int successCode([DescribeTransitGatewayRouteTablesResult? output]) => 200;
  @override
  DescribeTransitGatewayRouteTablesResult buildOutput(
    DescribeTransitGatewayRouteTablesResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeTransitGatewayRouteTablesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeTransitGatewayRouteTablesResult> run(
    DescribeTransitGatewayRouteTablesRequest input, {
  ...
  @override
  String? getToken(DescribeTransitGatewayRouteTablesResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<TransitGatewayRouteTable> getItems(
          DescribeTransitGatewayRouteTablesResult output) =>
      output.transitGatewayRouteTables ?? _i2.BuiltList();
  @override
  DescribeTransitGatewayRouteTablesRequest rebuildInput(
    DescribeTransitGatewayRouteTablesRequest input,
    String token,
    int? pageSize,
  ) =>
