...
class DescribeCapacityReservationFleetsOperation
    extends _i1.PaginatedHttpOperation<
        ...
        String,
        int,
        _i2.BuiltList<CapacityReservationFleet>> {
  /// Describes one or more Capacity Reservation Fleets.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeCapacityReservationFleetsRequest,
          DescribeCapacityReservationFleetsResult,
          DescribeCapacityReservationFleetsResult>> protocols = [
  ...
  @override
  int successCode([DescribeCapacityReservationFleetsResult? output]) => 200;
  @override
  DescribeCapacityReservationFleetsResult buildOutput(
    DescribeCapacityReservationFleetsResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeCapacityReservationFleetsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeCapacityReservationFleetsResult> run(
    DescribeCapacityReservationFleetsRequest input, {
  ...
  @override
  String? getToken(DescribeCapacityReservationFleetsResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<CapacityReservationFleet> getItems(
          DescribeCapacityReservationFleetsResult output) =>
      output.capacityReservationFleets ?? _i2.BuiltList();
  @override
  DescribeCapacityReservationFleetsRequest rebuildInput(
    DescribeCapacityReservationFleetsRequest input,
    String token,
    int? pageSize,
  ) =>
