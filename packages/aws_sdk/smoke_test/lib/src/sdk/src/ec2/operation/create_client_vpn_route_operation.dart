...
class CreateClientVpnRouteOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateClientVpnRouteRequest, CreateClientVpnRouteRequest,
          CreateClientVpnRouteResult, CreateClientVpnRouteResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateClientVpnRouteRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateClientVpnRouteResult? output]) => 200;
  @override
  CreateClientVpnRouteResult buildOutput(
    CreateClientVpnRouteResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateClientVpnRouteResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreateClientVpnRouteResult> run(
