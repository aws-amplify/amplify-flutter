...
abstract class CreateLocalGatewayRouteResult
  ...
  factory CreateLocalGatewayRouteResult({LocalGatewayRoute? route}) {
  ...
  static const List<_i2.SmithySerializer<CreateLocalGatewayRouteResult>>
      serializers = [CreateLocalGatewayRouteResultEc2QuerySerializer()];
...
class CreateLocalGatewayRouteResultEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<CreateLocalGatewayRouteResult> {
  ...
  Iterable<Object?> serialize(
    ...
    final CreateLocalGatewayRouteResult(:route) = object;
    if (route != null) {
      result$
