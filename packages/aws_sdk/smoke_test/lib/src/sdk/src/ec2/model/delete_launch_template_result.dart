...
abstract class DeleteLaunchTemplateResult
  ...
  factory DeleteLaunchTemplateResult({LaunchTemplate? launchTemplate}) {
  ...
  static const List<_i2.SmithySerializer<DeleteLaunchTemplateResult>>
      serializers = [DeleteLaunchTemplateResultEc2QuerySerializer()];
...
class DeleteLaunchTemplateResultEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<DeleteLaunchTemplateResult> {
