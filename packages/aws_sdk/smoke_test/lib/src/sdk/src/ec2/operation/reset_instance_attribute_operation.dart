...
library smoke_test.ec2.operation.reset_instance_attribute_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ResetInstanceAttributeOperation extends _i1.HttpOperation<
  ...
  ///
  /// The `sourceDestCheck` attribute controls whether source/destination checking is enabled. The default value is `true`, which means checking is enabled. This value must be `false` for a NAT instance to perform NAT. For more information, see [NAT Instances](https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_NAT_Instance.html) in the _Amazon VPC User Guide_.
  ResetInstanceAttributeOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<ResetInstanceAttributeRequest,
          ResetInstanceAttributeRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ResetInstanceAttributeRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'ResetInstanceAttribute';
  @override
