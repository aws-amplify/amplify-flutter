...
library smoke_test.ec2.operation.unassign_private_nat_gateway_address_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UnassignPrivateNatGatewayAddressOperation extends _i1.HttpOperation<
  ...
  ///
  /// A private IP address will only be released at the end of MaxDrainDurationSeconds. The private IP addresses stay associated and support the existing connections, but do not support any new connections (new connections are distributed across the remaining assigned private IP address). After the existing connections drain out, the private IP addresses are released.
  UnassignPrivateNatGatewayAddressOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          UnassignPrivateNatGatewayAddressRequest,
          UnassignPrivateNatGatewayAddressResult,
          UnassignPrivateNatGatewayAddressResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UnassignPrivateNatGatewayAddressRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UnassignPrivateNatGatewayAddressResult? output]) => 200;
  @override
  UnassignPrivateNatGatewayAddressResult buildOutput(
    UnassignPrivateNatGatewayAddressResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UnassignPrivateNatGatewayAddressResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'UnassignPrivateNatGatewayAddress';
  @override
  ...
  @override
  _i1.SmithyOperation<UnassignPrivateNatGatewayAddressResult> run(
