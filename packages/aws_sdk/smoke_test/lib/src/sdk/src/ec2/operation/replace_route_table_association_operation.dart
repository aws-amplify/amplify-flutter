...
class ReplaceRouteTableAssociationOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ReplaceRouteTableAssociationRequest,
          ReplaceRouteTableAssociationResult,
          ReplaceRouteTableAssociationResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ReplaceRouteTableAssociationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ReplaceRouteTableAssociationResult? output]) => 200;
  @override
  ReplaceRouteTableAssociationResult buildOutput(
    ReplaceRouteTableAssociationResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ReplaceRouteTableAssociationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ReplaceRouteTableAssociationResult> run(
