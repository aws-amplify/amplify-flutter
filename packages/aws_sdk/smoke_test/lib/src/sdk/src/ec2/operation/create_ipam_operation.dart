...
library smoke_test.ec2.operation.create_ipam_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateIpamOperation extends _i1.HttpOperation<CreateIpamRequest,
    CreateIpamRequest, CreateIpamResult, CreateIpamResult> {
  /// Create an IPAM. Amazon VPC IP Address Manager (IPAM) is a VPC feature that you can use to automate your IP address management workflows including assigning, tracking, troubleshooting, and auditing IP addresses across Amazon Web Services Regions and accounts throughout your Amazon Web Services Organization.
  ///
  /// For more information, see [Create an IPAM](https://docs.aws.amazon.com/vpc/latest/ipam/create-ipam.html) in the _Amazon VPC IPAM User Guide_.
  CreateIpamOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateIpamRequest, CreateIpamRequest, CreateIpamResult,
          CreateIpamResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateIpamRequest input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateIpamResult? output]) => 200;
  @override
  CreateIpamResult buildOutput(
    CreateIpamResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateIpamResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateIpam';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateIpamResult> run(
