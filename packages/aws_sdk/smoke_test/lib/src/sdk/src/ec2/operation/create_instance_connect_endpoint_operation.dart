...
library smoke_test.ec2.operation.create_instance_connect_endpoint_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateInstanceConnectEndpointOperation extends _i1.HttpOperation<
  ...
  ///
  /// An EC2 Instance Connect Endpoint allows you to connect to an instance, without requiring the instance to have a public IPv4 address. For more information, see [Connect to your instances without requiring a public IPv4 address using EC2 Instance Connect Endpoint](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Connect-using-EC2-Instance-Connect-Endpoint.html) in the _Amazon EC2 User Guide_.
  CreateInstanceConnectEndpointOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateInstanceConnectEndpointRequest,
          CreateInstanceConnectEndpointResult,
          CreateInstanceConnectEndpointResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateInstanceConnectEndpointRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateInstanceConnectEndpointResult? output]) => 200;
  @override
  CreateInstanceConnectEndpointResult buildOutput(
    CreateInstanceConnectEndpointResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateInstanceConnectEndpointResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateInstanceConnectEndpoint';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateInstanceConnectEndpointResult> run(
