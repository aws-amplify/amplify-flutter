...
class UpdateSecurityGroupRuleDescriptionsEgressOperation
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          UpdateSecurityGroupRuleDescriptionsEgressRequest,
          UpdateSecurityGroupRuleDescriptionsEgressResult,
          UpdateSecurityGroupRuleDescriptionsEgressResult>> protocols = [
  ...
  @override
  int successCode([UpdateSecurityGroupRuleDescriptionsEgressResult? output]) =>
      200;
  @override
  UpdateSecurityGroupRuleDescriptionsEgressResult buildOutput(
    UpdateSecurityGroupRuleDescriptionsEgressResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UpdateSecurityGroupRuleDescriptionsEgressResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UpdateSecurityGroupRuleDescriptionsEgressResult> run(
    UpdateSecurityGroupRuleDescriptionsEgressRequest input, {
