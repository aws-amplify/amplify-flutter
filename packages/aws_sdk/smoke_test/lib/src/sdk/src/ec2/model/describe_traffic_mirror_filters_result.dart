...
abstract class DescribeTrafficMirrorFiltersResult
  ...
  static const List<_i3.SmithySerializer<DescribeTrafficMirrorFiltersResult>>
      serializers = [DescribeTrafficMirrorFiltersResultEc2QuerySerializer()];

  /// Information about one or more Traffic Mirror filters.
  _i2.BuiltList<TrafficMirrorFilter>? get trafficMirrorFilters;
...
class DescribeTrafficMirrorFiltersResultEc2QuerySerializer
    extends _i3.StructuredSmithySerializer<DescribeTrafficMirrorFiltersResult> {
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'trafficMirrorFilterSet':
          result.trafficMirrorFilters.replace((const _i3.XmlBuiltListSerializer(
            memberName: 'item',
          ...
          ) as _i2.BuiltList<TrafficMirrorFilter>));
        case 'nextToken':
  ...
  Iterable<Object?> serialize(
    ...
    final DescribeTrafficMirrorFiltersResult(
      :trafficMirrorFilters,
      :nextToken
    ) = object;
    if (trafficMirrorFilters != null) {
      result$
        ..add(const _i3.XmlElementName('TrafficMirrorFilterSet'))
