...
library smoke_test.ec2.operation.delete_vpn_connection_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteVpnConnectionOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteVpnConnectionRequest, DeleteVpnConnectionRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteVpnConnectionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteVpnConnection';
  @override
