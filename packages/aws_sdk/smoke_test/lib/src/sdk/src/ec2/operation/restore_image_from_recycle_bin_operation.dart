...
class RestoreImageFromRecycleBinOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          RestoreImageFromRecycleBinRequest,
          RestoreImageFromRecycleBinResult,
          RestoreImageFromRecycleBinResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(RestoreImageFromRecycleBinRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([RestoreImageFromRecycleBinResult? output]) => 200;
  @override
  RestoreImageFromRecycleBinResult buildOutput(
    RestoreImageFromRecycleBinResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RestoreImageFromRecycleBinResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<RestoreImageFromRecycleBinResult> run(
