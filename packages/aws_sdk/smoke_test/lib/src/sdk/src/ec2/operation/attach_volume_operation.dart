...
library smoke_test.ec2.operation.attach_volume_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class AttachVolumeOperation extends _i1.HttpOperation<AttachVolumeRequest,
    AttachVolumeRequest, VolumeAttachment, VolumeAttachment> {
  /// Attaches an EBS volume to a running or stopped instance and exposes it to the instance with the specified device name.
  ///
  /// Encrypted EBS volumes must be attached to instances that support Amazon EBS encryption. For more information, see [Amazon EBS encryption](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html) in the _Amazon Elastic Compute Cloud User Guide_.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<AttachVolumeRequest, AttachVolumeRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(AttachVolumeRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'AttachVolume';
  @override
