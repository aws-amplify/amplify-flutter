...
class DescribeImportImageTasksOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeImportImageTasksRequest,
          DescribeImportImageTasksResult,
          DescribeImportImageTasksResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeImportImageTasksRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeImportImageTasksResult? output]) => 200;
  @override
  DescribeImportImageTasksResult buildOutput(
    DescribeImportImageTasksResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeImportImageTasksResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeImportImageTasksResult> run(
  ...
  @override
  String? getToken(DescribeImportImageTasksResult output) => output.nextToken;
  @override
  _i2.BuiltList<ImportImageTask> getItems(
          DescribeImportImageTasksResult output) =>
      output.importImageTasks ?? _i2.BuiltList();
  @override
  DescribeImportImageTasksRequest rebuildInput(
    DescribeImportImageTasksRequest input,
    String token,
    int? pageSize,
  ) =>
