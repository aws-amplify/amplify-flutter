...
library smoke_test.ec2.operation.create_network_interface_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateNetworkInterfaceOperation extends _i1.HttpOperation<
  ...
  ///
  /// For more information about network interfaces, see [Elastic network interfaces](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html) in the _Amazon Elastic Compute Cloud User Guide_.
  CreateNetworkInterfaceOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateNetworkInterfaceRequest,
          CreateNetworkInterfaceResult,
          CreateNetworkInterfaceResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateNetworkInterfaceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateNetworkInterfaceResult? output]) => 200;
  @override
  CreateNetworkInterfaceResult buildOutput(
    CreateNetworkInterfaceResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateNetworkInterfaceResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'CreateNetworkInterface';
  @override
  ...
  @override
  _i1.SmithyOperation<CreateNetworkInterfaceResult> run(
