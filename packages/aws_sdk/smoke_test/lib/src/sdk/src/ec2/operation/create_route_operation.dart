...
class CreateRouteOperation extends _i1.HttpOperation<CreateRouteRequest,
    CreateRouteRequest, CreateRouteResult, CreateRouteResult> {
  /// Creates a route in a route table within a VPC.
  ///
  /// You must specify either a destination CIDR block or a prefix list ID. You must also specify exactly one of the resources from the parameter list.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateRouteRequest, CreateRouteRequest,
          CreateRouteResult, CreateRouteResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateRouteRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateRouteResult? output]) => 200;
  @override
  CreateRouteResult buildOutput(
    CreateRouteResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateRouteResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreateRouteResult> run(
