...
class CreateStoreImageTaskOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateStoreImageTaskRequest, CreateStoreImageTaskRequest,
          CreateStoreImageTaskResult, CreateStoreImageTaskResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateStoreImageTaskRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateStoreImageTaskResult? output]) => 200;
  @override
  CreateStoreImageTaskResult buildOutput(
    CreateStoreImageTaskResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateStoreImageTaskResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreateStoreImageTaskResult> run(
