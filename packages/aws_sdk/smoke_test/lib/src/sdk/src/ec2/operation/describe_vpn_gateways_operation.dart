...
class DescribeVpnGatewaysOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeVpnGatewaysRequest, DescribeVpnGatewaysRequest,
          DescribeVpnGatewaysResult, DescribeVpnGatewaysResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeVpnGatewaysRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeVpnGatewaysResult? output]) => 200;
  @override
  DescribeVpnGatewaysResult buildOutput(
    DescribeVpnGatewaysResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeVpnGatewaysResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeVpnGatewaysResult> run(
