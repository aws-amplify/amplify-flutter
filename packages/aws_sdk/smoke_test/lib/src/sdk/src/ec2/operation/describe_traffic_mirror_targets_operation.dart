...
class DescribeTrafficMirrorTargetsOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<TrafficMirrorTarget>> {
  /// Information about one or more Traffic Mirror targets.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeTrafficMirrorTargetsRequest,
          DescribeTrafficMirrorTargetsResult,
          DescribeTrafficMirrorTargetsResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeTrafficMirrorTargetsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeTrafficMirrorTargetsResult? output]) => 200;
  @override
  DescribeTrafficMirrorTargetsResult buildOutput(
    DescribeTrafficMirrorTargetsResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeTrafficMirrorTargetsResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeTrafficMirrorTargetsResult> run(
  ...
  @override
  String? getToken(DescribeTrafficMirrorTargetsResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<TrafficMirrorTarget> getItems(
          DescribeTrafficMirrorTargetsResult output) =>
      output.trafficMirrorTargets ?? _i2.BuiltList();
  @override
  DescribeTrafficMirrorTargetsRequest rebuildInput(
    DescribeTrafficMirrorTargetsRequest input,
    String token,
    int? pageSize,
  ) =>
