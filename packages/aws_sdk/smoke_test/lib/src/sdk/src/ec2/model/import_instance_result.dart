...
abstract class ImportInstanceResult
  ...
  factory ImportInstanceResult({ConversionTask? conversionTask}) {
  ...
  static const List<_i2.SmithySerializer<ImportInstanceResult>> serializers = [
...
class ImportInstanceResultEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<ImportInstanceResult> {
