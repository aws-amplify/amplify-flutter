...
class DisableTransitGatewayRouteTablePropagationOperation
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DisableTransitGatewayRouteTablePropagationRequest,
          DisableTransitGatewayRouteTablePropagationResult,
          DisableTransitGatewayRouteTablePropagationResult>> protocols = [
  ...
  @override
  int successCode([DisableTransitGatewayRouteTablePropagationResult? output]) =>
      200;
  @override
  DisableTransitGatewayRouteTablePropagationResult buildOutput(
    DisableTransitGatewayRouteTablePropagationResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DisableTransitGatewayRouteTablePropagationResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DisableTransitGatewayRouteTablePropagationResult> run(
    DisableTransitGatewayRouteTablePropagationRequest input, {
