...
class DescribeAggregateIdFormatOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeAggregateIdFormatRequest,
          DescribeAggregateIdFormatResult,
          DescribeAggregateIdFormatResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeAggregateIdFormatRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeAggregateIdFormatResult? output]) => 200;
  @override
  DescribeAggregateIdFormatResult buildOutput(
    DescribeAggregateIdFormatResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeAggregateIdFormatResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeAggregateIdFormatResult> run(
