...
class CreateReservedInstancesListingOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreateReservedInstancesListingRequest,
          CreateReservedInstancesListingResult,
          CreateReservedInstancesListingResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateReservedInstancesListingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateReservedInstancesListingResult? output]) => 200;
  @override
  CreateReservedInstancesListingResult buildOutput(
    CreateReservedInstancesListingResult payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateReservedInstancesListingResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreateReservedInstancesListingResult> run(
