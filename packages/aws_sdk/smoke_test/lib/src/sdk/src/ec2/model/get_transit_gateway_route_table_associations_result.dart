...
abstract class GetTransitGatewayRouteTableAssociationsResult
  ...
  static const List<
          _i3.SmithySerializer<GetTransitGatewayRouteTableAssociationsResult>>
      serializers = [
    GetTransitGatewayRouteTableAssociationsResultEc2QuerySerializer()
  ];

  /// Information about the associations.
  _i2.BuiltList<TransitGatewayRouteTableAssociation>? get associations;
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'associations':
          ...
          ) as _i2.BuiltList<TransitGatewayRouteTableAssociation>));
        case 'nextToken':
