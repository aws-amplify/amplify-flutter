...
class DescribeClassicLinkInstancesOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<ClassicLinkInstance>> {
  /// This action is deprecated.
  ///
  /// Describes one or more of your linked EC2-Classic instances. This request only returns information about EC2-Classic instances linked to a VPC through ClassicLink. You cannot use this request to return information about other instances.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeClassicLinkInstancesRequest,
          DescribeClassicLinkInstancesResult,
          DescribeClassicLinkInstancesResult>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeClassicLinkInstancesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeClassicLinkInstancesResult? output]) => 200;
  @override
  DescribeClassicLinkInstancesResult buildOutput(
    DescribeClassicLinkInstancesResult payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      DescribeClassicLinkInstancesResult.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeClassicLinkInstancesResult> run(
  ...
  @override
  String? getToken(DescribeClassicLinkInstancesResult output) =>
      output.nextToken;
  @override
  _i2.BuiltList<ClassicLinkInstance> getItems(
          DescribeClassicLinkInstancesResult output) =>
      output.instances ?? _i2.BuiltList();
  @override
  DescribeClassicLinkInstancesRequest rebuildInput(
    DescribeClassicLinkInstancesRequest input,
    String token,
    int? pageSize,
  ) =>
