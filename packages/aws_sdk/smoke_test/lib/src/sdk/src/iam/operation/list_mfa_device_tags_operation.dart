...
class ListMfaDeviceTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListMfaDeviceTagsRequest, ListMfaDeviceTagsRequest,
          ListMfaDeviceTagsResponse, ListMfaDeviceTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListMfaDeviceTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListMfaDeviceTagsResponse? output]) => 200;
  @override
  ListMfaDeviceTagsResponse buildOutput(
    ListMfaDeviceTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListMfaDeviceTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListMfaDeviceTagsResponse> run(
  ...
  @override
  String? getToken(ListMfaDeviceTagsResponse output) => output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListMfaDeviceTagsResponse output) => output.tags;
  @override
  ListMfaDeviceTagsRequest rebuildInput(
    ListMfaDeviceTagsRequest input,
    String token,
    int? pageSize,
  ) =>
