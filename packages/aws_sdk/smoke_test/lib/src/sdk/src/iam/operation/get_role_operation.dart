...
class GetRoleOperation extends _i1.HttpOperation<GetRoleRequest, GetRoleRequest,
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetRoleRequest, GetRoleRequest, GetRoleResponse,
          GetRoleResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetRoleRequest input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetRoleResponse? output]) => 200;
  @override
  GetRoleResponse buildOutput(
    GetRoleResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetRoleResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetRoleResponse> run(
