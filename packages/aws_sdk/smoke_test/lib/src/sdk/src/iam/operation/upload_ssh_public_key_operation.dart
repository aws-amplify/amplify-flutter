...
class UploadSshPublicKeyOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<UploadSshPublicKeyRequest, UploadSshPublicKeyRequest,
          UploadSshPublicKeyResponse, UploadSshPublicKeyResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UploadSshPublicKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UploadSshPublicKeyResponse? output]) => 200;
  @override
  UploadSshPublicKeyResponse buildOutput(
    UploadSshPublicKeyResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UploadSshPublicKeyResponse.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        _i1.SmithyError<DuplicateSshPublicKeyException,
          ...
          DuplicateSshPublicKeyException,
          statusCode: 400,
          builder: DuplicateSshPublicKeyException.fromResponse,
        ),
        _i1.SmithyError<InvalidPublicKeyException, InvalidPublicKeyException>(
          _i1.ShapeId(
            namespace: 'com.amazonaws.iam',
            shape: 'InvalidPublicKeyException',
          ),
          ...
          statusCode: 400,
          builder: InvalidPublicKeyException.fromResponse,
        ),
  ...
  @override
  _i1.SmithyOperation<UploadSshPublicKeyResponse> run(
