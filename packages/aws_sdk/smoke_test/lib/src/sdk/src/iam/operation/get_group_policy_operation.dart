...
class GetGroupPolicyOperation extends _i1.HttpOperation<GetGroupPolicyRequest,
    GetGroupPolicyRequest, GetGroupPolicyResponse, GetGroupPolicyResponse> {
  /// Retrieves the specified inline policy document that is embedded in the specified IAM group.
  ///
  /// Policies returned by this operation are URL-encoded compliant with [RFC 3986](https://tools.ietf.org/html/rfc3986). You can use a URL decoding method to convert the policy back to plain JSON text. For example, if you use Java, you can use the `decode` method of the `java.net.URLDecoder` utility class in the Java SDK. Other languages and SDKs provide similar functionality.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetGroupPolicyRequest, GetGroupPolicyRequest,
          GetGroupPolicyResponse, GetGroupPolicyResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetGroupPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetGroupPolicyResponse? output]) => 200;
  @override
  GetGroupPolicyResponse buildOutput(
    GetGroupPolicyResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetGroupPolicyResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetGroupPolicyResponse> run(
