...
class AttachGroupPolicyOperation extends _i1.HttpOperation<
    AttachGroupPolicyRequest, AttachGroupPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Attaches the specified managed policy to the specified IAM group.
  ///
  /// You use this operation to attach a managed policy to a group. To embed an inline policy in a group, use [`PutGroupPolicy`](https://docs.aws.amazon.com/IAM/latest/APIReference/API_PutGroupPolicy.html) .
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<AttachGroupPolicyRequest, AttachGroupPolicyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(AttachGroupPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
