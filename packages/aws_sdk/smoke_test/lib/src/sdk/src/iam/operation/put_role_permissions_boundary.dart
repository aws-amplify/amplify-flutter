...
library smoke_test.iam.operation.put_role_permissions_boundary; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutRolePermissionsBoundaryOperation extends _i1.HttpOperation<
    _i2.PutRolePermissionsBoundaryRequest,
    _i2.PutRolePermissionsBoundaryRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Adds or updates the policy that is specified as the IAM role's permissions boundary. You can use an Amazon Web Services managed policy or a customer managed policy to set the boundary for a role. Use the boundary to control the maximum permissions that the role can have. Setting a permissions boundary is an advanced feature that can affect the permissions for the role.
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.PutRolePermissionsBoundaryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.PutRolePermissionsBoundaryRequest input, {
