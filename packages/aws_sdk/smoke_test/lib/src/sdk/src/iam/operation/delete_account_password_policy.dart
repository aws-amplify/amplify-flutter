...
library smoke_test.iam.operation.delete_account_password_policy; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteAccountPasswordPolicyOperation
  ...
  /// Deletes the password policy for the Amazon Web Services account. There are no parameters.
  DeleteAccountPasswordPolicyOperation({
  ...
  @override
  String get runtimeTypeName => 'DeleteAccountPasswordPolicy';
  @override
