...
abstract class ListPolicyVersionsRequest
  ...
  static const List<_i1.SmithySerializer> serializers = [
    ListPolicyVersionsRequestAwsQuerySerializer()
  ];
...
class ListPolicyVersionsRequestAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as ListPolicyVersionsRequest);
    final result = <Object?>[
    ...
    final ListPolicyVersionsRequest(:policyArn, :marker, :maxItems) = payload;
    result
