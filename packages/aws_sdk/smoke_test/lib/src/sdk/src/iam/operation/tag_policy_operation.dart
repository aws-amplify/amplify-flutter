...
library smoke_test.iam.operation.tag_policy_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TagPolicyOperation extends _i1.HttpOperation<_i2.TagPolicyRequest,
    _i2.TagPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Adds one or more tags to an IAM customer managed policy. If a tag with the same key name already exists, then that tag is overwritten with the new value.
  ///
  /// A tag consists of a key name and an associated value. By assigning tags to your resources, you can do the following:
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.TagPolicyRequest, _i2.TagPolicyRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.TagPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'TagPolicy';
  @override
