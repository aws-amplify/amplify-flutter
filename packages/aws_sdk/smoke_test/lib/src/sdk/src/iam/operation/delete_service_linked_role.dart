...
library smoke_test.iam.operation.delete_service_linked_role; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteServiceLinkedRoleOperation extends _i1.HttpOperation<
    _i2.DeleteServiceLinkedRoleRequest,
    _i2.DeleteServiceLinkedRoleRequest,
    _i3.DeleteServiceLinkedRoleResponse,
    _i3.DeleteServiceLinkedRoleResponse> {
  /// Submits a service-linked role deletion request and returns a `DeletionTaskId`, which you can use to check the status of the deletion. Before you call this operation, confirm that the role has no active sessions and that any resources used by the role in the linked service are deleted. If you call this operation more than once for the same service-linked role and an earlier deletion task is not complete, then the `DeletionTaskId` of the earlier request is returned.
  ///
  /// If you submit a deletion request for a service-linked role whose linked service is still accessing a resource, then the deletion task fails. If it fails, the GetServiceLinkedRoleDeletionStatus operation returns the reason for the failure, usually including the resources that must be deleted. To delete the service-linked role, you must first remove those resources from the linked service and then submit the deletion request again. Resources are specific to the service that is linked to the role. For more information about removing resources from a service, see the [Amazon Web Services documentation](http://docs.aws.amazon.com/) for your service.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DeleteServiceLinkedRoleRequest,
          _i3.DeleteServiceLinkedRoleResponse,
          _i3.DeleteServiceLinkedRoleResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteServiceLinkedRoleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DeleteServiceLinkedRoleResponse? output]) => 200;
  @override
  _i3.DeleteServiceLinkedRoleResponse buildOutput(
    _i3.DeleteServiceLinkedRoleResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DeleteServiceLinkedRoleResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DeleteServiceLinkedRoleResponse> run(
    _i2.DeleteServiceLinkedRoleRequest input, {
