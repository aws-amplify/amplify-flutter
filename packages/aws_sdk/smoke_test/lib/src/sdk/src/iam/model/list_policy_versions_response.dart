...
abstract class ListPolicyVersionsResponse
  ...
  static const List<_i4.SmithySerializer> serializers = [
    ListPolicyVersionsResponseAwsQuerySerializer()
  ];
...
class ListPolicyVersionsResponseAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as ListPolicyVersionsResponse);
    final result = <Object?>[
    ...
    final ListPolicyVersionsResponse(:versions, :isTruncated, :marker) =
        payload;
    if (versions != null) {
      result
