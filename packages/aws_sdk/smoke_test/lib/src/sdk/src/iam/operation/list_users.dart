...
library smoke_test.iam.operation.list_users; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListUsersOperation extends _i1.PaginatedHttpOperation<
    _i2.ListUsersRequest,
    _i2.ListUsersRequest,
    _i3.ListUsersResponse,
    _i3.ListUsersResponse,
    String,
    int,
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.ListUsersRequest, _i2.ListUsersRequest,
          _i3.ListUsersResponse, _i3.ListUsersResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListUsersRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListUsersResponse? output]) => 200;
  @override
  _i3.ListUsersResponse buildOutput(
    _i3.ListUsersResponse payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ListUsersResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ListUsers';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListUsersResponse> run(
    _i2.ListUsersRequest input, {
  ...
  @override
  String? getToken(_i3.ListUsersResponse output) => output.marker;
  @override
  _i4.BuiltList<_i5.User> getItems(_i3.ListUsersResponse output) =>
      output.users;
  @override
  _i2.ListUsersRequest rebuildInput(
    _i2.ListUsersRequest input,
    String token,
    int? pageSize,
  ) =>
