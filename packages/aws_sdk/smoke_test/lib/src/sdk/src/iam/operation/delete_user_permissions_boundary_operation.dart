...
library smoke_test.iam.operation.delete_user_permissions_boundary_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteUserPermissionsBoundaryOperation extends _i1.HttpOperation<
    _i2.DeleteUserPermissionsBoundaryRequest,
    _i2.DeleteUserPermissionsBoundaryRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Deletes the permissions boundary for the specified IAM user.
  ///
  /// Deleting the permissions boundary for a user might increase its permissions by allowing the user to perform all the actions granted in its permissions policies.
  DeleteUserPermissionsBoundaryOperation({
  ...
  _i1.HttpRequest buildRequest(
          _i2.DeleteUserPermissionsBoundaryRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteUserPermissionsBoundary';
  @override
