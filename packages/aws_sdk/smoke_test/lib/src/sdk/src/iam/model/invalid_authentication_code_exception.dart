...
abstract class InvalidAuthenticationCodeException
  ...
  static const List<_i2.SmithySerializer> serializers = [
    InvalidAuthenticationCodeExceptionAwsQuerySerializer()
  ];
...
class InvalidAuthenticationCodeExceptionAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as InvalidAuthenticationCodeException);
    final result = <Object?>[
    ...
    final InvalidAuthenticationCodeException(:message) = payload;
    if (message != null) {
      result
