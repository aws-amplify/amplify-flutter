...
library smoke_test.iam.operation.list_server_certificate_tags_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListServerCertificateTagsOperation extends _i1.PaginatedHttpOperation<
    _i2.ListServerCertificateTagsRequest,
    _i2.ListServerCertificateTagsRequest,
    _i3.ListServerCertificateTagsResponse,
    _i3.ListServerCertificateTagsResponse,
    String,
    int,
  ...
  ///
  /// For certificates in a Region supported by Certificate Manager (ACM), we recommend that you don't use IAM server certificates. Instead, use ACM to provision, manage, and deploy your server certificates. For more information about IAM server certificates, [Working with server certificates](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_server-certs.html) in the _IAM User Guide_.
  ListServerCertificateTagsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListServerCertificateTagsRequest,
          _i3.ListServerCertificateTagsResponse,
          _i3.ListServerCertificateTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListServerCertificateTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListServerCertificateTagsResponse? output]) => 200;
  @override
  _i3.ListServerCertificateTagsResponse buildOutput(
    _i3.ListServerCertificateTagsResponse payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ListServerCertificateTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ListServerCertificateTags';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListServerCertificateTagsResponse> run(
    _i2.ListServerCertificateTagsRequest input, {
  ...
  @override
  String? getToken(_i3.ListServerCertificateTagsResponse output) =>
      output.marker;
  @override
  _i4.BuiltList<_i5.Tag> getItems(
          _i3.ListServerCertificateTagsResponse output) =>
      output.tags;
  @override
  _i2.ListServerCertificateTagsRequest rebuildInput(
    _i2.ListServerCertificateTagsRequest input,
    String token,
    int? pageSize,
  ) =>
