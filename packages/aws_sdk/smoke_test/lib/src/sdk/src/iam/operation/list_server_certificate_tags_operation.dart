...
class ListServerCertificateTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListServerCertificateTagsRequest,
          ListServerCertificateTagsResponse,
          ListServerCertificateTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListServerCertificateTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListServerCertificateTagsResponse? output]) => 200;
  @override
  ListServerCertificateTagsResponse buildOutput(
    ListServerCertificateTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListServerCertificateTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListServerCertificateTagsResponse> run(
  ...
  @override
  String? getToken(ListServerCertificateTagsResponse output) => output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListServerCertificateTagsResponse output) =>
      output.tags;
  @override
  ListServerCertificateTagsRequest rebuildInput(
    ListServerCertificateTagsRequest input,
    String token,
    int? pageSize,
  ) =>
