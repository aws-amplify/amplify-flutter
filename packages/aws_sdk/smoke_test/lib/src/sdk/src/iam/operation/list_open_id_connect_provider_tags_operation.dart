...
class ListOpenIdConnectProviderTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListOpenIdConnectProviderTagsRequest,
          ListOpenIdConnectProviderTagsResponse,
          ListOpenIdConnectProviderTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListOpenIdConnectProviderTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListOpenIdConnectProviderTagsResponse? output]) => 200;
  @override
  ListOpenIdConnectProviderTagsResponse buildOutput(
    ListOpenIdConnectProviderTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListOpenIdConnectProviderTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListOpenIdConnectProviderTagsResponse> run(
  ...
  @override
  String? getToken(ListOpenIdConnectProviderTagsResponse output) =>
      output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListOpenIdConnectProviderTagsResponse output) =>
      output.tags;
  @override
  ListOpenIdConnectProviderTagsRequest rebuildInput(
    ListOpenIdConnectProviderTagsRequest input,
    String token,
    int? pageSize,
  ) =>
