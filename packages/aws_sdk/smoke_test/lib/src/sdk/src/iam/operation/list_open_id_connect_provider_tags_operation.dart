...
library smoke_test.iam.operation.list_open_id_connect_provider_tags_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListOpenIdConnectProviderTagsOperation extends _i1.PaginatedHttpOperation<
    _i2.ListOpenIdConnectProviderTagsRequest,
    _i2.ListOpenIdConnectProviderTagsRequest,
    _i3.ListOpenIdConnectProviderTagsResponse,
    _i3.ListOpenIdConnectProviderTagsResponse,
    String,
    int,
  ...
  ///
  /// For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  ListOpenIdConnectProviderTagsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListOpenIdConnectProviderTagsRequest,
          _i3.ListOpenIdConnectProviderTagsResponse,
          _i3.ListOpenIdConnectProviderTagsResponse>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.ListOpenIdConnectProviderTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListOpenIdConnectProviderTagsResponse? output]) => 200;
  @override
  _i3.ListOpenIdConnectProviderTagsResponse buildOutput(
    _i3.ListOpenIdConnectProviderTagsResponse payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ListOpenIdConnectProviderTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ListOpenIDConnectProviderTags';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListOpenIdConnectProviderTagsResponse> run(
    _i2.ListOpenIdConnectProviderTagsRequest input, {
  ...
  @override
  String? getToken(_i3.ListOpenIdConnectProviderTagsResponse output) =>
      output.marker;
  @override
  _i4.BuiltList<_i5.Tag> getItems(
          _i3.ListOpenIdConnectProviderTagsResponse output) =>
      output.tags;
  @override
  _i2.ListOpenIdConnectProviderTagsRequest rebuildInput(
    _i2.ListOpenIdConnectProviderTagsRequest input,
    String token,
    int? pageSize,
  ) =>
