...
class UpdateRoleOperation extends _i1.HttpOperation<UpdateRoleRequest,
    UpdateRoleRequest, UpdateRoleResponse, UpdateRoleResponse> {
  /// Updates the description or maximum session duration setting of a role.
  UpdateRoleOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateRoleRequest, UpdateRoleRequest, UpdateRoleResponse,
          UpdateRoleResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateRoleRequest input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UpdateRoleResponse? output]) => 200;
  @override
  UpdateRoleResponse buildOutput(
    UpdateRoleResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UpdateRoleResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UpdateRoleResponse> run(
