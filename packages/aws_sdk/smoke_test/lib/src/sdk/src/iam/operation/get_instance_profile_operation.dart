...
class GetInstanceProfileOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetInstanceProfileRequest, GetInstanceProfileRequest,
          GetInstanceProfileResponse, GetInstanceProfileResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetInstanceProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetInstanceProfileResponse? output]) => 200;
  @override
  GetInstanceProfileResponse buildOutput(
    GetInstanceProfileResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetInstanceProfileResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetInstanceProfileResponse> run(
