...
class ListInstanceProfilesForRoleOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListInstanceProfilesForRoleRequest,
          ListInstanceProfilesForRoleResponse,
          ListInstanceProfilesForRoleResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListInstanceProfilesForRoleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListInstanceProfilesForRoleResponse? output]) => 200;
  @override
  ListInstanceProfilesForRoleResponse buildOutput(
    ListInstanceProfilesForRoleResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListInstanceProfilesForRoleResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListInstanceProfilesForRoleResponse> run(
  ...
  @override
  String? getToken(ListInstanceProfilesForRoleResponse output) => output.marker;
  @override
  _i2.BuiltList<InstanceProfile> getItems(
          ListInstanceProfilesForRoleResponse output) =>
      output.instanceProfiles;
  @override
  ListInstanceProfilesForRoleRequest rebuildInput(
    ListInstanceProfilesForRoleRequest input,
    String token,
    int? pageSize,
  ) =>
