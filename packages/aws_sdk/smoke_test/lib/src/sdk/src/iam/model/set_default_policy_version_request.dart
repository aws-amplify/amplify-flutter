...
abstract class SetDefaultPolicyVersionRequest
  ...
  static const List<_i1.SmithySerializer> serializers = [
    SetDefaultPolicyVersionRequestAwsQuerySerializer()
  ];
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper('SetDefaultPolicyVersionRequest');
    helper.add(
      'policyArn',
      policyArn,
    );
...
class SetDefaultPolicyVersionRequestAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as SetDefaultPolicyVersionRequest);
    final result = <Object?>[
    ...
    final SetDefaultPolicyVersionRequest(:policyArn, :versionId) = payload;
    result
