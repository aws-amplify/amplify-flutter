...
class GetSamlProviderOperation extends _i1.HttpOperation<GetSamlProviderRequest,
    GetSamlProviderRequest, GetSamlProviderResponse, GetSamlProviderResponse> {
  /// Returns the SAML provider metadocument that was uploaded when the IAM SAML provider resource object was created or updated.
  ///
  /// This operation requires [Signature Version 4](https://docs.aws.amazon.com/general/latest/gr/signature-version-4.html).
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetSamlProviderRequest, GetSamlProviderRequest,
          GetSamlProviderResponse, GetSamlProviderResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetSamlProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetSamlProviderResponse? output]) => 200;
  @override
  GetSamlProviderResponse buildOutput(
    GetSamlProviderResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetSamlProviderResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetSamlProviderResponse> run(
