...
class ChangePasswordOperation extends _i1.HttpOperation<ChangePasswordRequest,
    ChangePasswordRequest, _i1.Unit, _i1.Unit> {
  /// Changes the password of the IAM user who is calling this operation. This operation can be performed using the CLI, the Amazon Web Services API, or the **My Security Credentials** page in the Amazon Web Services Management Console. The Amazon Web Services account root user password is not affected by this operation.
  ///
  /// Use UpdateLoginProfile to use the CLI, the Amazon Web Services API, or the **Users** page in the IAM console to change the password for any IAM user. For more information about modifying passwords, see [Managing passwords](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_ManagingLogins.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<ChangePasswordRequest, ChangePasswordRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ChangePasswordRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError<InvalidUserTypeException, InvalidUserTypeException>(
          _i1.ShapeId(
            namespace: 'com.amazonaws.iam',
            shape: 'InvalidUserTypeException',
          ),
          ...
          statusCode: 400,
          builder: InvalidUserTypeException.fromResponse,
        ),
