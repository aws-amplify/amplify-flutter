...
class GetOpenIdConnectProviderOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetOpenIdConnectProviderRequest,
          GetOpenIdConnectProviderResponse,
          GetOpenIdConnectProviderResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetOpenIdConnectProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetOpenIdConnectProviderResponse? output]) => 200;
  @override
  GetOpenIdConnectProviderResponse buildOutput(
    GetOpenIdConnectProviderResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetOpenIdConnectProviderResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetOpenIdConnectProviderResponse> run(
