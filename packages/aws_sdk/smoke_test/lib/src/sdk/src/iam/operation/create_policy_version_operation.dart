...
class CreatePolicyVersionOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          CreatePolicyVersionRequest,
          CreatePolicyVersionResponse,
          CreatePolicyVersionResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreatePolicyVersionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreatePolicyVersionResponse? output]) => 200;
  @override
  CreatePolicyVersionResponse buildOutput(
    CreatePolicyVersionResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreatePolicyVersionResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<CreatePolicyVersionResponse> run(
