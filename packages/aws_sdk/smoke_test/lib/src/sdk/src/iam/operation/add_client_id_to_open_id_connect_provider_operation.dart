...
library smoke_test.iam.operation.add_client_id_to_open_id_connect_provider_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class AddClientIdToOpenIdConnectProviderOperation extends _i1.HttpOperation<
    _i2.AddClientIdToOpenIdConnectProviderRequest,
    _i2.AddClientIdToOpenIdConnectProviderRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Adds a new client ID (also known as audience) to the list of client IDs already registered for the specified IAM OpenID Connect (OIDC) provider resource.
  ///
  /// This operation is idempotent; it does not fail or return an error if you add an existing client ID to the provider.
  AddClientIdToOpenIdConnectProviderOperation({
  ...
  _i1.HttpRequest buildRequest(
          _i2.AddClientIdToOpenIdConnectProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'AddClientIDToOpenIDConnectProvider';
  @override
