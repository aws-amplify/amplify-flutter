...
class ResyncMfaDeviceOperation extends _i1.HttpOperation<ResyncMfaDeviceRequest,
    ResyncMfaDeviceRequest, _i1.Unit, _i1.Unit> {
  /// Synchronizes the specified MFA device with its IAM resource object on the Amazon Web Services servers.
  ///
  /// For more information about creating and working with virtual MFA devices, see [Using a virtual MFA device](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_VirtualMFA.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<ResyncMfaDeviceRequest, ResyncMfaDeviceRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ResyncMfaDeviceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
