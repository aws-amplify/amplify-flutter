...
abstract class CredentialReportNotReadyException
  ...
  static const List<_i2.SmithySerializer> serializers = [
    CredentialReportNotReadyExceptionAwsQuerySerializer()
  ];
...
class CredentialReportNotReadyExceptionAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as CredentialReportNotReadyException);
    final result = <Object?>[
    ...
    final CredentialReportNotReadyException(:message) = payload;
    if (message != null) {
      result
