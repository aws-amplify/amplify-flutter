...
class GetServerCertificateOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetServerCertificateRequest,
          GetServerCertificateResponse,
          GetServerCertificateResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetServerCertificateRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetServerCertificateResponse? output]) => 200;
  @override
  GetServerCertificateResponse buildOutput(
    GetServerCertificateResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetServerCertificateResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetServerCertificateResponse> run(
