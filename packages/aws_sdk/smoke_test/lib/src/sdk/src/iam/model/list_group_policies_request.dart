...
abstract class ListGroupPoliciesRequest
  ...
  static const List<_i1.SmithySerializer> serializers = [
    ListGroupPoliciesRequestAwsQuerySerializer()
  ];

  @BuiltValueHook(initializeBuilder: true)
  static void _init(ListGroupPoliciesRequestBuilder b) {}
...
class ListGroupPoliciesRequestAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as ListGroupPoliciesRequest);
    final result = <Object?>[
    ...
    final ListGroupPoliciesRequest(:groupName, :marker, :maxItems) = payload;
    result
