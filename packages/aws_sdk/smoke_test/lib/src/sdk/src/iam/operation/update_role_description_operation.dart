...
class UpdateRoleDescriptionOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          UpdateRoleDescriptionRequest,
          UpdateRoleDescriptionResponse,
          UpdateRoleDescriptionResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateRoleDescriptionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UpdateRoleDescriptionResponse? output]) => 200;
  @override
  UpdateRoleDescriptionResponse buildOutput(
    UpdateRoleDescriptionResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UpdateRoleDescriptionResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UpdateRoleDescriptionResponse> run(
