...
library smoke_test.iam.operation.update_role_description_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateRoleDescriptionOperation extends _i1.HttpOperation<
    _i2.UpdateRoleDescriptionRequest,
    _i2.UpdateRoleDescriptionRequest,
    _i3.UpdateRoleDescriptionResponse,
    _i3.UpdateRoleDescriptionResponse> {
  /// Use UpdateRole instead.
  ///
  /// Modifies only the description of a role. This operation performs the same function as the `Description` parameter in the `UpdateRole` operation.
  UpdateRoleDescriptionOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.UpdateRoleDescriptionRequest,
          _i3.UpdateRoleDescriptionResponse,
          _i3.UpdateRoleDescriptionResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateRoleDescriptionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.UpdateRoleDescriptionResponse? output]) => 200;
  @override
  _i3.UpdateRoleDescriptionResponse buildOutput(
    _i3.UpdateRoleDescriptionResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.UpdateRoleDescriptionResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'UpdateRoleDescription';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.UpdateRoleDescriptionResponse> run(
    _i2.UpdateRoleDescriptionRequest input, {
