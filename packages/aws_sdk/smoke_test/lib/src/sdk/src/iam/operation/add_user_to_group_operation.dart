...
class AddUserToGroupOperation extends _i1.HttpOperation<AddUserToGroupRequest,
    AddUserToGroupRequest, _i1.Unit, _i1.Unit> {
  /// Adds the specified user to the specified group.
  ...
  @override
  late final List<
      _i1.HttpProtocol<AddUserToGroupRequest, AddUserToGroupRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(AddUserToGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
