...
library smoke_test.iam.operation.set_default_policy_version_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class SetDefaultPolicyVersionOperation extends _i1.HttpOperation<
    _i2.SetDefaultPolicyVersionRequest,
    _i2.SetDefaultPolicyVersionRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Sets the specified version of the specified policy as the policy's default (operative) version.
  ...
  ///
  /// For information about managed policies, see [Managed policies and inline policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html) in the _IAM User Guide_.
  SetDefaultPolicyVersionOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.SetDefaultPolicyVersionRequest,
          _i2.SetDefaultPolicyVersionRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.SetDefaultPolicyVersionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'SetDefaultPolicyVersion';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.SetDefaultPolicyVersionRequest input, {
