...
class SetDefaultPolicyVersionOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<SetDefaultPolicyVersionRequest,
          SetDefaultPolicyVersionRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(SetDefaultPolicyVersionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
