...
library smoke_test.iam.operation.untag_mfa_device; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagMfaDeviceOperation extends _i1.HttpOperation<
    _i2.UntagMfaDeviceRequest, _i2.UntagMfaDeviceRequest, _i1.Unit, _i1.Unit> {
  /// Removes the specified tags from the IAM virtual multi-factor authentication (MFA) device. For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UntagMfaDeviceRequest, _i2.UntagMfaDeviceRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UntagMfaDeviceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.UntagMfaDeviceRequest input, {
