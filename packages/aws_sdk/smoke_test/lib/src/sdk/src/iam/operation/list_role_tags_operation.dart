...
class ListRoleTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListRoleTagsRequest, ListRoleTagsRequest,
          ListRoleTagsResponse, ListRoleTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListRoleTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListRoleTagsResponse? output]) => 200;
  @override
  ListRoleTagsResponse buildOutput(
    ListRoleTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListRoleTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListRoleTagsResponse> run(
  ...
  @override
  String? getToken(ListRoleTagsResponse output) => output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListRoleTagsResponse output) => output.tags;
  @override
  ListRoleTagsRequest rebuildInput(
    ListRoleTagsRequest input,
    String token,
    int? pageSize,
  ) =>
