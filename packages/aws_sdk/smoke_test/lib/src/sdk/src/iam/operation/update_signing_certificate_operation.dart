...
library smoke_test.iam.operation.update_signing_certificate_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateSigningCertificateOperation extends _i1.HttpOperation<
  ...
  ///
  /// If the `UserName` field is not specified, the user name is determined implicitly based on the Amazon Web Services access key ID used to sign the request. This operation works for access keys under the Amazon Web Services account. Consequently, you can use this operation to manage Amazon Web Services account root user credentials even if the Amazon Web Services account has no associated users.
  UpdateSigningCertificateOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateSigningCertificateRequest,
          UpdateSigningCertificateRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateSigningCertificateRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UpdateSigningCertificate';
  @override
