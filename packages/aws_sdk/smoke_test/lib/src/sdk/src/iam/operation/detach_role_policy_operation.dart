...
class DetachRolePolicyOperation extends _i1.HttpOperation<
    DetachRolePolicyRequest, DetachRolePolicyRequest, _i1.Unit, _i1.Unit> {
  /// Removes the specified managed policy from the specified role.
  ///
  /// A role can also have inline policies embedded with it. To delete an inline policy, use DeleteRolePolicy. For information about policies, see [Managed policies and inline policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DetachRolePolicyRequest, DetachRolePolicyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DetachRolePolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
