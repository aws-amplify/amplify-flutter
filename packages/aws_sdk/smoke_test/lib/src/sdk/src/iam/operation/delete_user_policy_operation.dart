...
class DeleteUserPolicyOperation extends _i1.HttpOperation<
    DeleteUserPolicyRequest, DeleteUserPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the specified inline policy that is embedded in the specified IAM user.
  ///
  /// A user can also have managed policies attached to it. To detach a managed policy from a user, use DetachUserPolicy. For more information about policies, refer to [Managed policies and inline policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteUserPolicyRequest, DeleteUserPolicyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteUserPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
