...
class ListPolicyTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListPolicyTagsRequest, ListPolicyTagsRequest,
          ListPolicyTagsResponse, ListPolicyTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListPolicyTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListPolicyTagsResponse? output]) => 200;
  @override
  ListPolicyTagsResponse buildOutput(
    ListPolicyTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListPolicyTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListPolicyTagsResponse> run(
  ...
  @override
  String? getToken(ListPolicyTagsResponse output) => output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListPolicyTagsResponse output) => output.tags;
  @override
  ListPolicyTagsRequest rebuildInput(
    ListPolicyTagsRequest input,
    String token,
    int? pageSize,
  ) =>
