...
library smoke_test.iam.operation.tag_role_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:smoke_test/src/sdk/src/iam/model/service_failure_exception.dart'
    as _i12;
import 'package:smoke_test/src/sdk/src/iam/model/tag_role_request.dart' as _i2;
...
class TagRoleOperation extends _i1
    .HttpOperation<_i2.TagRoleRequest, _i2.TagRoleRequest, _i1.Unit, _i1.Unit> {
  /// Adds one or more tags to an IAM role. The role can be a regular role or a service-linked role. If a tag with the same key name already exists, then that tag is overwritten with the new value.
  ///
  /// A tag consists of a key name and an associated value. By assigning tags to your resources, you can do the following:
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.TagRoleRequest, _i2.TagRoleRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.TagRoleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'TagRole';
  @override
