...
library smoke_test.iam.operation.get_policy_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetPolicyOperation extends _i1.HttpOperation<_i2.GetPolicyRequest,
    _i2.GetPolicyRequest, _i3.GetPolicyResponse, _i3.GetPolicyResponse> {
  /// Retrieves information about the specified managed policy, including the policy's default version and the total number of IAM users, groups, and roles to which the policy is attached. To retrieve the list of the specific users, groups, and roles that the policy is attached to, use ListEntitiesForPolicy. This operation returns metadata about the policy. To retrieve the actual policy document for a specific version of the policy, use GetPolicyVersion.
  ///
  /// This operation retrieves information about managed policies. To retrieve information about an inline policy that is embedded with an IAM user, group, or role, use GetUserPolicy, GetGroupPolicy, or GetRolePolicy.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.GetPolicyRequest, _i2.GetPolicyRequest,
          _i3.GetPolicyResponse, _i3.GetPolicyResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.GetPolicyResponse? output]) => 200;
  @override
  _i3.GetPolicyResponse buildOutput(
    _i3.GetPolicyResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.GetPolicyResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetPolicy';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.GetPolicyResponse> run(
    _i2.GetPolicyRequest input, {
