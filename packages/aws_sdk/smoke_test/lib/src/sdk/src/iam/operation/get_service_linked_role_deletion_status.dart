...
library smoke_test.iam.operation.get_service_linked_role_deletion_status; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetServiceLinkedRoleDeletionStatusOperation extends _i1.HttpOperation<
    _i2.GetServiceLinkedRoleDeletionStatusRequest,
    _i2.GetServiceLinkedRoleDeletionStatusRequest,
    _i3.GetServiceLinkedRoleDeletionStatusResponse,
    _i3.GetServiceLinkedRoleDeletionStatusResponse> {
  /// Retrieves the status of your service-linked role deletion. After you use DeleteServiceLinkedRole to submit a service-linked role for deletion, you can use the `DeletionTaskId` parameter in `GetServiceLinkedRoleDeletionStatus` to check the status of the deletion. If the deletion fails, this operation returns the reason that it failed, if that information is returned by the service.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetServiceLinkedRoleDeletionStatusRequest,
          _i3.GetServiceLinkedRoleDeletionStatusResponse,
          _i3.GetServiceLinkedRoleDeletionStatusResponse>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.GetServiceLinkedRoleDeletionStatusRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.GetServiceLinkedRoleDeletionStatusResponse? output]) =>
      200;
  @override
  _i3.GetServiceLinkedRoleDeletionStatusResponse buildOutput(
    _i3.GetServiceLinkedRoleDeletionStatusResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.GetServiceLinkedRoleDeletionStatusResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.GetServiceLinkedRoleDeletionStatusResponse> run(
    _i2.GetServiceLinkedRoleDeletionStatusRequest input, {
