...
class ListAttachedGroupPoliciesOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListAttachedGroupPoliciesRequest,
          ListAttachedGroupPoliciesResponse,
          ListAttachedGroupPoliciesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListAttachedGroupPoliciesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListAttachedGroupPoliciesResponse? output]) => 200;
  @override
  ListAttachedGroupPoliciesResponse buildOutput(
    ListAttachedGroupPoliciesResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListAttachedGroupPoliciesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListAttachedGroupPoliciesResponse> run(
  ...
  @override
  String? getToken(ListAttachedGroupPoliciesResponse output) => output.marker;
  @override
  _i2.BuiltList<AttachedPolicy> getItems(
          ListAttachedGroupPoliciesResponse output) =>
      output.attachedPolicies ?? _i2.BuiltList();
  @override
  ListAttachedGroupPoliciesRequest rebuildInput(
    ListAttachedGroupPoliciesRequest input,
    String token,
    int? pageSize,
  ) =>
