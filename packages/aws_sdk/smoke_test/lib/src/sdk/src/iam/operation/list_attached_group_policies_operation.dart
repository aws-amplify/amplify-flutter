...
library smoke_test.iam.operation.list_attached_group_policies_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListAttachedGroupPoliciesOperation extends _i1.PaginatedHttpOperation<
    _i2.ListAttachedGroupPoliciesRequest,
    _i2.ListAttachedGroupPoliciesRequest,
    _i3.ListAttachedGroupPoliciesResponse,
    _i3.ListAttachedGroupPoliciesResponse,
    String,
    int,
  ...
  ///
  /// You can paginate the results using the `MaxItems` and `Marker` parameters. You can use the `PathPrefix` parameter to limit the list of policies to only those matching the specified path prefix. If there are no policies attached to the specified group (or none that match the specified path prefix), the operation returns an empty list.
  ListAttachedGroupPoliciesOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListAttachedGroupPoliciesRequest,
          _i3.ListAttachedGroupPoliciesResponse,
          _i3.ListAttachedGroupPoliciesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListAttachedGroupPoliciesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListAttachedGroupPoliciesResponse? output]) => 200;
  @override
  _i3.ListAttachedGroupPoliciesResponse buildOutput(
    _i3.ListAttachedGroupPoliciesResponse payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.ListAttachedGroupPoliciesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'ListAttachedGroupPolicies';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListAttachedGroupPoliciesResponse> run(
    _i2.ListAttachedGroupPoliciesRequest input, {
  ...
  @override
  String? getToken(_i3.ListAttachedGroupPoliciesResponse output) =>
      output.marker;
  @override
  _i4.BuiltList<_i5.AttachedPolicy> getItems(
          _i3.ListAttachedGroupPoliciesResponse output) =>
      output.attachedPolicies ?? _i4.BuiltList();
  @override
  _i2.ListAttachedGroupPoliciesRequest rebuildInput(
    _i2.ListAttachedGroupPoliciesRequest input,
    String token,
    int? pageSize,
  ) =>
