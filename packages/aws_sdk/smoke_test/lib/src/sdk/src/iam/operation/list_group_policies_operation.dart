...
class ListGroupPoliciesOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListGroupPoliciesRequest, ListGroupPoliciesRequest,
          ListGroupPoliciesResponse, ListGroupPoliciesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListGroupPoliciesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListGroupPoliciesResponse? output]) => 200;
  @override
  ListGroupPoliciesResponse buildOutput(
    ListGroupPoliciesResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListGroupPoliciesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListGroupPoliciesResponse> run(
  ...
  @override
  String? getToken(ListGroupPoliciesResponse output) => output.marker;
  @override
  _i2.BuiltList<String> getItems(ListGroupPoliciesResponse output) =>
      output.policyNames;
  @override
  ListGroupPoliciesRequest rebuildInput(
    ListGroupPoliciesRequest input,
    String token,
    int? pageSize,
  ) =>
