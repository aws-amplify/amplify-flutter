...
class GetPolicyVersionOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetPolicyVersionRequest, GetPolicyVersionRequest,
          GetPolicyVersionResponse, GetPolicyVersionResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetPolicyVersionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetPolicyVersionResponse? output]) => 200;
  @override
  GetPolicyVersionResponse buildOutput(
    GetPolicyVersionResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetPolicyVersionResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetPolicyVersionResponse> run(
