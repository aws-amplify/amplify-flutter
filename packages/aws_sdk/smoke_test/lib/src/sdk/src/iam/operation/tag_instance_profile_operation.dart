...
class TagInstanceProfileOperation extends _i1.HttpOperation<
    TagInstanceProfileRequest, TagInstanceProfileRequest, _i1.Unit, _i1.Unit> {
  /// Adds one or more tags to an IAM instance profile. If a tag with the same key name already exists, then that tag is overwritten with the new value.
  ///
  /// Each tag consists of a key name and an associated value. By assigning tags to your resources, you can do the following:
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<TagInstanceProfileRequest, TagInstanceProfileRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(TagInstanceProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
