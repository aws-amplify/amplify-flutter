...
library smoke_test.iam.operation.tag_instance_profile_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TagInstanceProfileOperation extends _i1.HttpOperation<
    _i2.TagInstanceProfileRequest,
    _i2.TagInstanceProfileRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Adds one or more tags to an IAM instance profile. If a tag with the same key name already exists, then that tag is overwritten with the new value.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.TagInstanceProfileRequest,
          _i2.TagInstanceProfileRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.TagInstanceProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'TagInstanceProfile';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.TagInstanceProfileRequest input, {
