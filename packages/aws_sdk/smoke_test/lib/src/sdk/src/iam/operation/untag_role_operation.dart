...
class UntagRoleOperation extends _i1
    .HttpOperation<UntagRoleRequest, UntagRoleRequest, _i1.Unit, _i1.Unit> {
  /// Removes the specified tags from the role. For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  UntagRoleOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(UntagRoleRequest input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
