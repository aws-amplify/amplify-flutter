...
library smoke_test.iam.operation.untag_role_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagRoleOperation extends _i1.HttpOperation<_i2.UntagRoleRequest,
    _i2.UntagRoleRequest, _i1.Unit, _i1.Unit> {
  /// Removes the specified tags from the role. For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  UntagRoleOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UntagRoleRequest, _i2.UntagRoleRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UntagRoleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UntagRole';
  @override
