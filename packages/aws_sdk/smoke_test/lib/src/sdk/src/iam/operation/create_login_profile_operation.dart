...
class CreateLoginProfileOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<CreateLoginProfileRequest, CreateLoginProfileRequest,
          CreateLoginProfileResponse, CreateLoginProfileResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(CreateLoginProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([CreateLoginProfileResponse? output]) => 200;
  @override
  CreateLoginProfileResponse buildOutput(
    CreateLoginProfileResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      CreateLoginProfileResponse.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError<PasswordPolicyViolationException,
          ...
          PasswordPolicyViolationException,
          statusCode: 400,
          builder: PasswordPolicyViolationException.fromResponse,
        ),
  ...
  @override
  _i1.SmithyOperation<CreateLoginProfileResponse> run(
