...
class UpdateSamlProviderOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateSamlProviderRequest, UpdateSamlProviderRequest,
          UpdateSamlProviderResponse, UpdateSamlProviderResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateSamlProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UpdateSamlProviderResponse? output]) => 200;
  @override
  UpdateSamlProviderResponse buildOutput(
    UpdateSamlProviderResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UpdateSamlProviderResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UpdateSamlProviderResponse> run(
