...
class UntagPolicyOperation extends _i1
    .HttpOperation<UntagPolicyRequest, UntagPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Removes the specified tags from the customer managed policy. For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UntagPolicyRequest, UntagPolicyRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UntagPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
