...
class GetAccountAuthorizationDetailsOperation extends _i1
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetAccountAuthorizationDetailsRequest,
          GetAccountAuthorizationDetailsResponse,
          GetAccountAuthorizationDetailsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(GetAccountAuthorizationDetailsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([GetAccountAuthorizationDetailsResponse? output]) => 200;
  @override
  GetAccountAuthorizationDetailsResponse buildOutput(
    GetAccountAuthorizationDetailsResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetAccountAuthorizationDetailsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetAccountAuthorizationDetailsResponse> run(
  ...
  @override
  String? getToken(GetAccountAuthorizationDetailsResponse output) =>
      output.marker;
  @override
  GetAccountAuthorizationDetailsResponse getItems(
          GetAccountAuthorizationDetailsResponse output) =>
      output;
  @override
  GetAccountAuthorizationDetailsRequest rebuildInput(
    GetAccountAuthorizationDetailsRequest input,
    String token,
    int? pageSize,
  ) =>
