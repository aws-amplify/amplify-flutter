...
library smoke_test.iam.operation.untag_open_id_connect_provider_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagOpenIdConnectProviderOperation extends _i1.HttpOperation<
    UntagOpenIdConnectProviderRequest,
    UntagOpenIdConnectProviderRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Removes the specified tags from the specified OpenID Connect (OIDC)-compatible identity provider in IAM. For more information about OIDC providers, see [About web identity federation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_oidc.html). For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  UntagOpenIdConnectProviderOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<UntagOpenIdConnectProviderRequest,
          UntagOpenIdConnectProviderRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UntagOpenIdConnectProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UntagOpenIDConnectProvider';
  @override
