...
library smoke_test.iam.operation.untag_saml_provider_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagSamlProviderOperation extends _i1.HttpOperation<
    _i2.UntagSamlProviderRequest,
    _i2.UntagSamlProviderRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Removes the specified tags from the specified Security Assertion Markup Language (SAML) identity provider in IAM. For more information about these providers, see [About web identity federation](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_oidc.html). For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  UntagSamlProviderOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UntagSamlProviderRequest,
          _i2.UntagSamlProviderRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UntagSamlProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UntagSAMLProvider';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.UntagSamlProviderRequest input, {
