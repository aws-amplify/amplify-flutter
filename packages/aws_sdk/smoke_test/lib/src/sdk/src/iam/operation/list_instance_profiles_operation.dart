...
class ListInstanceProfilesOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListInstanceProfilesRequest,
          ListInstanceProfilesResponse,
          ListInstanceProfilesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListInstanceProfilesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListInstanceProfilesResponse? output]) => 200;
  @override
  ListInstanceProfilesResponse buildOutput(
    ListInstanceProfilesResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListInstanceProfilesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListInstanceProfilesResponse> run(
  ...
  @override
  String? getToken(ListInstanceProfilesResponse output) => output.marker;
  @override
  _i2.BuiltList<InstanceProfile> getItems(
          ListInstanceProfilesResponse output) =>
      output.instanceProfiles;
  @override
  ListInstanceProfilesRequest rebuildInput(
    ListInstanceProfilesRequest input,
    String token,
    int? pageSize,
  ) =>
