...
class ListUsersOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListUsersRequest, ListUsersRequest, ListUsersResponse,
          ListUsersResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListUsersRequest input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListUsersResponse? output]) => 200;
  @override
  ListUsersResponse buildOutput(
    ListUsersResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListUsersResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListUsersResponse> run(
  ...
  @override
  String? getToken(ListUsersResponse output) => output.marker;
  @override
  _i2.BuiltList<User> getItems(ListUsersResponse output) => output.users;
  @override
  ListUsersRequest rebuildInput(
    ListUsersRequest input,
    String token,
    int? pageSize,
  ) =>
