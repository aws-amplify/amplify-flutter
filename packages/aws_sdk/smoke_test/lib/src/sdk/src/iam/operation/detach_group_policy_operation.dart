...
class DetachGroupPolicyOperation extends _i1.HttpOperation<
    DetachGroupPolicyRequest, DetachGroupPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Removes the specified managed policy from the specified IAM group.
  ///
  /// A group can also have inline policies embedded with it. To delete an inline policy, use DeleteGroupPolicy. For information about policies, see [Managed policies and inline policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DetachGroupPolicyRequest, DetachGroupPolicyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DetachGroupPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
