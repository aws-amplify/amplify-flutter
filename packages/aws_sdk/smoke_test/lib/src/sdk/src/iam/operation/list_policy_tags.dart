...
library smoke_test.iam.operation.list_policy_tags; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListPolicyTagsOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListPolicyTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListPolicyTagsResponse? output]) => 200;
  @override
