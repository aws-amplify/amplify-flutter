...
library smoke_test.iam.operation.tag_server_certificate_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class TagServerCertificateOperation extends _i1.HttpOperation<
    _i2.TagServerCertificateRequest,
    _i2.TagServerCertificateRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Adds one or more tags to an IAM server certificate. If a tag with the same key name already exists, then that tag is overwritten with the new value.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.TagServerCertificateRequest,
          _i2.TagServerCertificateRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.TagServerCertificateRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'TagServerCertificate';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.TagServerCertificateRequest input, {
