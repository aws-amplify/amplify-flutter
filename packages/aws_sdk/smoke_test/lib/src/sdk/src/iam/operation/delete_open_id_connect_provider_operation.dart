...
library smoke_test.iam.operation.delete_open_id_connect_provider_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteOpenIdConnectProviderOperation extends _i1.HttpOperation<
  ...
  ///
  /// This operation is idempotent; it does not fail or return an error if you call the operation for a provider that does not exist.
  DeleteOpenIdConnectProviderOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteOpenIdConnectProviderRequest,
          DeleteOpenIdConnectProviderRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteOpenIdConnectProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteOpenIDConnectProvider';
  @override
