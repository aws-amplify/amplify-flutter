...
class ListAttachedUserPoliciesOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListAttachedUserPoliciesRequest,
          ListAttachedUserPoliciesResponse,
          ListAttachedUserPoliciesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListAttachedUserPoliciesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListAttachedUserPoliciesResponse? output]) => 200;
  @override
  ListAttachedUserPoliciesResponse buildOutput(
    ListAttachedUserPoliciesResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListAttachedUserPoliciesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListAttachedUserPoliciesResponse> run(
  ...
  @override
  String? getToken(ListAttachedUserPoliciesResponse output) => output.marker;
  @override
  _i2.BuiltList<AttachedPolicy> getItems(
          ListAttachedUserPoliciesResponse output) =>
      output.attachedPolicies ?? _i2.BuiltList();
  @override
  ListAttachedUserPoliciesRequest rebuildInput(
    ListAttachedUserPoliciesRequest input,
    String token,
    int? pageSize,
  ) =>
