...
class ListUserTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListUserTagsRequest, ListUserTagsRequest,
          ListUserTagsResponse, ListUserTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListUserTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListUserTagsResponse? output]) => 200;
  @override
  ListUserTagsResponse buildOutput(
    ListUserTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListUserTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListUserTagsResponse> run(
  ...
  @override
  String? getToken(ListUserTagsResponse output) => output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListUserTagsResponse output) => output.tags;
  @override
  ListUserTagsRequest rebuildInput(
    ListUserTagsRequest input,
    String token,
    int? pageSize,
  ) =>
