...
library smoke_test.iam.operation.update_ssh_public_key; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UpdateSshPublicKeyOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UpdateSshPublicKeyRequest,
          _i2.UpdateSshPublicKeyRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UpdateSshPublicKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.UpdateSshPublicKeyRequest input, {
