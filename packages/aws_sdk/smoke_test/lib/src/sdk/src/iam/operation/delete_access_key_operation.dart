...
library smoke_test.iam.operation.delete_access_key_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteAccessKeyOperation extends _i1.HttpOperation<DeleteAccessKeyRequest,
    DeleteAccessKeyRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the access key pair associated with the specified IAM user.
  ///
  /// If you do not specify a user name, IAM determines the user name implicitly based on the Amazon Web Services access key ID signing the request. This operation works for access keys under the Amazon Web Services account. Consequently, you can use this operation to manage Amazon Web Services account root user credentials even if the Amazon Web Services account has no associated users.
  DeleteAccessKeyOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteAccessKeyRequest, DeleteAccessKeyRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteAccessKeyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteAccessKey';
  @override
