...
class TagMfaDeviceOperation extends _i1.HttpOperation<TagMfaDeviceRequest,
    TagMfaDeviceRequest, _i1.Unit, _i1.Unit> {
  /// Adds one or more tags to an IAM virtual multi-factor authentication (MFA) device. If a tag with the same key name already exists, then that tag is overwritten with the new value.
  ///
  /// A tag consists of a key name and an associated value. By assigning tags to your resources, you can do the following:
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<TagMfaDeviceRequest, TagMfaDeviceRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(TagMfaDeviceRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
