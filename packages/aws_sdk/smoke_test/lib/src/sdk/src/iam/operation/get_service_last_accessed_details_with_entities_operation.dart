...
class GetServiceLastAccessedDetailsWithEntitiesOperation extends _i1
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetServiceLastAccessedDetailsWithEntitiesRequest,
          GetServiceLastAccessedDetailsWithEntitiesResponse,
          GetServiceLastAccessedDetailsWithEntitiesResponse>> protocols = [
  ...
  @override
  int successCode(
          [GetServiceLastAccessedDetailsWithEntitiesResponse? output]) =>
      200;
  @override
  GetServiceLastAccessedDetailsWithEntitiesResponse buildOutput(
    GetServiceLastAccessedDetailsWithEntitiesResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetServiceLastAccessedDetailsWithEntitiesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetServiceLastAccessedDetailsWithEntitiesResponse> run(
    GetServiceLastAccessedDetailsWithEntitiesRequest input, {
