...
class DeleteGroupOperation extends _i1
    .HttpOperation<DeleteGroupRequest, DeleteGroupRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the specified IAM group. The group must not contain any users or have any attached policies.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteGroupRequest, DeleteGroupRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
