...
library smoke_test.iam.operation.delete_group_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteGroupOperation extends _i1.HttpOperation<_i2.DeleteGroupRequest,
    _i2.DeleteGroupRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the specified IAM group. The group must not contain any users or have any attached policies.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.DeleteGroupRequest, _i2.DeleteGroupRequest, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteGroupRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteGroup';
  @override
