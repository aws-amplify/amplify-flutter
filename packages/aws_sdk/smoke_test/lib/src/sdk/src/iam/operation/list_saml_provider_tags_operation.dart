...
class ListSamlProviderTagsOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListSamlProviderTagsRequest,
          ListSamlProviderTagsResponse,
          ListSamlProviderTagsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListSamlProviderTagsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListSamlProviderTagsResponse? output]) => 200;
  @override
  ListSamlProviderTagsResponse buildOutput(
    ListSamlProviderTagsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListSamlProviderTagsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListSamlProviderTagsResponse> run(
  ...
  @override
  String? getToken(ListSamlProviderTagsResponse output) => output.marker;
  @override
  _i2.BuiltList<Tag> getItems(ListSamlProviderTagsResponse output) =>
      output.tags;
  @override
  ListSamlProviderTagsRequest rebuildInput(
    ListSamlProviderTagsRequest input,
    String token,
    int? pageSize,
  ) =>
