...
library smoke_test.iam.operation.get_login_profile; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetLoginProfileOperation extends _i1.HttpOperation<
    _i2.GetLoginProfileRequest,
    _i2.GetLoginProfileRequest,
    _i3.GetLoginProfileResponse,
    _i3.GetLoginProfileResponse> {
  /// Retrieves the user name for the specified IAM user. A login profile is created when you create a password for the user to access the Amazon Web Services Management Console. If the user does not exist or does not have a password, the operation returns a 404 (`NoSuchEntity`) error.
  ///
  /// If you create an IAM user with access to the console, the `CreateDate` reflects the date you created the initial password for the user.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetLoginProfileRequest,
          _i3.GetLoginProfileResponse,
          _i3.GetLoginProfileResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetLoginProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.GetLoginProfileResponse? output]) => 200;
  @override
  _i3.GetLoginProfileResponse buildOutput(
    _i3.GetLoginProfileResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.GetLoginProfileResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.GetLoginProfileResponse> run(
    _i2.GetLoginProfileRequest input, {
