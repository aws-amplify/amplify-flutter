...
class ListPolicyVersionsOperation extends _i1.PaginatedHttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListPolicyVersionsRequest, ListPolicyVersionsRequest,
          ListPolicyVersionsResponse, ListPolicyVersionsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListPolicyVersionsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListPolicyVersionsResponse? output]) => 200;
  @override
  ListPolicyVersionsResponse buildOutput(
    ListPolicyVersionsResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListPolicyVersionsResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListPolicyVersionsResponse> run(
  ...
  @override
  String? getToken(ListPolicyVersionsResponse output) => output.marker;
  @override
  _i2.BuiltList<PolicyVersion> getItems(ListPolicyVersionsResponse output) =>
      output.versions ?? _i2.BuiltList();
  @override
  ListPolicyVersionsRequest rebuildInput(
    ListPolicyVersionsRequest input,
    String token,
    int? pageSize,
  ) =>
