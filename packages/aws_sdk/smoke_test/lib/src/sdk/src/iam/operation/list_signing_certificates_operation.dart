...
class ListSigningCertificatesOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<SigningCertificate>> {
  /// Returns information about the signing certificates associated with the specified IAM user. If none exists, the operation returns an empty list.
  ///
  /// Although each user is limited to a small number of signing certificates, you can still paginate the results using the `MaxItems` and `Marker` parameters.
  ///
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListSigningCertificatesRequest,
          ListSigningCertificatesResponse,
          ListSigningCertificatesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListSigningCertificatesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListSigningCertificatesResponse? output]) => 200;
  @override
  ListSigningCertificatesResponse buildOutput(
    ListSigningCertificatesResponse payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListSigningCertificatesResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListSigningCertificatesResponse> run(
  ...
  @override
  String? getToken(ListSigningCertificatesResponse output) => output.marker;
  @override
  _i2.BuiltList<SigningCertificate> getItems(
          ListSigningCertificatesResponse output) =>
      output.certificates;
  @override
  ListSigningCertificatesRequest rebuildInput(
    ListSigningCertificatesRequest input,
    String token,
    int? pageSize,
  ) =>
