...
library smoke_test.iam.operation.untag_instance_profile_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UntagInstanceProfileOperation extends _i1.HttpOperation<
    _i2.UntagInstanceProfileRequest,
    _i2.UntagInstanceProfileRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Removes the specified tags from the IAM instance profile. For more information about tagging, see [Tagging IAM resources](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_tags.html) in the _IAM User Guide_.
  UntagInstanceProfileOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.UntagInstanceProfileRequest,
          _i2.UntagInstanceProfileRequest, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.UntagInstanceProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'UntagInstanceProfile';
  @override
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.UntagInstanceProfileRequest input, {
