...
class GenerateCredentialReportOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i1.Unit, _i1.Unit, GenerateCredentialReportResponse,
          GenerateCredentialReportResponse>> protocols = [
  ...
  @override
  int successCode([GenerateCredentialReportResponse? output]) => 200;
  @override
  GenerateCredentialReportResponse buildOutput(
    GenerateCredentialReportResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GenerateCredentialReportResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GenerateCredentialReportResponse> run(
    _i1.Unit input, {
