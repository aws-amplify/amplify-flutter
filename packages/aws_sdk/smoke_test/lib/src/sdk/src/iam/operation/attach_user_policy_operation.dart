...
class AttachUserPolicyOperation extends _i1.HttpOperation<
    AttachUserPolicyRequest, AttachUserPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Attaches the specified managed policy to the specified user.
  ///
  /// You use this operation to attach a _managed_ policy to a user. To embed an inline policy in a user, use [`PutUserPolicy`](https://docs.aws.amazon.com/IAM/latest/APIReference/API_PutUserPolicy.html) .
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<AttachUserPolicyRequest, AttachUserPolicyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(AttachUserPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
