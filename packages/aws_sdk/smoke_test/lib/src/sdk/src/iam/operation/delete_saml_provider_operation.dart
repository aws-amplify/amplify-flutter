...
class DeleteSamlProviderOperation extends _i1.HttpOperation<
    DeleteSamlProviderRequest, DeleteSamlProviderRequest, _i1.Unit, _i1.Unit> {
  /// Deletes a SAML provider resource in IAM.
  ///
  /// Deleting the provider resource from IAM does not update any roles that reference the SAML provider resource's ARN as a principal in their trust policies. Any attempt to assume a role that references a non-existent provider resource ARN fails.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteSamlProviderRequest, DeleteSamlProviderRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteSamlProviderRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
