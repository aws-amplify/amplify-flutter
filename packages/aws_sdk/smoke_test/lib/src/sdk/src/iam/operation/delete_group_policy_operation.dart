...
class DeleteGroupPolicyOperation extends _i1.HttpOperation<
    DeleteGroupPolicyRequest, DeleteGroupPolicyRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the specified inline policy that is embedded in the specified IAM group.
  ///
  /// A group can also have managed policies attached to it. To detach a managed policy from a group, use DetachGroupPolicy. For more information about policies, refer to [Managed policies and inline policies](https://docs.aws.amazon.com/IAM/latest/UserGuide/policies-managed-vs-inline.html) in the _IAM User Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteGroupPolicyRequest, DeleteGroupPolicyRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteGroupPolicyRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
