...
library smoke_test.sts.operation.get_access_key_info; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetAccessKeyInfoOperation extends _i1.HttpOperation<
    _i2.GetAccessKeyInfoRequest,
    _i2.GetAccessKeyInfoRequest,
    _i3.GetAccessKeyInfoResponse,
    _i3.GetAccessKeyInfoResponse> {
  /// Returns the account identifier for the specified access key ID.
  ///
  /// Access keys consist of two parts: an access key ID (for example, `AKIAIOSFODNN7EXAMPLE`) and a secret access key (for example, `wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY`). For more information about access keys, see [Managing Access Keys for IAM Users](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html) in the _IAM User Guide_.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetAccessKeyInfoRequest,
          _i3.GetAccessKeyInfoResponse,
          _i3.GetAccessKeyInfoResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetAccessKeyInfoRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.GetAccessKeyInfoResponse? output]) => 200;
  @override
  _i3.GetAccessKeyInfoResponse buildOutput(
    _i3.GetAccessKeyInfoResponse payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.GetAccessKeyInfoResponse.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.GetAccessKeyInfoResponse> run(
    _i2.GetAccessKeyInfoRequest input, {
