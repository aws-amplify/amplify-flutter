...
class DescribeExportOperation extends _i1.HttpOperation<DescribeExportInput,
    DescribeExportInput, DescribeExportOutput, DescribeExportOutput> {
  /// Describes an existing table export.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeExportInput, DescribeExportInput,
          DescribeExportOutput, DescribeExportOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeExportInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeExportOutput? output]) => 200;
  @override
  DescribeExportOutput buildOutput(
    DescribeExportOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeExportOutput.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        _i1.SmithyError<ExportNotFoundException, ExportNotFoundException>(
          _i1.ShapeId(
          ...
          builder: ExportNotFoundException.fromResponse,
        ),
  ...
  @override
  String get runtimeTypeName => 'DescribeExport';
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeExportOutput> run(
