...
class UntagResourceOperation extends _i1
    .HttpOperation<UntagResourceInput, UntagResourceInput, _i1.Unit, _i1.Unit> {
  /// Removes the association of tags from an Amazon DynamoDB resource. You can call `UntagResource` up to five times per second, per account.
  ///
  /// For an overview on tagging DynamoDB resources, see [Tagging for DynamoDB](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Tagging.html) in the _Amazon DynamoDB Developer Guide_.
  ...
  @override
  late final List<
      _i1.HttpProtocol<UntagResourceInput, UntagResourceInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UntagResourceInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
