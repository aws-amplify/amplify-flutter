...
library smoke_test.dynamo_db.model.resource_in_use_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ResourceInUseExceptionAwsJson10Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final ResourceInUseException(:message) = payload;
    if (message != null) {
      result
        ..add('message')
