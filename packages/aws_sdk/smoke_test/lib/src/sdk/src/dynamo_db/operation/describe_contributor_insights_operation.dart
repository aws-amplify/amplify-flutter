...
class DescribeContributorInsightsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeContributorInsightsInput,
          DescribeContributorInsightsOutput,
          DescribeContributorInsightsOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeContributorInsightsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeContributorInsightsOutput? output]) => 200;
  @override
  DescribeContributorInsightsOutput buildOutput(
    DescribeContributorInsightsOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeContributorInsightsOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeContributorInsightsOutput> run(
