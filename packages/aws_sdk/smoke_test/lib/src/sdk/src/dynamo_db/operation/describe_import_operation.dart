...
class DescribeImportOperation extends _i1.HttpOperation<DescribeImportInput,
    DescribeImportInput, DescribeImportOutput, DescribeImportOutput> {
  /// Represents the properties of the import.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeImportInput, DescribeImportInput,
          DescribeImportOutput, DescribeImportOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeImportInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeImportOutput? output]) => 200;
  @override
  DescribeImportOutput buildOutput(
    DescribeImportOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeImportOutput.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        _i1.SmithyError<ImportNotFoundException, ImportNotFoundException>(
          _i1.ShapeId(
          ...
          builder: ImportNotFoundException.fromResponse,
        )
      ];
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeImportOutput> run(
