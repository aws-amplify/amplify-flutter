...
class DescribeGlobalTableSettingsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeGlobalTableSettingsInput,
          DescribeGlobalTableSettingsOutput,
          DescribeGlobalTableSettingsOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeGlobalTableSettingsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeGlobalTableSettingsOutput? output]) => 200;
  @override
  DescribeGlobalTableSettingsOutput buildOutput(
    DescribeGlobalTableSettingsOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeGlobalTableSettingsOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeGlobalTableSettingsOutput> run(
