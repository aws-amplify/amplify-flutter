...
library smoke_test.dynamo_db.model.limit_exceeded_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class LimitExceededExceptionAwsJson10Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final LimitExceededException(:message) = payload;
    if (message != null) {
      result
        ..add('message')
