...
class DeleteBackupOperation extends _i1.HttpOperation<DeleteBackupInput,
    DeleteBackupInput, DeleteBackupOutput, DeleteBackupOutput> {
  /// Deletes an existing backup of a table.
  ///
  /// You can call `DeleteBackup` at a maximum rate of 10 times per second.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteBackupInput, DeleteBackupInput, DeleteBackupOutput,
          DeleteBackupOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteBackupInput input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeleteBackupOutput? output]) => 200;
  @override
  DeleteBackupOutput buildOutput(
    DeleteBackupOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeleteBackupOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DeleteBackupOutput> run(
