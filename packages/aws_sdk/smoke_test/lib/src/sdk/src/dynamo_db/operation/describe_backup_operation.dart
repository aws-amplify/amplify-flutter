...
library smoke_test.dynamo_db.operation.describe_backup_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeBackupOperation extends _i1.HttpOperation<DescribeBackupInput,
    DescribeBackupInput, DescribeBackupOutput, DescribeBackupOutput> {
  /// Describes an existing backup of a table.
  ///
  /// You can call `DescribeBackup` at a maximum rate of 10 times per second.
  DescribeBackupOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeBackupInput, DescribeBackupInput,
          DescribeBackupOutput, DescribeBackupOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeBackupInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeBackupOutput? output]) => 200;
  @override
  DescribeBackupOutput buildOutput(
    DescribeBackupOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeBackupOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeBackupOutput> run(
