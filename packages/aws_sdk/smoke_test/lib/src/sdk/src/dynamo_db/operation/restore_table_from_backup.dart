...
library smoke_test.dynamo_db.operation.restore_table_from_backup; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class RestoreTableFromBackupOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.RestoreTableFromBackupInput,
          _i3.RestoreTableFromBackupOutput,
          _i3.RestoreTableFromBackupOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.RestoreTableFromBackupInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.RestoreTableFromBackupOutput? output]) => 200;
  @override
  _i3.RestoreTableFromBackupOutput buildOutput(
    _i3.RestoreTableFromBackupOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.RestoreTableFromBackupOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.RestoreTableFromBackupOutput> run(
    _i2.RestoreTableFromBackupInput input, {
