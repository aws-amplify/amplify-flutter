...
class DescribeGlobalTableOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeGlobalTableInput, DescribeGlobalTableInput,
          DescribeGlobalTableOutput, DescribeGlobalTableOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeGlobalTableInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeGlobalTableOutput? output]) => 200;
  @override
  DescribeGlobalTableOutput buildOutput(
    DescribeGlobalTableOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeGlobalTableOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeGlobalTableOutput> run(
