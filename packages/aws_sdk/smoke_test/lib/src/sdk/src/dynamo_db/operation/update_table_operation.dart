...
class UpdateTableOperation extends _i1.HttpOperation<UpdateTableInput,
    UpdateTableInput, UpdateTableOutput, UpdateTableOutput> {
  /// Modifies the provisioned throughput settings, global secondary indexes, or DynamoDB Streams settings for a given table.
  ///
  /// This operation only applies to [Version 2019.11.21 (Current)](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html) of global tables.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateTableInput, UpdateTableInput, UpdateTableOutput,
          UpdateTableOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateTableInput input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UpdateTableOutput? output]) => 200;
  @override
  UpdateTableOutput buildOutput(
    UpdateTableOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UpdateTableOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UpdateTableOutput> run(
