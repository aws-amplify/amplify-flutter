...
library smoke_test.dynamo_db.operation.describe_table_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeTableOperation extends _i1.HttpOperation<DescribeTableInput,
    DescribeTableInput, DescribeTableOutput, DescribeTableOutput> {
  /// Returns information about the table, including the current status of the table, when it was created, the primary key schema, and any indexes on the table.
  ///
  /// This operation only applies to [Version 2019.11.21 (Current)](https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html) of global tables.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeTableInput, DescribeTableInput,
          DescribeTableOutput, DescribeTableOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeTableInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeTableOutput? output]) => 200;
  @override
  DescribeTableOutput buildOutput(
    DescribeTableOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeTableOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeTableOutput> run(
