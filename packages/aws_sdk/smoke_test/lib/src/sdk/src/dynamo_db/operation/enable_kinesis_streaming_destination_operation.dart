...
library smoke_test.dynamo_db.operation.enable_kinesis_streaming_destination_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class EnableKinesisStreamingDestinationOperation extends _i1.HttpOperation<
    KinesisStreamingDestinationInput,
    KinesisStreamingDestinationInput,
    KinesisStreamingDestinationOutput,
    KinesisStreamingDestinationOutput> {
  /// Starts table data replication to the specified Kinesis data stream at a timestamp chosen during the enable workflow. If this operation doesn't return results immediately, use DescribeKinesisStreamingDestination to check if streaming to the Kinesis data stream is ACTIVE.
  EnableKinesisStreamingDestinationOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          KinesisStreamingDestinationInput,
          KinesisStreamingDestinationOutput,
          KinesisStreamingDestinationOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(KinesisStreamingDestinationInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([KinesisStreamingDestinationOutput? output]) => 200;
  @override
  KinesisStreamingDestinationOutput buildOutput(
    KinesisStreamingDestinationOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      KinesisStreamingDestinationOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'EnableKinesisStreamingDestination';
  @override
  ...
  @override
  _i1.SmithyOperation<KinesisStreamingDestinationOutput> run(
