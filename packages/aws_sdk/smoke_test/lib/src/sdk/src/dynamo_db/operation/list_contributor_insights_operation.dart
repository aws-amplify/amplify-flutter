...
class ListContributorInsightsOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListContributorInsightsInput,
          ListContributorInsightsOutput,
          ListContributorInsightsOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListContributorInsightsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListContributorInsightsOutput? output]) => 200;
  @override
  ListContributorInsightsOutput buildOutput(
    ListContributorInsightsOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ListContributorInsightsOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListContributorInsightsOutput> run(
  ...
  @override
  String? getToken(ListContributorInsightsOutput output) => output.nextToken;
  @override
  ListContributorInsightsOutput getItems(
          ListContributorInsightsOutput output) =>
      output;
  @override
  ListContributorInsightsInput rebuildInput(
    ListContributorInsightsInput input,
    String token,
    int? pageSize,
  ) =>
