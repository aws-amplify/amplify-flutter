...
library smoke_test.dynamo_db.common.endpoint_resolver; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
final _partitions = [
  _i1.Partition(
    ...
    endpoints: const {
      ...
      'ca-central-1-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb-fips.ca-central-1.amazonaws.com',
      ...
      'us-east-1-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb-fips.us-east-1.amazonaws.com',
        credentialScope: _i1.CredentialScope(region: 'us-east-1'),
        variants: [],
      ),
      ...
      'us-east-2-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb-fips.us-east-2.amazonaws.com',
      ...
      'us-west-1-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb-fips.us-west-1.amazonaws.com',
      ...
      'us-west-2-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb-fips.us-west-2.amazonaws.com',
  ...
  _i1.Partition(
    ...
    endpoints: const {
      ...
      'us-gov-east-1-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb.us-gov-east-1.amazonaws.com',
      ...
      'us-gov-west-1-fips': _i1.EndpointDefinition(
        hostname: 'dynamodb.us-gov-west-1.amazonaws.com',
