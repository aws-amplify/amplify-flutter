...
library smoke_test.dynamo_db.operation.describe_continuous_backups; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeContinuousBackupsOperation extends _i1.HttpOperation<
    _i2.DescribeContinuousBackupsInput,
    _i2.DescribeContinuousBackupsInput,
    _i3.DescribeContinuousBackupsOutput,
    _i3.DescribeContinuousBackupsOutput> {
  /// Checks the status of continuous backups and point in time recovery on the specified table. Continuous backups are `ENABLED` on all tables at table creation. If point in time recovery is enabled, `PointInTimeRecoveryStatus` will be set to ENABLED.
  ///
  /// After continuous backups and point in time recovery are enabled, you can restore to any point in time within `EarliestRestorableDateTime` and `LatestRestorableDateTime`.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeContinuousBackupsInput,
          _i3.DescribeContinuousBackupsOutput,
          _i3.DescribeContinuousBackupsOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeContinuousBackupsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeContinuousBackupsOutput? output]) => 200;
  @override
  ...
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError(
          ...
          _i1.ErrorKind.client,
          _i11.TableNotFoundException,
          builder: _i11.TableNotFoundException.fromResponse,
        ),
      ];
  @override
