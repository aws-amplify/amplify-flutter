...
library smoke_test.dynamo_db.model.internal_server_error; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class InternalServerErrorAwsJson10Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as InternalServerError);
    final result = <Object?>[];
    final InternalServerError(:message) = payload;
    if (message != null) {
      result
        ..add('message')
