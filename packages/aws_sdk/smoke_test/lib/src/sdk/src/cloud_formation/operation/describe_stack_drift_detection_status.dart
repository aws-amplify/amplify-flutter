...
library smoke_test.cloud_formation.operation.describe_stack_drift_detection_status; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeStackDriftDetectionStatusOperation extends _i1.HttpOperation<
    _i2.DescribeStackDriftDetectionStatusInput,
    _i2.DescribeStackDriftDetectionStatusInput,
    _i3.DescribeStackDriftDetectionStatusOutput,
    _i3.DescribeStackDriftDetectionStatusOutput> {
  /// Returns information about a stack drift detection operation. A stack drift detection operation detects whether a stack's actual configuration differs, or has _drifted_, from it's expected configuration, as defined in the stack template and any values specified as template parameters. A stack is considered to have drifted if one or more of its resources have drifted. For more information about stack and resource drift, see [Detecting Unregulated Configuration Changes to Stacks and Resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html).
  ///
  /// Use DetectStackDrift to initiate a stack drift detection operation. `DetectStackDrift` returns a `StackDriftDetectionId` you can use to monitor the progress of the operation using `DescribeStackDriftDetectionStatus`. Once the drift detection operation has completed, use DescribeStackResourceDrifts to return drift information about the stack and its resources.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeStackDriftDetectionStatusInput,
          _i3.DescribeStackDriftDetectionStatusOutput,
          _i3.DescribeStackDriftDetectionStatusOutput>> protocols = [
  ...
  _i1.HttpRequest buildRequest(
          _i2.DescribeStackDriftDetectionStatusInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeStackDriftDetectionStatusOutput? output]) => 200;
  @override
  _i3.DescribeStackDriftDetectionStatusOutput buildOutput(
    _i3.DescribeStackDriftDetectionStatusOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeStackDriftDetectionStatusOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeStackDriftDetectionStatusOutput> run(
    _i2.DescribeStackDriftDetectionStatusInput input, {
