...
library smoke_test.cloud_formation.operation.create_stack_instances; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class CreateStackInstancesOperation extends _i1.HttpOperation<
    _i2.CreateStackInstancesInput,
    _i2.CreateStackInstancesInput,
    _i3.CreateStackInstancesOutput,
    _i3.CreateStackInstancesOutput> {
  /// Creates stack instances for the specified accounts, within the specified Amazon Web Services Regions. A stack instance refers to a stack in a specific account and Region. You must specify at least one value for either `Accounts` or `DeploymentTargets`, and you must specify at least one value for `Regions`.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.CreateStackInstancesInput,
          _i3.CreateStackInstancesOutput,
          _i3.CreateStackInstancesOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.CreateStackInstancesInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.CreateStackInstancesOutput? output]) => 200;
  @override
  _i3.CreateStackInstancesOutput buildOutput(
    _i3.CreateStackInstancesOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.CreateStackInstancesOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.CreateStackInstancesOutput> run(
    _i2.CreateStackInstancesInput input, {
