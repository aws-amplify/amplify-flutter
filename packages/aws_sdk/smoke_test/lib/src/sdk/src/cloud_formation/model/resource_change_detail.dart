...
abstract class ResourceChangeDetail
  ...
  static const List<_i2.SmithySerializer<ResourceChangeDetail>> serializers = [
  ...
  ResourceTargetDefinition? get target;
...
class ResourceChangeDetailAwsQuerySerializer
    extends _i2.StructuredSmithySerializer<ResourceChangeDetail> {
      ...
      switch (key) {
        case 'Target':
          result.target.replace((serializers.deserialize(
            value,
            specifiedType: const FullType(ResourceTargetDefinition),
          ) as ResourceTargetDefinition));
        case 'Evaluation':
  ...
  Iterable<Object?> serialize(
    ...
    if (target != null) {
      result$
        ..add(const _i2.XmlElementName('Target'))
    ...
    if (causingEntity != null) {
      result$
        ..add(const _i2.XmlElementName('CausingEntity'))
        ..add(serializers.serialize(
          causingEntity,
          specifiedType: const FullType(String),
        ));
