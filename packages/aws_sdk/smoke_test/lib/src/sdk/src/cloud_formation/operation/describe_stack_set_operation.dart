...
class DescribeStackSetOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeStackSetOperationInput,
          DescribeStackSetOperationOutput,
          DescribeStackSetOperationOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeStackSetOperationInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeStackSetOperationOutput? output]) => 200;
  @override
  DescribeStackSetOperationOutput buildOutput(
    DescribeStackSetOperationOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeStackSetOperationOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeStackSetOperationOutput> run(
