...
abstract class DescribeStackInstanceOutput
  ...
  static const List<_i3.SmithySerializer> serializers = [
    DescribeStackInstanceOutputAwsQuerySerializer()
  ];
...
class DescribeStackInstanceOutputAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as DescribeStackInstanceOutput);
    final result = <Object?>[
    ...
    final DescribeStackInstanceOutput(:stackInstance) = payload;
