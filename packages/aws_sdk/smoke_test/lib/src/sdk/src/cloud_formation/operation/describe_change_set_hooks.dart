...
library smoke_test.cloud_formation.operation.describe_change_set_hooks; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeChangeSetHooksOperation extends _i1.HttpOperation<
    _i2.DescribeChangeSetHooksInput,
    _i2.DescribeChangeSetHooksInput,
    _i3.DescribeChangeSetHooksOutput,
    _i3.DescribeChangeSetHooksOutput> {
  /// Returns hook-related information for the change set and a list of changes that CloudFormation makes when you run the change set.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeChangeSetHooksInput,
          _i3.DescribeChangeSetHooksOutput,
          _i3.DescribeChangeSetHooksOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeChangeSetHooksInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeChangeSetHooksOutput? output]) => 200;
  @override
  _i3.DescribeChangeSetHooksOutput buildOutput(
    _i3.DescribeChangeSetHooksOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeChangeSetHooksOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeChangeSetHooksOutput> run(
    _i2.DescribeChangeSetHooksInput input, {
