...
library smoke_test.cloud_formation.operation.detect_stack_drift_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DetectStackDriftOperation extends _i1.HttpOperation<
    _i2.DetectStackDriftInput,
    _i2.DetectStackDriftInput,
    _i3.DetectStackDriftOutput,
    _i3.DetectStackDriftOutput> {
  /// Detects whether a stack's actual configuration differs, or has _drifted_, from it's expected configuration, as defined in the stack template and any values specified as template parameters. For each resource in the stack that supports drift detection, CloudFormation compares the actual configuration of the resource with its expected template configuration. Only resource properties explicitly defined in the stack template are checked for drift. A stack is considered to have drifted if one or more of its resources differ from their expected template configurations. For more information, see [Detecting Unregulated Configuration Changes to Stacks and Resources](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html).
  ///
  /// Use `DetectStackDrift` to detect drift on all supported resources for a given stack, or DetectStackResourceDrift to detect drift on individual resources.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.DetectStackDriftInput, _i2.DetectStackDriftInput,
          _i3.DetectStackDriftOutput, _i3.DetectStackDriftOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DetectStackDriftInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DetectStackDriftOutput? output]) => 200;
  @override
  _i3.DetectStackDriftOutput buildOutput(
    _i3.DetectStackDriftOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DetectStackDriftOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DetectStackDrift';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DetectStackDriftOutput> run(
    _i2.DetectStackDriftInput input, {
