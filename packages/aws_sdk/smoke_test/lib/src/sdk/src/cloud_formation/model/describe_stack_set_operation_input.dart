...
abstract class DescribeStackSetOperationInput
  ...
  static const List<_i1.SmithySerializer> serializers = [
    DescribeStackSetOperationInputAwsQuerySerializer()
  ];
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper('DescribeStackSetOperationInput');
    helper.add(
      'stackSetName',
      stackSetName,
    );
...
class DescribeStackSetOperationInputAwsQuerySerializer
  ...
  Iterable<Object?> serialize(
    ...
    final payload = (object as DescribeStackSetOperationInput);
    final result = <Object?>[
