...
class UpdateTerminationProtectionOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          UpdateTerminationProtectionInput,
          UpdateTerminationProtectionOutput,
          UpdateTerminationProtectionOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(UpdateTerminationProtectionInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([UpdateTerminationProtectionOutput? output]) => 200;
  @override
  UpdateTerminationProtectionOutput buildOutput(
    UpdateTerminationProtectionOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      UpdateTerminationProtectionOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<UpdateTerminationProtectionOutput> run(
