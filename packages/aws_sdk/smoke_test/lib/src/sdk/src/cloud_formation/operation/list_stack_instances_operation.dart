...
class ListStackInstancesOperation extends _i1.PaginatedHttpOperation<
    ...
    String,
    int,
    _i2.BuiltList<StackInstanceSummary>> {
  /// Returns summary information about stack instances that are associated with the specified stack set. You can filter for stack instances that are associated with a specific Amazon Web Services account name or Region, or that have a specific status.
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListStackInstancesInput, ListStackInstancesInput,
          ListStackInstancesOutput, ListStackInstancesOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListStackInstancesInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([ListStackInstancesOutput? output]) => 200;
  @override
  ListStackInstancesOutput buildOutput(
    ListStackInstancesOutput payload,
    _i5.AWSBaseHttpResponse response,
  ) =>
      ListStackInstancesOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListStackInstancesOutput> run(
  ...
  @override
  String? getToken(ListStackInstancesOutput output) => output.nextToken;
  @override
  _i2.BuiltList<StackInstanceSummary> getItems(
          ListStackInstancesOutput output) =>
      output.summaries ?? _i2.BuiltList();
  @override
  ListStackInstancesInput rebuildInput(
    ListStackInstancesInput input,
    String token,
    int? pageSize,
  ) =>
