...
class DeleteStackSetOperation extends _i1.HttpOperation<DeleteStackSetInput,
    DeleteStackSetInput, DeleteStackSetOutput, DeleteStackSetOutput> {
  /// Deletes a stack set. Before you can delete a stack set, all its member stack instances must be deleted. For more information about how to complete this, see DeleteStackInstances.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteStackSetInput, DeleteStackSetInput,
          DeleteStackSetOutput, DeleteStackSetOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteStackSetInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeleteStackSetOutput? output]) => 200;
  @override
  DeleteStackSetOutput buildOutput(
    DeleteStackSetOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeleteStackSetOutput.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError<StackSetNotEmptyException, StackSetNotEmptyException>(
          _i1.ShapeId(
            namespace: 'com.amazonaws.cloudformation',
            shape: 'StackSetNotEmptyException',
          ),
          ...
          statusCode: 409,
          builder: StackSetNotEmptyException.fromResponse,
        ),
      ];
  @override
  ...
  @override
  _i1.SmithyOperation<DeleteStackSetOutput> run(
