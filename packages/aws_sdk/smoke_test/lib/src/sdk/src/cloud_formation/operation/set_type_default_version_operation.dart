...
class SetTypeDefaultVersionOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          SetTypeDefaultVersionInput,
          SetTypeDefaultVersionOutput,
          SetTypeDefaultVersionOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(SetTypeDefaultVersionInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([SetTypeDefaultVersionOutput? output]) => 200;
  @override
  SetTypeDefaultVersionOutput buildOutput(
    SetTypeDefaultVersionOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      SetTypeDefaultVersionOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<SetTypeDefaultVersionOutput> run(
