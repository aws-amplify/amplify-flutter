...
class DeleteStackOperation extends _i1
    .HttpOperation<DeleteStackInput, DeleteStackInput, _i1.Unit, _i1.Unit> {
  /// Deletes a specified stack. Once the call completes successfully, stack deletion starts. Deleted stacks don't show up in the DescribeStacks operation if the deletion has been completed successfully.
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteStackInput input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
