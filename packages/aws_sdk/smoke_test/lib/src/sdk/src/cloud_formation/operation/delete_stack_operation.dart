...
library smoke_test.cloud_formation.operation.delete_stack_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteStackOperation extends _i1.HttpOperation<_i2.DeleteStackInput,
    _i2.DeleteStackInput, _i1.Unit, _i1.Unit> {
  /// Deletes a specified stack. Once the call completes successfully, stack deletion starts. Deleted stacks don't show up in the DescribeStacks operation if the deletion has been completed successfully.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.DeleteStackInput, _i2.DeleteStackInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteStackInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  String get runtimeTypeName => 'DeleteStack';
  @override
