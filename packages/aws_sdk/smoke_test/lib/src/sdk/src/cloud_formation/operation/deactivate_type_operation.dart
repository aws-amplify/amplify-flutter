...
class DeactivateTypeOperation extends _i1.HttpOperation<DeactivateTypeInput,
    DeactivateTypeInput, DeactivateTypeOutput, DeactivateTypeOutput> {
  /// Deactivates a public extension that was previously activated in this account and Region.
  ///
  /// Once deactivated, an extension can't be used in any CloudFormation operation. This includes stack update operations where the stack template includes the extension, even if no updates are being made to the extension. In addition, deactivated extensions aren't automatically updated if a new version of the extension is released.
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeactivateTypeInput, DeactivateTypeInput,
          DeactivateTypeOutput, DeactivateTypeOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeactivateTypeInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeactivateTypeOutput? output]) => 200;
  @override
  DeactivateTypeOutput buildOutput(
    DeactivateTypeOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeactivateTypeOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DeactivateTypeOutput> run(
