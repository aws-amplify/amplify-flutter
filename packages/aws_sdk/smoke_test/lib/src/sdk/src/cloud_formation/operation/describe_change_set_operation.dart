...
class DescribeChangeSetOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DescribeChangeSetInput, DescribeChangeSetInput,
          DescribeChangeSetOutput, DescribeChangeSetOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeChangeSetInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeChangeSetOutput? output]) => 200;
  @override
  DescribeChangeSetOutput buildOutput(
    DescribeChangeSetOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeChangeSetOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeChangeSetOutput> run(
