...
class DescribeTypeRegistrationOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeTypeRegistrationInput,
          DescribeTypeRegistrationOutput,
          DescribeTypeRegistrationOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeTypeRegistrationInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeTypeRegistrationOutput? output]) => 200;
  @override
  DescribeTypeRegistrationOutput buildOutput(
    DescribeTypeRegistrationOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeTypeRegistrationOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeTypeRegistrationOutput> run(
