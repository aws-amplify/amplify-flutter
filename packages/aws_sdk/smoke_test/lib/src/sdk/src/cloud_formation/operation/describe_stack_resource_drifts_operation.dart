...
class DescribeStackResourceDriftsOperation extends _i1.PaginatedHttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeStackResourceDriftsInput,
          DescribeStackResourceDriftsOutput,
          DescribeStackResourceDriftsOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeStackResourceDriftsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeStackResourceDriftsOutput? output]) => 200;
  @override
  DescribeStackResourceDriftsOutput buildOutput(
    DescribeStackResourceDriftsOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeStackResourceDriftsOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeStackResourceDriftsOutput> run(
  ...
  @override
  String? getToken(DescribeStackResourceDriftsOutput output) =>
      output.nextToken;
  @override
  DescribeStackResourceDriftsOutput getItems(
          DescribeStackResourceDriftsOutput output) =>
      output;
  @override
  DescribeStackResourceDriftsInput rebuildInput(
    DescribeStackResourceDriftsInput input,
    String token,
    int? pageSize,
  ) =>
