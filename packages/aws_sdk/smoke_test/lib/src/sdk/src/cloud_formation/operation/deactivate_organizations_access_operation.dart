...
class DeactivateOrganizationsAccessOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DeactivateOrganizationsAccessInput,
          DeactivateOrganizationsAccessOutput,
          DeactivateOrganizationsAccessOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DeactivateOrganizationsAccessInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DeactivateOrganizationsAccessOutput? output]) => 200;
  @override
  DeactivateOrganizationsAccessOutput buildOutput(
    DeactivateOrganizationsAccessOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DeactivateOrganizationsAccessOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DeactivateOrganizationsAccessOutput> run(
