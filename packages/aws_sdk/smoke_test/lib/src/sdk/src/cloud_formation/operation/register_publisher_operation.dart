...
class RegisterPublisherOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<RegisterPublisherInput, RegisterPublisherInput,
          RegisterPublisherOutput, RegisterPublisherOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(RegisterPublisherInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([RegisterPublisherOutput? output]) => 200;
  @override
  RegisterPublisherOutput buildOutput(
    RegisterPublisherOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RegisterPublisherOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<RegisterPublisherOutput> run(
