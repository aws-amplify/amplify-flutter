...
library smoke_test.cloud_formation.operation.register_publisher_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class RegisterPublisherOperation extends _i1.HttpOperation<
    _i2.RegisterPublisherInput,
    _i2.RegisterPublisherInput,
    _i3.RegisterPublisherOutput,
    _i3.RegisterPublisherOutput> {
  /// Registers your account as a publisher of public extensions in the CloudFormation registry. Public extensions are available for use by all CloudFormation users. This publisher ID applies to your account in all Amazon Web Services Regions.
  ///
  /// For information about requirements for registering as a public extension publisher, see [Registering your account to publish CloudFormation extensions](https://docs.aws.amazon.com/cloudformation-cli/latest/userguide/publish-extension.html#publish-extension-prereqs) in the _CloudFormation CLI User Guide_.
  RegisterPublisherOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.RegisterPublisherInput,
          _i3.RegisterPublisherOutput,
          _i3.RegisterPublisherOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.RegisterPublisherInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.RegisterPublisherOutput? output]) => 200;
  @override
  _i3.RegisterPublisherOutput buildOutput(
    _i3.RegisterPublisherOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.RegisterPublisherOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'RegisterPublisher';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.RegisterPublisherOutput> run(
    _i2.RegisterPublisherInput input, {
