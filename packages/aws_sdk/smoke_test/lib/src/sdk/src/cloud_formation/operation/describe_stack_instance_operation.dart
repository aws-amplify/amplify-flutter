...
class DescribeStackInstanceOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeStackInstanceInput,
          DescribeStackInstanceOutput,
          DescribeStackInstanceOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeStackInstanceInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeStackInstanceOutput? output]) => 200;
  @override
  DescribeStackInstanceOutput buildOutput(
    DescribeStackInstanceOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeStackInstanceOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeStackInstanceOutput> run(
