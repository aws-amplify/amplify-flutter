...
class StopStackSetOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          StopStackSetOperationInput,
          StopStackSetOperationOutput,
          StopStackSetOperationOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(StopStackSetOperationInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([StopStackSetOperationOutput? output]) => 200;
  @override
  StopStackSetOperationOutput buildOutput(
    StopStackSetOperationOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      StopStackSetOperationOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<StopStackSetOperationOutput> run(
