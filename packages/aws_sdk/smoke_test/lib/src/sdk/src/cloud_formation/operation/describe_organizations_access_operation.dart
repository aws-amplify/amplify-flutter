...
class DescribeOrganizationsAccessOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          DescribeOrganizationsAccessInput,
          DescribeOrganizationsAccessOutput,
          DescribeOrganizationsAccessOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(DescribeOrganizationsAccessInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([DescribeOrganizationsAccessOutput? output]) => 200;
  @override
  DescribeOrganizationsAccessOutput buildOutput(
    DescribeOrganizationsAccessOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      DescribeOrganizationsAccessOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<DescribeOrganizationsAccessOutput> run(
