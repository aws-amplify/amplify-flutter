...
library smoke_test.cloud_formation.operation.describe_organizations_access_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeOrganizationsAccessOperation extends _i1.HttpOperation<
    _i2.DescribeOrganizationsAccessInput,
    _i2.DescribeOrganizationsAccessInput,
    _i3.DescribeOrganizationsAccessOutput,
    _i3.DescribeOrganizationsAccessOutput> {
  /// Retrieves information about the account's `OrganizationAccess` status. This API can be called either by the management account or the delegated administrator by using the `CallAs` parameter. This API can also be called without the `CallAs` parameter by the management account.
  DescribeOrganizationsAccessOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeOrganizationsAccessInput,
          _i3.DescribeOrganizationsAccessOutput,
          _i3.DescribeOrganizationsAccessOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeOrganizationsAccessInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeOrganizationsAccessOutput? output]) => 200;
  @override
  _i3.DescribeOrganizationsAccessOutput buildOutput(
    _i3.DescribeOrganizationsAccessOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeOrganizationsAccessOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'DescribeOrganizationsAccess';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeOrganizationsAccessOutput> run(
    _i2.DescribeOrganizationsAccessInput input, {
