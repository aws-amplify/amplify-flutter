...
library smoke_test.dynamo_db_streams.common.endpoint_resolver; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
final _partitions = [
  _i1.Partition(
    ...
    defaults: const _i1.EndpointDefinition(
      ...
      credentialScope: _i1.CredentialScope(service: 'dynamodb'),
      variants: [],
    ),
    regions: const {
      'af-south-1',
...
@_i2.internal
const String sdkId = 'DynamoDB Streams';
