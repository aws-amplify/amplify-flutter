...
library smoke_test.dynamo_db_streams.model.stream_view_type; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class StreamViewType extends _i1.SmithyEnum<StreamViewType> {
  ...
  const StreamViewType._sdkUnknown(super.value) : super.sdkUnknown();
