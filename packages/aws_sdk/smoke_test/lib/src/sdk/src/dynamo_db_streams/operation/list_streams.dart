...
library smoke_test.dynamo_db_streams.operation.list_streams; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListStreamsOperation extends _i1.HttpOperation<_i2.ListStreamsInput,
    _i2.ListStreamsInput, _i3.ListStreamsOutput, _i3.ListStreamsOutput> {
  /// Returns an array of stream ARNs associated with the current account and endpoint. If the `TableName` parameter is present, then `ListStreams` will return only the streams ARNs for that table.
  ///
  /// You can call `ListStreams` at a maximum rate of 5 times per second.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.ListStreamsInput, _i2.ListStreamsInput,
          _i3.ListStreamsOutput, _i3.ListStreamsOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.ListStreamsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.ListStreamsOutput? output]) => 200;
  @override
