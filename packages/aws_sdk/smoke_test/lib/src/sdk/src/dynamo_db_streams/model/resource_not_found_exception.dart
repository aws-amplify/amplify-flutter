...
library smoke_test.dynamo_db_streams.model.resource_not_found_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ResourceNotFoundExceptionAwsJson10Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final ResourceNotFoundException(:message) = payload;
    if (message != null) {
      result
        ..add('message')
