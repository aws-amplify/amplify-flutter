...
class PutObjectLegalHoldOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          PutObjectLegalHoldRequest,
          PutObjectLegalHoldOutputPayload,
          PutObjectLegalHoldOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(PutObjectLegalHoldRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  @override
  int successCode([PutObjectLegalHoldOutput? output]) => 200;
  @override
  PutObjectLegalHoldOutput buildOutput(
    PutObjectLegalHoldOutputPayload payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      PutObjectLegalHoldOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<PutObjectLegalHoldOutput> run(
