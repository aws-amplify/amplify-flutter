...
class GetBucketVersioningOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetBucketVersioningRequest,
          GetBucketVersioningOutput,
          GetBucketVersioningOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(GetBucketVersioningRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([GetBucketVersioningOutput? output]) => 200;
  @override
  GetBucketVersioningOutput buildOutput(
    GetBucketVersioningOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetBucketVersioningOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetBucketVersioningOutput> run(
