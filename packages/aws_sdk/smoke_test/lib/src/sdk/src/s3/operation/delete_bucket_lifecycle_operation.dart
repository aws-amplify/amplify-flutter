...
class DeleteBucketLifecycleOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteBucketLifecycleRequestPayload,
          DeleteBucketLifecycleRequest, _i1.Unit, _i1.Unit>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteBucketLifecycleRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
