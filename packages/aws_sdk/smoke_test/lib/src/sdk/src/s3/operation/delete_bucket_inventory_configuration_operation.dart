...
library smoke_test.s3.operation.delete_bucket_inventory_configuration_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteBucketInventoryConfigurationOperation extends _i1.HttpOperation<
    _i2.DeleteBucketInventoryConfigurationRequestPayload,
    _i2.DeleteBucketInventoryConfigurationRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Deletes an inventory configuration (identified by the inventory ID) from the bucket.
  ///
  ...
  _i1.HttpRequest buildRequest(
          _i2.DeleteBucketInventoryConfigurationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
  ...
  @override
  String get runtimeTypeName => 'DeleteBucketInventoryConfiguration';
  @override
