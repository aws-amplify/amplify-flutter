...
library smoke_test.s3.operation.put_object_retention; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutObjectRetentionOperation extends _i1.HttpOperation<
    _i2.ObjectLockRetention,
    _i3.PutObjectRetentionRequest,
    _i4.PutObjectRetentionOutputPayload,
    _i4.PutObjectRetentionOutput> {
  /// Places an Object Retention configuration on an object. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html). Users or accounts require the `s3:PutObjectRetention` permission in order to place an Object Retention configuration on objects. Bypassing a Governance Retention configuration requires the `s3:BypassGovernanceRetention` permission.
  ///
  /// This action is not supported by Amazon S3 on Outposts.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i3.PutObjectRetentionRequest,
          _i4.PutObjectRetentionOutputPayload,
          _i4.PutObjectRetentionOutput>> protocols = [
    _i5.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(_i3.PutObjectRetentionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  @override
  int successCode([_i4.PutObjectRetentionOutput? output]) => 200;
  @override
  _i4.PutObjectRetentionOutput buildOutput(
    _i4.PutObjectRetentionOutputPayload payload,
    _i8.AWSBaseHttpResponse response,
  ) =>
      _i4.PutObjectRetentionOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i4.PutObjectRetentionOutput> run(
    _i3.PutObjectRetentionRequest input, {
