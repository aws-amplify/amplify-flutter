...
library smoke_test.s3.operation.put_bucket_accelerate_configuration; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutBucketAccelerateConfigurationOperation extends _i1.HttpOperation<
    _i2.AccelerateConfiguration,
    _i3.PutBucketAccelerateConfigurationRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Sets the accelerate configuration of an existing bucket. Amazon S3 Transfer Acceleration is a bucket-level feature that enables you to perform faster data transfers to Amazon S3.
  ///
  ...
  _i1.HttpRequest buildRequest(
          _i3.PutBucketAccelerateConfigurationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
