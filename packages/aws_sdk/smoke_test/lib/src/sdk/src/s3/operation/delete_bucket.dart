...
library smoke_test.s3.operation.delete_bucket; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteBucketOperation extends _i1.HttpOperation<
    _i2.DeleteBucketRequestPayload,
    _i2.DeleteBucketRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Deletes the S3 bucket. All objects (including all object versions and delete markers) in the bucket must be deleted before the bucket itself can be deleted.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.DeleteBucketRequestPayload, _i2.DeleteBucketRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteBucketRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
  ...
  @override
  String get runtimeTypeName => 'DeleteBucket';
  @override
