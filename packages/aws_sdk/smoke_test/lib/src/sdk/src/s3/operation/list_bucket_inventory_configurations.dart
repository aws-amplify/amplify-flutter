...
library smoke_test.s3.operation.list_bucket_inventory_configurations; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ListBucketInventoryConfigurationsOperation extends _i1.HttpOperation<
    _i2.ListBucketInventoryConfigurationsRequestPayload,
    _i2.ListBucketInventoryConfigurationsRequest,
    _i3.ListBucketInventoryConfigurationsOutput,
    _i3.ListBucketInventoryConfigurationsOutput> {
  /// Returns a list of inventory configurations for the bucket. You can have up to 1,000 analytics configurations per bucket.
  ///
  /// This action supports list pagination and does not return more than 100 configurations at a time. Always check the `IsTruncated` element in the response. If there are no more configurations to list, `IsTruncated` is set to false. If there are more configurations to list, `IsTruncated` is set to true, and there is a value in `NextContinuationToken`. You use the `NextContinuationToken` value to continue the pagination of the list by passing the value in continuation-token in the request to `GET` the next page.
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.ListBucketInventoryConfigurationsRequest,
          _i3.ListBucketInventoryConfigurationsOutput,
          _i3.ListBucketInventoryConfigurationsOutput>> protocols = [
    _i4.RestXmlProtocol(
  ...
  _i1.HttpRequest buildRequest(
          _i2.ListBucketInventoryConfigurationsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([_i3.ListBucketInventoryConfigurationsOutput? output]) => 200;
  @override
  _i3.ListBucketInventoryConfigurationsOutput buildOutput(
    _i3.ListBucketInventoryConfigurationsOutput payload,
    _i7.AWSBaseHttpResponse response,
  ) =>
      _i3.ListBucketInventoryConfigurationsOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.ListBucketInventoryConfigurationsOutput> run(
    _i2.ListBucketInventoryConfigurationsRequest input, {
