...
class PutBucketLoggingOperation extends _i1.HttpOperation<BucketLoggingStatus,
    PutBucketLoggingRequest, _i1.Unit, _i1.Unit> {
  /// Set the logging parameters for a bucket and to specify permissions for who can view and modify the logging parameters. All logs are saved to buckets in the same Amazon Web Services Region as the source bucket. To set the logging status of a bucket, you must be the bucket owner.
  ///
  /// The bucket owner is automatically granted FULL_CONTROL to all logs. You use the `Grantee` request element to grant access to other people. The `Permissions` request element specifies the kind of access the grantee has to the logs.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<BucketLoggingStatus, PutBucketLoggingRequest, _i1.Unit,
          _i1.Unit>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(PutBucketLoggingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path =
