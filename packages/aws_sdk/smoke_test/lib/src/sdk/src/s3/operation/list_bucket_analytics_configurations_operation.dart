...
class ListBucketAnalyticsConfigurationsOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          ListBucketAnalyticsConfigurationsRequest,
          ListBucketAnalyticsConfigurationsOutput,
          ListBucketAnalyticsConfigurationsOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  int successCode([ListBucketAnalyticsConfigurationsOutput? output]) => 200;
  @override
  ListBucketAnalyticsConfigurationsOutput buildOutput(
    ListBucketAnalyticsConfigurationsOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      ListBucketAnalyticsConfigurationsOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<ListBucketAnalyticsConfigurationsOutput> run(
    ListBucketAnalyticsConfigurationsRequest input, {
