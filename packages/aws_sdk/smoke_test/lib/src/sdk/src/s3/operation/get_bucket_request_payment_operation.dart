...
class GetBucketRequestPaymentOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetBucketRequestPaymentRequest,
          GetBucketRequestPaymentOutput,
          GetBucketRequestPaymentOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(GetBucketRequestPaymentRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([GetBucketRequestPaymentOutput? output]) => 200;
  @override
  GetBucketRequestPaymentOutput buildOutput(
    GetBucketRequestPaymentOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetBucketRequestPaymentOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetBucketRequestPaymentOutput> run(
