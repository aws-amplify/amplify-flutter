...
library smoke_test.s3.operation.delete_bucket_ownership_controls_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DeleteBucketOwnershipControlsOperation extends _i1.HttpOperation<
    _i2.DeleteBucketOwnershipControlsRequestPayload,
    _i2.DeleteBucketOwnershipControlsRequest,
    _i1.Unit,
    _i1.Unit> {
  /// Removes `OwnershipControls` for an Amazon S3 bucket. To use this operation, you must have the `s3:PutBucketOwnershipControls` permission. For more information about Amazon S3 permissions, see [Specifying Permissions in a Policy](https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html).
  ///
  ...
  _i1.HttpRequest buildRequest(
          _i2.DeleteBucketOwnershipControlsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
  ...
  @override
  String get runtimeTypeName => 'DeleteBucketOwnershipControls';
  @override
