...
abstract class MetricsAndOperator
  ...
  static const List<_i3.SmithySerializer<MetricsAndOperator>> serializers = [
...
class MetricsAndOperatorRestXmlSerializer
    extends _i3.StructuredSmithySerializer<MetricsAndOperator> {
  ...
  Iterable<Object?> serialize(
    ...
    if (accessPointArn != null) {
      result$
        ..add(const _i3.XmlElementName('AccessPointArn'))
