...
class GetBucketLoggingOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<GetBucketLoggingRequestPayload, GetBucketLoggingRequest,
          GetBucketLoggingOutput, GetBucketLoggingOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(GetBucketLoggingRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
  ...
  @override
  int successCode([GetBucketLoggingOutput? output]) => 200;
  @override
  GetBucketLoggingOutput buildOutput(
    GetBucketLoggingOutput payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetBucketLoggingOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetBucketLoggingOutput> run(
