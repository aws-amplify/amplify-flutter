...
class DeleteBucketOperation extends _i1.HttpOperation<
    DeleteBucketRequestPayload, DeleteBucketRequest, _i1.Unit, _i1.Unit> {
  /// Deletes the S3 bucket. All objects (including all object versions and delete markers) in the bucket must be deleted before the bucket itself can be deleted.
  ///
  /// The following operations are related to `DeleteBucket`:
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<DeleteBucketRequestPayload, DeleteBucketRequest,
  ...
  @override
  _i1.HttpRequest buildRequest(DeleteBucketRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
