...
abstract class ReplicationConfiguration
  ...
  factory ReplicationConfiguration({
    ...
    required List<ReplicationRule> rules,
  }) {
    return _$ReplicationConfiguration._(
      role: role,
      rules: _i2.BuiltList(rules),
    );
  }
  ...
  static const List<_i3.SmithySerializer<ReplicationConfiguration>>
  ...
  _i2.BuiltList<ReplicationRule> get rules;
  @override
...
class ReplicationConfigurationRestXmlSerializer
    extends _i3.StructuredSmithySerializer<ReplicationConfiguration> {
