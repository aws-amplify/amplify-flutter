...
class GetObjectRetentionOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetObjectRetentionRequest,
          ObjectLockRetention,
          GetObjectRetentionOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(GetObjectRetentionRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([GetObjectRetentionOutput? output]) => 200;
  @override
  GetObjectRetentionOutput buildOutput(
    ObjectLockRetention? payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetObjectRetentionOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetObjectRetentionOutput> run(
