...
class RestoreObjectOperation extends _i1.HttpOperation<RestoreRequest,
    RestoreObjectRequest, RestoreObjectOutputPayload, RestoreObjectOutput> {
  /// Restores an archived copy of an object back into Amazon S3
  ///
  /// This action is not supported by Amazon S3 on Outposts.
  ///
  ...
  @override
  late final List<
      _i1.HttpProtocol<RestoreRequest, RestoreObjectRequest,
          RestoreObjectOutputPayload, RestoreObjectOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(RestoreObjectRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  int successCode([RestoreObjectOutput? output]) => 200;
  @override
  RestoreObjectOutput buildOutput(
    RestoreObjectOutputPayload payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      RestoreObjectOutput.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        _i1.SmithyError<ObjectAlreadyInActiveTierError,
          ...
          ObjectAlreadyInActiveTierError,
          builder: ObjectAlreadyInActiveTierError.fromResponse,
        )
      ];
  @override
  ...
  @override
  _i1.SmithyOperation<RestoreObjectOutput> run(
