...
class GetObjectLockConfigurationOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          GetObjectLockConfigurationRequest,
          ObjectLockConfiguration,
          GetObjectLockConfigurationOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(GetObjectLockConfigurationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([GetObjectLockConfigurationOutput? output]) => 200;
  @override
  GetObjectLockConfigurationOutput buildOutput(
    ObjectLockConfiguration? payload,
    _i4.AWSBaseHttpResponse response,
  ) =>
      GetObjectLockConfigurationOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  _i1.SmithyOperation<GetObjectLockConfigurationOutput> run(
