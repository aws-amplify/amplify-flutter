...
library smoke_test.s3.operation.get_object_lock_configuration_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class GetObjectLockConfigurationOperation extends _i1.HttpOperation<
    _i2.GetObjectLockConfigurationRequestPayload,
    _i2.GetObjectLockConfigurationRequest,
    _i3.ObjectLockConfiguration,
    _i4.GetObjectLockConfigurationOutput> {
  /// Gets the Object Lock configuration for a bucket. The rule specified in the Object Lock configuration will be applied by default to every new object placed in the specified bucket. For more information, see [Locking Objects](https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html).
  ///
  /// The following action is related to `GetObjectLockConfiguration`:
  ///
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.GetObjectLockConfigurationRequest,
          _i3.ObjectLockConfiguration,
          _i4.GetObjectLockConfigurationOutput>> protocols = [
    _i5.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.GetObjectLockConfigurationRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  int successCode([_i4.GetObjectLockConfigurationOutput? output]) => 200;
  @override
  _i4.GetObjectLockConfigurationOutput buildOutput(
    _i3.ObjectLockConfiguration? payload,
    _i8.AWSBaseHttpResponse response,
  ) =>
      _i4.GetObjectLockConfigurationOutput.fromResponse(
        payload,
        response,
      );
  @override
  ...
  @override
  String get runtimeTypeName => 'GetObjectLockConfiguration';
  @override
  ...
  @override
  _i1.SmithyOperation<_i4.GetObjectLockConfigurationOutput> run(
    _i2.GetObjectLockConfigurationRequest input, {
