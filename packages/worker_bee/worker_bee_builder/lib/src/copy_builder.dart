...
class WorkerCopyBuilder extends Builder {
  ...
  late final Map<String, List<String>> buildExtensions = {
    '.debug.dart.js': ['.dev.js'],
    '.debug.dart2js.js': ['.dev.dart2js.js'],
    '.debug.dart2js.js.map': ['.dev.dart2js.js.map'],
    '.release.dart.js': ['.min.js'],
    '.release.dart2js.js': ['.min.dart2js.js'],
    '.release.dart2js.js.map': ['.min.dart2js.js.map'],
    '.debug.wasm': ['.dev.wasm'],
    '.debug.wasm.map': ['.dev.wasm.map'],
    '.debug.mjs': ['.dev.mjs'],
  ...
  Future<void> build(BuildStep buildStep) async {
    ...
    final outputFilename = originalFilename
        .replaceFirst('.debug.dart2js.js.map', '.dev.dart2js.js.map')
        .replaceFirst('.debug.dart2js.js', '.dev.dart2js.js')
        .replaceFirst('.debug.dart.js', '.dev.js')
        ...
        .replaceFirst('.debug.wasm.map', '.dev.wasm.map')
        .replaceFirst('.debug.wasm', '.dev.wasm')
        .replaceFirst('.debug.mjs', '.dev.mjs')
    ...
    if (inputPath.endsWith('.wasm')) {
      ...
      //Update JS/WASM loader with new source file names
        ...
        input = input.replaceAll('.debug.', '.dev.');
