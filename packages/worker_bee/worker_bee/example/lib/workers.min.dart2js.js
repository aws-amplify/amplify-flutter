...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    IntCoercingSerializer_IntCoercingSerializer$forType($T) {
      var t1 = $.$get$IntCoercingSerializer__defaults().serializerForType$1(A.createRuntimeType($T));
      t1.toString;
      return new A.IntCoercingSerializer($T._eval$1("PrimitiveSerializer<0>")._as(t1), $T._eval$1("IntCoercingSerializer<0>"));
    },
    IntCoercingSerializer: function IntCoercingSerializer(t0, t1) {
      this._int_coercing_serializer$_delegate = t0;
      this.$ti = t1;
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = init.G;
              A._asJSObject(t1.self).addEventListener("message", jsOnMessageCallback._readLocal$0());
              A.JSObjectUnsafeUtilExtension_callMethod(A._asJSObject(t1.self), "postMessage", "__worker_bee_online__", null, type$.nullable_Object);
  ...
  A.IntCoercingSerializer.prototype = {
    get$types() {
      return this._int_coercing_serializer$_delegate.get$types();
    },
    get$wireName() {
      return this._int_coercing_serializer$_delegate.get$wireName();
    },
    serialize$3$specifiedType(serializers, object, specifiedType) {
      return this._int_coercing_serializer$_delegate.serialize$3$specifiedType(serializers, this.$ti._precomputed1._as(object), specifiedType);
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
    deserialize$3$specifiedType(serializers, serialized, specifiedType) {
      var t1 = typeof serialized == "number" ? B.JSNumber_methods.toInt$0(serialized) : serialized;
      return this._int_coercing_serializer$_delegate.deserialize$3$specifiedType(serializers, t1, specifiedType);
    },
    deserialize$2(serializers, serialized) {
      return this.deserialize$3$specifiedType(serializers, serialized, B.FullType_null_List_empty_false);
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1.info$1("Echo worker running as: js (dart2js)");
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "IntCoercingSerializer__defaults", "$get$IntCoercingSerializer__defaults", () => A.Serializers_Serializers());
    _lazyFinal($, "workerBeeSerializers", "$get$workerBeeSerializers", () => {
      ...
      t1.add$1(0, A.IntCoercingSerializer_IntCoercingSerializer$forType(type$.int));
      t1.add$1(0, A.IntCoercingSerializer_IntCoercingSerializer$forType(type$.Duration));
      t1.add$1(0, A.IntCoercingSerializer_IntCoercingSerializer$forType(type$.DateTime));
      return t1.build$0();
    });
