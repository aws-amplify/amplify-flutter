...
let { compileStreaming } = await import("./workers.min.mjs");

let app = await compileStreaming(fetch(relativeURL("workers.min.wasm")));
...
scriptTag.src = relativeURL("./workers.min.dart2js.js");
