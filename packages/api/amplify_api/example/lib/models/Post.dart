...
class Post extends Model {
  ...
  const Post._internal({required this.id, required title, required rating, blog, comments, createdAt, updatedAt}): _title = title, _rating = rating, _blog = blog, _comments = comments, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Post({String? id, required String title, required int rating, Blog? blog, List<Comment>? comments}) {
  ...
  Post copyWith({String? title, int? rating, Blog? blog, List<Comment>? comments}) {
    return Post._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'rating': _rating, 'blog': _blog?.toJson(), 'comments': _comments?.map((Comment? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'rating': _rating, 'blog': _blog, 'comments': _comments, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
