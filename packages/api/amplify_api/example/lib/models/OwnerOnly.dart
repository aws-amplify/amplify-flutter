...
class OwnerOnly extends Model {
  ...
  OwnerOnlyModelIdentifier get modelIdentifier {
      return OwnerOnlyModelIdentifier(
        id: id
      );
  }
  ...
  const OwnerOnly._internal({required this.id, required name, createdAt, updatedAt}): _name = name, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  static final QueryModelIdentifier<OwnerOnlyModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<OwnerOnlyModelIdentifier>();
...
class OwnerOnlyModelIdentifier implements ModelIdentifier<OwnerOnly> {
  ...
  const OwnerOnlyModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is OwnerOnlyModelIdentifier &&
      id == other.id;
  }
