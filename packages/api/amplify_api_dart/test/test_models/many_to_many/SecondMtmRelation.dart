...
class SecondMtmRelation extends amplify_core.Model {
  ...
  SecondMtmRelationModelIdentifier get modelIdentifier {
      return SecondMtmRelationModelIdentifier(
        id: id
      );
  }
  ...
  const SecondMtmRelation._internal({required this.id, required manyToManyPrimary, required manyToManySecondary, createdAt, updatedAt}): _manyToManyPrimary = manyToManyPrimary, _manyToManySecondary = manyToManySecondary, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory SecondMtmRelation({String? id, required ManyToManyPrimary manyToManyPrimary, required ManyToManySecondary manyToManySecondary}) {
  ...
  static final amplify_core.QueryModelIdentifier<SecondMtmRelationModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<SecondMtmRelationModelIdentifier>();
...
class _SecondMtmRelationModelType extends amplify_core.ModelType<SecondMtmRelation> {
 ...
 */
class SecondMtmRelationModelIdentifier implements amplify_core.ModelIdentifier<SecondMtmRelation> {
  final String id;

  /** Create an instance of SecondMtmRelationModelIdentifier using [id] the primary key. */
  const SecondMtmRelationModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is SecondMtmRelationModelIdentifier &&
      id == other.id;
  }
