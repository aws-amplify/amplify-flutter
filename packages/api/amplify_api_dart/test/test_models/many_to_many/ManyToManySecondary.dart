...
class ManyToManySecondary extends amplify_core.Model {
  ...
  ManyToManySecondary copyWithModelFieldValues({
    ...
    return ManyToManySecondary._internal(
      ...
      firstMtmToPrimary: firstMtmToPrimary == null ? this.firstMtmToPrimary : firstMtmToPrimary.value,
      secondMtmToPrimary: secondMtmToPrimary == null ? this.secondMtmToPrimary : secondMtmToPrimary.value
    );
  }
  ...
  static final amplify_core.QueryModelIdentifier<ManyToManySecondaryModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<ManyToManySecondaryModelIdentifier>();
...
class _ManyToManySecondaryModelType extends amplify_core.ModelType<ManyToManySecondary> {
 ...
 */
class ManyToManySecondaryModelIdentifier implements amplify_core.ModelIdentifier<ManyToManySecondary> {
  final String id;
