...
class ManyToManyPrimary extends amplify_core.Model {
  ...
  ManyToManyPrimary copyWithModelFieldValues({
    ...
    return ManyToManyPrimary._internal(
      ...
      firstMtmToSecondary: firstMtmToSecondary == null ? this.firstMtmToSecondary : firstMtmToSecondary.value,
      secondMtmToSecondary: secondMtmToSecondary == null ? this.secondMtmToSecondary : secondMtmToSecondary.value
    );
  }
  ...
  ManyToManyPrimary.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _name = json['name'],
      _firstMtmToSecondary = json['firstMtmToSecondary']  != null
        ? (json['firstMtmToSecondary']['items'] as List)
          .where((e) => e != null)
          .map((e) => FirstMtmRelation.fromJson(new Map<String, dynamic>.from(e)))
          .toList()
        : null,
      _secondMtmToSecondary = json['secondMtmToSecondary']  != null
        ? (json['secondMtmToSecondary']['items'] as List)
          .where((e) => e != null)
          .map((e) => SecondMtmRelation.fromJson(new Map<String, dynamic>.from(e)))
          .toList()
        : null,
  ...
  static final amplify_core.QueryModelIdentifier<ManyToManyPrimaryModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<ManyToManyPrimaryModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final NAME = amplify_core.QueryField(fieldName: "name");
  static final FIRSTMTMTOSECONDARY = amplify_core.QueryField(
    fieldName: "firstMtmToSecondary",
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'FirstMtmRelation'));
  static final SECONDMTMTOSECONDARY = amplify_core.QueryField(
    fieldName: "secondMtmToSecondary",
    fieldType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.model, ofModelName: 'SecondMtmRelation'));
...
class _ManyToManyPrimaryModelType extends amplify_core.ModelType<ManyToManyPrimary> {
 ...
 */
class ManyToManyPrimaryModelIdentifier implements amplify_core.ModelIdentifier<ManyToManyPrimary> {
  final String id;
