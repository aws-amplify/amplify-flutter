...
import 'dart:convert';
import 'amplify_auth_cognito_platform_interface.dart';
...
class AmplifyAuthCognitoMethodChannel extends AmplifyAuthCognitoInterface {
  ...
  CognitoSignUpResult _formatSignUpResponse(Map<String, dynamic> res, method) {
