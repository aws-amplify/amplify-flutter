...
class Person extends amplify_core.Model {
  ...
  const Person._internal({required this.id, required name, propertiesAddresses, required contact, createdAt, updatedAt}): _name = name, _propertiesAddresses = propertiesAddresses, _contact = contact, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Person({String? id, required String name, List<Address>? propertiesAddresses, required Contact contact}) {
    return Person._internal(
      id: id == null ? amplify_core.UUID.getUUID() : id,
      name: name,
      propertiesAddresses: propertiesAddresses != null ? List<Address>.unmodifiable(propertiesAddresses) : propertiesAddresses,
      contact: contact);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is Person &&
      id == other.id &&
      _name == other._name &&
      DeepCollectionEquality().equals(_propertiesAddresses, other._propertiesAddresses) &&
  ...
  String toString() {
    ...
    buffer.write("propertiesAddresses=" + (_propertiesAddresses != null ? _propertiesAddresses!.toString() : "null") + ", ");
  ...
  Person copyWith({String? name, List<Address>? propertiesAddresses, Contact? contact}) {
    return Person._internal(
      id: id,
      name: name ?? this.name,
  ...
  Person copyWithModelFieldValues({
    ...
    return Person._internal(
      ...
      propertiesAddresses: propertiesAddresses == null ? this.propertiesAddresses : propertiesAddresses.value,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'propertiesAddresses': _propertiesAddresses?.map((Address? e) => e?.toJson()).toList(), 'contact': _contact?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<PersonModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<PersonModelIdentifier>();
  static final ID = amplify_core.QueryField(fieldName: "id");
  static final NAME = amplify_core.QueryField(fieldName: "name");
  static final PROPERTIESADDRESSES = amplify_core.QueryField(fieldName: "propertiesAddresses");
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      ...
      isRequired: false,
      isArray: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'Address')
    ));
    
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      fieldName: 'contact',
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embedded, ofCustomTypeName: 'Contact')
    ));
