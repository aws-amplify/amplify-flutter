...
class Contact {
  ...
  Contact copyWith({String? email, Phone? phone, List<Address>? mailingAddresses}) {
    return Contact._internal(
  ...
  Contact copyWithModelFieldValues({
    ...
    return Contact._internal(
      ...
      mailingAddresses: mailingAddresses == null ? this.mailingAddresses : mailingAddresses.value
    );
  }
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      fieldName: 'phone',
      isRequired: true,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embedded, ofCustomTypeName: 'Phone')
    ));
