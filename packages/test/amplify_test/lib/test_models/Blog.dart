...
class Blog extends amplify_core.Model {
  ...
  factory Blog({String? id, required String name, amplify_core.TemporalDateTime? createdAt, S3Object? file, List<S3Object>? files, List<Post>? posts}) {
  ...
  Blog copyWith({String? name, amplify_core.TemporalDateTime? createdAt, S3Object? file, List<S3Object>? files, List<Post>? posts}) {
    return Blog._internal(
      id: id,
      name: name ?? this.name,
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(amplify_core.ModelFieldDefinition.embedded(
      fieldName: 'file',
      isRequired: false,
      ofType: amplify_core.ModelFieldType(amplify_core.ModelFieldTypeEnum.embedded, ofCustomTypeName: 'S3Object')
    ));
