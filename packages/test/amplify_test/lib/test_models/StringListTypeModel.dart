...
class StringListTypeModel extends amplify_core.Model {
  ...
  static final amplify_core.QueryModelIdentifier<StringListTypeModelModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<StringListTypeModelModelIdentifier>();
...
class _StringListTypeModelModelType extends amplify_core.ModelType<StringListTypeModel> {
 ...
 */
class StringListTypeModelModelIdentifier implements amplify_core.ModelIdentifier<StringListTypeModel> {
  final String id;
