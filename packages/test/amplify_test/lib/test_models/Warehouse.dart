...
class Warehouse extends amplify_core.Model {
  ...
  const Warehouse._internal({required this.id, required name, required region, createdAt, updatedAt}): _name = name, _region = region, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Warehouse({String? id, required String name, required String region}) {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'region': _region, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final amplify_core.QueryModelIdentifier<WarehouseModelIdentifier> MODEL_IDENTIFIER = amplify_core.QueryModelIdentifier<WarehouseModelIdentifier>();
  ...
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      amplify_core.ModelIndex(fields: const ["id", "name", "region"], name: null)
    ];
 ...
 */
class WarehouseModelIdentifier implements amplify_core.ModelIdentifier<Warehouse> {
  final String id;
  final String name;
  final String region;
  ...
  @override
  String toString() => 'WarehouseModelIdentifier(id: $id, name: $name, region: $region)';
