...
class ModelProvider implements amplify_core.ModelProviderInterface {
  ...
  @override
  List<amplify_core.ModelSchema> modelSchemas = [Blog.schema, Comment.schema, Inventory.schema, Person.schema, Post.schema, PostWithAuthRules.schema, Product.schema, StringListTypeModel.schema, Warehouse.schema];
  @override
  List<amplify_core.ModelSchema> customTypeSchemas = [Address.schema, Contact.schema, FileMeta.schema, Phone.schema, S3Object.schema];
