...
void main() {
  ...
  group('AmplifyStorageS3Dart API', () {
    ...
    group('list()', () {
      ...
      test(
        ...
        () async {
          ...
          when(
            () =>
                storageS3Service.list(path: testPath, options: defaultOptions),
    ...
    group('getProperties()', () {
      ...
      test(
        'should forward options to StorageS3Service.getProperties() API',
        () async {
    ...
    group('getUrl() API', () {
      ...
      test(
        'should forward default options to StorageS3Service.getUrl() API',
        () async {
    ...
    group('downloadData() API', () {
      ...
      test(
        'should forward options to StorageS3Service.downloadData API',
        () async {
    ...
    group('uploadData() API', () {
      ...
      setUpAll(() {
        registerFallbackValue(const StorageUploadDataOptions());
        registerFallbackValue(const S3DataPayload.empty());
        registerFallbackValue(
          const StorageBucket.fromBucketInfo(
            BucketInfo(bucketName: 'bucketName', region: 'region'),
          ),
        );
      });

      test(
        'should forward default options to StorageS3Service.uploadData API',
        () async {
      ...
      test(
        'should forward options to StorageS3Service.uploadData API',
        () async {
          const testOptions = StorageUploadDataOptions(
            bucket: StorageBucket.fromBucketInfo(
              BucketInfo(bucketName: 'test-bucket', region: 'test-region'),
            ),
            pluginOptions: S3UploadDataPluginOptions(
              getProperties: true,
              useAccelerateEndpoint: true,
      ...
      test(
        'should forward options.metadata to StorageS3Service.uploadData API',
        () async {
          const testMetadata = {'filename': '123'};
          const testOptions = StorageUploadDataOptions(metadata: testMetadata);
    ...
    group('uploadFile() API', () {
      ...
      setUpAll(() {
        registerFallbackValue(const StorageUploadFileOptions());
        registerFallbackValue(const S3DataPayload.empty());
        registerFallbackValue(AWSFile.fromData([]));
      });

      test(
        'should forward default options to StorageS3Service.uploadFile API',
        () async {
      ...
      test(
        'should forward options to StorageS3Service.uploadFile API',
        () async {
      ...
      test(
        'should forward options.metadata to StorageS3Service.uploadFile API',
        () async {
          const testMetadata = {'filename': '123'};
          const testOptions = StorageUploadFileOptions(metadata: testMetadata);
    ...
    group('remove() API', () {
      ...
      final testResult = S3RemoveResult(removedItem: S3Item(path: testKey));

      setUpAll(() {
        registerFallbackValue(const StorageRemoveOptions());
      });

      test(
        'should forward default options to StorageS3Service.remove() API',
        () async {
    ...
    group('removeMany() API', () {
      ...
      setUpAll(() {
        registerFallbackValue(const StorageRemoveManyOptions());
      });
      ...
      test(
        'should forward options to StorageS3Service.removeMany() API',
        () async {
