...
library amplify_storage_s3_dart.s3.model.object_lock_legal_hold_status; // ignore_for_file: no_leading_underscores_for_library_prefixes

import 'package:smithy/smithy.dart' as _i1;

class ObjectLockLegalHoldStatus
    extends _i1.SmithyEnum<ObjectLockLegalHoldStatus> {
  const ObjectLockLegalHoldStatus._(int index, String name, String value)
  ...
  static const List<_i1.SmithySerializer<ObjectLockLegalHoldStatus>>
      serializers = [
    _i1.SmithyEnumSerializer('ObjectLockLegalHoldStatus',
        values: values,
