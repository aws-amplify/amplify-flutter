...
class PartRestXmlSerializer extends _i3.StructuredSmithySerializer<Part> {
  ...
  @override
  Part deserialize(Serializers serializers, Iterable<Object?> serialized,
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    final result = <Object?>[
      const _i3.XmlElementName(
          'Part', _i3.XmlNamespace('http://s3.amazonaws.com/doc/2006-03-01/'))
    ];
    ...
    if (payload.partNumber != null) {
      result
        ...
        ..add(serializers.serialize(payload.partNumber!,
