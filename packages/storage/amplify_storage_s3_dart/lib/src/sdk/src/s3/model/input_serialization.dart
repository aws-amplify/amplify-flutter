...
abstract class InputSerialization
  ...
  @override
  List<Object?> get props => [compressionType, csv, json, parquet];
  @override
  String toString() {
    final helper = newBuiltValueToStringHelper('InputSerialization');
    helper.add('compressionType', compressionType);
    helper.add('csv', csv);
    helper.add('json', json);
    helper.add('parquet', parquet);
...
class InputSerializationRestXmlSerializer
    ...
    while (iterator.moveNext()) {
      ...
      switch (key as String) {
        case 'CompressionType':
          if (value != null) {
            result.compressionType = (serializers.deserialize(value,
        ...
        case 'CSV':
          if (value != null) {
            result.csv.replace((serializers.deserialize(value,
                specifiedType: const FullType(_i3.CsvInput)) as _i3.CsvInput));
          }
          break;
        case 'JSON':
          if (value != null) {
        ...
        case 'Parquet':
          if (value != null) {
            result.parquet.replace((serializers.deserialize(value,
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    final result = <Object?>[
      const _i6.XmlElementName('InputSerialization',
