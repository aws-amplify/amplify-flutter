...
library amplify_storage_s3_dart.s3.model.file_header_info; // ignore_for_file: no_leading_underscores_for_library_prefixes

import 'package:smithy/smithy.dart' as _i1;

class FileHeaderInfo extends _i1.SmithyEnum<FileHeaderInfo> {
  const FileHeaderInfo._(int index, String name, String value)
  ...
  static const List<_i1.SmithySerializer<FileHeaderInfo>> serializers = [
    _i1.SmithyEnumSerializer('FileHeaderInfo',
        values: values,
