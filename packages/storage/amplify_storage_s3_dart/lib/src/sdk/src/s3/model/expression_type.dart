...
library amplify_storage_s3_dart.s3.model.expression_type; // ignore_for_file: no_leading_underscores_for_library_prefixes

import 'package:smithy/smithy.dart' as _i1;

class ExpressionType extends _i1.SmithyEnum<ExpressionType> {
  const ExpressionType._(int index, String name, String value)
  ...
  static const List<_i1.SmithySerializer<ExpressionType>> serializers = [
    _i1.SmithyEnumSerializer('ExpressionType',
        values: values,
