...
class ObjectStorageClass extends _i1.SmithyEnum<ObjectStorageClass> {
  ...
  static const glacierIr = ObjectStorageClass._(2, 'GLACIER_IR', 'GLACIER_IR');

  static const intelligentTiering =
      ObjectStorageClass._(3, 'INTELLIGENT_TIERING', 'INTELLIGENT_TIERING');

  static const onezoneIa = ObjectStorageClass._(4, 'ONEZONE_IA', 'ONEZONE_IA');

  static const outposts = ObjectStorageClass._(5, 'OUTPOSTS', 'OUTPOSTS');

  static const reducedRedundancy =
      ObjectStorageClass._(6, 'REDUCED_REDUNDANCY', 'REDUCED_REDUNDANCY');

  static const standard = ObjectStorageClass._(7, 'STANDARD', 'STANDARD');

  static const standardIa =
      ObjectStorageClass._(8, 'STANDARD_IA', 'STANDARD_IA');
