...
abstract class MultipartUpload
  ...
  String toString() {
    ...
    helper.add('initiated', initiated);
...
class MultipartUploadRestXmlSerializer
  ...
  @override
  Iterable<Type> get types => const [MultipartUpload, _$MultipartUpload];
  @override
  ...
  MultipartUpload deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key as String) {
        ...
        case 'Initiated':
          if (value != null) {
            result.initiated = (serializers.deserialize(value,
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    final result = <Object?>[
      const _i6.XmlElementName('MultipartUpload',
    ...
    if (payload.initiated != null) {
      result
        ...
        ..add(serializers.serialize(payload.initiated!,
