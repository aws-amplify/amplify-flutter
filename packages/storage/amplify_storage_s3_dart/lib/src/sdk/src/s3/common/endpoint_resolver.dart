...
library amplify_storage_s3_dart.s3.common.endpoint_resolver; // ignore_for_file: no_leading_underscores_for_library_prefixes
  ...
  _i1.Partition(
      ...
      endpoints: const {
        ...
        'ca-central-1': _i1.EndpointDefinition(variants: [
          _i1.EndpointDefinitionVariant(
              hostname: 's3-fips.ca-central-1.amazonaws.com', tags: ['fips']),
          _i1.EndpointDefinitionVariant(
        ...
        'us-east-1': _i1.EndpointDefinition(
            ...
            variants: [
              _i1.EndpointDefinitionVariant(
                  ...
                  tags: ['dualstack', 'fips']),
              _i1.EndpointDefinitionVariant(
                  hostname: 's3-fips.us-east-1.amazonaws.com', tags: ['fips']),
              _i1.EndpointDefinitionVariant(
        ...
        'us-east-2': _i1.EndpointDefinition(variants: [
          _i1.EndpointDefinitionVariant(
              ...
              tags: ['dualstack', 'fips']),
          _i1.EndpointDefinitionVariant(
              hostname: 's3-fips.us-east-2.amazonaws.com', tags: ['fips']),
          _i1.EndpointDefinitionVariant(
        ...
        'us-west-1': _i1.EndpointDefinition(
            ...
            variants: [
              _i1.EndpointDefinitionVariant(
                  ...
                  tags: ['dualstack', 'fips']),
              _i1.EndpointDefinitionVariant(
                  hostname: 's3-fips.us-west-1.amazonaws.com', tags: ['fips']),
              _i1.EndpointDefinitionVariant(
        ...
        'us-west-2': _i1.EndpointDefinition(
            ...
            variants: [
              _i1.EndpointDefinitionVariant(
                  ...
                  tags: ['dualstack', 'fips']),
              _i1.EndpointDefinitionVariant(
                  hostname: 's3-fips.us-west-2.amazonaws.com', tags: ['fips']),
              _i1.EndpointDefinitionVariant(
