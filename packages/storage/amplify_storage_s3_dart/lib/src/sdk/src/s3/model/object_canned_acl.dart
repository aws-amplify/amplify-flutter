...
class ObjectCannedAcl extends _i1.SmithyEnum<ObjectCannedAcl> {
  const ObjectCannedAcl._(int index, String name, String value)
      : super(index, name, value);

  const ObjectCannedAcl._sdkUnknown(String value) : super.sdkUnknown(value);

  static const authenticatedRead =
      ObjectCannedAcl._(0, 'authenticated_read', 'authenticated-read');

  static const awsExecRead =
      ObjectCannedAcl._(1, 'aws_exec_read', 'aws-exec-read');

  static const bucketOwnerFullControl = ObjectCannedAcl._(
      2, 'bucket_owner_full_control', 'bucket-owner-full-control');

  static const bucketOwnerRead =
      ObjectCannedAcl._(3, 'bucket_owner_read', 'bucket-owner-read');

  static const private = ObjectCannedAcl._(4, 'private', 'private');

  static const publicRead = ObjectCannedAcl._(5, 'public_read', 'public-read');

  static const publicReadWrite =
      ObjectCannedAcl._(6, 'public_read_write', 'public-read-write');
  ...
  static const List<_i1.SmithySerializer<ObjectCannedAcl>> serializers = [
    _i1.SmithyEnumSerializer('ObjectCannedACL',
        values: values,
