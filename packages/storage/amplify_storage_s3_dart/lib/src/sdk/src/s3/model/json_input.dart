...
class JsonInputRestXmlSerializer
  ...
  @override
  JsonInput deserialize(Serializers serializers, Iterable<Object?> serialized,
        ...
        case 'Type':
          if (value != null) {
            result.type = (serializers.deserialize(value,
                specifiedType: const FullType(_i2.JsonType)) as _i2.JsonType);
          }
          break;
      }
    }
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    final result = <Object?>[
      const _i3.XmlElementName('JsonInput',
