...
import 'package:amplify_storage_plugin_interface/src/List/ListRequest.dart';
...
void main() {
  ...
  test(
      'A ListRequest can be initialized without any parameters, and is serialized to an empty map',
      () async {
