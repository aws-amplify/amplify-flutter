...
class Inventory extends Model {
  ...
  const Inventory._internal({required productID, required name, required warehouseID, required region, createdAt, updatedAt}): _productID = productID, _name = name, _warehouseID = warehouseID, _region = region, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Inventory({required String productID, required String name, required String warehouseID, required String region}) {
  ...
  Map<String, dynamic> toJson() => {
    'productID': _productID, 'name': _name, 'warehouseID': _warehouseID, 'region': _region, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'productID': _productID, 'name': _name, 'warehouseID': _warehouseID, 'region': _region, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ModelIndex(fields: const ["productID", "name", "warehouseID", "region"], name: null)
    ];
...
class InventoryModelIdentifier implements ModelIdentifier<Inventory> {
  ...
  @override
  String toString() => 'InventoryModelIdentifier(productID: $productID, name: $name, warehouseID: $warehouseID, region: $region)';
