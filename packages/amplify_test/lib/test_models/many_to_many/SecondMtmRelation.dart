...
class SecondMtmRelation extends Model {
  ...
  static final QueryModelIdentifier<SecondMtmRelationModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<SecondMtmRelationModelIdentifier>();
 ...
 */
@immutable
class SecondMtmRelationModelIdentifier implements ModelIdentifier<SecondMtmRelation> {
  final String id;
