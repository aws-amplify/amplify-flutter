...
class Product extends Model {
  ...
  const Product._internal({required productID, required name, required amount, createdAt, updatedAt}): _productID = productID, _name = name, _amount = amount, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Product({required String productID, required String name, required int amount}) {
  ...
  Map<String, dynamic> toJson() => {
    'productID': _productID, 'name': _name, 'amount': _amount, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'productID': _productID, 'name': _name, 'amount': _amount, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
