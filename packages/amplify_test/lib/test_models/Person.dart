...
class Person extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'propertiesAddresses': _propertiesAddresses, 'contact': _contact, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
  ...
  static final QueryField PROPERTIESADDRESSES = QueryField(fieldName: "propertiesAddresses");
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.embedded(
      fieldName: 'contact',
      isRequired: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.embedded, ofCustomTypeName: 'Contact')
    ));
