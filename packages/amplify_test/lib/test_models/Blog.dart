...
class Blog extends Model {
  ...
  const Blog._internal({required this.id, required name, createdAt, file, files, posts, updatedAt}): _name = name, _createdAt = createdAt, _file = file, _files = files, _posts = posts, _updatedAt = updatedAt;
  
  factory Blog({String? id, required String name, TemporalDateTime? createdAt, S3Object? file, List<S3Object>? files, List<Post>? posts}) {
  ...
  String toString() {
    ...
    buffer.write("files=" + (_files != null ? _files!.toString() : "null") + ", ");
  ...
  Blog copyWith({String? name, TemporalDateTime? createdAt, S3Object? file, List<S3Object>? files, List<Post>? posts}) {
    return Blog._internal(
      id: id,
      name: name ?? this.name,
  ...
  Blog.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _files = json['files'] is List
        ? (json['files'] as List)
          .where((e) => e != null)
          .map((e) => S3Object.fromJson(new Map<String, dynamic>.from(e['serializedData'])))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'createdAt': _createdAt?.format(), 'file': _file?.toJson(), 'files': _files?.map((S3Object? e) => e?.toJson()).toList(), 'posts': _posts?.map((Post? e) => e?.toJson()).toList(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'createdAt': _createdAt, 'file': _file, 'files': _files, 'posts': _posts, 'updatedAt': _updatedAt
  };
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.embedded(
      fieldName: 'file',
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.embedded, ofCustomTypeName: 'S3Object')
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.embedded(
      ...
      isRequired: false,
      isArray: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'S3Object')
    ));
