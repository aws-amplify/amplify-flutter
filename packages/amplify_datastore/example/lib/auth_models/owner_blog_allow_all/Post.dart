...
class Post extends Model {
  ...
  const Post._internal({required this.id, required title, required rating, created, blog, comments}): _title = title, _rating = rating, _created = created, _blog = blog, _comments = comments;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'rating': _rating, 'created': _created?.format(), 'blog': _blog?.toJson(), 'comments': _comments?.map((Comment? e) => e?.toJson()).toList()
  };
