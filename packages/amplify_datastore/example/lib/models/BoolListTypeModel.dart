...
class BoolListTypeModel extends Model {
  ...
  static final QueryField<BoolListTypeModel, String> ID = QueryField(
    fieldName: "boolListTypeModel.id",
    getValue: (model) => model.id,
  );
  static final QueryField<BoolListTypeModel, List<bool>?> VALUE = QueryField(
    fieldName: "value",
