...
class MultiRelatedRegistration extends Model {
  ...
  const MultiRelatedRegistration._internal({required this.id, required meeting, required attendee, createdAt, updatedAt}): _meeting = meeting, _attendee = attendee, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory MultiRelatedRegistration({String? id, required MultiRelatedMeeting meeting, required MultiRelatedAttendee attendee}) {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("meeting=" + (_meeting != null ? _meeting!.toString() : "null") + ", ");
    buffer.write("attendee=" + (_attendee != null ? _attendee!.toString() : "null") + ", ");
  ...
  MultiRelatedRegistration.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _meeting = json['meeting'] != null
        ? MultiRelatedMeeting.fromJson(new Map<String, dynamic>.from(json['meeting']))
        : null,
      _attendee = json['attendee'] != null
        ? MultiRelatedAttendee.fromJson(new Map<String, dynamic>.from(json['attendee']))
        : null,
      _createdAt = json['createdAt'] != null ? TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'meeting': _meeting?.toJson(), 'attendee': _attendee?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final QueryField MEETING = QueryField(
    fieldName: "meeting",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'MultiRelatedMeeting'));
  static final QueryField ATTENDEE = QueryField(
    fieldName: "attendee",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'MultiRelatedAttendee'));
...
class _MultiRelatedRegistrationModelType extends ModelType<MultiRelatedRegistration> {
