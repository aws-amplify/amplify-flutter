...
class EnumTypeModel extends Model {
  ...
  const EnumTypeModel._internal({required this.id, value, createdAt, updatedAt}): _value = value, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'value': enumToString(_value), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
