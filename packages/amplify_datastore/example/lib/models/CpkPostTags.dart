...
class CpkPostTags extends Model {
  ...
  CpkPostTagsModelIdentifier get modelIdentifier {
      return CpkPostTagsModelIdentifier(
        id: id
      );
  }
  ...
  const CpkPostTags._internal({required this.id, required cpkManyToManyPost, required cpkManyToManyTag, createdAt, updatedAt}): _cpkManyToManyPost = cpkManyToManyPost, _cpkManyToManyTag = cpkManyToManyTag, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkPostTags({String? id, required CpkManyToManyPost cpkManyToManyPost, required CpkManyToManyTag cpkManyToManyTag}) {
  ...
  String toString() {
    ...
    buffer.write("id=" + "$id" + ", ");
    buffer.write("cpkManyToManyPost=" + (_cpkManyToManyPost != null ? _cpkManyToManyPost!.toString() : "null") + ", ");
    buffer.write("cpkManyToManyTag=" + (_cpkManyToManyTag != null ? _cpkManyToManyTag!.toString() : "null") + ", ");
  ...
  CpkPostTags copyWith({CpkManyToManyPost? cpkManyToManyPost, CpkManyToManyTag? cpkManyToManyTag}) {
    return CpkPostTags._internal(
      id: id,
  ...
  CpkPostTags.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _cpkManyToManyPost = json['cpkManyToManyPost'] != null
        ? CpkManyToManyPost.fromJson(new Map<String, dynamic>.from(json['cpkManyToManyPost']))
        : null,
      _cpkManyToManyTag = json['cpkManyToManyTag'] != null
        ? CpkManyToManyTag.fromJson(new Map<String, dynamic>.from(json['cpkManyToManyTag']))
        : null,
      _createdAt = json['createdAt'] != null ? TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'cpkManyToManyPost': _cpkManyToManyPost?.toJson(), 'cpkManyToManyTag': _cpkManyToManyTag?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'cpkManyToManyPost': _cpkManyToManyPost, 'cpkManyToManyTag': _cpkManyToManyTag, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<CpkPostTagsModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkPostTagsModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField CPKMANYTOMANYPOST = QueryField(
    fieldName: "cpkManyToManyPost",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkManyToManyPost'));
  static final QueryField CPKMANYTOMANYTAG = QueryField(
    fieldName: "cpkManyToManyTag",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkManyToManyTag'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "CpkPostTags";
    modelSchemaDefinition.pluralName = "CpkPostTags";
    
    modelSchemaDefinition.indexes = [
      ModelIndex(fields: const ["cpkManyToManyPostId"], name: "byCpkManyToManyPost"),
      ModelIndex(fields: const ["cpkManyToManyTagId", "cpkManyToManyTaglabel"], name: "byCpkManyToManyTag")
    ];
...
class CpkPostTagsModelIdentifier implements ModelIdentifier<CpkPostTags> {
  ...
  const CpkPostTagsModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is CpkPostTagsModelIdentifier &&
      id == other.id;
  }
