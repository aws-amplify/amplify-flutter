...
class CpkOneToOneBidirectionalChildExplicitCD extends Model {
  static const classType = const _CpkOneToOneBidirectionalChildExplicitCDModelType();
  final String id;
  final String? _name;
  ...
  const CpkOneToOneBidirectionalChildExplicitCD._internal({required this.id, required name, belongsToParent, createdAt, updatedAt}): _name = name, _belongsToParent = belongsToParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkOneToOneBidirectionalChildExplicitCD({String? id, required String name, CpkOneToOneBidirectionalParentCD? belongsToParent}) {
  ...
  CpkOneToOneBidirectionalChildExplicitCD copyWith({CpkOneToOneBidirectionalParentCD? belongsToParent}) {
    return CpkOneToOneBidirectionalChildExplicitCD._internal(
      id: id,
      name: name,
  ...
  static final QueryModelIdentifier<CpkOneToOneBidirectionalChildExplicitCDModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkOneToOneBidirectionalChildExplicitCDModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.pluralName = "CpkOneToOneBidirectionalChildExplicitCDS";
...
class _CpkOneToOneBidirectionalChildExplicitCDModelType extends ModelType<CpkOneToOneBidirectionalChildExplicitCD> {
  const _CpkOneToOneBidirectionalChildExplicitCDModelType();
  
  @override
  CpkOneToOneBidirectionalChildExplicitCD fromJson(Map<String, dynamic> jsonData) {
 ...
 */
@immutable
class CpkOneToOneBidirectionalChildExplicitCDModelIdentifier implements ModelIdentifier<CpkOneToOneBidirectionalChildExplicitCD> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkOneToOneBidirectionalChildExplicitCDModelIdentifier(id: $id, name: $name)';
