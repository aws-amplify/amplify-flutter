...
class CpkHasManyUnidirectionalParent extends Model {
  ...
  const CpkHasManyUnidirectionalParent._internal({required this.id, required name, implicitChildren, explicitChildren, createdAt, updatedAt}): _name = name, _implicitChildren = implicitChildren, _explicitChildren = explicitChildren, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkHasManyUnidirectionalParent({String? id, required String name, List<CpkHasManyUnidirectionalChildImplicit>? implicitChildren, List<CpkHasManyUnidirectionalChildExplicit>? explicitChildren}) {
    return CpkHasManyUnidirectionalParent._internal(
      id: id == null ? UUID.getUUID() : id,
      name: name,
      implicitChildren: implicitChildren != null ? List<CpkHasManyUnidirectionalChildImplicit>.unmodifiable(implicitChildren) : implicitChildren,
      explicitChildren: explicitChildren != null ? List<CpkHasManyUnidirectionalChildExplicit>.unmodifiable(explicitChildren) : explicitChildren);
  }
  ...
  CpkHasManyUnidirectionalParent copyWith({List<CpkHasManyUnidirectionalChildImplicit>? implicitChildren, List<CpkHasManyUnidirectionalChildExplicit>? explicitChildren}) {
    return CpkHasManyUnidirectionalParent._internal(
      id: id,
      name: name,
    ...
    : id = json['id'],
      ...
      _implicitChildren = json['implicitChildren']  != null
        ? (json['implicitChildren']['items'] as List)
          .where((e) => e != null)
          .map((e) => CpkHasManyUnidirectionalChildImplicit.fromJson(new Map<String, dynamic>.from(e)))
          .toList()
        : null,
      _explicitChildren = json['explicitChildren']  != null
        ? (json['explicitChildren']['items'] as List)
          .where((e) => e != null)
          .map((e) => CpkHasManyUnidirectionalChildExplicit.fromJson(new Map<String, dynamic>.from(e)))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'implicitChildren': _implicitChildren?.map((CpkHasManyUnidirectionalChildImplicit? e) => e?.toJson()).toList(), 'explicitChildren': _explicitChildren?.map((CpkHasManyUnidirectionalChildExplicit? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final QueryModelIdentifier<CpkHasManyUnidirectionalParentModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkHasManyUnidirectionalParentModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField IMPLICITCHILDREN = QueryField(
    fieldName: "implicitChildren",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkHasManyUnidirectionalChildImplicit'));
  static final QueryField EXPLICITCHILDREN = QueryField(
    fieldName: "explicitChildren",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkHasManyUnidirectionalChildExplicit'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
      ...
      associatedKey: CpkHasManyUnidirectionalChildImplicit.CPKHASMANYUNIDIRECTIONALPARENTIMPLICITCHILDRENID
    ));
...
class _CpkHasManyUnidirectionalParentModelType extends ModelType<CpkHasManyUnidirectionalParent> {
 ...
 */
@immutable
class CpkHasManyUnidirectionalParentModelIdentifier implements ModelIdentifier<CpkHasManyUnidirectionalParent> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkHasManyUnidirectionalParentModelIdentifier(id: $id, name: $name)';
