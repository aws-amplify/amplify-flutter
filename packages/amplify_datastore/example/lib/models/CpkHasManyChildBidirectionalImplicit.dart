...
class CpkHasManyChildBidirectionalImplicit extends Model {
  static const classType = const _CpkHasManyChildBidirectionalImplicitModelType();
  final String id;
  final String? _name;
  ...
  const CpkHasManyChildBidirectionalImplicit._internal({required this.id, required name, hasManyParent, createdAt, updatedAt}): _name = name, _hasManyParent = hasManyParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkHasManyChildBidirectionalImplicit({String? id, required String name, CpkHasManyParentBidirectionalImplicit? hasManyParent}) {
  ...
  CpkHasManyChildBidirectionalImplicit copyWith({CpkHasManyParentBidirectionalImplicit? hasManyParent}) {
    return CpkHasManyChildBidirectionalImplicit._internal(
      id: id,
      name: name,
  ...
  CpkHasManyChildBidirectionalImplicit.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _hasManyParent = json['hasManyParent'] != null
        ? CpkHasManyParentBidirectionalImplicit.fromJson(new Map<String, dynamic>.from(json['hasManyParent']))
        : null,
  ...
  static final QueryModelIdentifier<CpkHasManyChildBidirectionalImplicitModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkHasManyChildBidirectionalImplicitModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField HASMANYPARENT = QueryField(
    fieldName: "hasManyParent",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkHasManyParentBidirectionalImplicit'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.belongsTo(
      ...
      isRequired: false,
      targetNames: ['cpkHasManyParentBidirectionalImplicitBidirectionalImplicitChildrenId', 'cpkHasManyParentBidirectionalImplicitBidirectionalImplicitChildrenName'],
...
class _CpkHasManyChildBidirectionalImplicitModelType extends ModelType<CpkHasManyChildBidirectionalImplicit> {
 ...
 */
@immutable
class CpkHasManyChildBidirectionalImplicitModelIdentifier implements ModelIdentifier<CpkHasManyChildBidirectionalImplicit> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkHasManyChildBidirectionalImplicitModelIdentifier(id: $id, name: $name)';
