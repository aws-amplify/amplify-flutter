...
class CpkHasManyParentBidirectionalImplicit extends amplify_core.Model {
  ...
  factory CpkHasManyParentBidirectionalImplicit({
    ...
    List<CpkHasManyChildBidirectionalImplicit>? bidirectionalImplicitChildren,
  }) {
  ...
  CpkHasManyParentBidirectionalImplicit copyWith({
    ...
    return CpkHasManyParentBidirectionalImplicit._internal(
      ...
      name: name,
      bidirectionalImplicitChildren:
          bidirectionalImplicitChildren ?? this.bidirectionalImplicitChildren,
    );
  }
      ...
      _bidirectionalImplicitChildren =
          ...
          ? (json['bidirectionalImplicitChildren']['items'] is List
                ? (json['bidirectionalImplicitChildren']['items'] as List)
                      .where((e) => e != null)
                      .map(
                        (e) => CpkHasManyChildBidirectionalImplicit.fromJson(
  ...
  static var schema = amplify_core.Model.defineSchema(
    define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
      ...
      modelSchemaDefinition.pluralName =
          "CpkHasManyParentBidirectionalImplicits";
      ...
      modelSchemaDefinition.addField(
        amplify_core.ModelFieldDefinition.hasMany(
          key: CpkHasManyParentBidirectionalImplicit
              .BIDIRECTIONALIMPLICITCHILDREN,
          isRequired: false,
          ofModelName: 'CpkHasManyChildBidirectionalImplicit',
