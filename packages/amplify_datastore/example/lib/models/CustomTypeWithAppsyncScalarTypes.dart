...
class CustomTypeWithAppsyncScalarTypes {
  ...
  factory CustomTypeWithAppsyncScalarTypes({String? stringValue, List<String>? listOfStringValue, int? intValue, List<int>? listOfIntValue, double? floatValue, List<double>? listOfFloatValue, bool? booleanValue, List<bool>? listOfBooleanValue, TemporalDate? awsDateValue, List<TemporalDate>? listOfAWSDateValue, TemporalDateTime? awsDateTimeValue, List<TemporalDateTime>? listOfAWSDateTimeValue, TemporalTime? awsTimeValue, List<TemporalTime>? listOfAWSTimeValue, TemporalTimestamp? awsTimestampValue, List<TemporalTimestamp>? listOfAWSTimestampValue, String? awsEmailValue, List<String>? listOfAWSEmailValue, String? awsJsonValue, List<String>? listOfAWSJsonValue, String? awsPhoneValue, List<String>? listOfAWSPhoneValue, String? awsURLValue, List<String>? listOfAWSURLValue, String? awsIPAddressValue, List<String>? listOfAWSIPAddressValue, EnumField? enumValue, List<EnumField>? listOfEnumValue, SimpleCustomType? customTypeValue, List<SimpleCustomType>? listOfCustomTypeValue}) {
    return CustomTypeWithAppsyncScalarTypes._internal(
      ...
      enumValue: enumValue,
      listOfEnumValue: listOfEnumValue != null ? List<EnumField>.unmodifiable(listOfEnumValue) : listOfEnumValue,
      customTypeValue: customTypeValue,
      listOfCustomTypeValue: listOfCustomTypeValue != null ? List<SimpleCustomType>.unmodifiable(listOfCustomTypeValue) : listOfCustomTypeValue);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is CustomTypeWithAppsyncScalarTypes &&
      ...
      DeepCollectionEquality().equals(_listOfEnumValue, other._listOfEnumValue) &&
  ...
  String toString() {
    ...
    buffer.write("enumValue=" + (_enumValue != null ? enumToString(_enumValue)! : "null") + ", ");
    buffer.write("listOfEnumValue=" + (_listOfEnumValue != null ? _listOfEnumValue!.map((e) => enumToString(e)).toString() : "null") + ", ");
  ...
  CustomTypeWithAppsyncScalarTypes.fromJson(Map<String, dynamic> json)  
    : _stringValue = json['stringValue'],
      ...
      _enumValue = enumFromString<EnumField>(json['enumValue'], EnumField.values),
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.embedded(
      ...
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.embedded, ofCustomTypeName: 'SimpleCustomType')
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.embedded(
      ...
      isRequired: false,
      isArray: true,
      ofType: ModelFieldType(ModelFieldTypeEnum.embeddedCollection, ofCustomTypeName: 'SimpleCustomType')
    ));
  });
}