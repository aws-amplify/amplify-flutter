...
class CpkOneToOneBidirectionalParentCD extends Model {
  ...
  bool operator ==(Object other) {
    ...
    return other is CpkOneToOneBidirectionalParentCD &&
      ...
      _cpkOneToOneBidirectionalParentCDImplicitChildId == other._cpkOneToOneBidirectionalParentCDImplicitChildId &&
  ...
  String toString() {
    ...
    buffer.write("cpkOneToOneBidirectionalParentCDImplicitChildId=" + "$_cpkOneToOneBidirectionalParentCDImplicitChildId" + ", ");
    buffer.write("cpkOneToOneBidirectionalParentCDImplicitChildName=" + "$_cpkOneToOneBidirectionalParentCDImplicitChildName" + ", ");
    buffer.write("cpkOneToOneBidirectionalParentCDExplicitChildId=" + "$_cpkOneToOneBidirectionalParentCDExplicitChildId" + ", ");
  ...
  CpkOneToOneBidirectionalParentCD copyWith({CpkOneToOneBidirectionalChildImplicitCD? implicitChild, CpkOneToOneBidirectionalChildExplicitCD? explicitChild, String? cpkOneToOneBidirectionalParentCDImplicitChildId, String? cpkOneToOneBidirectionalParentCDImplicitChildName, String? cpkOneToOneBidirectionalParentCDExplicitChildId, String? cpkOneToOneBidirectionalParentCDExplicitChildName}) {
    return CpkOneToOneBidirectionalParentCD._internal(
      ...
      cpkOneToOneBidirectionalParentCDImplicitChildId: cpkOneToOneBidirectionalParentCDImplicitChildId ?? this.cpkOneToOneBidirectionalParentCDImplicitChildId,
      cpkOneToOneBidirectionalParentCDImplicitChildName: cpkOneToOneBidirectionalParentCDImplicitChildName ?? this.cpkOneToOneBidirectionalParentCDImplicitChildName,
      cpkOneToOneBidirectionalParentCDExplicitChildId: cpkOneToOneBidirectionalParentCDExplicitChildId ?? this.cpkOneToOneBidirectionalParentCDExplicitChildId,
      cpkOneToOneBidirectionalParentCDExplicitChildName: cpkOneToOneBidirectionalParentCDExplicitChildName ?? this.cpkOneToOneBidirectionalParentCDExplicitChildName);
  }
  ...
  CpkOneToOneBidirectionalParentCD.fromJson(Map<String, dynamic> json)  
    : _customId = json['customId'],
      ...
      _implicitChild = json['implicitChild'] != null
        ? CpkOneToOneBidirectionalChildImplicitCD.fromJson(new Map<String, dynamic>.from(json['implicitChild']))
        : null,
      _explicitChild = json['explicitChild'] != null
        ? CpkOneToOneBidirectionalChildExplicitCD.fromJson(new Map<String, dynamic>.from(json['explicitChild']))
        : null,
      _createdAt = json['createdAt'] != null ? TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? TemporalDateTime.fromString(json['updatedAt']) : null,
      _cpkOneToOneBidirectionalParentCDImplicitChildId = json['cpkOneToOneBidirectionalParentCDImplicitChildId'],
      _cpkOneToOneBidirectionalParentCDImplicitChildName = json['cpkOneToOneBidirectionalParentCDImplicitChildName'],
      _cpkOneToOneBidirectionalParentCDExplicitChildId = json['cpkOneToOneBidirectionalParentCDExplicitChildId'],
      _cpkOneToOneBidirectionalParentCDExplicitChildName = json['cpkOneToOneBidirectionalParentCDExplicitChildName'];
  ...
  Map<String, Object?> toMap() => {
    'customId': _customId, 'name': _name, 'implicitChild': _implicitChild, 'explicitChild': _explicitChild, 'createdAt': _createdAt, 'updatedAt': _updatedAt, 'cpkOneToOneBidirectionalParentCDImplicitChildId': _cpkOneToOneBidirectionalParentCDImplicitChildId, 'cpkOneToOneBidirectionalParentCDImplicitChildName': _cpkOneToOneBidirectionalParentCDImplicitChildName, 'cpkOneToOneBidirectionalParentCDExplicitChildId': _cpkOneToOneBidirectionalParentCDExplicitChildId, 'cpkOneToOneBidirectionalParentCDExplicitChildName': _cpkOneToOneBidirectionalParentCDExplicitChildName
  };

  static final QueryModelIdentifier<CpkOneToOneBidirectionalParentCDModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkOneToOneBidirectionalParentCDModelIdentifier>();
  ...
  static final QueryField IMPLICITCHILD = QueryField(
    ...
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkOneToOneBidirectionalChildImplicitCD'));
  static final QueryField EXPLICITCHILD = QueryField(
    fieldName: "explicitChild",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkOneToOneBidirectionalChildExplicitCD'));
  static final QueryField CPKONETOONEBIDIRECTIONALPARENTCDIMPLICITCHILDID = QueryField(fieldName: "cpkOneToOneBidirectionalParentCDImplicitChildId");
  static final QueryField CPKONETOONEBIDIRECTIONALPARENTCDIMPLICITCHILDNAME = QueryField(fieldName: "cpkOneToOneBidirectionalParentCDImplicitChildName");
  static final QueryField CPKONETOONEBIDIRECTIONALPARENTCDEXPLICITCHILDID = QueryField(fieldName: "cpkOneToOneBidirectionalParentCDExplicitChildId");
  static final QueryField CPKONETOONEBIDIRECTIONALPARENTCDEXPLICITCHILDNAME = QueryField(fieldName: "cpkOneToOneBidirectionalParentCDExplicitChildName");
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasOne(
      ...
      associatedKey: CpkOneToOneBidirectionalChildImplicitCD.BELONGSTOPARENT
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasOne(
      ...
      associatedKey: CpkOneToOneBidirectionalChildExplicitCD.BELONGSTOPARENT
    ));
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: CpkOneToOneBidirectionalParentCD.CPKONETOONEBIDIRECTIONALPARENTCDIMPLICITCHILDID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: CpkOneToOneBidirectionalParentCD.CPKONETOONEBIDIRECTIONALPARENTCDIMPLICITCHILDNAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: CpkOneToOneBidirectionalParentCD.CPKONETOONEBIDIRECTIONALPARENTCDEXPLICITCHILDID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: CpkOneToOneBidirectionalParentCD.CPKONETOONEBIDIRECTIONALPARENTCDEXPLICITCHILDNAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _CpkOneToOneBidirectionalParentCDModelType extends ModelType<CpkOneToOneBidirectionalParentCD> {
 ...
 */
@immutable
class CpkOneToOneBidirectionalParentCDModelIdentifier implements ModelIdentifier<CpkOneToOneBidirectionalParentCD> {
  ...
  @override
  String toString() => 'CpkOneToOneBidirectionalParentCDModelIdentifier(customId: $customId, name: $name)';
