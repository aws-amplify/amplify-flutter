...
class CpkInventory extends Model {
  ...
  const CpkInventory._internal({required productId, required productName, required warehouseId, description, createdAt, updatedAt}): _productId = productId, _productName = productName, _warehouseId = warehouseId, _description = description, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkInventory({required String productId, required String productName, required String warehouseId, String? description}) {
  ...
  Map<String, dynamic> toJson() => {
    'productId': _productId, 'productName': _productName, 'warehouseId': _warehouseId, 'description': _description, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'productId': _productId, 'productName': _productName, 'warehouseId': _warehouseId, 'description': _description, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<CpkInventoryModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkInventoryModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ModelIndex(fields: const ["productId", "productName", "warehouseId"], name: null)
    ];
...
class CpkInventoryModelIdentifier implements ModelIdentifier<CpkInventory> {
  ...
  @override
  String toString() => 'CpkInventoryModelIdentifier(productId: $productId, productName: $productName, warehouseId: $warehouseId)';
