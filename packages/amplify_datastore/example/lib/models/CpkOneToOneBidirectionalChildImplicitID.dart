...
class CpkOneToOneBidirectionalChildImplicitID extends amplify_core.Model {
  ...
  CpkOneToOneBidirectionalChildImplicitID copyWithModelFieldValues(
...
class _CpkOneToOneBidirectionalChildImplicitIDModelType
    extends amplify_core.ModelType<CpkOneToOneBidirectionalChildImplicitID> {
  const _CpkOneToOneBidirectionalChildImplicitIDModelType();
...
class CpkOneToOneBidirectionalChildImplicitIDModelIdentifier
    implements
        amplify_core.ModelIdentifier<CpkOneToOneBidirectionalChildImplicitID> {
  final String id;
  final String name;
