...
class CpkOneToOneBidirectionalChildImplicitID extends Model {
  static const classType = const _CpkOneToOneBidirectionalChildImplicitIDModelType();
  final String id;
  final String? _name;
  ...
  const CpkOneToOneBidirectionalChildImplicitID._internal({required this.id, required name, belongsToParent, createdAt, updatedAt}): _name = name, _belongsToParent = belongsToParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkOneToOneBidirectionalChildImplicitID({String? id, required String name, CpkOneToOneBidirectionalParentID? belongsToParent}) {
  ...
  CpkOneToOneBidirectionalChildImplicitID copyWith({CpkOneToOneBidirectionalParentID? belongsToParent}) {
    return CpkOneToOneBidirectionalChildImplicitID._internal(
      id: id,
      name: name,
  ...
  CpkOneToOneBidirectionalChildImplicitID.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _belongsToParent = json['belongsToParent'] != null
        ? CpkOneToOneBidirectionalParentID.fromJson(new Map<String, dynamic>.from(json['belongsToParent']))
        : null,
  ...
  static final QueryModelIdentifier<CpkOneToOneBidirectionalChildImplicitIDModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkOneToOneBidirectionalChildImplicitIDModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField BELONGSTOPARENT = QueryField(
    fieldName: "belongsToParent",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkOneToOneBidirectionalParentID'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "CpkOneToOneBidirectionalChildImplicitID";
    modelSchemaDefinition.pluralName = "CpkOneToOneBidirectionalChildImplicitIDS";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.belongsTo(
      ...
      isRequired: false,
      targetNames: ['cpkOneToOneBidirectionalChildImplicitIDBelongsToParentId', 'cpkOneToOneBidirectionalChildImplicitIDBelongsToParentName'],
...
class _CpkOneToOneBidirectionalChildImplicitIDModelType extends ModelType<CpkOneToOneBidirectionalChildImplicitID> {
  const _CpkOneToOneBidirectionalChildImplicitIDModelType();
  
  @override
  CpkOneToOneBidirectionalChildImplicitID fromJson(Map<String, dynamic> jsonData) {
    return CpkOneToOneBidirectionalChildImplicitID.fromJson(jsonData);
  }
  
  @override
  String modelName() {
    return 'CpkOneToOneBidirectionalChildImplicitID';
  }
}
 ...
 */
@immutable
class CpkOneToOneBidirectionalChildImplicitIDModelIdentifier implements ModelIdentifier<CpkOneToOneBidirectionalChildImplicitID> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkOneToOneBidirectionalChildImplicitIDModelIdentifier(id: $id, name: $name)';
