...
class CpkManyToManyPost extends Model {
  ...
  CpkManyToManyPostModelIdentifier get modelIdentifier {
      return CpkManyToManyPostModelIdentifier(
        id: id
      );
  }
  ...
  const CpkManyToManyPost._internal({required this.id, required title, tags, createdAt, updatedAt}): _title = title, _tags = tags, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkManyToManyPost({String? id, required String title, List<CpkPostTags>? tags}) {
    ...
    : id = json['id'],
      ...
      _tags = json['tags']  != null
        ? (json['tags']['items'] as List)
          .where((e) => e != null)
          .map((e) => CpkPostTags.fromJson(new Map<String, dynamic>.from(e)))
          .toList()
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'tags': _tags?.map((CpkPostTags? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'title': _title, 'tags': _tags, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<CpkManyToManyPostModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkManyToManyPostModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField TITLE = QueryField(fieldName: "title");
  static final QueryField TAGS = QueryField(
    fieldName: "tags",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkPostTags'));
 ...
 */
@immutable
class CpkManyToManyPostModelIdentifier implements ModelIdentifier<CpkManyToManyPost> {
  final String id;

  /** Create an instance of CpkManyToManyPostModelIdentifier using [id] the primary key. */
  const CpkManyToManyPostModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is CpkManyToManyPostModelIdentifier &&
      id == other.id;
  }
