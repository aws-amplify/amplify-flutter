...
class CpkManyToManyTag extends Model {
  ...
  CpkManyToManyTagModelIdentifier get modelIdentifier {
    try {
      return CpkManyToManyTagModelIdentifier(
        id: id,
        label: _label!
      );
    } catch(e) {
  ...
  const CpkManyToManyTag._internal({required this.id, required label, posts, createdAt, updatedAt}): _label = label, _posts = posts, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkManyToManyTag({String? id, required String label, List<CpkPostTags>? posts}) {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'label': _label, 'posts': _posts?.map((CpkPostTags? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final QueryModelIdentifier<CpkManyToManyTagModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkManyToManyTagModelIdentifier>();
 ...
 */
@immutable
class CpkManyToManyTagModelIdentifier implements ModelIdentifier<CpkManyToManyTag> {
  final String id;
  final String label;
  ...
  @override
  String toString() => 'CpkManyToManyTagModelIdentifier(id: $id, label: $label)';
