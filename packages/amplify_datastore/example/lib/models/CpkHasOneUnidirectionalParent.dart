...
class CpkHasOneUnidirectionalParent extends Model {
  ...
  CpkHasOneUnidirectionalParentModelIdentifier get modelIdentifier {
    try {
      return CpkHasOneUnidirectionalParentModelIdentifier(
        id: id,
        name: _name!
      );
    } catch(e) {
  ...
  factory CpkHasOneUnidirectionalParent({String? id, required String name, CpkHasOneUnidirectionalChild? implicitChild, String? explicitChildID, String? explicitChildName, CpkHasOneUnidirectionalChild? explicitChild, String? cpkHasOneUnidirectionalParentImplicitChildId, String? cpkHasOneUnidirectionalParentImplicitChildName}) {
    return CpkHasOneUnidirectionalParent._internal(
      ...
      cpkHasOneUnidirectionalParentImplicitChildId: cpkHasOneUnidirectionalParentImplicitChildId,
      cpkHasOneUnidirectionalParentImplicitChildName: cpkHasOneUnidirectionalParentImplicitChildName);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is CpkHasOneUnidirectionalParent &&
      ...
      _cpkHasOneUnidirectionalParentImplicitChildId == other._cpkHasOneUnidirectionalParentImplicitChildId &&
      _cpkHasOneUnidirectionalParentImplicitChildName == other._cpkHasOneUnidirectionalParentImplicitChildName;
  }
  ...
  String toString() {
    ...
    buffer.write("cpkHasOneUnidirectionalParentImplicitChildId=" + "$_cpkHasOneUnidirectionalParentImplicitChildId" + ", ");
    buffer.write("cpkHasOneUnidirectionalParentImplicitChildName=" + "$_cpkHasOneUnidirectionalParentImplicitChildName");
    buffer.write("}");
    
    return buffer.toString();
  }
  
  CpkHasOneUnidirectionalParent copyWith({CpkHasOneUnidirectionalChild? implicitChild, String? explicitChildID, String? explicitChildName, CpkHasOneUnidirectionalChild? explicitChild, String? cpkHasOneUnidirectionalParentImplicitChildId, String? cpkHasOneUnidirectionalParentImplicitChildName}) {
    return CpkHasOneUnidirectionalParent._internal(
      id: id,
      name: name,
      ...
      cpkHasOneUnidirectionalParentImplicitChildId: cpkHasOneUnidirectionalParentImplicitChildId ?? this.cpkHasOneUnidirectionalParentImplicitChildId,
      cpkHasOneUnidirectionalParentImplicitChildName: cpkHasOneUnidirectionalParentImplicitChildName ?? this.cpkHasOneUnidirectionalParentImplicitChildName);
  }
  ...
  CpkHasOneUnidirectionalParent.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _implicitChild = json['implicitChild'] != null
        ? CpkHasOneUnidirectionalChild.fromJson(new Map<String, dynamic>.from(json['implicitChild']))
        : null,
      _explicitChildID = json['explicitChildID'],
      _explicitChildName = json['explicitChildName'],
      _explicitChild = json['explicitChild'] != null
        ? CpkHasOneUnidirectionalChild.fromJson(new Map<String, dynamic>.from(json['explicitChild']))
        : null,
      _createdAt = json['createdAt'] != null ? TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? TemporalDateTime.fromString(json['updatedAt']) : null,
      _cpkHasOneUnidirectionalParentImplicitChildId = json['cpkHasOneUnidirectionalParentImplicitChildId'],
      _cpkHasOneUnidirectionalParentImplicitChildName = json['cpkHasOneUnidirectionalParentImplicitChildName'];
  
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'implicitChild': _implicitChild?.toJson(), 'explicitChildID': _explicitChildID, 'explicitChildName': _explicitChildName, 'explicitChild': _explicitChild?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format(), 'cpkHasOneUnidirectionalParentImplicitChildId': _cpkHasOneUnidirectionalParentImplicitChildId, 'cpkHasOneUnidirectionalParentImplicitChildName': _cpkHasOneUnidirectionalParentImplicitChildName
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'implicitChild': _implicitChild, 'explicitChildID': _explicitChildID, 'explicitChildName': _explicitChildName, 'explicitChild': _explicitChild, 'createdAt': _createdAt, 'updatedAt': _updatedAt, 'cpkHasOneUnidirectionalParentImplicitChildId': _cpkHasOneUnidirectionalParentImplicitChildId, 'cpkHasOneUnidirectionalParentImplicitChildName': _cpkHasOneUnidirectionalParentImplicitChildName
  };

  static final QueryModelIdentifier<CpkHasOneUnidirectionalParentModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkHasOneUnidirectionalParentModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField IMPLICITCHILD = QueryField(
    fieldName: "implicitChild",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkHasOneUnidirectionalChild'));
  static final QueryField EXPLICITCHILDID = QueryField(fieldName: "explicitChildID");
  static final QueryField EXPLICITCHILDNAME = QueryField(fieldName: "explicitChildName");
  static final QueryField EXPLICITCHILD = QueryField(
    fieldName: "explicitChild",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkHasOneUnidirectionalChild'));
  static final QueryField CPKHASONEUNIDIRECTIONALPARENTIMPLICITCHILDID = QueryField(fieldName: "cpkHasOneUnidirectionalParentImplicitChildId");
  static final QueryField CPKHASONEUNIDIRECTIONALPARENTIMPLICITCHILDNAME = QueryField(fieldName: "cpkHasOneUnidirectionalParentImplicitChildName");
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: CpkHasOneUnidirectionalParent.CPKHASONEUNIDIRECTIONALPARENTIMPLICITCHILDID,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
    
    modelSchemaDefinition.addField(ModelFieldDefinition.field(
      key: CpkHasOneUnidirectionalParent.CPKHASONEUNIDIRECTIONALPARENTIMPLICITCHILDNAME,
      isRequired: false,
      ofType: ModelFieldType(ModelFieldTypeEnum.string)
    ));
  });
...
class _CpkHasOneUnidirectionalParentModelType extends ModelType<CpkHasOneUnidirectionalParent> {
 ...
 */
@immutable
class CpkHasOneUnidirectionalParentModelIdentifier implements ModelIdentifier<CpkHasOneUnidirectionalParent> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkHasOneUnidirectionalParentModelIdentifier(id: $id, name: $name)';
