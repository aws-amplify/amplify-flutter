...
class TimestampTypeModel extends Model {
  ...
  static final QueryField<TimestampTypeModel, String> ID = QueryField(
    fieldName: "timestampTypeModel.id",
    getValue: (model) => model.id,
  );
  static final QueryField<TimestampTypeModel, TemporalTimestamp?> VALUE =
      QueryField(
    fieldName: "value",
