...
class DateTypeModel extends Model {
  ...
  const DateTypeModel._internal({required this.id, value, createdAt, updatedAt}): _value = value, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  DateTypeModel.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _value = json['value'] != null ? TemporalDate.fromString(json['value']) : null,
