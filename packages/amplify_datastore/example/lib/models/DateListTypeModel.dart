...
class DateListTypeModel extends Model {
  ...
  const DateListTypeModel._internal({required this.id, value, createdAt, updatedAt}): _value = value, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  DateListTypeModel.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _value = (json['value'] as List)?.map((e) => TemporalDate.fromString(e))?.toList(),
