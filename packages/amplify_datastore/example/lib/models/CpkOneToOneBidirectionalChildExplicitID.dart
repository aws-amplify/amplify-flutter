...
class CpkOneToOneBidirectionalChildExplicitID extends Model {
  static const classType = const _CpkOneToOneBidirectionalChildExplicitIDModelType();
  final String id;
  final String? _name;
  ...
  const CpkOneToOneBidirectionalChildExplicitID._internal({required this.id, required name, belongsToParent, createdAt, updatedAt}): _name = name, _belongsToParent = belongsToParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkOneToOneBidirectionalChildExplicitID({String? id, required String name, CpkOneToOneBidirectionalParentID? belongsToParent}) {
  ...
  CpkOneToOneBidirectionalChildExplicitID copyWith({CpkOneToOneBidirectionalParentID? belongsToParent}) {
    return CpkOneToOneBidirectionalChildExplicitID._internal(
      id: id,
      name: name,
  ...
  static final QueryModelIdentifier<CpkOneToOneBidirectionalChildExplicitIDModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkOneToOneBidirectionalChildExplicitIDModelIdentifier>();
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.pluralName = "CpkOneToOneBidirectionalChildExplicitIDS";
...
class _CpkOneToOneBidirectionalChildExplicitIDModelType extends ModelType<CpkOneToOneBidirectionalChildExplicitID> {
  const _CpkOneToOneBidirectionalChildExplicitIDModelType();
  
  @override
  CpkOneToOneBidirectionalChildExplicitID fromJson(Map<String, dynamic> jsonData) {
 ...
 */
@immutable
class CpkOneToOneBidirectionalChildExplicitIDModelIdentifier implements ModelIdentifier<CpkOneToOneBidirectionalChildExplicitID> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkOneToOneBidirectionalChildExplicitIDModelIdentifier(id: $id, name: $name)';
