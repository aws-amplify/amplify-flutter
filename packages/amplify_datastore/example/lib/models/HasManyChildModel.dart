...
class HasManyChildModel extends Model {
  ...
  const HasManyChildModel._internal({required this.id, required name, parent, createdAt, updatedAt}): _name = name, _parent = parent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory HasManyChildModel({String? id, required String name, HasManyModel? parent}) {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'parent': _parent?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
