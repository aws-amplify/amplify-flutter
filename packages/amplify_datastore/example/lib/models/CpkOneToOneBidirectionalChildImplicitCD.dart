...
class CpkOneToOneBidirectionalChildImplicitCD extends Model {
  static const classType = const _CpkOneToOneBidirectionalChildImplicitCDModelType();
  final String id;
  final String? _name;
  ...
  const CpkOneToOneBidirectionalChildImplicitCD._internal({required this.id, required name, belongsToParent, createdAt, updatedAt}): _name = name, _belongsToParent = belongsToParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkOneToOneBidirectionalChildImplicitCD({String? id, required String name, CpkOneToOneBidirectionalParentCD? belongsToParent}) {
  ...
  CpkOneToOneBidirectionalChildImplicitCD copyWith({CpkOneToOneBidirectionalParentCD? belongsToParent}) {
    return CpkOneToOneBidirectionalChildImplicitCD._internal(
      id: id,
      name: name,
  ...
  CpkOneToOneBidirectionalChildImplicitCD.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _belongsToParent = json['belongsToParent'] != null
        ? CpkOneToOneBidirectionalParentCD.fromJson(new Map<String, dynamic>.from(json['belongsToParent']))
        : null,
  ...
  static final QueryModelIdentifier<CpkOneToOneBidirectionalChildImplicitCDModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkOneToOneBidirectionalChildImplicitCDModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField BELONGSTOPARENT = QueryField(
    fieldName: "belongsToParent",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkOneToOneBidirectionalParentCD'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    modelSchemaDefinition.name = "CpkOneToOneBidirectionalChildImplicitCD";
    modelSchemaDefinition.pluralName = "CpkOneToOneBidirectionalChildImplicitCDS";
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.belongsTo(
      ...
      isRequired: false,
      targetNames: ['cpkOneToOneBidirectionalChildImplicitCDBelongsToParentCustomId', 'cpkOneToOneBidirectionalChildImplicitCDBelongsToParentName'],
...
class _CpkOneToOneBidirectionalChildImplicitCDModelType extends ModelType<CpkOneToOneBidirectionalChildImplicitCD> {
  const _CpkOneToOneBidirectionalChildImplicitCDModelType();
  
  @override
  CpkOneToOneBidirectionalChildImplicitCD fromJson(Map<String, dynamic> jsonData) {
 ...
 */
@immutable
class CpkOneToOneBidirectionalChildImplicitCDModelIdentifier implements ModelIdentifier<CpkOneToOneBidirectionalChildImplicitCD> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkOneToOneBidirectionalChildImplicitCDModelIdentifier(id: $id, name: $name)';
