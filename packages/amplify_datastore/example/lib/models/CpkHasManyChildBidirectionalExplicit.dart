...
class CpkHasManyChildBidirectionalExplicit extends Model {
  static const classType = const _CpkHasManyChildBidirectionalExplicitModelType();
  final String id;
  final String? _name;
  ...
  const CpkHasManyChildBidirectionalExplicit._internal({required this.id, required name, hasManyParent, createdAt, updatedAt}): _name = name, _hasManyParent = hasManyParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkHasManyChildBidirectionalExplicit({String? id, required String name, CpkHasManyParentBidirectionalExplicit? hasManyParent}) {
  ...
  CpkHasManyChildBidirectionalExplicit.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _hasManyParent = json['hasManyParent'] != null
        ? CpkHasManyParentBidirectionalExplicit.fromJson(new Map<String, dynamic>.from(json['hasManyParent']))
        : null,
  ...
  static final QueryModelIdentifier<CpkHasManyChildBidirectionalExplicitModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkHasManyChildBidirectionalExplicitModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField HASMANYPARENT = QueryField(
    fieldName: "hasManyParent",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'CpkHasManyParentBidirectionalExplicit'));
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ...
      ModelIndex(fields: const ["hasManyParentID", "hasManyParentName"], name: "byHasManyParent")
    ];
...
class _CpkHasManyChildBidirectionalExplicitModelType extends ModelType<CpkHasManyChildBidirectionalExplicit> {
 ...
 */
@immutable
class CpkHasManyChildBidirectionalExplicitModelIdentifier implements ModelIdentifier<CpkHasManyChildBidirectionalExplicit> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkHasManyChildBidirectionalExplicitModelIdentifier(id: $id, name: $name)';
