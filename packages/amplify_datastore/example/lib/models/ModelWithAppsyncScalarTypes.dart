...
class ModelWithAppsyncScalarTypes extends amplify_core.Model {
  ...
  String toString() {
    ...
    buffer.write(
      "listOfStringValue=" +
          (_listOfStringValue != null
              ? _listOfStringValue.toString()
              : "null") +
          ", ",
    );
    buffer.write(
      "intValue=" + (_intValue != null ? _intValue.toString() : "null") + ", ",
    );
    buffer.write(
      "altIntValue=" +
    ...
    buffer.write(
      "awsTimestampValue=" +
          (_awsTimestampValue != null
              ? _awsTimestampValue.toString()
              : "null") +
          ", ",
    );
    buffer.write(
    ...
    buffer.write(
      "listOfAWSURLValue=" +
          (_listOfAWSURLValue != null
              ? _listOfAWSURLValue.toString()
              : "null") +
          ", ",
    );
  ...
  ModelWithAppsyncScalarTypes copyWithModelFieldValues({
    ...
    return ModelWithAppsyncScalarTypes._internal(
      ...
      altStringValue: altStringValue == null
          ? this.altStringValue
  ...
  static final ALTSTRINGVALUE = amplify_core.QueryField(
    fieldName: "altStringValue",
  );
  static final LISTOFSTRINGVALUE = amplify_core.QueryField(
  ...
  static final LISTOFINTVALUE = amplify_core.QueryField(
    fieldName: "listOfIntValue",
  );
  static final FLOATVALUE = amplify_core.QueryField(fieldName: "floatValue");
  static final LISTOFFLOATVALUE = amplify_core.QueryField(
    fieldName: "listOfFloatValue",
  );
  static final BOOLEANVALUE = amplify_core.QueryField(
    fieldName: "booleanValue",
  );
  static final LISTOFBOOLEANVALUE = amplify_core.QueryField(
    fieldName: "listOfBooleanValue",
  );
  static final AWSDATEVALUE = amplify_core.QueryField(
    fieldName: "awsDateValue",
  );
  static final LISTOFAWSDATEVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSDateValue",
  );
  static final AWSTIMEVALUE = amplify_core.QueryField(
    fieldName: "awsTimeValue",
  );
  static final LISTOFAWSTIMEVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSTimeValue",
  );
  static final AWSDATETIMEVALUE = amplify_core.QueryField(
    fieldName: "awsDateTimeValue",
  );
  static final LISTOFAWSDATETIMEVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSDateTimeValue",
  );
  static final AWSTIMESTAMPVALUE = amplify_core.QueryField(
    fieldName: "awsTimestampValue",
  );
  static final LISTOFAWSTIMESTAMPVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSTimestampValue",
  );
  static final AWSEMAILVALUE = amplify_core.QueryField(
    fieldName: "awsEmailValue",
  );
  static final LISTOFAWSEMAILVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSEmailValue",
  );
  static final AWSJSONVALUE = amplify_core.QueryField(
    fieldName: "awsJsonValue",
  );
  static final LISTOFAWSJSONVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSJsonValue",
  );
  static final AWSPHONEVALUE = amplify_core.QueryField(
    fieldName: "awsPhoneValue",
  );
  static final LISTOFAWSPHONEVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSPhoneValue",
  );
  static final AWSURLVALUE = amplify_core.QueryField(fieldName: "awsURLValue");
  static final LISTOFAWSURLVALUE = amplify_core.QueryField(
    fieldName: "listOfAWSURLValue",
  );
  static final AWSIPADDRESSVALUE = amplify_core.QueryField(
    fieldName: "awsIPAddressValue",
  );
  static final LISTOFAWSIPADDRESSVALUE = amplify_core.QueryField(
