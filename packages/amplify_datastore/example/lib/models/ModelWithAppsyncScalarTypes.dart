...
class ModelWithAppsyncScalarTypes extends Model {
  ...
  bool operator ==(Object other) {
    ...
    return other is ModelWithAppsyncScalarTypes &&
      ...
      DeepCollectionEquality().equals(_listOfStringValue, other._listOfStringValue) &&
      _intValue == other._intValue &&
      _altIntValue == other._altIntValue &&
      DeepCollectionEquality().equals(_listOfIntValue, other._listOfIntValue) &&
      _floatValue == other._floatValue &&
      DeepCollectionEquality().equals(_listOfFloatValue, other._listOfFloatValue) &&
      _booleanValue == other._booleanValue &&
      DeepCollectionEquality().equals(_listOfBooleanValue, other._listOfBooleanValue) &&
      _awsDateValue == other._awsDateValue &&
      DeepCollectionEquality().equals(_listOfAWSDateValue, other._listOfAWSDateValue) &&
      _awsTimeValue == other._awsTimeValue &&
      DeepCollectionEquality().equals(_listOfAWSTimeValue, other._listOfAWSTimeValue) &&
      _awsDateTimeValue == other._awsDateTimeValue &&
      DeepCollectionEquality().equals(_listOfAWSDateTimeValue, other._listOfAWSDateTimeValue) &&
      _awsTimestampValue == other._awsTimestampValue &&
      DeepCollectionEquality().equals(_listOfAWSTimestampValue, other._listOfAWSTimestampValue) &&
      _awsEmailValue == other._awsEmailValue &&
      DeepCollectionEquality().equals(_listOfAWSEmailValue, other._listOfAWSEmailValue) &&
      _awsJsonValue == other._awsJsonValue &&
      DeepCollectionEquality().equals(_listOfAWSJsonValue, other._listOfAWSJsonValue) &&
      _awsPhoneValue == other._awsPhoneValue &&
      DeepCollectionEquality().equals(_listOfAWSPhoneValue, other._listOfAWSPhoneValue) &&
      _awsURLValue == other._awsURLValue &&
      DeepCollectionEquality().equals(_listOfAWSURLValue, other._listOfAWSURLValue) &&
      _awsIPAddressValue == other._awsIPAddressValue &&
      DeepCollectionEquality().equals(_listOfAWSIPAddressValue, other._listOfAWSIPAddressValue);
  }
  ...
  String toString() {
    ...
    buffer.write("listOfStringValue=" + (_listOfStringValue != null ? _listOfStringValue!.toString() : "null") + ", ");
    buffer.write("intValue=" + (_intValue != null ? _intValue!.toString() : "null") + ", ");
    buffer.write("altIntValue=" + (_altIntValue != null ? _altIntValue!.toString() : "null") + ", ");
    buffer.write("listOfIntValue=" + (_listOfIntValue != null ? _listOfIntValue!.toString() : "null") + ", ");
    buffer.write("floatValue=" + (_floatValue != null ? _floatValue!.toString() : "null") + ", ");
    buffer.write("listOfFloatValue=" + (_listOfFloatValue != null ? _listOfFloatValue!.toString() : "null") + ", ");
    buffer.write("booleanValue=" + (_booleanValue != null ? _booleanValue!.toString() : "null") + ", ");
    buffer.write("listOfBooleanValue=" + (_listOfBooleanValue != null ? _listOfBooleanValue!.toString() : "null") + ", ");
    buffer.write("awsDateValue=" + (_awsDateValue != null ? _awsDateValue!.format() : "null") + ", ");
    buffer.write("listOfAWSDateValue=" + (_listOfAWSDateValue != null ? _listOfAWSDateValue!.toString() : "null") + ", ");
    buffer.write("awsTimeValue=" + (_awsTimeValue != null ? _awsTimeValue!.format() : "null") + ", ");
    buffer.write("listOfAWSTimeValue=" + (_listOfAWSTimeValue != null ? _listOfAWSTimeValue!.toString() : "null") + ", ");
    buffer.write("awsDateTimeValue=" + (_awsDateTimeValue != null ? _awsDateTimeValue!.format() : "null") + ", ");
    buffer.write("listOfAWSDateTimeValue=" + (_listOfAWSDateTimeValue != null ? _listOfAWSDateTimeValue!.toString() : "null") + ", ");
    buffer.write("awsTimestampValue=" + (_awsTimestampValue != null ? _awsTimestampValue!.toString() : "null") + ", ");
    buffer.write("listOfAWSTimestampValue=" + (_listOfAWSTimestampValue != null ? _listOfAWSTimestampValue!.toString() : "null") + ", ");
    buffer.write("awsEmailValue=" + "$_awsEmailValue" + ", ");
    buffer.write("listOfAWSEmailValue=" + (_listOfAWSEmailValue != null ? _listOfAWSEmailValue!.toString() : "null") + ", ");
    buffer.write("awsJsonValue=" + "$_awsJsonValue" + ", ");
    buffer.write("listOfAWSJsonValue=" + (_listOfAWSJsonValue != null ? _listOfAWSJsonValue!.toString() : "null") + ", ");
    buffer.write("awsPhoneValue=" + "$_awsPhoneValue" + ", ");
    buffer.write("listOfAWSPhoneValue=" + (_listOfAWSPhoneValue != null ? _listOfAWSPhoneValue!.toString() : "null") + ", ");
    buffer.write("awsURLValue=" + "$_awsURLValue" + ", ");
    buffer.write("listOfAWSURLValue=" + (_listOfAWSURLValue != null ? _listOfAWSURLValue!.toString() : "null") + ", ");
    buffer.write("awsIPAddressValue=" + "$_awsIPAddressValue" + ", ");
    buffer.write("listOfAWSIPAddressValue=" + (_listOfAWSIPAddressValue != null ? _listOfAWSIPAddressValue!.toString() : "null") + ", ");
  ...
  ModelWithAppsyncScalarTypes copyWith({String? stringValue, String? altStringValue, List<String>? listOfStringValue, int? intValue, int? altIntValue, List<int>? listOfIntValue, double? floatValue, List<double>? listOfFloatValue, bool? booleanValue, List<bool>? listOfBooleanValue, TemporalDate? awsDateValue, List<TemporalDate>? listOfAWSDateValue, TemporalTime? awsTimeValue, List<TemporalTime>? listOfAWSTimeValue, TemporalDateTime? awsDateTimeValue, List<TemporalDateTime>? listOfAWSDateTimeValue, TemporalTimestamp? awsTimestampValue, List<TemporalTimestamp>? listOfAWSTimestampValue, String? awsEmailValue, List<String>? listOfAWSEmailValue, String? awsJsonValue, List<String>? listOfAWSJsonValue, String? awsPhoneValue, List<String>? listOfAWSPhoneValue, String? awsURLValue, List<String>? listOfAWSURLValue, String? awsIPAddressValue, List<String>? listOfAWSIPAddressValue}) {
    return ModelWithAppsyncScalarTypes._internal(
      ...
      listOfAWSDateTimeValue: listOfAWSDateTimeValue ?? this.listOfAWSDateTimeValue,
      awsTimestampValue: awsTimestampValue ?? this.awsTimestampValue,
      listOfAWSTimestampValue: listOfAWSTimestampValue ?? this.listOfAWSTimestampValue,
      ...
      listOfAWSIPAddressValue: listOfAWSIPAddressValue ?? this.listOfAWSIPAddressValue);
  }
  ...
  ModelWithAppsyncScalarTypes.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _listOfIntValue = (json['listOfIntValue'] as List?)?.map((e) => (e as num).toInt()).toList(),
      _floatValue = (json['floatValue'] as num?)?.toDouble(),
      _listOfFloatValue = (json['listOfFloatValue'] as List?)?.map((e) => (e as num).toDouble()).toList(),
      _booleanValue = json['booleanValue'],
      _listOfBooleanValue = json['listOfBooleanValue']?.cast<bool>(),
      _awsDateValue = json['awsDateValue'] != null ? TemporalDate.fromString(json['awsDateValue']) : null,
      _listOfAWSDateValue = (json['listOfAWSDateValue'] as List?)?.map((e) => TemporalDate.fromString(e)).toList(),
      _awsTimeValue = json['awsTimeValue'] != null ? TemporalTime.fromString(json['awsTimeValue']) : null,
      _listOfAWSTimeValue = (json['listOfAWSTimeValue'] as List?)?.map((e) => TemporalTime.fromString(e)).toList(),
      _awsDateTimeValue = json['awsDateTimeValue'] != null ? TemporalDateTime.fromString(json['awsDateTimeValue']) : null,
      _listOfAWSDateTimeValue = (json['listOfAWSDateTimeValue'] as List?)?.map((e) => TemporalDateTime.fromString(e)).toList(),
      _awsTimestampValue = json['awsTimestampValue'] != null ? TemporalTimestamp.fromSeconds(json['awsTimestampValue']) : null,
      _listOfAWSTimestampValue = (json['listOfAWSTimestampValue'] as List?)?.map((e) => TemporalTimestamp.fromSeconds(e)).toList(),
  ...
  static final QueryField LISTOFSTRINGVALUE = QueryField(fieldName: "listOfStringValue");
  ...
  static final QueryField LISTOFINTVALUE = QueryField(fieldName: "listOfIntValue");
  static final QueryField FLOATVALUE = QueryField(fieldName: "floatValue");
  static final QueryField LISTOFFLOATVALUE = QueryField(fieldName: "listOfFloatValue");
  static final QueryField BOOLEANVALUE = QueryField(fieldName: "booleanValue");
  static final QueryField LISTOFBOOLEANVALUE = QueryField(fieldName: "listOfBooleanValue");
  static final QueryField AWSDATEVALUE = QueryField(fieldName: "awsDateValue");
  static final QueryField LISTOFAWSDATEVALUE = QueryField(fieldName: "listOfAWSDateValue");
  static final QueryField AWSTIMEVALUE = QueryField(fieldName: "awsTimeValue");
  static final QueryField LISTOFAWSTIMEVALUE = QueryField(fieldName: "listOfAWSTimeValue");
  static final QueryField AWSDATETIMEVALUE = QueryField(fieldName: "awsDateTimeValue");
  static final QueryField LISTOFAWSDATETIMEVALUE = QueryField(fieldName: "listOfAWSDateTimeValue");
  static final QueryField AWSTIMESTAMPVALUE = QueryField(fieldName: "awsTimestampValue");
  static final QueryField LISTOFAWSTIMESTAMPVALUE = QueryField(fieldName: "listOfAWSTimestampValue");
  static final QueryField AWSEMAILVALUE = QueryField(fieldName: "awsEmailValue");
  static final QueryField LISTOFAWSEMAILVALUE = QueryField(fieldName: "listOfAWSEmailValue");
  static final QueryField AWSJSONVALUE = QueryField(fieldName: "awsJsonValue");
  static final QueryField LISTOFAWSJSONVALUE = QueryField(fieldName: "listOfAWSJsonValue");
  static final QueryField AWSPHONEVALUE = QueryField(fieldName: "awsPhoneValue");
  static final QueryField LISTOFAWSPHONEVALUE = QueryField(fieldName: "listOfAWSPhoneValue");
  static final QueryField AWSURLVALUE = QueryField(fieldName: "awsURLValue");
  static final QueryField LISTOFAWSURLVALUE = QueryField(fieldName: "listOfAWSURLValue");
  static final QueryField AWSIPADDRESSVALUE = QueryField(fieldName: "awsIPAddressValue");
  static final QueryField LISTOFAWSIPADDRESSVALUE = QueryField(fieldName: "listOfAWSIPAddressValue");
...
class _ModelWithAppsyncScalarTypesModelType extends ModelType<ModelWithAppsyncScalarTypes> {
