...
class BelongsToChildExplicit extends Model {
  ...
  const BelongsToChildExplicit._internal({required this.id, name, belongsToParent, createdAt, updatedAt}): _name = name, _belongsToParent = belongsToParent, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory BelongsToChildExplicit({String? id, String? name, BelongsToParent? belongsToParent}) {
...
class _BelongsToChildExplicitModelType extends ModelType<BelongsToChildExplicit> {
