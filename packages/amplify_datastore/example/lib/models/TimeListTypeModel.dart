...
class TimeListTypeModel extends Model {
  ...
  const TimeListTypeModel._internal({required this.id, value, createdAt, updatedAt}): _value = value, _createdAt = createdAt, _updatedAt = updatedAt;
  ...
  TimeListTypeModel.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _value = (json['value'] as List)?.map((e) => TemporalTime.fromString(e))?.toList(),
