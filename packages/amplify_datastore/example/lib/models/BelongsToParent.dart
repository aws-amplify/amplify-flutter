...
class BelongsToParent extends Model {
  ...
  BelongsToParentModelIdentifier get modelIdentifier {
      return BelongsToParentModelIdentifier(
        id: id
      );
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is BelongsToParent &&
      ...
      _belongsToParentImplicitChildId == other._belongsToParentImplicitChildId &&
      _belongsToParentExplicitChildId == other._belongsToParentExplicitChildId;
  }
  ...
  String toString() {
    ...
    buffer.write("belongsToParentImplicitChildId=" + "$_belongsToParentImplicitChildId" + ", ");
    buffer.write("belongsToParentExplicitChildId=" + "$_belongsToParentExplicitChildId");
    buffer.write("}");
    
    return buffer.toString();
  }
  
  BelongsToParent copyWith({String? name, BelongsToChildImplicit? implicitChild, BelongsToChildExplicit? explicitChild, String? belongsToParentImplicitChildId, String? belongsToParentExplicitChildId}) {
    return BelongsToParent._internal(
      id: id,
      name: name ?? this.name,
      implicitChild: implicitChild ?? this.implicitChild,
      explicitChild: explicitChild ?? this.explicitChild,
      belongsToParentImplicitChildId: belongsToParentImplicitChildId ?? this.belongsToParentImplicitChildId,
  ...
  BelongsToParent.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _implicitChild = json['implicitChild'] != null
        ? BelongsToChildImplicit.fromJson(new Map<String, dynamic>.from(json['implicitChild']))
        : null,
      _explicitChild = json['explicitChild'] != null
        ? BelongsToChildExplicit.fromJson(new Map<String, dynamic>.from(json['explicitChild']))
        : null,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'implicitChild': _implicitChild?.toJson(), 'explicitChild': _explicitChild?.toJson(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format(), 'belongsToParentImplicitChildId': _belongsToParentImplicitChildId, 'belongsToParentExplicitChildId': _belongsToParentExplicitChildId
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'implicitChild': _implicitChild, 'explicitChild': _explicitChild, 'createdAt': _createdAt, 'updatedAt': _updatedAt, 'belongsToParentImplicitChildId': _belongsToParentImplicitChildId, 'belongsToParentExplicitChildId': _belongsToParentExplicitChildId
  };

  static final QueryModelIdentifier<BelongsToParentModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<BelongsToParentModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField IMPLICITCHILD = QueryField(
    fieldName: "implicitChild",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'BelongsToChildImplicit'));
  static final QueryField EXPLICITCHILD = QueryField(
    fieldName: "explicitChild",
    fieldType: ModelFieldType(ModelFieldTypeEnum.model, ofModelName: 'BelongsToChildExplicit'));
  static final QueryField BELONGSTOPARENTIMPLICITCHILDID = QueryField(fieldName: "belongsToParentImplicitChildId");
  static final QueryField BELONGSTOPARENTEXPLICITCHILDID = QueryField(fieldName: "belongsToParentExplicitChildId");
 ...
 */
@immutable
class BelongsToParentModelIdentifier implements ModelIdentifier<BelongsToParent> {
  final String id;

  /** Create an instance of BelongsToParentModelIdentifier using [id] the primary key. */
  const BelongsToParentModelIdentifier({
    required this.id});
  ...
  bool operator ==(Object other) {
    ...
    return other is BelongsToParentModelIdentifier &&
      id == other.id;
  }
