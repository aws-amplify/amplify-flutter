...
class CpkHasManyUnidirectionalChildExplicit extends Model {
  static const classType = const _CpkHasManyUnidirectionalChildExplicitModelType();
  final String id;
  final String? _name;
  ...
  const CpkHasManyUnidirectionalChildExplicit._internal({required this.id, required name, required hasManyParentID, required hasManyParentName, createdAt, updatedAt}): _name = name, _hasManyParentID = hasManyParentID, _hasManyParentName = hasManyParentName, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory CpkHasManyUnidirectionalChildExplicit({String? id, required String name, required String hasManyParentID, required String hasManyParentName}) {
  ...
  CpkHasManyUnidirectionalChildExplicit copyWith({String? hasManyParentID, String? hasManyParentName}) {
    return CpkHasManyUnidirectionalChildExplicit._internal(
      id: id,
      name: name,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'hasManyParentID': _hasManyParentID, 'hasManyParentName': _hasManyParentName, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'hasManyParentID': _hasManyParentID, 'hasManyParentName': _hasManyParentName, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<CpkHasManyUnidirectionalChildExplicitModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<CpkHasManyUnidirectionalChildExplicitModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField NAME = QueryField(fieldName: "name");
  static final QueryField HASMANYPARENTID = QueryField(fieldName: "hasManyParentID");
  static final QueryField HASMANYPARENTNAME = QueryField(fieldName: "hasManyParentName");
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      ...
      ModelIndex(fields: const ["hasManyParentID", "hasManyParentName"], name: "byHasManyParentCpk")
    ];
...
class _CpkHasManyUnidirectionalChildExplicitModelType extends ModelType<CpkHasManyUnidirectionalChildExplicit> {
  const _CpkHasManyUnidirectionalChildExplicitModelType();
  
  @override
  CpkHasManyUnidirectionalChildExplicit fromJson(Map<String, dynamic> jsonData) {
 ...
 */
@immutable
class CpkHasManyUnidirectionalChildExplicitModelIdentifier implements ModelIdentifier<CpkHasManyUnidirectionalChildExplicit> {
  final String id;
  final String name;
  ...
  @override
  String toString() => 'CpkHasManyUnidirectionalChildExplicitModelIdentifier(id: $id, name: $name)';
