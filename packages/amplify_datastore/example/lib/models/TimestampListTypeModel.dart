...
class TimestampListTypeModel extends Model {
  ...
  const TimestampListTypeModel._internal({required this.id, value, createdAt, updatedAt}): _value = value, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory TimestampListTypeModel({String? id, List<TemporalTimestamp>? value}) {
    return TimestampListTypeModel._internal(
      id: id == null ? UUID.getUUID() : id,
      value: value != null ? List<TemporalTimestamp>.unmodifiable(value) : value);
  }
  ...
  TimestampListTypeModel copyWith({String? id, List<TemporalTimestamp>? value}) {
    return TimestampListTypeModel._internal(
      id: id ?? this.id,
  ...
  TimestampListTypeModel.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      _value = (json['value'] as List)?.map((e) => TemporalTimestamp.fromSeconds(e))?.toList(),
      _createdAt = json['createdAt'] != null ? TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'value': _value?.map((e) => e.toSeconds()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };

  static final QueryField ID = QueryField(fieldName: "timestampListTypeModel.id");
...
class _TimestampListTypeModelModelType extends ModelType<TimestampListTypeModel> {
