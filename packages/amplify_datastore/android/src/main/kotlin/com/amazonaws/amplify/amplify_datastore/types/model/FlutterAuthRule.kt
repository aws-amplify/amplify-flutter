...
data class FlutterAuthRule(val map: Map<String, Any>) {
    ...
    private val authStrategy: AuthStrategy = stringToAuthStrategy(map["authStrategy"] as String)
    ...
    fun convertToNativeAuthRule(): AuthRule {
        ...
        var builder: AuthRule.Builder = AuthRule.builder().authStrategy(authStrategy)
