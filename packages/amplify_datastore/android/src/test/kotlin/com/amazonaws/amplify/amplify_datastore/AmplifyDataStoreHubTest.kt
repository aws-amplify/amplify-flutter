...
class AmplifyDataStoreHubTest {
    ...
    fun test_hub_outboxMutationEnqueued_event() {
        val eventData: HashMap<String, Any> = (readMapFromFile("hub",
        ...
        val modelMetadata = ModelMetadata(metadataMap["id"] as String, metadataMap["_deleted"] as Boolean?, metadataMap["_version"] as Int?, time)
        val modelData = mapOf("id" to serializedData["id"] as String,
        ...
        val outboxMutationEnqueued: OutboxMutationEvent<*> = OutboxMutationEvent.create(eventData["modelName"] as String, modelWithMetadata)
        ...
        verify(hubSpy).sendEvent(hubMap.toValueMap())
    }
    ...
    fun test_hub_outboxMutationProcessed_event() {
        ...
        val modelWithMetadata: ModelWithMetadata<SerializedModel> = ModelWithMetadata(instance, modelMetadata)
        val outboxMutationProcessed: OutboxMutationEvent<*> = OutboxMutationEvent.create(eventData["modelName"] as String, modelWithMetadata)
    ...
    fun test_hub_networkStatus_event() {
        ...
        val networkStatusEvent = NetworkStatusEvent(eventData["active"] as Boolean)
    ...
    fun test_hub_syncQueriesStarted_event() {
        ...
        val syncQueriesStartedEvent = SyncQueriesStartedEvent(arrayOf("Post"))
    ...
    fun test_hub_modelSynced_event() {
        ...
        val modelSyncedEvent = ModelSyncedEvent(
                eventData["modelName"] as String,
