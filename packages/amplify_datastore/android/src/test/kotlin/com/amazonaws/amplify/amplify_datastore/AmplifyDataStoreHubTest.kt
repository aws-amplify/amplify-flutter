...
@RunWith(RobolectricTestRunner::class) class AmplifyDataStoreHubTest {
    ...
    @Test fun test_hub_outboxMutationEnqueued_event() {
        ...
        var eventData: HashMap<String, Any> =
            (
                readMapFromFile("hub", "outboxMutationEnqueuedEvent.json", HashMap::class.java)
        ...
        var serializedData: HashMap<String, Any> =
            modelMap["serializedData"] as HashMap<String, Any>
        ...
        var modelWithMetadata: ModelWithMetadata<SerializedModel> =
            ModelWithMetadata(instance, modelMetadata)
        var outboxMutationEnqueued: OutboxMutationEvent<*> =
        ...
        val hubMap = FlutterOutboxMutationEnqueuedEvent(
            ...
            eventData["modelName"] as String, outboxMutationEnqueued.element
        )
    ...
    @Test fun test_hub_outboxMutationProcessed_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
        var eventData: HashMap<String, Any> =
            (
                readMapFromFile("hub", "outboxMutationProcessedEvent.json", HashMap::class.java)
                    as HashMap<String, Any>
                )
        var element: HashMap<String, Any> = eventData["element"] as HashMap<String, Any>
        ...
        var modelMetadata =
            ModelMetadata(
                metadataMap["id"] as String, metadataMap["_deleted"] as Boolean,
                metadataMap["_version"] as Int, time
            )
        var modelData = mapOf(
            "id" to serializedData["id"] as String,
            "title" to serializedData["title"] as String,
        ...
        var modelWithMetadata: ModelWithMetadata<SerializedModel> =
            ModelWithMetadata(instance, modelMetadata)
        var outboxMutationProcessed: OutboxMutationEvent<*> =
            OutboxMutationEvent.create(eventData["modelName"] as String, modelWithMetadata)
        var event = HubEvent.create("outboxMutationProcessed", outboxMutationProcessed)
        ...
        val hubMap = FlutterOutboxMutationProcessedEvent(
            eventData["eventName"] as String,
            eventData["modelName"] as String, outboxMutationProcessed.element
        )
    ...
    @Test fun test_hub_ready_event() {
        ...
        val hubSpy = spy(realHubHandler)
        val hubMap = FlutterReadyEvent(eventData["eventName"] as String)
    ...
    @Test fun test_hub_subscriptionsEstablished_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
        var eventData: HashMap<String, Any> =
            (
                readMapFromFile("hub", "subscriptionsEstablishedEvent.json", HashMap::class.java)
                    as HashMap<String, Any>
                )
        ...
        val hubSpy = spy(realHubHandler)
        val hubMap = FlutterSubscriptionsEstablishedEvent(eventData["eventName"] as String)
    ...
    @Test fun test_hub_syncQueriesReady_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
        var eventData: HashMap<String, Any> = (
            readMapFromFile(
                "hub", "syncQueriesReadyEvent.json",
                HashMap::class.java
            ) as HashMap<String, Any>
            )
        ...
        val hubSpy = spy(realHubHandler)
        val hubMap = FlutterSyncQueriesReadyEvent(eventData["eventName"] as String)
    ...
    @Test fun test_hub_networkStatus_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
        var eventData: HashMap<String, Any> = (
            readMapFromFile(
                "hub", "networkStatusEvent.json",
                HashMap::class.java
            ) as HashMap<String, Any>
            )

        var networkStatusEvent: NetworkStatusEvent =
            NetworkStatusEvent(eventData["active"] as Boolean)
    ...
    @Test fun test_hub_outboxStatus_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
    ...
    @Test fun test_hub_syncQueriesStarted_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
        var eventData: HashMap<String, Any> =
            (
                readMapFromFile("hub", "syncQueriesStartedEvent.json", HashMap::class.java)
                    as HashMap<String, Any>
                )

        var syncQueriesStartedEvent: SyncQueriesStartedEvent =
            SyncQueriesStartedEvent(arrayOf("Post"))
        ...
        val hubSpy = spy(realHubHandler)
        val hubMap =
            FlutterSyncQueriesStartedEvent(eventData["eventName"] as String, arrayOf("Post"))
    ...
    @Test fun test_hub_modelSynced_event() {
        flutterPlugin = AmplifyDataStorePlugin(
            eventHandler = mockStreamHandler,
            hubEventHandler = mockHubHandler
        )
        var eventData: HashMap<String, Any> = (
            readMapFromFile(
                "hub", "modelSyncedEvent.json",
                HashMap::class.java
            ) as HashMap<String, Any>
            )

        var modelSyncedEvent: ModelSyncedEvent =
            ModelSyncedEvent(
                eventData["model"] as String, eventData["isFullSync"] as Boolean,
                eventData["added"] as Int, eventData["updated"] as Int,
        ...
        val hubMap = FlutterModelSyncedEvent(
            eventData["eventName"] as String,
            eventData["model"] as String, eventData["isFullSync"] as Boolean,
            eventData["isDeltaSync"] as Boolean, eventData["added"] as Int,
            eventData["updated"] as Int, eventData["deleted"] as Int
        )
