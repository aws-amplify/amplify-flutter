...
class Post extends Model {
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'rating': _rating, 'created': _created?.format(), 'blog': _blog?.toJson(), 'comments': _comments?.map((e) => e?.toJson())?.toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
