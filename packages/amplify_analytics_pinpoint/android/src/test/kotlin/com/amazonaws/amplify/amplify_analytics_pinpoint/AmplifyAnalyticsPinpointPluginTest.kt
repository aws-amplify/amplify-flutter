...
class AmplifyAnalyticsPinpointPluginTest {
    ...
    @Test
    fun test_recordEvent_returnsSuccess() {
    ...
    @Test
    fun test_recordEvent_withProperties_returnsSuccess() {
    ...
    @Test
    fun test_flushEvents_returnsSuccess() {
    ...
    @Test
    fun test_registerGlobalProperties_withProperties_returnsSuccess() {
        val propertiesMap = hashMapOf<String, Any>(
                "AnalyticsStringProperty" to "Pancakes",
                "AnalyticsBooleanProperty" to true,
                "AnalyticsDoubleProperty" to 3.14,
    ...
    @Test
    fun test_identifyUser_withProperties_returnsSuccess() {
    ...
    @Test
    fun test_identifyUser_withNoLocation_returnsSuccess() {
        val userProfileMap = hashMapOf<String, Any>(
                "name" to "test-user",
                "email" to "user@test.com",
                "plan" to "test-plan"
