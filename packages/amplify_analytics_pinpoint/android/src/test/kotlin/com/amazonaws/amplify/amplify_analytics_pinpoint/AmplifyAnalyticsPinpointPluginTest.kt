...
@RunWith(RobolectricTestRunner::class) class AmplifyAnalyticsPinpointPluginTest {
    ...
    @Test fun recordEvent_returnsSuccess() {

        val arguments: HashMap<*, *> = hashMapOf("name" to "amplify-event")
    ...
    @Test fun recordEvent_withProperties_returnsSuccess() {

        val propertiesMap = hashMapOf<String, Any>(
            "AnalyticsStringProperty" to "Pancakes",
            "AnalyticsBooleanProperty" to true, "AnalyticsDoubleProperty" to 3.14,
            "AnalyticsIntegerProperty" to 42
        )
        val propertiesTypesMap = hashMapOf<String, Any>(
            "AnalyticsStringProperty" to "STRING",
            "AnalyticsBooleanProperty" to "BOOL", "AnalyticsDoubleProperty" to "DOUBLE",
            "AnalyticsIntegerProperty" to "INT"
        )

        val arguments: HashMap<*, *> =
            hashMapOf(
                "name" to "amplify-event", "propertiesMap" to propertiesMap,
    ...
    @Test fun flushEvents_returnsSuccess() {
    ...
    @Test fun registerGlobalProperties_withProperties_returnsSuccess() {
        val propertiesMap = hashMapOf<String, Any>(
            "AnalyticsStringProperty" to "Pancakes",
            "AnalyticsBooleanProperty" to true, "AnalyticsDoubleProperty" to 3.14,
            "AnalyticsIntegerProperty" to 42
    ...
    @Test fun identifyUser_withProperties_returnsSuccess() {
        val locationMap =
            hashMapOf<String, Any>(
                "latitude" to 47.6154086, "longitude" to -122.3349685,
                "postalCode" to "98122", "city" to "Seattle", "region" to "WA",
                "country" to "USA"
            )
        ...
        val userProfileMap =
            hashMapOf<String, Any>(
                "name" to "test-user", "email" to "user@test.com",
                "plan" to "test-plan", "location" to locationMap,
                "propertiesMap" to customPropertiesMap,
                "propertiesTypesMap" to customPropertiesTypesMap
            )

        val userMap =
            hashMapOf<String, Any>("userId" to "userId", "userProfileMap" to userProfileMap)
    ...
    @Test fun identifyUser_withNoLocation_returnsSuccess() {
        val userProfileMap =
            hashMapOf<String, Any>(
                "name" to "test-user", "email" to "user@test.com",
                "plan" to "test-plan"
