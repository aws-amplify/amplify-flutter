...
object FlutterAuthProviders {
     ...
     */
    private val context = newSingleThreadContext("FlutterAuthProviders")
     ...
     */
    fun getToken(authType: AuthorizationType): String? = runBlocking(context) {
        tokens[authType]
    }
     ...
     */
    fun setToken(authType: AuthorizationType, value: String?) = runBlocking(context) {
