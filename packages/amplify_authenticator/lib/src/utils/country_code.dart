...
const countryCodes = [
  ...
  Country('AF', '93', CountryResolverKey.af$),
    ...
    Country('KY', ' 345', CountryResolverKey.ky$),
    ...
    Country('GY', '595', CountryResolverKey.gy$),
    ...
    Country('KZ', '77', CountryResolverKey.kz$),
    ...
    Country('AN', '599', CountryResolverKey.an$),
    ...
    Country('PN', '872', CountryResolverKey.pn$),
