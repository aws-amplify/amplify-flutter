...
class RememberDeviceControl extends StatefulWidget {
  const RememberDeviceControl({Key? key}) : super(key: key);

  @override
  _RememberDeviceControl createState() => _RememberDeviceControl();
}

class _RememberDeviceControl extends State<RememberDeviceControl> {
  @override
  Widget build(BuildContext context) {
    final ConfirmSignInViewModel _authViewModel =
        InheritedAuthViewModel.of(context)!.confirmSignInViewModel;
    final ButtonResolver _buttonText =
        InheritedStrings.of(context)!.resolver.buttons;
    bool isChecked = _authViewModel.rememberDevice;
        ...
        children: [
          ...
          Checkbox(
            ...
            onChanged: (bool? value) {
              ...
              _authViewModel.setRememberDevice(value!);
            },
          ),
        ],
      ),
