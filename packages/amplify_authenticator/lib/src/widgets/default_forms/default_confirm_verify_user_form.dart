...
class DefaultConfirmVerifyUserForm extends ConfirmVerifyUserForm {
  const DefaultConfirmVerifyUserForm() : super(formFields: const []);

  @override
  ConfirmVerifyUserForm build(BuildContext context) {
