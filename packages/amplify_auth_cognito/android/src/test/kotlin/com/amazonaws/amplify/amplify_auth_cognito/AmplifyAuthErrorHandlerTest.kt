...
@RunWith(RobolectricTestRunner::class) class AuthErrorHandlerTest {
    ...
    private val cognitoErrorSuffix =
    ...
    @Test fun aliasExistsException() {
        // Arrange
        val expectedCode = "AliasExistsException"
        val exception: AuthException =
            AuthException.AliasExistsException(AliasExistsException(expectedCode))
        ...
        val details = mapOf(
            ...
            "underlyingException" to
                "${cognitoErrorPrefix}$expectedCode: ${expectedCode}$cognitoErrorSuffix"
        )
    ...
    @Test fun codeDeliveryException() {
        // Arrange
        val expectedCode = "CodeDeliveryFailureException"
        val exception: AuthException = AuthException.CodeDeliveryFailureException(
            CodeDeliveryFailureException(expectedCode)
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
    ...
    @Test fun codeExpiredException() {
        // Arrange
        val expectedCode = "CodeExpiredException"
        val exception: AuthException =
            AuthException.CodeExpiredException(ExpiredCodeException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
        ...
        val details =
            mapOf(
                ...
                "underlyingException" to
                    "${cognitoErrorPrefix}ExpiredCodeException: " +
                    "${expectedCode}$cognitoErrorSuffix"
            )
    ...
    @Test fun codeMismatchException() {
        // Arrange
        val expectedCode = "CodeMismatchException"
        val exception: AuthException =
            AuthException.CodeMismatchException(CodeMismatchException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun failedAttemptsLimitExceededException() {
        // Arrange
        val expectedCode = "FailedAttemptsLimitExceededException"
        val exception: AuthException = AuthException.FailedAttemptsLimitExceededException(
            TooManyFailedAttemptsException(expectedCode)
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        ...
        val details =
            mapOf(
                "recoverySuggestion" to
                    "Please check out the service configuration to see the " +
                    "condition of locking.",
                "message" to "User has made too many failed attempts for a given action.",
                "underlyingException" to
                    "${cognitoErrorPrefix}TooManyFailedAttemptsException: " +
                    "${expectedCode}$cognitoErrorSuffix"
            )
    ...
    @Test fun invalidAccountTypeExceptionException() {
        // Arrange
        val expectedCode = "InvalidAccountTypeException"
        val exception: AuthException = AuthException.InvalidAccountTypeException(
            InvalidUserPoolConfigurationException(expectedCode)
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        ...
        val details =
            mapOf(
                "recoverySuggestion" to
                    "Update your Auth configuration to an account " +
                    "type which supports this operation.",
                "message" to
                    "The account type you have configured doesn't support this operation.",
                "underlyingException" to
                    "${cognitoErrorPrefix}InvalidUserPoolConfigurationException: " +
                    "${expectedCode}$cognitoErrorSuffix"
            )
    ...
    @Test fun invalidParameterException() {
        // Arrange
        val expectedCode = "InvalidParameterException"
        val exception: AuthException =
            AuthException.InvalidParameterException(InvalidParameterException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun invalidPasswordException() {
        // Arrange
        val expectedCode = "InvalidPasswordException"
        val exception: AuthException =
            AuthException.InvalidPasswordException(InvalidPasswordException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun limitExceededException() {
        // Arrange
        val expectedCode = "LimitExceededException"
        val exception: AuthException =
            AuthException.LimitExceededException(LimitExceededException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun passwordResetRequiredException() {
        // Arrange
        val expectedCode = "PasswordResetRequiredException"
        val exception: AuthException = AuthException.PasswordResetRequiredException(
            PasswordResetRequiredException(expectedCode)
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
    ...
    @Test fun resourceNotFoundException() {
        // Arrange
        val expectedCode = "ResourceNotFoundException"
        val exception: AuthException =
            AuthException.ResourceNotFoundException(ResourceNotFoundException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
        ...
        val details =
            mapOf(
                "recoverySuggestion" to
                    "Retry with exponential back-off or check your " +
                    "config file to be sure the endpoint is valid.",
                "message" to "Could not find the requested online resource.",
                "underlyingException" to
                    "${cognitoErrorPrefix}$expectedCode: " +
                    "${expectedCode}$cognitoErrorSuffix"
            )
    ...
    @Test fun sessionExpiredException() {
        // Arrange
        val expectedCode = "SessionExpiredException"
        val exception: AuthException =
            AuthException.SessionExpiredException(ExpiredTokenException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
        ...
        val details = mapOf(
            ...
            "underlyingException" to
                ...
                "SessionExpiredException (Service: null; Status Code: 0; Error Code: null; " +
                "Request ID: null)"
        )
    ...
    @Test fun sessionUnavailableOfflineException() {
        // Arrange
        val expectedCode = "AuthException"
        val exception: AuthException = AuthException.SessionUnavailableOfflineException(
            AmazonClientException(expectedCode)
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        ...
        val details =
            mapOf(
                ...
                "message" to
                    "Unable to fetch/refresh credentials because the server is unreachable.",
    ...
    @Test fun sessionUnavailableServiceException() {
        // Arrange
        val expectedCode = "AuthException"
        val exception: AuthException = AuthException.SessionUnavailableServiceException(
            AmazonClientException(expectedCode)
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
    ...
    @Test fun signedOutException() {
        // Arrange
        val expectedCode = "SignedOutException"
        val exception: AuthException =
            AuthException.SignedOutException(AmazonClientException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun unknownException() {
        // Arrange
        val expectedCode = "UnknownException"
        val exception: AuthException =
            AuthException.UnknownException(AmazonClientException(expectedCode))
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun userCancelledException() {
        // Arrange
        val expectedCode = "UserCancelledException"
        val exception: AuthException = AuthException.UserCancelledException(
            expectedCode,
            AmazonClientException(expectedCode), expectedCode
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        ...
        val details = mapOf(
            "recoverySuggestion" to expectedCode, "message" to expectedCode,
    ...
    @Test fun notAuthorizedException() {
        // Arrange
        val expectedCode = "NotAuthorizedException"
        val exception =
            AuthException(expectedCode, NotAuthorizedException(expectedCode), expectedCode)
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
    ...
    @Test fun invalidLambdaResponseException() {
        // Arrange
        val expectedCode = "LambdaException"
        val exception = AuthException(
            expectedCode, InvalidLambdaResponseException(expectedCode),
            expectedCode
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
        ...
        val details = mapOf(
            "recoverySuggestion" to expectedCode, "message" to expectedCode,
            "underlyingException" to
                "${cognitoErrorPrefix}InvalidLambdaResponseException: " +
                "${expectedCode}$cognitoErrorSuffix"
        )
    ...
    @Test fun unexpectedLambdaException() {
        // Arrange
        val expectedCode = "LambdaException"
        val exception =
            AuthException(expectedCode, UnexpectedLambdaException(expectedCode), expectedCode)
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
            null as Void?
        }.`when`(mockAuth).signOut(
        ...
        val details = mapOf(
            "recoverySuggestion" to expectedCode, "message" to expectedCode,
            "underlyingException" to
                "${cognitoErrorPrefix}UnexpectedLambdaException: " +
                "${expectedCode}$cognitoErrorSuffix"
        )
    ...
    @Test fun userLambdaValidationException() {
        // Arrange
        val expectedCode = "LambdaException"
        val exception = AuthException(
            expectedCode, UserLambdaValidationException(expectedCode),
            expectedCode
        )
        doAnswer { invocation: InvocationOnMock ->
            errorHandler.handleAuthError(mockResult, exception)
        ...
        val details = mapOf(
            "recoverySuggestion" to expectedCode, "message" to expectedCode,
            "underlyingException" to
                "${cognitoErrorPrefix}UserLambdaValidationException: " +
                "${expectedCode}$cognitoErrorSuffix"
        )
