...
the endpoint and region from the `notifications.amazon_connect`
...
> `notifications.amazon_connect { aws_region, endpoint }`
> directly.
...
backend (it already carries the `notifications.amazon_connect`
