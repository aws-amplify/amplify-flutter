...
class $FirehoseRecordsTable extends FirehoseRecords
    with TableInfo<$FirehoseRecordsTable, DriftStoredRecord> {
  @override
...
class DriftStoredRecord extends DataClass
  ...
  DriftStoredRecord copyWithCompanion(FirehoseRecordsCompanion data) {
    return DriftStoredRecord(
...
class FirehoseRecordsCompanion extends UpdateCompanion<DriftStoredRecord> {
  final Value<int> id;
...
abstract class _$FirehoseRecordDatabase extends GeneratedDatabase {
  ...
  late final $FirehoseRecordsTable firehoseRecords = $FirehoseRecordsTable(
    this,
  );
  @override
...
typedef $$FirehoseRecordsTableCreateCompanionBuilder =
    FirehoseRecordsCompanion Function({
      Value<int> id,
      required String streamName,
      required Uint8List data,
      required int dataSize,
...
typedef $$FirehoseRecordsTableUpdateCompanionBuilder =
    FirehoseRecordsCompanion Function({
      Value<int> id,
      Value<String> streamName,
      Value<Uint8List> data,
...
class $$FirehoseRecordsTableTableManager
    extends
        RootTableManager<
  ...
  $$FirehoseRecordsTableTableManager(
    _$FirehoseRecordDatabase db,
    $FirehoseRecordsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$FirehoseRecordsTableProcessedTableManager =
