...
/// {@template amplify_firehose_dart.record_storage}
...
///
/// Unlike Kinesis Data Streams, Firehose records have no partition key.
///
...
abstract class RecordStorage {
  /// {@macro amplify_firehose_dart.record_storage}
  RecordStorage({
    required int maxCacheBytes,
    int maxRecordsPerBatch = limits.maxRecordsPerBatch,
    int maxBatchSizeBytes = limits.maxBatchSizeBytes,
  ...
  int get maxBatchSizeBytes => _maxBatchSizeBytes;
