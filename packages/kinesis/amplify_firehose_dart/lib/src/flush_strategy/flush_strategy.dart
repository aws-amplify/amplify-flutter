...
/// {@template amplify_firehose_dart.flush_strategy}
...
sealed class AmazonDataFirehoseFlushStrategy {
  /// {@macro amplify_firehose_dart.flush_strategy}
  const AmazonDataFirehoseFlushStrategy();
}

/// {@template amplify_firehose_dart.interval_flush_strategy}
...
class AmazonDataFirehoseInterval extends AmazonDataFirehoseFlushStrategy {
  /// {@macro amplify_firehose_dart.interval_flush_strategy}
...
/// {@template amplify_firehose_dart.none_flush_strategy}
...
class AmazonDataFirehoseNone extends AmazonDataFirehoseFlushStrategy {
  /// {@macro amplify_firehose_dart.none_flush_strategy}
