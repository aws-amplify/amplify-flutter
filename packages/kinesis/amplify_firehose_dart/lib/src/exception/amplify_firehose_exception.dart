...
sealed class AmplifyFirehoseException extends AmplifyException {
  /// {@macro amplify_firehose_dart.amplify_firehose_exception}
...
/// {@template amplify_firehose_dart.firehose_storage_exception}
/// Thrown when a local cache/database error occurs.
/// {@endtemplate}
class FirehoseStorageException extends AmplifyFirehoseException {
  /// {@macro amplify_firehose_dart.firehose_storage_exception}
...
/// {@template amplify_firehose_dart.firehose_service_exception}
...
class FirehoseServiceException extends AmplifyFirehoseException {
  /// {@macro amplify_firehose_dart.firehose_service_exception}
...
/// {@template amplify_firehose_dart.firehose_limit_exceeded_exception}
/// Thrown when the local cache is full.
/// {@endtemplate}
class FirehoseLimitExceededException extends AmplifyFirehoseException {
  /// {@macro amplify_firehose_dart.firehose_limit_exceeded_exception}
...
/// {@template amplify_firehose_dart.firehose_unknown_exception}
/// Catch-all for unexpected errors.
/// {@endtemplate}
class FirehoseUnknownException extends AmplifyFirehoseException {
  /// {@macro amplify_firehose_dart.firehose_unknown_exception}
...
/// {@template amplify_firehose_dart.firehose_network_exception}
...
class FirehoseNetworkException extends AmplifyFirehoseException {
  /// {@macro amplify_firehose_dart.firehose_network_exception}
...
/// {@template amplify_firehose_dart.firehose_record_too_large_exception}
...
class FirehoseRecordTooLargeException extends AmplifyFirehoseException {
  /// {@macro amplify_firehose_dart.firehose_record_too_large_exception}
