...
library amplify_firehose_dart.firehose.model.invalid_argument_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class InvalidArgumentExceptionAwsJson11Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result$ = <Object?>[];
    final InvalidArgumentException(:message) = object;
    if (message != null) {
      result$
        ..add('message')
        ..add(
