...
/// {@template aws_kinesis_datastreams.v2_credentials_provider_bridge}
...
/// plugin (V2) to pass them directly to the Kinesis client without
/// boilerplate.
///
/// ## Usage
///
...
///
/// // Bridge to V3 and pass to the Kinesis client
...
class V2CredentialsProviderBridge
  ...
  /// {@macro aws_kinesis_datastreams.v2_credentials_provider_bridge}
