...
// in amplify_push_notifications_pinpoint/example/ios/.symlinks/plugins/amplify_push_notifications/test/amplify_push_noitfications_impl_test.dart.
...
/// A class which mocks [PluginUtilities].
///
/// See the documentation for Mockito's code generation for more information.
class MockPluginUtilities extends _i1.Mock implements _i7.PluginUtilities {
  MockPluginUtilities() {
    _i1.throwOnMissingStub(this);
  }
}

/// A class which mocks [PushNotificationsNativeToFlutterApi].
///
/// See the documentation for Mockito's code generation for more information.
class MockPushNotificationsNativeToFlutterApi extends _i1.Mock
  ...
  @override
  List<_i4.OnRemoteMessageCallback>
      get onNotificationReceivedInBackgroundCallbacks => (super.noSuchMethod(
            Invocation.getter(#onNotificationReceivedInBackgroundCallbacks),
