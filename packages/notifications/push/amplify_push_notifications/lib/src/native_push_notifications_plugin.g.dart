...
abstract class PushNotificationsFlutterApi {
  static const MessageCodec<Object?> codec = _PushNotificationsFlutterApiCodec();
  ...
  static void setup(PushNotificationsFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.PushNotificationsFlutterApi.onNotificationReceivedInBackground', codec,
    ...
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.PushNotificationsFlutterApi.onLaunchNotificationOpened', codec,
          binaryMessenger: binaryMessenger);
      if (api == null) {
        channel.setMessageHandler(null);
      } else {
...
class PushNotificationsHostApi {
  ...
  Future<GetPermissionStatusResult> getPermissionStatus() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.PushNotificationsHostApi.getPermissionStatus', codec,
  ...
  Future<bool> requestPermissions(PermissionsOptions arg_withPermissionOptions) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.PushNotificationsHostApi.requestPermissions', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_withPermissionOptions]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
  ...
  Future<Map<Object?, Object?>?> getLaunchNotification() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.PushNotificationsHostApi.getLaunchNotification', codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(null) as List<Object?>?;
    if (replyList == null) {
