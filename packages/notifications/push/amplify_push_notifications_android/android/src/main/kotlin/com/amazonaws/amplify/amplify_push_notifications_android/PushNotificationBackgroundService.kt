        ...
        synchronized(sServiceStarted) {
            ...
            if (sBackgroundFlutterEngine == null) {
                ...
                val callbackHandle = context.getSharedPreferences(
                    AmplifyPushNotificationsAndroidPlugin.SHARED_PREFERENCES_KEY,
                    Context.MODE_PRIVATE
                )
                    .getLong(
                        AmplifyPushNotificationsAndroidPlugin.CALLBACK_DISPATCHER_HANDLE_KEY,
                        0
                    )
...
//                IsolateHolderService.setBackgroundFlutterEngine(sBackgroundFlutterEngine)
    ...
    override fun onHandleWork(intent: Intent) {
        ...
        val callbackKey =
            AmplifyPushNotificationsAndroidPlugin.BG_USER_CALLBACK_HANDLE_KEY
        ...
        synchronized(sServiceStarted) {
            if (!sServiceStarted.get()) {
                ...
                queue.add(listOf(callbackHandle))
            } else {
