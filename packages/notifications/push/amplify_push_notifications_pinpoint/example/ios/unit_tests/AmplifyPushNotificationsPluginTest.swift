...
final class AmplifyPushNotificationsPluginTest: XCTestCase {
    ...
    func testDidReceiveRemoteNotification_AppBackground() {
        ...
        let plugin = AmplifyPushNotificationsPlugin(
            overrideFlutterApi: MockPushNotificationsFlutterApi(),
            overrideSharedEventsStreamHandlers: EventsStreamHandlers(binaryMessenger: MockFlutterBinaryMessenger())
        )
    ...
    func testDidReceiveRemoteNotification_AppInActive() {
        ...
        let plugin = AmplifyPushNotificationsPlugin(
            ...
            overrideSharedEventsStreamHandlers: MockEventsStreamHandlers(
