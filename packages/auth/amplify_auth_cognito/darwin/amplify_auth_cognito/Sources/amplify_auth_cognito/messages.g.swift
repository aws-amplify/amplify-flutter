...
struct NativeUserContextData: Hashable {
  ...
  static func == (lhs: NativeUserContextData, rhs: NativeUserContextData) -> Bool {
    ...
    return deepEqualsmessages(lhs.deviceName, rhs.deviceName) && deepEqualsmessages(lhs.thirdPartyDeviceId, rhs.thirdPartyDeviceId) && deepEqualsmessages(lhs.deviceFingerprint, rhs.deviceFingerprint) && deepEqualsmessages(lhs.applicationName, rhs.applicationName) && deepEqualsmessages(lhs.applicationVersion, rhs.applicationVersion) && deepEqualsmessages(lhs.deviceLanguage, rhs.deviceLanguage) && deepEqualsmessages(lhs.deviceOsReleaseVersion, rhs.deviceOsReleaseVersion) && deepEqualsmessages(lhs.screenHeightPixels, rhs.screenHeightPixels) && deepEqualsmessages(lhs.screenWidthPixels, rhs.screenWidthPixels)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("NativeUserContextData")
    deepHashmessages(value: deviceName, hasher: &hasher)
    deepHashmessages(value: thirdPartyDeviceId, hasher: &hasher)
    deepHashmessages(value: deviceFingerprint, hasher: &hasher)
    deepHashmessages(value: applicationName, hasher: &hasher)
    deepHashmessages(value: applicationVersion, hasher: &hasher)
    deepHashmessages(value: deviceLanguage, hasher: &hasher)
    deepHashmessages(value: deviceOsReleaseVersion, hasher: &hasher)
    deepHashmessages(value: screenHeightPixels, hasher: &hasher)
    deepHashmessages(value: screenWidthPixels, hasher: &hasher)
  }
}
...
struct LegacyCredentialStoreData: Hashable {
  ...
  static func == (lhs: LegacyCredentialStoreData, rhs: LegacyCredentialStoreData) -> Bool {
    ...
    return deepEqualsmessages(lhs.identityId, rhs.identityId) && deepEqualsmessages(lhs.accessKeyId, rhs.accessKeyId) && deepEqualsmessages(lhs.secretAccessKey, rhs.secretAccessKey) && deepEqualsmessages(lhs.sessionToken, rhs.sessionToken) && deepEqualsmessages(lhs.expirationMsSinceEpoch, rhs.expirationMsSinceEpoch) && deepEqualsmessages(lhs.accessToken, rhs.accessToken) && deepEqualsmessages(lhs.refreshToken, rhs.refreshToken) && deepEqualsmessages(lhs.idToken, rhs.idToken)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("LegacyCredentialStoreData")
    deepHashmessages(value: identityId, hasher: &hasher)
    deepHashmessages(value: accessKeyId, hasher: &hasher)
    deepHashmessages(value: secretAccessKey, hasher: &hasher)
    deepHashmessages(value: sessionToken, hasher: &hasher)
    deepHashmessages(value: expirationMsSinceEpoch, hasher: &hasher)
...
struct LegacyDeviceDetailsSecret: Hashable {
  ...
  static func == (lhs: LegacyDeviceDetailsSecret, rhs: LegacyDeviceDetailsSecret) -> Bool {
    ...
    return deepEqualsmessages(lhs.deviceKey, rhs.deviceKey) && deepEqualsmessages(lhs.deviceGroupKey, rhs.deviceGroupKey) && deepEqualsmessages(lhs.devicePassword, rhs.devicePassword) && deepEqualsmessages(lhs.asfDeviceId, rhs.asfDeviceId)
  }

  func hash(into hasher: inout Hasher) {
    hasher.combine("LegacyDeviceDetailsSecret")
    deepHashmessages(value: deviceKey, hasher: &hasher)
    deepHashmessages(value: deviceGroupKey, hasher: &hasher)
    deepHashmessages(value: devicePassword, hasher: &hasher)
    deepHashmessages(value: asfDeviceId, hasher: &hasher)
  }
}
