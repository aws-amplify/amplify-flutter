...
/// {@template amplify_auth_cognito_dart.hosted_ui_platform}
...
abstract class HostedUiPlatform {
  ...
  /// {@template amplify_auth_cognito_dart.hosted_ui_platform.auth_code_grant}
  /// Internal representation of the OAuth flow.
  /// {@endtemplate}
  oauth2.AuthorizationCodeGrant? _authCodeGrant;

  /// {@macro amplify_auth_cognito_dart.hosted_ui_platform.auth_code_grant}
  @protected
  @visibleForTesting
