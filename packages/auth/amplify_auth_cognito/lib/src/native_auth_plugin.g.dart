...
class CognitoUserPoolConfig {
  ...
  static CognitoUserPoolConfig decode(Object result) {
    result as List<Object?>;
    return CognitoUserPoolConfig(
      poolId: result[0] as String?,
    );
  }
}
...
class _NativeAuthBridgeCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is CognitoUserPoolConfig) {
      buffer.putUint8(128);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      case 128:
        return CognitoUserPoolConfig.decode(readValue(buffer)!);
      case 129:
...
class NativeAuthBridge {
  ...
  Future<void> deleteLegacyDeviceSecrets(
      CognitoUserPoolConfig? arg_userPoolConfig) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.amplify_auth_cognito.NativeAuthBridge.deleteLegacyDeviceSecrets',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_userPoolConfig]) as List<Object?>?;
    if (replyList == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
