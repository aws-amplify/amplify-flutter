...
import 'package:amplify_auth_cognito/src/flows/constants.dart';
...
import 'package:amplify_core/amplify_core.dart' hide NotAuthorizedException;
import 'package:built_collection/built_collection.dart';
import 'package:stream_transform/stream_transform.dart';

import '../../sdk/cognito_identity_provider.dart';
import 'generated/fetch_auth_session_state_machine_base.dart';

/// {@template amplify_auth_cognito_dart.fetch_auth_session_state_machine}
...
class FetchAuthSessionStateMachine extends FetchAuthSessionStateMachineBase {
  /// {@macro amplify_auth_cognito_dart.fetch_auth_session_state_machine}
  ...
  CognitoIdentityProviderClient get _cognitoIdpClient => expect();
  ...
  Future<FetchAuthSessionSuccess?> getLatestResult() async {
    ...
    return fetchState is FetchAuthSessionSuccess ? fetchState : null;
  }
  ...
  Future<CognitoUserPoolTokens> _refreshUserPoolTokens({
    ...
    final refreshRequest = InitiateAuthRequest.build((b) {
      b
