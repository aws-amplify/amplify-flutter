...
library amplify_auth_cognito.cognito_identity_provider.operation.initiate_auth_operation;
...
class InitiateAuthOperation extends _i1.HttpOperation<
    _i2.InitiateAuthRequest,
    _i2.InitiateAuthRequest,
    _i3.InitiateAuthResponse,
    _i3.InitiateAuthResponse> {
  /// Initiates the authentication flow.
  ///
  /// This action might generate an SMS text message. Starting June 1, 2021, U.S. telecom carriers require that you register an origination phone number before you can send SMS messages to U.S. phone numbers. If you use SMS text messages in Amazon Cognito, you must register a phone number with [Amazon Pinpoint](https://console.aws.amazon.com/pinpoint/home/). Cognito will use the the registered number automatically. Otherwise, Cognito users that must receive SMS messages might be unable to sign up, activate their accounts, or sign in.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.InitiateAuthRequest, _i2.InitiateAuthRequest,
          _i3.InitiateAuthResponse, _i3.InitiateAuthResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.InitiateAuthRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.InitiateAuthResponse? output]) => 200;
  @override
  _i3.InitiateAuthResponse buildOutput(_i3.InitiateAuthResponse payload,
          _i7.AWSStreamedHttpResponse response) =>
      _i3.InitiateAuthResponse.fromResponse(payload, response);
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError(
            ...
            _i1.ErrorKind.client,
            _i12.InvalidSmsRoleAccessPolicyException,
            statusCode: 400,
            builder: _i12.InvalidSmsRoleAccessPolicyException.fromResponse),
        _i1.SmithyError(
            _i1.ShapeId(
                namespace: 'com.amazonaws.cognitoidentityprovider',
                shape: 'InvalidSmsRoleTrustRelationshipException'),
            _i1.ErrorKind.client,
            _i13.InvalidSmsRoleTrustRelationshipException,
            statusCode: 400,
            builder:
                _i13.InvalidSmsRoleTrustRelationshipException.fromResponse),
        _i1.SmithyError(
            _i1.ShapeId(
                namespace: 'com.amazonaws.cognitoidentityprovider',
        ...
        _i1.SmithyError(
            ...
            _i1.ErrorKind.client,
            _i19.UnexpectedLambdaException,
            statusCode: 400,
            builder: _i19.UnexpectedLambdaException.fromResponse),
        _i1.SmithyError(
            _i1.ShapeId(
                namespace: 'com.amazonaws.cognitoidentityprovider',
                shape: 'UserLambdaValidationException'),
            _i1.ErrorKind.client,
            _i20.UserLambdaValidationException,
            statusCode: 400,
            builder: _i20.UserLambdaValidationException.fromResponse),
        _i1.SmithyError(
            _i1.ShapeId(
                namespace: 'com.amazonaws.cognitoidentityprovider',
                shape: 'UserNotConfirmedException'),
            _i1.ErrorKind.client,
            _i21.UserNotConfirmedException,
            statusCode: 400,
            builder: _i21.UserNotConfirmedException.fromResponse),
        _i1.SmithyError(
            _i1.ShapeId(
                namespace: 'com.amazonaws.cognitoidentityprovider',
                shape: 'UserNotFoundException'),
            _i1.ErrorKind.client,
            _i22.UserNotFoundException,
            statusCode: 404,
            builder: _i22.UserNotFoundException.fromResponse)
      ];
  @override
  ...
  @override
  _i23.Future<_i3.InitiateAuthResponse> run(_i2.InitiateAuthRequest input,
