...
class GetUserAttributeVerificationCodeOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(GetUserAttributeVerificationCodeRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  int successCode([GetUserAttributeVerificationCodeResponse? output]) => 200;

  @override
  GetUserAttributeVerificationCodeResponse buildOutput(
    GetUserAttributeVerificationCodeResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) => GetUserAttributeVerificationCodeResponse.fromResponse(payload, response);

  @override
  List<_i1.SmithyError> get errorTypes => const [
    _i1.SmithyError<CodeDeliveryFailureException, CodeDeliveryFailureException>(
      _i1.ShapeId(
  ...
  @override
  _i1.SmithyOperation<GetUserAttributeVerificationCodeResponse> run(
