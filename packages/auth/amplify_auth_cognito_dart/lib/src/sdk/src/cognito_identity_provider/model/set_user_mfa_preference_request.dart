...
abstract class SetUserMfaPreferenceRequest
  ...
  factory SetUserMfaPreferenceRequest({
    _i3.SmsMfaSettingsType? smsMfaSettings,
    _i4.SoftwareTokenMfaSettingsType? softwareTokenMfaSettings,
  ...
  static void _init(SetUserMfaPreferenceRequestBuilder b) {}

  /// The SMS text message multi-factor authentication (MFA) settings.
  _i3.SmsMfaSettingsType? get smsMfaSettings;

  /// The time-based one-time password (TOTP) software token MFA settings.
  _i4.SoftwareTokenMfaSettingsType? get softwareTokenMfaSettings;
      ...
      switch (key) {
        case 'SMSMfaSettings':
          result.smsMfaSettings.replace((serializers.deserialize(
            value,
            specifiedType: const FullType(_i3.SmsMfaSettingsType),
          ) as _i3.SmsMfaSettingsType));
        case 'SoftwareTokenMfaSettings':
          result.softwareTokenMfaSettings.replace((serializers.deserialize(
            value,
            specifiedType: const FullType(_i4.SoftwareTokenMfaSettingsType),
          ) as _i4.SoftwareTokenMfaSettingsType));
        case 'AccessToken':
