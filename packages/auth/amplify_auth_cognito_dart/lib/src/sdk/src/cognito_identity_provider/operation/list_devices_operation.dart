...
class ListDevicesOperation extends _i1.HttpOperation<ListDevicesRequest,
  ...
  @override
  late final List<
      _i1.HttpProtocol<ListDevicesRequest, ListDevicesRequest,
          ListDevicesResponse, ListDevicesResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ListDevicesRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  ListDevicesResponse buildOutput(
    ...
    _i4.AWSBaseHttpResponse response,
      ...
      ListDevicesResponse.fromResponse(
        payload,
        response,
      );
