...
class UpdateDeviceStatusOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<UpdateDeviceStatusRequest, UpdateDeviceStatusRequest,
          UpdateDeviceStatusResponse, UpdateDeviceStatusResponse>> protocols = [
  ...
  UpdateDeviceStatusResponse buildOutput(
    ...
    _i4.AWSBaseHttpResponse response,
      ...
      UpdateDeviceStatusResponse.fromResponse(
        payload,
        response,
      );
