...
class SignUpOperation extends _i1.HttpOperation<SignUpRequest, SignUpRequest,
  ...
  @override
  late final List<
      _i1.HttpProtocol<SignUpRequest, SignUpRequest, SignUpResponse,
          SignUpResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(SignUpRequest input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
