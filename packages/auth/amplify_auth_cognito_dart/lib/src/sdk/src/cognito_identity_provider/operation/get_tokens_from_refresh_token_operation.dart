...
library amplify_auth_cognito_dart.cognito_identity_provider.operation.get_tokens_from_refresh_token_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
import 'package:amplify_auth_cognito_dart/src/sdk/src/cognito_identity_provider/model/refresh_token_reuse_exception.dart';
...
class GetTokensFromRefreshTokenOperation
    extends
        _i1.HttpOperation<
        ...
        > {
  /// Given a refresh token, issues new ID, access, and optionally refresh tokens for the user who owns the submitted token. This operation issues a new refresh token and invalidates the original refresh token after an optional grace period when refresh token rotation is enabled. If refresh token rotation is disabled, issues new ID and access tokens only.
  GetTokensFromRefreshTokenOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(GetTokensFromRefreshTokenRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  @override
  int successCode([GetTokensFromRefreshTokenResponse? output]) => 200;

  @override
  GetTokensFromRefreshTokenResponse buildOutput(
    GetTokensFromRefreshTokenResponse payload,
    _i4.AWSBaseHttpResponse response,
  ) => GetTokensFromRefreshTokenResponse.fromResponse(payload, response);
  ...
  List<_i1.SmithyError> get errorTypes => const [
    ...
    _i1.SmithyError<RefreshTokenReuseException, RefreshTokenReuseException>(
      _i1.ShapeId(
        namespace: 'com.amazonaws.cognitoidentityprovider',
      ...
      statusCode: 400,
      builder: RefreshTokenReuseException.fromResponse,
    ),
  ...
  @override
  String get runtimeTypeName => 'GetTokensFromRefreshToken';
  ...
  @override
  _i1.SmithyOperation<GetTokensFromRefreshTokenResponse> run(
