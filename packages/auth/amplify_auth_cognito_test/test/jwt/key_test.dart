        ...
        jwk: '''
{
  ...
  "kid":"1"
        ...
        key: JsonWebKey(
          ...
          x: base64UrlUintDecode('MKBCTNIcKUSDii11ySs3526iDZ8AiTo7Tu6KPAqv7D4'),
          y: base64UrlUintDecode('4Etl6SRW2YiLUrN5vfvVHuhp7x8PxltmWWlbbM4IFyM'),
        ...
        jwk: '''
{
  ...
  "kid":"1"
        ...
        key: JsonWebKey(
          ...
          x: base64UrlUintDecode('MKBCTNIcKUSDii11ySs3526iDZ8AiTo7Tu6KPAqv7D4'),
          y: base64UrlUintDecode('4Etl6SRW2YiLUrN5vfvVHuhp7x8PxltmWWlbbM4IFyM'),
          d: base64UrlUintDecode('870MB6gfuTJ4HtUnUvYMyJpr5eUZNP4Bk43bVdj3eAE'),
          publicKeyUse: PublicKeyUse.encryption,
          keyId: '1',
        ),
      ),
        ...
        jwk: '''
{
  ...
  "kid":"2011-04-29"
    ...
    for (final testCase in tests) {
      test('${testCase.name} parse', () {
        final key = JsonWebKey.fromJson(
          jsonDecode(testCase.jwk) as Map<String, Object?>,
        );
        expect(key.isPrivate, testCase.private);
        expect(key.toJson(), jsonDecode(testCase.jwk));
      });
    }
  });
}
