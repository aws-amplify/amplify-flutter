...
class AmplifySecureStorageApi {
  ...
  Future<String?> read(
      String arg_packageId, String arg_scope, String arg_key) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AmplifySecureStorageApi.read', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object?>[arg_packageId, arg_scope, arg_key])
  ...
  Future<void> write(String arg_packageId, String arg_scope, String arg_key,
      String? arg_value) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AmplifySecureStorageApi.write', codec,
        binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap = await channel
            .send(<Object?>[arg_packageId, arg_scope, arg_key, arg_value])
        as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
