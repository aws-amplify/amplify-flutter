...
public class Messages {
  ...
  public interface AmplifySecureStorageApi {
    @Nullable String read(@NonNull String packageId, @NonNull String scope, @NonNull String key);
    void write(@NonNull String packageId, @NonNull String scope, @NonNull String key, @Nullable String value);
    void delete(@NonNull String packageId, @NonNull String scope, @NonNull String key);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              String packageIdArg = (String)args.get(0);
              if (packageIdArg == null) {
                throw new NullPointerException("packageIdArg unexpectedly null.");
              }
              String scopeArg = (String)args.get(1);
              if (scopeArg == null) {
              ...
              String output = api.read(packageIdArg, scopeArg, keyArg);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              String valueArg = (String)args.get(3);
              api.write(packageIdArg, scopeArg, keyArg, valueArg);
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              ...
              api.delete(packageIdArg, scopeArg, keyArg);
              wrapped.put("result", null);
            }
            catch (Error | RuntimeException exception) {
              wrapped.put("error", wrapError(exception));
