...
class CodegenServiceClient extends $grpc.Client {
  static final _$codegen =
      $grpc.ClientMethod<$0.CodegenRequest, $0.CodegenResponse>(
        ...
        ($core.List<$core.int> value) => $0.CodegenResponse.fromBuffer(value),
      );
  ...
  $grpc.ResponseFuture<$0.CodegenResponse> codegen(
    $0.CodegenRequest request, {
    $grpc.CallOptions? options,
  }) {
...
abstract class CodegenServiceBase extends $grpc.Service {
  ...
  CodegenServiceBase() {
    $addMethod(
      $grpc.ServiceMethod<$0.CodegenRequest, $0.CodegenResponse>(
        'Codegen',
        codegen_Pre,
        false,
        false,
  ...
  $async.Future<$0.CodegenResponse> codegen_Pre(
    ...
    $async.Future<$0.CodegenRequest> request,
  ) async {
