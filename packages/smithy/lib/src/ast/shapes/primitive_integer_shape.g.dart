...
class _$PrimitiveIntegerShape extends PrimitiveIntegerShape {
  ...
  factory _$PrimitiveIntegerShape(
      ...
      (new PrimitiveIntegerShapeBuilder()..update(updates)).build();

  _$PrimitiveIntegerShape._({required this.shapeId, required this.traits})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        shapeId, 'PrimitiveIntegerShape', 'shapeId');
    BuiltValueNullFieldError.checkNotNull(
        traits, 'PrimitiveIntegerShape', 'traits');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PrimitiveIntegerShape')
          ..add('shapeId', shapeId)
          ..add('traits', traits))
        .toString();
  }
