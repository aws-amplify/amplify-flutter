...
class _$BigIntegerShape extends BigIntegerShape {
  ...
  factory _$BigIntegerShape([void Function(BigIntegerShapeBuilder)? updates]) =>
      (new BigIntegerShapeBuilder()..update(updates)).build();

  _$BigIntegerShape._({required this.shapeId, required this.traits})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        shapeId, 'BigIntegerShape', 'shapeId');
    BuiltValueNullFieldError.checkNotNull(traits, 'BigIntegerShape', 'traits');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('BigIntegerShape')
          ..add('shapeId', shapeId)
          ..add('traits', traits))
        .toString();
  }
