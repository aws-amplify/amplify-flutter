...
class _$PrimitiveShortShape extends PrimitiveShortShape {
  ...
  factory _$PrimitiveShortShape(
      ...
      (new PrimitiveShortShapeBuilder()..update(updates)).build();

  _$PrimitiveShortShape._({required this.shapeId, required this.traits})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        shapeId, 'PrimitiveShortShape', 'shapeId');
    BuiltValueNullFieldError.checkNotNull(
        traits, 'PrimitiveShortShape', 'traits');
  }
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('PrimitiveShortShape')
          ..add('shapeId', shapeId)
          ..add('traits', traits))
        .toString();
  }
