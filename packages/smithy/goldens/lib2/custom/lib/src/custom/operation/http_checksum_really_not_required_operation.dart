...
class HttpChecksumReallyNotRequiredOperation extends _i1.HttpOperation<
    _i2.Uint8List, HttpChecksumReallyNotRequiredInput, _i1.Unit, _i1.Unit> {
  /// Tests the behavior of @httpChecksum combined with @httpChecksumRequired as described \[here\](https://awslabs.github.io/smithy/2.0/aws/aws-core.html#behavior-with-httpchecksumrequired).
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.Uint8List, HttpChecksumReallyNotRequiredInput,
  ...
  @override
  _i1.HttpRequest buildRequest(HttpChecksumReallyNotRequiredInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
