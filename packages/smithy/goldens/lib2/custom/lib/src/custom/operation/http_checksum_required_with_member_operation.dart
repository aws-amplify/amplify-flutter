...
class HttpChecksumRequiredWithMemberOperation extends _i1.HttpOperation<
    _i2.Uint8List, HttpChecksumRequiredWithMemberInput, _i1.Unit, _i1.Unit> {
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.Uint8List, HttpChecksumRequiredWithMemberInput,
  ...
  @override
  _i1.HttpRequest buildRequest(HttpChecksumRequiredWithMemberInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
