...
abstract class CustomServerBase extends _i1.HttpServerBase {
  ...
  late final Router _router = () {
    ...
    router.add('POST', r'/reallyRequired', service.httpChecksumReallyRequired);
    router.add('POST', r'/required', service.httpChecksumRequired);
    router.add(
      'POST',
      r'/requiredWithMember',
      service.httpChecksumRequiredWithMember,
    );
    router.add('POST', r'/nestedCollections', service.nestedCollections);
    return router;
  }();
...
class _CustomServer extends _i1.HttpServer<CustomServerBase> {
  ...
  late final _i1.HttpProtocol<
    ...
    _i1.Unit
  >
  _httpChecksumReallyNotRequiredProtocol = _i2.RestJson1Protocol(
    serializers: serializers,
    builderFactories: builderFactories,
  );
  ...
  late final _i1.HttpProtocol<
    ...
    _i1.Unit
  >
  _httpChecksumReallyRequiredProtocol = _i2.RestJson1Protocol(
    serializers: serializers,
    builderFactories: builderFactories,
  );
  ...
  late final _i1.HttpProtocol<
    ...
    _i1.Unit
  >
  _httpChecksumRequiredWithMemberProtocol = _i2.RestJson1Protocol(
    serializers: serializers,
    builderFactories: builderFactories,
  );
  ...
  late final _i1.HttpProtocol<
    ...
    _i1.Unit
  >
  _nestedCollectionsProtocol = _i2.RestJson1Protocol(
    serializers: serializers,
    builderFactories: builderFactories,
  );
  ...
  _i3.Future<_i4.Response> defaultValues(_i4.Request request) async {
    ...
    try {
      final payload =
          (await _defaultValuesProtocol.wireSerializer.deserialize(
      ...
      final output = await service.defaultValues(input, context);
      const statusCode = 200;
      final body = await _defaultValuesProtocol.wireSerializer.serialize(
        output,
        specifiedType: const FullType(DefaultValuesOutput, [
  ...
  _i3.Future<_i4.Response> httpChecksumNotRequiredWithMember(
    ...
    try {
      final payload =
          (await _httpChecksumNotRequiredWithMemberProtocol.wireSerializer
                  .deserialize(
                    await awsRequest.bodyBytes,
  ...
  _i3.Future<_i4.Response> httpChecksumReallyNotRequired(
    ...
    try {
      final payload =
          (await _httpChecksumReallyNotRequiredProtocol.wireSerializer
                  .deserialize(
                    await awsRequest.bodyBytes,
                    specifiedType: const FullType.nullable(_i5.Uint8List),
                  )
      ...
      const statusCode = 200;
      final body = await _httpChecksumReallyNotRequiredProtocol.wireSerializer
          .serialize(
            output,
            specifiedType: const FullType(_i1.Unit, [FullType(_i1.Unit)]),
          );
  ...
  _i3.Future<_i4.Response> httpChecksumReallyRequired(
    ...
    try {
      ...
      final output = await service.httpChecksumReallyRequired(input, context);
      const statusCode = 200;
      final body = await _httpChecksumReallyRequiredProtocol.wireSerializer
          .serialize(
            output,
            specifiedType: const FullType(_i1.Unit, [FullType(_i1.Unit)]),
          );
  ...
  _i3.Future<_i4.Response> httpChecksumRequiredWithMember(
    ...
    try {
      final payload =
          (await _httpChecksumRequiredWithMemberProtocol.wireSerializer
                  .deserialize(
                    await awsRequest.bodyBytes,
                    specifiedType: const FullType.nullable(_i5.Uint8List),
                  )
  ...
  _i3.Future<_i4.Response> nestedCollections(_i4.Request request) async {
    ...
    try {
      ...
      final output = await service.nestedCollections(input, context);
      const statusCode = 200;
