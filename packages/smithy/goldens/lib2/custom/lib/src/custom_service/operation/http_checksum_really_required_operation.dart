...
library custom_v2.custom_service.operation.http_checksum_really_required_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpChecksumReallyRequiredOperation extends _i1.HttpOperation<
  ...
  late final List<
    ...
    _i4.RestJson1Protocol(
      ...
      responseInterceptors: [const _i1.ValidateChecksum()],
    )
  ];
