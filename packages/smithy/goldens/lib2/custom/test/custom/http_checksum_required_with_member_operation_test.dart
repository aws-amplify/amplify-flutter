...
library custom_v2.custom.test.http_checksum_required_with_member_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('HttpChecksumRequiredWithMemberNoAlgorithm (request)', () async {
  ...
  _i1.test('HttpChecksumRequiredWithMemberWithSHA1 (request)', () async {
    await _i2.httpRequestTest(
      operation: HttpChecksumRequiredWithMemberOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('HttpChecksumRequiredWithMemberWithSHA256 (request)', () async {
    await _i2.httpRequestTest(
      operation: HttpChecksumRequiredWithMemberOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
      ...
      testCase: const _i2.HttpRequestTestCase(
        ...
        body: 'hello, world',
        bodyMediaType: 'application/octet-stream',
        params: {'checksumAlgorithm': 'SHA256', 'content': 'hello, world'},
        vendorParamsShape: null,
        vendorParams: {},
        headers: {
          'Content-Type': 'application/octet-stream',
  ...
  _i1.test('HttpChecksumRequiredWithMemberWithCRC32 (request)', () async {
    await _i2.httpRequestTest(
      operation: HttpChecksumRequiredWithMemberOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
      ...
      testCase: const _i2.HttpRequestTestCase(
        ...
        body: 'hello, world',
        bodyMediaType: 'application/octet-stream',
        params: {'checksumAlgorithm': 'CRC32', 'content': 'hello, world'},
        vendorParamsShape: null,
        vendorParams: {},
        headers: {
          'Content-Type': 'application/octet-stream',
  ...
  _i1.test('HttpChecksumRequiredWithMemberWithCRC32C (request)', () async {
    await _i2.httpRequestTest(
      operation: HttpChecksumRequiredWithMemberOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
      ...
      testCase: const _i2.HttpRequestTestCase(
        ...
        body: 'hello, world',
        bodyMediaType: 'application/octet-stream',
        params: {'checksumAlgorithm': 'CRC32C', 'content': 'hello, world'},
        vendorParamsShape: null,
        vendorParams: {},
        headers: {
          'Content-Type': 'application/octet-stream',
...
class HttpChecksumRequiredWithMemberInputRestJson1Serializer
    extends
        _i3.StructuredSmithySerializer<HttpChecksumRequiredWithMemberInput> {
  const HttpChecksumRequiredWithMemberInputRestJson1Serializer()
    : super('HttpChecksumRequiredWithMemberInput');

  @override
  Iterable<Type> get types => const [HttpChecksumRequiredWithMemberInput];
  ...
  @override
  HttpChecksumRequiredWithMemberInput deserialize(
    Serializers serializers,
    Iterable<Object?> serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = HttpChecksumRequiredWithMemberInputBuilder();
  ...
  Iterable<Object?> serialize(
    Serializers serializers,
    HttpChecksumRequiredWithMemberInput object, {
    FullType specifiedType = FullType.unspecified,
  }) {
