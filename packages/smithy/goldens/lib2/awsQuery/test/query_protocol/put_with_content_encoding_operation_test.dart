...
library aws_query_v2.query_protocol.test.put_with_content_encoding_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('SDKAppliedContentEncoding_awsQuery (request)', () async {
    await _i2.httpRequestTest(
      ...
      inputSerializers: const [PutWithContentEncodingInputAwsQuerySerializer()],
    );
  }, skip: 'Request compression not supported yet');
  _i1.test(
    'SDKAppendsGzipAndIgnoresHttpProvidedEncoding_awsQuery (request)',
    () async {
      await _i2.httpRequestTest(
        operation: PutWithContentEncodingOperation(
          region: 'us-east-1',
        ...
        inputSerializers: const [
          PutWithContentEncodingInputAwsQuerySerializer(),
        ],
      );
    },
    skip: 'Request compression not supported yet',
