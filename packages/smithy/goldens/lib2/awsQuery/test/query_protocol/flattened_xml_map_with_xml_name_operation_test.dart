...
library aws_query_v2.query_protocol.test.flattened_xml_map_with_xml_name_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('QueryQueryFlattenedXmlMapWithXmlName (response)', () async {
