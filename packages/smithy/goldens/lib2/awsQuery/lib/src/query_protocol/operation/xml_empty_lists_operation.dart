...
library aws_query_v2.query_protocol.operation.xml_empty_lists_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlEmptyListsOperation
    extends
        _i1.HttpOperation<_i1.Unit, _i1.Unit, XmlListsOutput, XmlListsOutput> {
  ...
  ) => XmlListsOutput.fromResponse(payload, response);
