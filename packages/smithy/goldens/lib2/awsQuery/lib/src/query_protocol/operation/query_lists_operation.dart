...
class QueryListsOperation extends _i1
    .HttpOperation<QueryListsInput, QueryListsInput, _i1.Unit, _i1.Unit> {
  /// This test serializes simple and complex lists.
  QueryListsOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(QueryListsInput input) => _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
