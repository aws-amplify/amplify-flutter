...
class IgnoresWrappingXmlNameOperation extends _i1.HttpOperation<_i1.Unit,
    _i1.Unit, IgnoresWrappingXmlNameOutput, IgnoresWrappingXmlNameOutput> {
  /// The xmlName trait on the output structure is ignored in AWS Query. The wrapping element is always operation name + "Response", and inside of that wrapper is another wrapper named operation name + "Result".
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i1.Unit, _i1.Unit, IgnoresWrappingXmlNameOutput,
          IgnoresWrappingXmlNameOutput>> protocols = [
  ...
  IgnoresWrappingXmlNameOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      IgnoresWrappingXmlNameOutput.fromResponse(
        payload,
        response,
      );
