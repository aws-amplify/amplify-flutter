...
library aws_query_v2.query_protocol.model.custom_code_error; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class CustomCodeError
  ...
  factory CustomCodeError.build([
    void Function(CustomCodeErrorBuilder) updates,
  ]) = _$CustomCodeError;
...
class CustomCodeErrorAwsQuerySerializer
  ...
  @override
  Iterable<Type> get types => const [CustomCodeError, _$CustomCodeError];
