...
library aws_query_v2.query_protocol.operation.query_timestamps_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class QueryTimestampsOperation extends _i1.HttpOperation<
    _i2.QueryTimestampsInput, _i2.QueryTimestampsInput, _i1.Unit, _i1.Unit> {
  /// This test serializes timestamps. 1. Timestamps are serialized as RFC 3339 date-time values by default. 2. A timestampFormat trait on a member changes the format. 3. A timestampFormat trait on the shape targeted by the member changes the format.
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.QueryTimestampsInput, _i2.QueryTimestampsInput,
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.QueryTimestampsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i2.QueryTimestampsInput input, {
