...
library rest_json1_v2.rest_json_validation_protocol.operation.malformed_range_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedRangeOperation extends _i1.HttpOperation<MalformedRangeInput,
    MalformedRangeInput, _i1.Unit, _i1.Unit> {
  MalformedRangeOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedRangeInput, MalformedRangeInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedRangeInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/MalformedRange';
      });
  ...
  @override
  String get runtimeTypeName => 'MalformedRange';
