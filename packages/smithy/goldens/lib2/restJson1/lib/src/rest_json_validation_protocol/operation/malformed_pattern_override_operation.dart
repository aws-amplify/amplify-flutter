...
class MalformedPatternOverrideOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedPatternOverrideInput,
          MalformedPatternOverrideInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedPatternOverrideInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
