...
abstract class MalformedLengthOverrideInput
  ...
  factory MalformedLengthOverrideInput.fromRequest(
          MalformedLengthOverrideInput payload, _i2.AWSBaseHttpRequest request,
  ...
  String toString() {
    ...
    helper.add('map', map);
    helper.add('maxString', maxString);
    helper.add('minString', minString);
...
class MalformedLengthOverrideInputRestJson1Serializer
  ...
  Iterable<Type> get types =>
      const [MalformedLengthOverrideInput, _$MalformedLengthOverrideInput];
  @override
  ...
  MalformedLengthOverrideInput deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'maxString':
          if (value != null) {
            result.maxString = (serializers.deserialize(value,
                specifiedType: const FullType(String)) as String);
          }
          break;
        case 'minString':
          if (value != null) {
            result.minString = (serializers.deserialize(value,
                specifiedType: const FullType(String)) as String);
          }
          break;
        case 'string':
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    if (payload.maxString != null) {
      result
        ..add('maxString')
        ..add(serializers.serialize(payload.maxString!,
            specifiedType: const FullType(String)));
    }
    if (payload.minString != null) {
      result
        ..add('minString')
        ..add(serializers.serialize(payload.minString!,
            specifiedType: const FullType(String)));
    }
