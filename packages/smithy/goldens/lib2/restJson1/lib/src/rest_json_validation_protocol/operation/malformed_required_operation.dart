...
library rest_json1_v2.rest_json_validation_protocol.operation.malformed_required_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedRequiredOperation extends _i1.HttpOperation<
    MalformedRequiredInputPayload, MalformedRequiredInput, _i1.Unit, _i1.Unit> {
  MalformedRequiredOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedRequiredInputPayload, MalformedRequiredInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedRequiredInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
