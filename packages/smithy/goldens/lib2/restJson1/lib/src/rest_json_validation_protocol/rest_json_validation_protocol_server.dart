...
abstract class RestJsonValidationProtocolServerBase extends _i1.HttpServerBase {
  ...
  late final Router _router = () {
    ...
    router.add('POST', r'/MalformedUniqueItems', service.malformedUniqueItems);
...
class _RestJsonValidationProtocolServer
  ...
  late final _i1.HttpProtocol<
    ...
    _i1.Unit
  >
  _malformedUniqueItemsProtocol = _i2.RestJson1Protocol(
    serializers: serializers,
    builderFactories: builderFactories,
  );
  ...
  _i3.Future<_i4.Response> malformedEnum(_i4.Request request) async {
    ...
    try {
      final payload =
          (await _malformedEnumProtocol.wireSerializer.deserialize(
  ...
  _i3.Future<_i4.Response> malformedLengthOverride(_i4.Request request) async {
    ...
    try {
      ...
      const statusCode = 200;
      final body = await _malformedLengthOverrideProtocol.wireSerializer
          .serialize(
            output,
            specifiedType: const FullType(_i1.Unit, [FullType(_i1.Unit)]),
          );
  ...
  _i3.Future<_i4.Response> malformedLengthQueryString(
    ...
    try {
      ...
      const statusCode = 200;
      final body = await _malformedLengthQueryStringProtocol.wireSerializer
          .serialize(
            output,
            specifiedType: const FullType(_i1.Unit, [FullType(_i1.Unit)]),
          );
  ...
  _i3.Future<_i4.Response> malformedPatternOverride(_i4.Request request) async {
    ...
    try {
      ...
      const statusCode = 200;
      final body = await _malformedPatternOverrideProtocol.wireSerializer
          .serialize(
            output,
            specifiedType: const FullType(_i1.Unit, [FullType(_i1.Unit)]),
          );
  ...
  _i3.Future<_i4.Response> malformedRange(_i4.Request request) async {
    ...
    try {
      final payload =
          (await _malformedRangeProtocol.wireSerializer.deserialize(
                await awsRequest.bodyBytes,
  ...
  _i3.Future<_i4.Response> malformedRangeOverride(_i4.Request request) async {
    ...
    try {
      ...
      const statusCode = 200;
      final body = await _malformedRangeOverrideProtocol.wireSerializer
          .serialize(
            output,
            specifiedType: const FullType(_i1.Unit, [FullType(_i1.Unit)]),
          );
  ...
  _i3.Future<_i4.Response> malformedUniqueItems(_i4.Request request) async {
    ...
    try {
      ...
      final output = await service.malformedUniqueItems(input, context);
      const statusCode = 200;
