...
library rest_json1_v2.rest_json_validation_protocol.operation.malformed_enum_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedEnumOperation extends _i1
    .HttpOperation<MalformedEnumInput, MalformedEnumInput, _i1.Unit, _i1.Unit> {
  MalformedEnumOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedEnumInput, MalformedEnumInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedEnumInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedEnum';
