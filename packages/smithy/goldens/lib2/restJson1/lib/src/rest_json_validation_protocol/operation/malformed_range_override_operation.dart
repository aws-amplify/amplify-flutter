...
library rest_json1_v2.rest_json_validation_protocol.operation.malformed_range_override_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedRangeOverrideOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedRangeOverrideOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedRangeOverrideInput, MalformedRangeOverrideInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedRangeOverrideInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedRangeOverride';
