...
library rest_json1_v2.rest_json_validation_protocol.operation.malformed_unique_items_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedUniqueItemsOperation extends _i1.HttpOperation<
    MalformedUniqueItemsInput, MalformedUniqueItemsInput, _i1.Unit, _i1.Unit> {
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedUniqueItemsInput, MalformedUniqueItemsInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedUniqueItemsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
