...
library rest_json1_v2.rest_json_validation_protocol.operation.malformed_pattern_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedPatternOperation extends _i1.HttpOperation<
  ...
  MalformedPatternOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;

  @override
  late final List<
      _i1.HttpProtocol<_i2.MalformedPatternInput, _i2.MalformedPatternInput,
  ...
  @override
  _i8.Future<_i1.Unit> run(_i2.MalformedPatternInput input,
