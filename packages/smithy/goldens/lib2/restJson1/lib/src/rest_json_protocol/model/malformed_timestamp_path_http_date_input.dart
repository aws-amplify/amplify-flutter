...
library rest_json1_v2.rest_json_protocol.model.malformed_timestamp_path_http_date_input; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class MalformedTimestampPathHttpDateInputPayload
    with _i2.AWSEquatable<MalformedTimestampPathHttpDateInputPayload>
    implements
        Built<
          MalformedTimestampPathHttpDateInputPayload,
...
class MalformedTimestampPathHttpDateInputRestJson1Serializer
    extends
