...
library rest_json1_v2.rest_json_protocol.operation.malformed_float_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedFloatOperation extends _i1.HttpOperation<
    MalformedFloatInputPayload, MalformedFloatInput, _i1.Unit, _i1.Unit> {
  MalformedFloatOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedFloatInputPayload, MalformedFloatInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedFloatInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedFloat';
