...
library rest_json1_v2.rest_json_protocol.operation.malformed_timestamp_query_epoch_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedTimestampQueryEpochOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedTimestampQueryEpochInputPayload,
          MalformedTimestampQueryEpochInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedTimestampQueryEpochInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedTimestampQueryEpoch';
