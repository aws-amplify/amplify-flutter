...
library rest_json1_v2.rest_json_protocol.operation.malformed_accept_with_generic_string_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedAcceptWithGenericStringOperation
    extends
        _i1.HttpOperation<
          _i1.Unit,
          _i1.Unit,
  ...
  ) => MalformedAcceptWithGenericStringOutput.fromResponse(payload, response);
