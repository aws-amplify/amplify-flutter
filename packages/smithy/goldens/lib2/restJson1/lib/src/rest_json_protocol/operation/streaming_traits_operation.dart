...
library rest_json1_v2.rest_json_protocol.operation.streaming_traits_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class StreamingTraitsOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.Stream<List<int>>, StreamingTraitsInputOutput,
          _i2.Stream<List<int>>, StreamingTraitsInputOutput>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(StreamingTraitsInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  StreamingTraitsInputOutput buildOutput(
    ...
    _i4.AWSBaseHttpResponse response,
      ...
      StreamingTraitsInputOutput.fromResponse(
        payload,
        response,
      );
