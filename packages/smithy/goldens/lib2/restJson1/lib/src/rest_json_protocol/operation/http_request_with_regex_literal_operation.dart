...
library rest_json1_v2.rest_json_protocol.operation.http_request_with_regex_literal_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpRequestWithRegexLiteralOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  HttpRequestWithRegexLiteralOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<HttpRequestWithRegexLiteralInputPayload,
          HttpRequestWithRegexLiteralInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(HttpRequestWithRegexLiteralInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  String get runtimeTypeName => 'HttpRequestWithRegexLiteral';
