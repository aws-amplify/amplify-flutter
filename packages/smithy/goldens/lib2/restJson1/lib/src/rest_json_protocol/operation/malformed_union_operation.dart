...
class MalformedUnionOperation extends _i1.HttpOperation<_i2.MalformedUnionInput,
  ...
  MalformedUnionOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;

  @override
  late final List<
      _i1.HttpProtocol<_i2.MalformedUnionInput, _i2.MalformedUnionInput,
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.MalformedUnionInput input,
