...
library rest_json1_v2.rest_json_protocol.operation.malformed_boolean_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedBooleanOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedBooleanInput input) => _i1.HttpRequest((
    b,
  ) {
    b.method = 'POST';
    ...
    if (input.booleanInQuery != null) {
      b.queryParameters.add('booleanInQuery', input.booleanInQuery!.toString());
    }
  });
