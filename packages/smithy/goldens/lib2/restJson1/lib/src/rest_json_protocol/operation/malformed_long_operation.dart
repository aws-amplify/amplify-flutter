...
library rest_json1_v2.rest_json_protocol.operation.malformed_long_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedLongOperation extends _i1.HttpOperation<
    MalformedLongInputPayload, MalformedLongInput, _i1.Unit, _i1.Unit> {
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedLongInputPayload, MalformedLongInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedLongInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedLong';
