...
class MalformedIntegerOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedIntegerInput input) => _i1.HttpRequest((
    b,
  ) {
    b.method = 'POST';
    ...
    if (input.integerInQuery != null) {
      b.queryParameters.add('integerInQuery', input.integerInQuery!.toString());
    }
  });
