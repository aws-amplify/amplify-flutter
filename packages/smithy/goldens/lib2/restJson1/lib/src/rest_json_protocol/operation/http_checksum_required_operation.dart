...
library rest_json1_v2.rest_json_protocol.operation.http_checksum_required_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpChecksumRequiredOperation
    extends
        _i1.HttpOperation<
  ...
  protocols = [
    _i2.RestJson1Protocol(
      ...
      responseInterceptors:
          <_i1.HttpResponseInterceptor>[const _i1.ValidateChecksum()] +
  ...
  ) => HttpChecksumRequiredInputOutput.fromResponse(payload, response);
