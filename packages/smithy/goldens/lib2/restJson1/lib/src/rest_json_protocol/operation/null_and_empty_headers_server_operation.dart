...
library rest_json1_v2.rest_json_protocol.operation.null_and_empty_headers_server_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class NullAndEmptyHeadersServerOperation extends _i1.HttpOperation<
    ...
    _i2.NullAndEmptyHeadersIo> {
  /// Null and empty headers are not sent over the wire.
  NullAndEmptyHeadersServerOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
