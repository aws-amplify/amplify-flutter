...
library rest_json1_v2.rest_json_protocol.operation.malformed_content_type_without_body_empty_input_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedContentTypeWithoutBodyEmptyInputOperation
  ...
  _i1.HttpRequest buildRequest(
          _i2.MalformedContentTypeWithoutBodyEmptyInputInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/MalformedContentTypeWithoutBodyEmptyInput';
        if (input.header != null) {
          if (input.header!.isNotEmpty) {
            b.headers['header'] = input.header!;
          }
        }
      });
  @override
