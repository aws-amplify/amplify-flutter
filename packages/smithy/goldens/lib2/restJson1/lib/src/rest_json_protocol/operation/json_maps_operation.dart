...
library rest_json1_v2.rest_json_protocol.operation.json_maps_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class JsonMapsOperation
  ...
  ) => JsonMapsInputOutput.fromResponse(payload, response);
