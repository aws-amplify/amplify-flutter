...
library rest_json1_v2.rest_json_protocol.operation.all_query_string_types_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class AllQueryStringTypesOperation extends _i1.HttpOperation<
    ...
    _i1.Unit> {
  /// This example uses all query string types.
  AllQueryStringTypesOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.AllQueryStringTypesInput input,
