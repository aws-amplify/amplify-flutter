...
class MalformedTimestampPathEpochOperation extends _i1.HttpOperation<
    _i2.MalformedTimestampPathEpochInputPayload,
    _i2.MalformedTimestampPathEpochInput,
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampPathEpochOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.MalformedTimestampPathEpochInput input,
