...
library rest_json1_v2.rest_json_protocol.operation.constant_query_string_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ConstantQueryStringOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<ConstantQueryStringInputPayload,
          ConstantQueryStringInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(ConstantQueryStringInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
  ...
  @override
  String get runtimeTypeName => 'ConstantQueryString';
