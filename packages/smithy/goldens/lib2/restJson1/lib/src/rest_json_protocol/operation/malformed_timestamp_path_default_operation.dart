...
library rest_json1_v2.rest_json_protocol.operation.malformed_timestamp_path_default_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedTimestampPathDefaultOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampPathDefaultOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.MalformedTimestampPathDefaultInput input,
