...
abstract class JsonMapsInputOutput
  ...
  String toString() {
    ...
    helper.add('denseBooleanMap', denseBooleanMap);
    helper.add('denseNumberMap', denseNumberMap);
    helper.add('denseSetMap', denseSetMap);
    helper.add('denseStringMap', denseStringMap);
    helper.add('denseStructMap', denseStructMap);
    helper.add('sparseBooleanMap', sparseBooleanMap);
    helper.add('sparseNumberMap', sparseNumberMap);
    helper.add('sparseSetMap', sparseSetMap);
    helper.add('sparseStringMap', sparseStringMap);
    helper.add('sparseStructMap', sparseStructMap);
          ...
          if (value != null) {
            result.denseBooleanMap.replace((serializers.deserialize(value,
                    specifiedType: const FullType(
                        _i3.BuiltMap, [FullType(String), FullType(bool)]))
        ...
        case 'denseNumberMap':
          if (value != null) {
            result.denseNumberMap.replace((serializers.deserialize(value,
                    specifiedType: const FullType(
                        _i3.BuiltMap, [FullType(String), FullType(int)]))
    ...
    if (payload.sparseBooleanMap != null) {
      result
        ...
        ..add(serializers.serialize(payload.sparseBooleanMap!,
            specifiedType: const FullType(
                _i3.BuiltMap, [FullType(String), FullType.nullable(bool)])));
    }
    if (payload.sparseNumberMap != null) {
      result
        ...
        ..add(serializers.serialize(payload.sparseNumberMap!,
            specifiedType: const FullType(
                _i3.BuiltMap, [FullType(String), FullType.nullable(int)])));
    }
    ...
    if (payload.sparseStringMap != null) {
      result
        ...
        ..add(serializers.serialize(payload.sparseStringMap!,
            specifiedType: const FullType(
                _i3.BuiltMap, [FullType(String), FullType.nullable(String)])));
    }
    if (payload.sparseStructMap != null) {
      result
        ...
        ..add(serializers.serialize(payload.sparseStructMap!,
            specifiedType: const FullType(_i3.BuiltMap,
                [FullType(String), FullType.nullable(_i4.GreetingStruct)])));
    }
    return result;
  }
}
