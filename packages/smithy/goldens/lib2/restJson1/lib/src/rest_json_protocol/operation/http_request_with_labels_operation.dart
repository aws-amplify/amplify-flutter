...
library rest_json1_v2.rest_json_protocol.operation.http_request_with_labels_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpRequestWithLabelsOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<HttpRequestWithLabelsInputPayload,
          HttpRequestWithLabelsInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(HttpRequestWithLabelsInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
        b.path =
