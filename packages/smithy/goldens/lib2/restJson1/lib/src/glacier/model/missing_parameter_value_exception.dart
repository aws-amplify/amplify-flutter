...
library rest_json1_v2.glacier.model.missing_parameter_value_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MissingParameterValueExceptionRestJson1Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final MissingParameterValueException(:code, :message, :type) = payload;
    if (code != null) {
      result
        ..add('code')
