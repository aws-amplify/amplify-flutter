...
import 'package:rest_json1_v2/src/glacier/common/serializers.dart' as _i3;
...
class _GlacierServer extends _i1.HttpServer<GlacierServerBase> {
  ...
  late final _i1.HttpProtocol<_i4.Stream<List<int>>, _i6.UploadArchiveInput,
          _i5.ArchiveCreationOutputPayload, _i5.ArchiveCreationOutput>
  ...
  _i4.Future<_i9.Response> uploadArchive(
    ...
    try {
      final payload =
          (await _uploadArchiveProtocol.deserialize(awsRequest.split(),
              specifiedType: const FullType.nullable(_i4.Stream, [
                FullType(List, [FullType(int)])
              ])) as _i4.Stream<List<int>>?);
      final input = _i6.UploadArchiveInput.fromRequest(payload, awsRequest,
  ...
  _i4.Future<_i9.Response> uploadMultipartPart(_i9.Request request,
    ...
    try {
      final payload =
          (await _uploadMultipartPartProtocol.deserialize(awsRequest.split(),
              specifiedType: const FullType.nullable(_i4.Stream, [
                FullType(List, [FullType(int)])
              ])) as _i4.Stream<List<int>>?);
      final input = _i8.UploadMultipartPartInput.fromRequest(
          payload, awsRequest, labels: {
        'accountId': accountId,
        'vaultName': vaultName,
        'uploadId': uploadId
      });
