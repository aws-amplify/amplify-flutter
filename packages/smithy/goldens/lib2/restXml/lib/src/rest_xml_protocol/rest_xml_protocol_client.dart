...
class RestXmlProtocolClient {
  ...
  _i2.Future<void> constantQueryString(_i9.ConstantQueryStringInput input,
      {_i1.HttpClient? client}) {
  ...
  _i2.Future<void> httpRequestWithLabels(_i47.HttpRequestWithLabelsInput input,
      {_i1.HttpClient? client}) {
  ...
  _i2.Future<void> queryPrecedence(_i71.QueryPrecedenceInput input,
      {_i1.HttpClient? client}) {
  ...
  _i2.Future<_i83.XmlBlobsInputOutput> xmlBlobs(_i83.XmlBlobsInputOutput input,
      {_i1.HttpClient? client}) {
  ...
  _i2.Future<_i92.XmlEnumsInputOutput> xmlEnums(_i92.XmlEnumsInputOutput input,
      {_i1.HttpClient? client}) {
  ...
  _i2.Future<_i86.XmlListsInputOutput> xmlLists(_i86.XmlListsInputOutput input,
      {_i1.HttpClient? client}) {
  ...
  _i2.Future<_i88.XmlMapsInputOutput> xmlMaps(_i88.XmlMapsInputOutput input,
      {_i1.HttpClient? client}) {
