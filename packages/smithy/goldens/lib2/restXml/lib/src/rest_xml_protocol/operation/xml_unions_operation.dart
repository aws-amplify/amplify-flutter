...
class XmlUnionsOperation extends _i1.HttpOperation<XmlUnionsInputOutput,
    XmlUnionsInputOutput, XmlUnionsInputOutput, XmlUnionsInputOutput> {
  XmlUnionsOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<XmlUnionsInputOutput, XmlUnionsInputOutput,
          XmlUnionsInputOutput, XmlUnionsInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  XmlUnionsInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      XmlUnionsInputOutput.fromResponse(
        payload,
        response,
      );
