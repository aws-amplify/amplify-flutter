...
library rest_xml_v2.rest_xml_protocol.operation.xml_timestamps_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlTimestampsOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<XmlTimestampsInputOutput, XmlTimestampsInputOutput,
          XmlTimestampsInputOutput, XmlTimestampsInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(XmlTimestampsInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  XmlTimestampsInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      XmlTimestampsInputOutput.fromResponse(
        payload,
        response,
      );
