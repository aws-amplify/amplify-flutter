...
library rest_xml_v2.rest_xml_protocol.operation.http_payload_with_xml_name_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpPayloadWithXmlNameOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<PayloadWithXmlName, HttpPayloadWithXmlNameInputOutput,
          PayloadWithXmlName, HttpPayloadWithXmlNameInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(HttpPayloadWithXmlNameInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  HttpPayloadWithXmlNameInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      HttpPayloadWithXmlNameInputOutput.fromResponse(
        payload,
        response,
      );
