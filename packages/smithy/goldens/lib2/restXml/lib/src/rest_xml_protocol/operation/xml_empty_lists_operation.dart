...
library rest_xml_v2.rest_xml_protocol.operation.xml_empty_lists_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlEmptyListsOperation extends _i1.HttpOperation<XmlListsInputOutput,
    XmlListsInputOutput, XmlListsInputOutput, XmlListsInputOutput> {
  XmlEmptyListsOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<XmlListsInputOutput, XmlListsInputOutput,
          XmlListsInputOutput, XmlListsInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(XmlListsInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  XmlListsInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      XmlListsInputOutput.fromResponse(
        payload,
        response,
      );
