...
import 'package:rest_xml_v2/src/s3/common/serializers.dart';
...
class _S3Server extends _i1.HttpServer<S3ServerBase> {
  ...
  >
  _deleteObjectTaggingProtocol = _i2.RestXmlProtocol(
    serializers: serializers,
    builderFactories: builderFactories,
  ...
  >
  _getBucketLocationProtocol = _i2.RestXmlProtocol(
    serializers: serializers,
    builderFactories: builderFactories,
    noErrorWrapping: true,
  );
  ...
  late final _i1.HttpProtocol<
    ...
    ListObjectsV2Output
  >
  _listObjectsV2Protocol = _i2.RestXmlProtocol(
    serializers: serializers,
    builderFactories: builderFactories,
    noErrorWrapping: true,
  );
  ...
  _i3.Future<_i4.Response> deleteObjectTagging(
    ...
    try {
      ...
      final output = await service.deleteObjectTagging(input, context);
      const statusCode = 204;
      final body = await _deleteObjectTaggingProtocol.wireSerializer.serialize(
        output,
        specifiedType: const FullType(DeleteObjectTaggingOutput, [
  ...
  _i3.Future<_i4.Response> getBucketLocation(
    ...
    try {
      ...
      final body = await _getBucketLocationProtocol.wireSerializer.serialize(
        output,
        specifiedType: const FullType(GetBucketLocationOutput, [
  ...
  _i3.Future<_i4.Response> listObjectsV2(
    ...
    try {
      final payload =
          (await _listObjectsV2Protocol.wireSerializer.deserialize(
                await awsRequest.bodyBytes,
      ...
      final body = _listObjectsV2Protocol.wireSerializer.serialize(
        e,
        specifiedType: const FullType(NoSuchBucket, [FullType(NoSuchBucket)]),
      );
