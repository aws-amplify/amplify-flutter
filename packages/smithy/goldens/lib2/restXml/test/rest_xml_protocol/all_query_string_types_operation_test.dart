...
void main() {
  _i1.test('AllQueryStringTypes (request)', () async {
  ...
  _i1.test('RestXmlQueryStringMap (request)', () async {
    await _i2.httpRequestTest(
      operation: AllQueryStringTypesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('RestXmlQueryStringEscaping (request)', () async {
    await _i2.httpRequestTest(
      operation: AllQueryStringTypesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('RestXmlSupportsNaNFloatQueryValues (request)', () async {
    await _i2.httpRequestTest(
      operation: AllQueryStringTypesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('RestXmlSupportsInfinityFloatQueryValues (request)', () async {
    await _i2.httpRequestTest(
      operation: AllQueryStringTypesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'queryIntegerSet':
          result.queryIntegerSet.replace(
            (serializers.deserialize(
                  value,
        ...
        case 'queryTimestamp':
          result.queryTimestamp = _i3.TimestampSerializer.epochSeconds
        ...
        case 'queryParamsMapOfStrings':
          result.queryParamsMapOfStrings.replace(
            (serializers.deserialize(
                  value,
