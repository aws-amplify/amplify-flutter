...
library aws_json1_0_v2.json_rpc_10.model.s3_config; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class S3ConfigAwsJson10Serializer
    extends _i3.StructuredSmithySerializer<S3Config> {
  const S3ConfigAwsJson10Serializer() : super('S3Config');
