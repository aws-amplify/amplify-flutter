...
library aws_json1_0_v2.json_rpc_10.test.put_with_content_encoding_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test(
    'SDKAppliedContentEncoding_awsJson1_0 (request)',
    () async {
      await _i2.httpRequestTest(
        ...
        inputSerializers: const [
          PutWithContentEncodingInputAwsJson10Serializer(),
        ],
      );
    },
  ...
  _i1.test(
    'SDKAppendsGzipAndIgnoresHttpProvidedEncoding_awsJson1_0 (request)',
    () async {
      await _i2.httpRequestTest(
        operation: PutWithContentEncodingOperation(
          region: 'us-east-1',
