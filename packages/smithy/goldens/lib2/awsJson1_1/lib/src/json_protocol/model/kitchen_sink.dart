  ...
  Iterable<Object?> serialize(
    ...
    if (boolean != null) {
      result$
        ..add('Boolean')
        ..add(
          serializers.serialize(boolean, specifiedType: const FullType(bool)),
        );
    }
    if (double_ != null) {
      result$
        ..add('Double')
        ..add(
          serializers.serialize(double_, specifiedType: const FullType(double)),
        );
    }
    if (emptyStruct != null) {
      result$
    ...
    if (long != null) {
      result$
        ..add('Long')
        ..add(
          serializers.serialize(long, specifiedType: const FullType(_i4.Int64)),
        );
    }
