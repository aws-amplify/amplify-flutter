...
library aws_json1_1_v2.json_protocol.operation.null_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class NullOperation extends _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(NullOperationInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
