...
library ec2_query_v2.ec2_protocol.model.xml_enums_output; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlEnumsOutputEc2QuerySerializer
  ...
  @override
  Iterable<Type> get types => const [XmlEnumsOutput, _$XmlEnumsOutput];
      ...
      result$
        ...
        ..add(
          const _i3.XmlBuiltSetSerializer(
            ...
            serializers,
            fooEnumSet,
            specifiedType: const FullType(_i2.BuiltSet, [FullType(FooEnum)]),
          ),
        );
    }
    if (fooEnumMap != null) {
