...
library ec2_query_v2.ec2_protocol.test.empty_input_and_empty_output_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('Ec2QueryEmptyInputAndEmptyOutput (request)', () async {
  ...
  _i1.test('Ec2QueryEmptyInputAndEmptyOutput (response)', () async {
