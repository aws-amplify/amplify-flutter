...
library ec2_query_v2.ec2_protocol.test.simple_scalar_xml_properties_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('Ec2SimpleScalarProperties (response)', () async {
  ...
  _i1.test('Ec2QuerySupportsNaNFloatOutputs (response)', () async {
    await _i2.httpResponseTest(
      operation: SimpleScalarXmlPropertiesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2QuerySupportsInfinityFloatOutputs (response)', () async {
    await _i2.httpResponseTest(
      operation: SimpleScalarXmlPropertiesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2QuerySupportsNegativeInfinityFloatOutputs (response)', () async {
    await _i2.httpResponseTest(
      operation: SimpleScalarXmlPropertiesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
