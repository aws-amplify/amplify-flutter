...
library ec2_query_v2.ec2_protocol.test.no_input_and_output_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('Ec2QueryNoInputAndOutput (request)', () async {
  ...
  _i1.test('Ec2QueryNoInputAndOutput (response)', () async {
