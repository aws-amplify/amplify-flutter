...
library aws_json1_0.json_rpc_10.json_rpc10_client; // ignore_for_file: no_leading_underscores_for_library_prefixes

import 'dart:async' as _i4;

import 'package:aws_json1_0/src/json_rpc_10/common/serializers.dart' as _i3;
import 'package:aws_json1_0/src/json_rpc_10/model/complex_error.dart' as _i16;
...
class _JsonRpc10Server extends _i1.HttpServer<JsonRpc10ServerBase> {
  ...
  late final _i1.HttpProtocol<_i11.JsonUnionsInput, _i11.JsonUnionsInput,
          _i10.JsonUnionsOutput, _i10.JsonUnionsOutput> _jsonUnionsProtocol =
      _i2.AwsJson1_0Protocol(
          serializers: _i3.serializers, builderFactories: _i3.builderFactories);
    ...
    try {
      final payload = (await _endpointWithHostLabelOperationProtocol
              .deserialize(awsRequest.split(),
                  specifiedType:
                      const FullType(_i7.EndpointWithHostLabelOperationInput))
  ...
  _i4.Future<_i15.Response> greetingWithErrors(_i15.Request request) async {
    ...
    try {
      ...
      final input = _i9.GreetingWithErrorsInput.fromRequest(payload, awsRequest,
          labels: {});
  ...
  _i4.Future<_i15.Response> jsonUnions(_i15.Request request) async {
    ...
    try {
      ...
      final input =
          _i11.JsonUnionsInput.fromRequest(payload, awsRequest, labels: {});
