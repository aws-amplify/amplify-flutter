...
library aws_json1_1.json_protocol.model.kitchen_sink; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class KitchenSink
  ...
  String toString() {
    ...
    helper.add('emptyStruct', emptyStruct);
    helper.add('float', float);
    helper.add('httpdateTimestamp', httpdateTimestamp);
    helper.add('integer', integer);
    helper.add('iso8601Timestamp', iso8601Timestamp);
    helper.add('jsonValue', jsonValue);
    helper.add('listOfLists', listOfLists);
    helper.add('listOfMapsOfStrings', listOfMapsOfStrings);
    helper.add('listOfStrings', listOfStrings);
    helper.add('listOfStructs', listOfStructs);
    helper.add('long', long);
    helper.add('mapOfListsOfStrings', mapOfListsOfStrings);
    helper.add('mapOfMaps', mapOfMaps);
    helper.add('mapOfStrings', mapOfStrings);
    helper.add('mapOfStructs', mapOfStructs);
    helper.add('recursiveList', recursiveList);
    helper.add('recursiveMap', recursiveMap);
    helper.add('recursiveStruct', recursiveStruct);
    helper.add('simpleStruct', simpleStruct);
    helper.add('string', string);
    helper.add('structWithJsonName', structWithJsonName);
    helper.add('timestamp', timestamp);
    helper.add('unixTimestamp', unixTimestamp);
    ...
    if (payload.listOfStrings != null) {
      result
        ...
        ..add(serializers.serialize(payload.listOfStrings!,
            specifiedType: const FullType(_i6.BuiltList, [FullType(String)])));
    }
    if (payload.listOfStructs != null) {
      result
        ...
        ..add(serializers.serialize(payload.listOfStructs!,
            specifiedType:
                const FullType(_i6.BuiltList, [FullType(_i7.SimpleStruct)])));
    }
