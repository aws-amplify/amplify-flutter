...
library aws_query_v1.query_protocol.test.xml_empty_lists_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('QueryXmlEmptyLists (response)', () async {
