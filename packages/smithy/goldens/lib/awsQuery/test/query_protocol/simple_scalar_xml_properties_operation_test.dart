...
void main() {
  _i1.test('QuerySimpleScalarProperties (response)', () async {
  ...
  _i1.test('AwsQuerySupportsNaNFloatOutputs (response)', () async {
    await _i2.httpResponseTest(
      operation: SimpleScalarXmlPropertiesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('AwsQuerySupportsInfinityFloatOutputs (response)', () async {
    await _i2.httpResponseTest(
      operation: SimpleScalarXmlPropertiesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('AwsQuerySupportsNegativeInfinityFloatOutputs (response)', () async {
    await _i2.httpResponseTest(
      operation: SimpleScalarXmlPropertiesOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
