...
library aws_query_v1.query_protocol.operation.xml_enums_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlEnumsOperation
    extends
        _i1.HttpOperation<_i1.Unit, _i1.Unit, XmlEnumsOutput, XmlEnumsOutput> {
  /// This example serializes enums as top level properties, in lists, sets, and maps.
  XmlEnumsOperation({
  ...
  ) => XmlEnumsOutput.fromResponse(payload, response);
