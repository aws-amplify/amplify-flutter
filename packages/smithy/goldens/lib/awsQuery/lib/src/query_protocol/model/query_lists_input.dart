...
abstract class QueryListsInput
  ...
  factory QueryListsInput.build([
    void Function(QueryListsInputBuilder) updates,
  ]) = _$QueryListsInput;
...
class QueryListsInputAwsQuerySerializer
  ...
  @override
  Iterable<Type> get types => const [QueryListsInput, _$QueryListsInput];
  ...
  QueryListsInput deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'Hi':
          result.flattenedListArgWithXmlName.add(
            (serializers.deserialize(
                  value,
                  specifiedType: const FullType(String),
                )
