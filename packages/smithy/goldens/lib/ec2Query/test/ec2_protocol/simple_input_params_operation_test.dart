...
library ec2_query_v1.ec2_protocol.test.simple_input_params_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('Ec2SimpleInputParamsStrings (request)', () async {
  ...
  _i1.test('Ec2SimpleInputParamsStringAndBooleanTrue (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2SimpleInputParamsStringsAndBooleanFalse (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2SimpleInputParamsInteger (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2SimpleInputParamsFloat (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2SimpleInputParamsBlob (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2Enums (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2Query (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2QueryIsPreferred (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2XmlNameIsUppercased (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2QuerySupportsNaNFloatInputs (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
  ...
  _i1.test('Ec2QuerySupportsInfinityFloatInputs (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
      ...
      testCase: const _i2.HttpRequestTestCase(
        ...
        bodyMediaType: 'application/x-www-form-urlencoded',
        params: {'FloatValue': 'Infinity', 'Boo': 'Infinity'},
        vendorParamsShape: null,
        vendorParams: {},
        headers: {'Content-Type': 'application/x-www-form-urlencoded'},
        forbidHeaders: [],
  ...
  _i1.test('Ec2QuerySupportsNegativeInfinityFloatInputs (request)', () async {
    await _i2.httpRequestTest(
      operation: SimpleInputParamsOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
