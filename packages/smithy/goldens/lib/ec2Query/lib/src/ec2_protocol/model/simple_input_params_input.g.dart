...
class _$SimpleInputParamsInput extends SimpleInputParamsInput {
  ...
  @override
  final String? hasQueryName;
  @override
  final String? hasQueryAndXmlName;
  @override
  final String? usesXmlName;
  ...
  bool operator ==(Object other) {
    ...
    return other is SimpleInputParamsInput &&
        ...
        hasQueryName == other.hasQueryName &&
        hasQueryAndXmlName == other.hasQueryAndXmlName &&
        usesXmlName == other.usesXmlName;
  }
  ...
  int get hashCode {
    ...
    _$hash = $jc(_$hash, hasQueryName.hashCode);
    _$hash = $jc(_$hash, hasQueryAndXmlName.hashCode);
    _$hash = $jc(_$hash, usesXmlName.hashCode);
    _$hash = $jf(_$hash);
    return _$hash;
  }
}
...
class SimpleInputParamsInputBuilder
  ...
  String? _hasQueryName;
  String? get hasQueryName => _$this._hasQueryName;
  set hasQueryName(String? hasQueryName) => _$this._hasQueryName = hasQueryName;

  String? _hasQueryAndXmlName;
  String? get hasQueryAndXmlName => _$this._hasQueryAndXmlName;
  set hasQueryAndXmlName(String? hasQueryAndXmlName) =>
      _$this._hasQueryAndXmlName = hasQueryAndXmlName;

  String? _usesXmlName;
  String? get usesXmlName => _$this._usesXmlName;
  set usesXmlName(String? usesXmlName) => _$this._usesXmlName = usesXmlName;
  ...
  SimpleInputParamsInputBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _qux = $v.qux;
      _fooEnum = $v.fooEnum;
      _hasQueryName = $v.hasQueryName;
      _hasQueryAndXmlName = $v.hasQueryAndXmlName;
      _usesXmlName = $v.usesXmlName;
      _$v = null;
    }
    return this;
  }
