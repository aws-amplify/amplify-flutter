...
library ec2_query_v1.ec2_protocol.model.environment_config; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class EnvironmentConfig
  ...
  static const List<_i2.SmithySerializer<EnvironmentConfig>> serializers = [
    EnvironmentConfigEc2QuerySerializer()
  ];
...
class EnvironmentConfigEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<EnvironmentConfig> {
  const EnvironmentConfigEc2QuerySerializer() : super('EnvironmentConfig');
