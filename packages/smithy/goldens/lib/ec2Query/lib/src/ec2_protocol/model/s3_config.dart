...
library ec2_query_v1.ec2_protocol.model.s3_config; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class S3ConfigEc2QuerySerializer
    extends _i2.StructuredSmithySerializer<S3Config> {
  const S3ConfigEc2QuerySerializer() : super('S3Config');
