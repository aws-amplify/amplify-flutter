...
library rest_json1_v1.rest_json_validation_protocol.operation.malformed_length_query_string_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedLengthQueryStringOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedLengthQueryStringOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedLengthQueryStringInputPayload,
          MalformedLengthQueryStringInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedLengthQueryStringInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedLengthQueryString';
