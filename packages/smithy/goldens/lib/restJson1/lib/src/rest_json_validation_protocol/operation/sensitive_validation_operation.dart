...
library rest_json1_v1.rest_json_validation_protocol.operation.sensitive_validation_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class SensitiveValidationOperation extends _i1.HttpOperation<
    SensitiveValidationInput, SensitiveValidationInput, _i1.Unit, _i1.Unit> {
  ...
  @override
  late final List<
      _i1.HttpProtocol<SensitiveValidationInput, SensitiveValidationInput,
  ...
  @override
  _i1.HttpRequest buildRequest(SensitiveValidationInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
