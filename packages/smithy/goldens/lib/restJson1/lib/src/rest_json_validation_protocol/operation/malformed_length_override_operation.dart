...
library rest_json1_v1.rest_json_validation_protocol.operation.malformed_length_override_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedLengthOverrideOperation extends _i1.HttpOperation<
    ...
    _i1.Unit,
    _i1.Unit> {
  MalformedLengthOverrideOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedLengthOverrideInput,
          MalformedLengthOverrideInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedLengthOverrideInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedLengthOverride';
