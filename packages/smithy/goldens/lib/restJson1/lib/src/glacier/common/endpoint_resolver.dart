...
library rest_json1_v1.glacier.common.endpoint_resolver; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
final _partitions = [
  _i1.Partition(
      ...
      endpoints: const {
        ...
        'us-east-1': _i1.EndpointDefinition(variants: [
          _i1.EndpointDefinitionVariant(
              hostname: 'glacier-fips.us-east-1.amazonaws.com', tags: ['fips'])
        ]),
        'us-east-2': _i1.EndpointDefinition(variants: [
          _i1.EndpointDefinitionVariant(
              hostname: 'glacier-fips.us-east-2.amazonaws.com', tags: ['fips'])
        ]),
        'us-west-1': _i1.EndpointDefinition(variants: [
          _i1.EndpointDefinitionVariant(
              hostname: 'glacier-fips.us-west-1.amazonaws.com', tags: ['fips'])
        ]),
        'us-west-2': _i1.EndpointDefinition(variants: [
          _i1.EndpointDefinitionVariant(
              hostname: 'glacier-fips.us-west-2.amazonaws.com', tags: ['fips'])
        ])
      }),
  _i1.Partition(
      id: 'aws-cn',
  ...
  _i1.Partition(
      ...
      endpoints: const {
        'us-iso-east-1':
            _i1.EndpointDefinition(protocols: ['http', 'https'], variants: []),
  ...
  _i1.Partition(
      ...
      endpoints: const {
        'us-isob-east-1': _i1.EndpointDefinition(variants: [])
      }),
  _i1.Partition(
      id: 'aws-us-gov',
