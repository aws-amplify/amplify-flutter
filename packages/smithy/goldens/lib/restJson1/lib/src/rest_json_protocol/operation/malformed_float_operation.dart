...
class MalformedFloatOperation extends _i1.HttpOperation<
    _i2.MalformedFloatInputPayload,
    _i2.MalformedFloatInput,
    _i1.Unit,
    _i1.Unit> {
  MalformedFloatOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  _i1.HttpRequest buildRequest(_i2.MalformedFloatInput input) =>
      _i1.HttpRequest((b) {
        ...
        if (input.floatInQuery != null) {
          b.queryParameters.add('floatInQuery', input.floatInQuery!.toString());
        }
      });
  @override
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.MalformedFloatInput input,
