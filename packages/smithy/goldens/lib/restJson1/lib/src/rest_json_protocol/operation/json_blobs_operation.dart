...
library rest_json1_v1.rest_json_protocol.operation.json_blobs_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class JsonBlobsOperation extends _i1.HttpOperation<
    ...
    _i2.JsonBlobsInputOutput> {
  /// Blobs are base64 encoded
  JsonBlobsOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i7.Future<_i2.JsonBlobsInputOutput> run(_i2.JsonBlobsInputOutput input,
