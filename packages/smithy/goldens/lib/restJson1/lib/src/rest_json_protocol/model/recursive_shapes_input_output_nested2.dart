...
library rest_json1.rest_json_protocol.model.recursive_shapes_input_output_nested2; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class RecursiveShapesInputOutputNested2
  ...
  String toString() {
    ...
    helper.add('bar', bar);
    helper.add('recursiveMember', recursiveMember);
