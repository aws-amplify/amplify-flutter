...
class _$PutWithContentEncodingInputPayload
    extends PutWithContentEncodingInputPayload {
  @override
  final String? data;
  ...
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is PutWithContentEncodingInputPayload && data == other.data;
  }
...
class PutWithContentEncodingInputPayloadBuilder
  ...
  PutWithContentEncodingInputPayloadBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _data = $v.data;
      _$v = null;
