...
library rest_json1_v1.rest_json_protocol.operation.post_union_with_json_name_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PostUnionWithJsonNameOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(PostUnionWithJsonNameInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  ) => PostUnionWithJsonNameOutput.fromResponse(payload, response);
