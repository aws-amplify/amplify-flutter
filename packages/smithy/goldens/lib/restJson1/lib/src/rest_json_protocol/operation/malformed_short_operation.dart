...
library rest_json1_v1.rest_json_protocol.operation.malformed_short_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedShortOperation extends _i1.HttpOperation<
    MalformedShortInputPayload, MalformedShortInput, _i1.Unit, _i1.Unit> {
  MalformedShortOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedShortInputPayload, MalformedShortInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedShortInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedShort';
