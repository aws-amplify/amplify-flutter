...
library rest_json1_v1.rest_json_protocol.operation.endpoint_with_host_label_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class EndpointWithHostLabelOperation extends _i1
  ...
  EndpointWithHostLabelOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.HostLabelInput input,
