...
class MediaTypeHeaderOperation
    extends
        _i1.HttpOperation<
  ...
  _i1.HttpRequest buildRequest(MediaTypeHeaderInput input) =>
      _i1.HttpRequest((b) {
        ...
        if (input.json != null) {
          b.headers['X-Json'] = _i3.base64Encode(
            _i3.utf8.encode(_i3.jsonEncode(input.json!.value)),
          );
        }
      });
  ...
  ) => MediaTypeHeaderOutput.fromResponse(payload, response);
