...
library rest_json1_v1.rest_json_protocol.operation.http_payload_traits_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpPayloadTraitsOperation
    extends
        _i1.HttpOperation<
          _i2.Uint8List,
  ...
  ) => HttpPayloadTraitsInputOutput.fromResponse(payload, response);
