...
abstract class HttpRequestWithFloatLabelsInput
  ...
  factory HttpRequestWithFloatLabelsInput({
    ...
    return _$HttpRequestWithFloatLabelsInput._(float: float, double_: double_);
  }
  ...
  @override
  List<Object?> get props => [float, double_];
...
abstract class HttpRequestWithFloatLabelsInputPayload
    with _i2.AWSEquatable<HttpRequestWithFloatLabelsInputPayload>
    implements
        Built<
          HttpRequestWithFloatLabelsInputPayload,
...
class HttpRequestWithFloatLabelsInputRestJson1Serializer
    extends
        _i1.StructuredSmithySerializer<HttpRequestWithFloatLabelsInputPayload> {
