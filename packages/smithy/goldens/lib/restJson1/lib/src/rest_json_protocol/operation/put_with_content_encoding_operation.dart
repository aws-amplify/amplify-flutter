...
library rest_json1_v1.rest_json_protocol.operation.put_with_content_encoding_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PutWithContentEncodingOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<PutWithContentEncodingInputPayload,
          PutWithContentEncodingInput, _i1.Unit, _i1.Unit>> protocols = [
  ...
  _i1.HttpRequest buildRequest(PutWithContentEncodingInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/requestcompression/putcontentwithencoding';
