...
library rest_json1_v1.rest_json_protocol.operation.malformed_integer_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedIntegerOperation extends _i1.HttpOperation<
    MalformedIntegerInputPayload, MalformedIntegerInput, _i1.Unit, _i1.Unit> {
  MalformedIntegerOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedIntegerInputPayload, MalformedIntegerInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedIntegerInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedInteger';
