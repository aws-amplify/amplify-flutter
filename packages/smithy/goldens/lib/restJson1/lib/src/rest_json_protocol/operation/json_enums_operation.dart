...
library rest_json1_v1.rest_json_protocol.operation.json_enums_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class JsonEnumsOperation extends _i1.HttpOperation<JsonEnumsInputOutput,
  ...
  @override
  _i1.HttpRequest buildRequest(JsonEnumsInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
        b.path = r'/JsonEnums';
      });
  ...
  @override
  int successCode([JsonEnumsInputOutput? output]) => 200;
  ...
  @override
  String get runtimeTypeName => 'JsonEnums';
  ...
  @override
  _i1.SmithyOperation<JsonEnumsInputOutput> run(
