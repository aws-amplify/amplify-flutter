...
library rest_json1_v1.rest_json_protocol.operation.malformed_request_body_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedRequestBodyOperation extends _i1.HttpOperation<
    MalformedRequestBodyInput, MalformedRequestBodyInput, _i1.Unit, _i1.Unit> {
  MalformedRequestBodyOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedRequestBodyInput, MalformedRequestBodyInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedRequestBodyInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedRequestBody';
