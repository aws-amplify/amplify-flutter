...
class MalformedDoubleOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedDoubleInput input) => _i1.HttpRequest((
    b,
  ) {
    b.method = 'POST';
    ...
    if (input.doubleInQuery != null) {
      b.queryParameters.add('doubleInQuery', input.doubleInQuery!.toString());
    }
  });
