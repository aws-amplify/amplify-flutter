...
library rest_json1_v1.rest_json_protocol.operation.malformed_double_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedDoubleOperation extends _i1.HttpOperation<
    MalformedDoubleInputPayload, MalformedDoubleInput, _i1.Unit, _i1.Unit> {
  MalformedDoubleOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedDoubleInputPayload, MalformedDoubleInput,
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedDoubleInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedDouble';
