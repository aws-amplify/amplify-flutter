...
library rest_json1_v1.rest_json_protocol.operation.malformed_byte_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedByteOperation extends _i1.HttpOperation<
    MalformedByteInputPayload, MalformedByteInput, _i1.Unit, _i1.Unit> {
  MalformedByteOperation({
  ...
  @override
  late final List<
      _i1.HttpProtocol<MalformedByteInputPayload, MalformedByteInput, _i1.Unit,
          _i1.Unit>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedByteInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  @override
  String get runtimeTypeName => 'MalformedByte';
