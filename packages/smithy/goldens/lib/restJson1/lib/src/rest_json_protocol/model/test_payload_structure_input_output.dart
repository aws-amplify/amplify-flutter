...
library rest_json1.rest_json_protocol.model.test_payload_structure_input_output; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class TestPayloadStructureInputOutput
  ...
  String toString() {
    ...
    helper.add('payloadConfig', payloadConfig);
