...
library rest_json1_v1.rest_json_protocol.operation.malformed_timestamp_body_date_time_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedTimestampBodyDateTimeOperation
    extends
        _i1.HttpOperation<
          ...
          _i1.Unit
        > {
  MalformedTimestampBodyDateTimeOperation({
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedTimestampBodyDateTimeInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/MalformedTimestampBodyDateTime';
      });
  ...
  @override
  String get runtimeTypeName => 'MalformedTimestampBodyDateTime';
