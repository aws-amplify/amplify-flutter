...
class MalformedTimestampBodyDefaultOperation extends _i1.HttpOperation<
    _i2.MalformedTimestampBodyDefaultInput,
    _i2.MalformedTimestampBodyDefaultInput,
    _i1.Unit,
    _i1.Unit> {
  MalformedTimestampBodyDefaultOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i7.Future<_i1.Unit> run(_i2.MalformedTimestampBodyDefaultInput input,
