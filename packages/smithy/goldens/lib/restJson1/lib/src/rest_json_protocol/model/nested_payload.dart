...
library rest_json1_v1.rest_json_protocol.model.nested_payload; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class NestedPayloadRestJson1Serializer
  ...
  Iterable<Object?> serialize(
    ...
    final result = <Object?>[];
    final NestedPayload(:greeting, :name) = payload;
    if (greeting != null) {
      result
        ..add('greeting')
