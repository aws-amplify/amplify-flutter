...
abstract class MalformedDoubleInput
  ...
  String toString() {
    ...
    helper.add('doubleInBody', doubleInBody);
    helper.add('doubleInHeader', doubleInHeader);
    helper.add('doubleInPath', doubleInPath);
    helper.add('doubleInQuery', doubleInQuery);
