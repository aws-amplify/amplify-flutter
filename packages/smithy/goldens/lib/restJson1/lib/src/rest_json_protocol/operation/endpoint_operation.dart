...
library rest_json1_v1.rest_json_protocol.operation.endpoint_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class EndpointOperation
  ...
  EndpointOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
