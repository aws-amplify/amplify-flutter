...
library rest_json1_v1.rest_json_protocol.operation.constant_and_variable_query_string_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ConstantAndVariableQueryStringOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(ConstantAndVariableQueryStringInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'GET';
