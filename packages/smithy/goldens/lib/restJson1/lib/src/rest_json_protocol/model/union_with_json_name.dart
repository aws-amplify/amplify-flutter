...
library rest_json1.rest_json_protocol.model.union_with_json_name; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class UnionWithJsonNameSdkUnknown extends UnionWithJsonName {
  const UnionWithJsonNameSdkUnknown(this.name, this.value) : super._();
