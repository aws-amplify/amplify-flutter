...
library rest_json1_v1.rest_json_protocol.operation.malformed_timestamp_query_http_date_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class MalformedTimestampQueryHttpDateOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(MalformedTimestampQueryHttpDateInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
