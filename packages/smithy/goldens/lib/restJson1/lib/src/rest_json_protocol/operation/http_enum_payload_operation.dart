...
library rest_json1_v1.rest_json_protocol.operation.http_enum_payload_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpEnumPayloadOperation extends _i1.HttpOperation<_i2.StringEnum,
  ...
  HttpEnumPayloadOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
