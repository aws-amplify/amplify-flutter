...
class _ApiGatewayServer extends _i1.HttpServer<ApiGatewayServerBase> {
  ...
  late final _i1.HttpProtocol<_i6.GetRestApisRequestPayload,
          _i6.GetRestApisRequest, _i5.RestApis, _i5.RestApis>
  ...
  _i4.Future<_i7.Response> getRestApis(_i7.Request request) async {
    ...
    try {
      ...
      final input =
          _i6.GetRestApisRequest.fromRequest(payload, awsRequest, labels: {});
