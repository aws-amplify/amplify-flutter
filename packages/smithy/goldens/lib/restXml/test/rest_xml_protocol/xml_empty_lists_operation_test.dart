...
library rest_xml.rest_xml_protocol.test.xml_empty_lists_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
  ...
  _i5.XmlListsInputOutput deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'flattenedList':
          if (value != null) {
            result.flattenedList.replace((serializers.deserialize(value,
                    specifiedType:
        ...
        case 'flattenedList2':
          if (value != null) {
            result.flattenedList2.replace((serializers.deserialize(value,
                    specifiedType:
                        const FullType(_i6.BuiltList, [FullType(String)]))
                as _i6.BuiltList<String>));
          }
        ...
        case 'renamedListMembers':
          if (value != null) {
            result.renamedListMembers.replace((serializers.deserialize(value,
                    specifiedType:
                        const FullType(_i6.BuiltList, [FullType(String)]))
                as _i6.BuiltList<String>));
          }
