...
void main() {
  _i1.test('HttpPayloadWithXmlNamespace (request)', () async {
  ...
  _i1.test('HttpPayloadWithXmlNamespace (response)', () async {
...
class HttpPayloadWithXmlNamespaceInputOutputRestXmlSerializer
    extends
        _i3.StructuredSmithySerializer<HttpPayloadWithXmlNamespaceInputOutput> {
