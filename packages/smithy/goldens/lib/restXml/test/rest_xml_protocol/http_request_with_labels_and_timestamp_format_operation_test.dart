...
library rest_xml.rest_xml_protocol.test.http_request_with_labels_and_timestamp_format_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test(
    'HttpRequestWithLabelsAndTimestampFormat (request)',
    () async {
...
class HttpRequestWithLabelsAndTimestampFormatInputRestXmlSerializer
  ...
  _i5.HttpRequestWithLabelsAndTimestampFormatInput deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        case 'defaultFormat':
          result.defaultFormat = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
        case 'memberDateTime':
          result.memberDateTime = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
        case 'memberEpochSeconds':
          result.memberEpochSeconds = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
        case 'memberHttpDate':
          result.memberHttpDate = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
        case 'targetDateTime':
          result.targetDateTime = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
        case 'targetEpochSeconds':
          result.targetEpochSeconds = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
        case 'targetHttpDate':
          result.targetHttpDate = _i4.TimestampSerializer.epochSeconds
              .deserialize(serializers, value!);
          break;
      }
    }
