...
library rest_xml_v1.rest_xml_protocol.test.http_payload_with_member_xml_name_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('HttpPayloadWithMemberXmlName (request)', () async {
  ...
  _i1.test('HttpPayloadWithMemberXmlName (response)', () async {
