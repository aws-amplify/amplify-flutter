...
library rest_xml_v1.rest_xml_protocol.test.put_with_content_encoding_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('SDKAppliedContentEncoding_restXml (request)', () async {
  ...
  _i1.test('SDKAppendedGzipAfterProvidedEncoding_restXml (request)', () async {
    await _i2.httpRequestTest(
      operation: PutWithContentEncodingOperation(
        region: 'us-east-1',
        baseUri: Uri.parse('https://example.com'),
