...
library rest_xml_v1.rest_xml_protocol.test.no_input_and_output_operation_test_test; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
void main() {
  _i1.test('NoInputAndOutput (request)', () async {
  ...
  _i1.test('NoInputAndOutput (response)', () async {
