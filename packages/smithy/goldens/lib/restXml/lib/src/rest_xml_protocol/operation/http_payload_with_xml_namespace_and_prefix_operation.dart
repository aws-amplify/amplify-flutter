...
library rest_xml_v1.rest_xml_protocol.operation.http_payload_with_xml_namespace_and_prefix_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpPayloadWithXmlNamespaceAndPrefixOperation extends _i1.HttpOperation<
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          HttpPayloadWithXmlNamespaceAndPrefixInputOutput,
          PayloadWithXmlNamespaceAndPrefix,
          HttpPayloadWithXmlNamespaceAndPrefixInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  HttpPayloadWithXmlNamespaceAndPrefixInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      HttpPayloadWithXmlNamespaceAndPrefixInputOutput.fromResponse(
        payload,
        response,
      );
