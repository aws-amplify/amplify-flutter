...
class XmlEnumsInputOutputRestXmlSerializer
  ...
  Iterable<Type> get types =>
      const [XmlEnumsInputOutput, _$XmlEnumsInputOutput];
  @override
  ...
  XmlEnumsInputOutput deserialize(
    ...
    while (iterator.moveNext()) {
      ...
      switch (key as String) {
        ...
        case 'fooEnumMap':
          if (value != null) {
            result.fooEnumMap.replace(const _i1.XmlBuiltMapSerializer()
                .deserialize(
                    serializers, (value as Iterable<Object?>),
                    specifiedType: const FullType(_i4.BuiltMap,
                        [FullType(String), FullType(_i3.FooEnum)])));
          }
          break;
        case 'fooEnumSet':
          if (value != null) {
    ...
    if (payload.fooEnumList != null) {
      result
        ...
        ..add(const _i1.XmlBuiltListSerializer().serialize(
            serializers, payload.fooEnumList!,
    ...
    if (payload.fooEnumMap != null) {
      result
        ...
        ..add(const _i1.XmlBuiltMapSerializer().serialize(
            serializers, payload.fooEnumMap!,
            specifiedType: const FullType.nullable(
