...
library rest_xml_v1.rest_xml_protocol.operation.http_payload_with_member_xml_name_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpPayloadWithMemberXmlNameOperation
    extends
        _i1.HttpOperation<
          PayloadWithXmlName,
  ...
  @override
  _i1.HttpRequest buildRequest(HttpPayloadWithMemberXmlNameInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  @override
  int successCode([HttpPayloadWithMemberXmlNameInputOutput? output]) => 200;

  @override
  HttpPayloadWithMemberXmlNameInputOutput buildOutput(
    PayloadWithXmlName? payload,
    _i3.AWSBaseHttpResponse response,
  ) => HttpPayloadWithMemberXmlNameInputOutput.fromResponse(payload, response);
  ...
  @override
  _i1.SmithyOperation<HttpPayloadWithMemberXmlNameInputOutput> run(
