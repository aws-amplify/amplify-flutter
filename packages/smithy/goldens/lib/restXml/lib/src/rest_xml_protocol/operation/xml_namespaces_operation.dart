...
library rest_xml_v1.rest_xml_protocol.operation.xml_namespaces_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlNamespacesOperation extends _i1.HttpOperation<
    ...
    _i2.XmlNamespacesInputOutput,
    _i2.XmlNamespacesInputOutput> {
  XmlNamespacesOperation({required String region, Uri? baseUri})
      : _region = region,
        _baseUri = baseUri;
  ...
  @override
  _i2.XmlNamespacesInputOutput buildOutput(_i2.XmlNamespacesInputOutput payload,
          _i6.AWSStreamedHttpResponse response) =>
      _i2.XmlNamespacesInputOutput.fromResponse(payload, response);
  @override
  ...
  @override
  _i7.Future<_i2.XmlNamespacesInputOutput> run(
