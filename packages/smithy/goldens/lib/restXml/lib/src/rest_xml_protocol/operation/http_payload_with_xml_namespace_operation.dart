...
library rest_xml_v1.rest_xml_protocol.operation.http_payload_with_xml_namespace_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpPayloadWithXmlNamespaceOperation
    extends
        _i1.HttpOperation<
  ...
  @override
  _i1.HttpRequest buildRequest(HttpPayloadWithXmlNamespaceInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  @override
  int successCode([HttpPayloadWithXmlNamespaceInputOutput? output]) => 200;

  @override
  HttpPayloadWithXmlNamespaceInputOutput buildOutput(
    PayloadWithXmlNamespace? payload,
    _i3.AWSBaseHttpResponse response,
  ) => HttpPayloadWithXmlNamespaceInputOutput.fromResponse(payload, response);
  ...
  @override
  _i1.SmithyOperation<HttpPayloadWithXmlNamespaceInputOutput> run(
