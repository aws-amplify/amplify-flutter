...
library rest_xml_v1.rest_xml_protocol.operation.xml_empty_blobs_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlEmptyBlobsOperation extends _i1.HttpOperation<XmlBlobsInputOutput,
    XmlBlobsInputOutput, XmlBlobsInputOutput, XmlBlobsInputOutput> {
  /// Blobs are base64 encoded
  ...
  @override
  late final List<
      _i1.HttpProtocol<XmlBlobsInputOutput, XmlBlobsInputOutput,
          XmlBlobsInputOutput, XmlBlobsInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(XmlBlobsInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
