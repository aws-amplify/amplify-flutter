...
library rest_xml_v1.rest_xml_protocol.model.timestamp_format_headers_io; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class TimestampFormatHeadersIo
  ...
  String toString() {
    final helper =
        newBuiltValueToStringHelper('TimestampFormatHeadersIo')
...
abstract class TimestampFormatHeadersIoPayload
    with _i2.AWSEquatable<TimestampFormatHeadersIoPayload>
    implements
        Built<
          TimestampFormatHeadersIoPayload,
