...
library rest_xml_v1.rest_xml_protocol.model.payload_with_xml_namespace_and_prefix; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class PayloadWithXmlNamespaceAndPrefixRestXmlSerializer
  ...
  Iterable<Object?> serialize(
    ...
    final PayloadWithXmlNamespaceAndPrefix(:name) = payload;
    if (name != null) {
      result
