...
library rest_xml.rest_xml_protocol.model.xml_timestamps_input_output; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class XmlTimestampsInputOutput
  ...
  String toString() {
    ...
    helper.add('epochSeconds', epochSeconds);
    helper.add('httpDate', httpDate);
...
class XmlTimestampsInputOutputRestXmlSerializer
  ...
  Iterable<Type> get types =>
      const [XmlTimestampsInputOutput, _$XmlTimestampsInputOutput];
  @override
