...
library rest_xml_v1.rest_xml_protocol.model.s3_config; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class S3ConfigRestXmlSerializer
  ...
  Iterable<Object?> serialize(
    ...
    final result$ = <Object?>[const _i2.XmlElementName('S3Config')];
    final S3Config(
      :addressingStyle,
      :useAccelerateEndpoint,
      :useDualstackEndpoint
