...
library rest_xml_v1.rest_xml_protocol.operation.nested_xml_maps_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class NestedXmlMapsOperation
  ...
  ) => NestedXmlMapsInputOutput.fromResponse(payload, response);
