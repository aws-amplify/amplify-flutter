...
library rest_xml_v1.rest_xml_protocol.operation.http_payload_with_structure_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpPayloadWithStructureOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<NestedPayload, HttpPayloadWithStructureInputOutput,
          NestedPayload, HttpPayloadWithStructureInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(HttpPayloadWithStructureInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'PUT';
  ...
  HttpPayloadWithStructureInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      HttpPayloadWithStructureInputOutput.fromResponse(
        payload,
        response,
      );
