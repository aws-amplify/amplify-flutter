...
library rest_xml_v1.rest_xml_protocol.operation.xml_maps_xml_name_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class XmlMapsXmlNameOperation extends _i1.HttpOperation<
  ...
  @override
  late final List<
      _i1.HttpProtocol<XmlMapsXmlNameInputOutput, XmlMapsXmlNameInputOutput,
          XmlMapsXmlNameInputOutput, XmlMapsXmlNameInputOutput>> protocols = [
    _i2.RestXmlProtocol(
  ...
  @override
  _i1.HttpRequest buildRequest(XmlMapsXmlNameInputOutput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  XmlMapsXmlNameInputOutput buildOutput(
    ...
    _i3.AWSBaseHttpResponse response,
      ...
      XmlMapsXmlNameInputOutput.fromResponse(
        payload,
        response,
      );
