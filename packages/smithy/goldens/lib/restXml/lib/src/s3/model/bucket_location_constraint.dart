...
library rest_xml.s3.model.bucket_location_constraint; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class BucketLocationConstraint
  ...
  static const usWest2 =
      BucketLocationConstraint._(0, 'us_west_2', 'us-west-2');
