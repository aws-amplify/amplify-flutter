...
library rest_xml.s3.model.object_storage_class; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ObjectStorageClass extends _i1.SmithyEnum<ObjectStorageClass> {
  ...
  static const intelligentTiering =
      ObjectStorageClass._(2, 'INTELLIGENT_TIERING', 'INTELLIGENT_TIERING');
  ...
  static const reducedRedundancy =
      ObjectStorageClass._(5, 'REDUCED_REDUNDANCY', 'REDUCED_REDUNDANCY');

  static const standard = ObjectStorageClass._(6, 'STANDARD', 'STANDARD');

  static const standardIa =
      ObjectStorageClass._(7, 'STANDARD_IA', 'STANDARD_IA');
