...
library custom_v1.custom.operation.http_checksum_really_required_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class HttpChecksumReallyRequiredOperation extends _i1.HttpOperation<
    _i2.Uint8List, _i3.HttpChecksumReallyRequiredInput, _i1.Unit, _i1.Unit> {
  /// Tests the behavior of @httpChecksum combined with @httpChecksumRequired as described \[here\](https://awslabs.github.io/smithy/2.0/aws/aws-core.html#behavior-with-httpchecksumrequired).
  ...
  @override
  late final List<
      _i1.HttpProtocol<_i2.Uint8List, _i3.HttpChecksumReallyRequiredInput,
  ...
  @override
  _i1.HttpRequest buildRequest(_i3.HttpChecksumReallyRequiredInput input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
  ...
  _i1.SmithyOperation<_i1.Unit> run(
    _i3.HttpChecksumReallyRequiredInput input, {
