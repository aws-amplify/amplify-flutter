...
HttpRequestTestCase _$HttpRequestTestCaseFromJson(Map json) =>
    HttpRequestTestCase(
      ...
      authScheme: _$JsonConverterFromJson<String, ShapeId>(
        json['authScheme'],
        const ShapeIdConverter().fromJson,
      ),
      body: json['body'] as String?,
      bodyMediaType: json['bodyMediaType'] as String?,
      params:
          (json['params'] as Map?)?.map((k, e) => MapEntry(k as String, e)) ??
          const {},
      vendorParamsShape: _$JsonConverterFromJson<String, ShapeId>(
        json['vendorParamsShape'],
        const ShapeIdConverter().fromJson,
      ),
      vendorParams:
          (json['vendorParams'] as Map?)?.map(
      ...
      headers:
          ...
          const {},
      forbidHeaders:
          (json['forbidHeaders'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      requireHeaders:
          (json['requireHeaders'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      tags:
      ...
      queryParams:
          ...
          const [],
      forbidQueryParams:
          (json['forbidQueryParams'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
      requireQueryParams:
          (json['requireQueryParams'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList() ??
          const [],
    );
