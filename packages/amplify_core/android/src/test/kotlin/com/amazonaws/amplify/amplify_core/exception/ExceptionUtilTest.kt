...
class ExceptionUtilTest {
    ...
    fun serialize_AmplifyException_with_cause() {
        ...
        val exceptionWithCause =
                AmplifyException("test message", NumberFormatException("test exception"),
                        "test recovery")
    ...
    fun serialize_DataStoreException() {
        // Setup data
        val exceptionWithCause =
                DataStoreException("test message", NumberFormatException("test exception"),
                        "test recovery")
    ...
    fun serialize_DataStoreException_with_AmplifyException_as_cause() {
        // Setup data
        val exceptionWithCause =
                DataStoreException("test message",
    ...
    fun serialize_GraphQLResponseExceptionException_with_extra_fields() {
        ...
        val graphqlException =
                DataStoreException.GraphQLResponseException("test message",
