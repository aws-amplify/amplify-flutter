...
library amplify_subpath_strategy_plugin_interface;

import 'package:amplify_core/amplify_core.dart';
import 'package:meta/meta.dart';

/// Defines Amplify Subpath Strategy plugin interface.
///
/// {@macro amplify_core.amplify_storage_category}
abstract class SubpathStrategyPluginInterface extends AmplifyPluginInterface {
  @override
  @nonVirtual
