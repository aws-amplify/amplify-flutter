...
library amplify_core.amplify_configuration_service.model.validation_exception_field; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
abstract class ValidationExceptionField
  ...
  static const List<_i2.SmithySerializer<ValidationExceptionField>>
      serializers = [ValidationExceptionFieldSerializer()];
...
class ValidationExceptionFieldSerializer
    extends _i2.StructuredSmithySerializer<ValidationExceptionField> {
  const ValidationExceptionFieldSerializer()
