...
library amplify_core.amplify_configuration_service.model.validation_exception; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class ValidationExceptionSerializer
    extends _i2.StructuredSmithySerializer<ValidationException> {
  const ValidationExceptionSerializer() : super('ValidationException');
