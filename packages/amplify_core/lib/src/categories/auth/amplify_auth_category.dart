...
class AuthCategory {
  ...
  AuthCategoryInterface? authPlugin;

  /// `Add plugin` method
  Future<void> addPlugin(AuthCategoryInterface plugin) async {
    if (authPlugin == null) {
  ...
  StreamController get streamController {
    if (authPlugin != null) {
      return authPlugin!.streamController;
    }
  ...
  Future<SignUpResult> signUp({
    ...
    if (authPlugin != null) {
      return authPlugin!.signUp(request: request);
    }
    throw _pluginNotAddedException('Auth');
  }
