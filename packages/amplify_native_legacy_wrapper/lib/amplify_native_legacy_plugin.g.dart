...
class LegacyNativePlugin {
  ...
  Future<void> configure(String arg_config) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.amplify_native_legacy_wrapper.LegacyNativePlugin.configure',
        codec,
  ...
  Future<void> signOut() async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.amplify_native_legacy_wrapper.LegacyNativePlugin.signOut',
        codec,
        binaryMessenger: _binaryMessenger);
  ...
  Future<void> signIn(String arg_username, String arg_password) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.amplify_native_legacy_wrapper.LegacyNativePlugin.signIn',
        codec,
        binaryMessenger: _binaryMessenger);
  ...
  Future<void> confirmSignIn(String arg_value) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.amplify_native_legacy_wrapper.LegacyNativePlugin.confirmSignIn',
        codec,
        binaryMessenger: _binaryMessenger);
    final List<Object?>? replyList =
