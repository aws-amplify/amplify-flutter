...
library aws_logging_cloudwatch.cloud_watch_logs.operation.describe_log_groups_operation; // ignore_for_file: no_leading_underscores_for_library_prefixes
...
class DescribeLogGroupsOperation extends _i1.PaginatedHttpOperation<
    _i2.DescribeLogGroupsRequest,
    _i2.DescribeLogGroupsRequest,
    _i3.DescribeLogGroupsResponse,
    _i3.DescribeLogGroupsResponse,
    String,
    int,
    _i4.BuiltList<_i5.LogGroup>> {
  /// Lists the specified log groups. You can list all your log groups or filter the results by prefix. The results are ASCII-sorted by log group name.
  ///
  /// CloudWatch Logs doesn’t support IAM policies that control access to the `DescribeLogGroups` action by using the `aws:ResourceTag/_key-name_` condition key. Other CloudWatch Logs actions do support the use of the `aws:ResourceTag/_key-name_` condition key to control access. For more information about using tags to control access, see [Controlling access to Amazon Web Services resources using tags](https://docs.aws.amazon.com/IAM/latest/UserGuide/access_tags.html).
  ///
  /// If you are using CloudWatch cross-account observability, you can use this operation in a monitoring account and view data from the linked source accounts. For more information, see [CloudWatch cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html).
  DescribeLogGroupsOperation({
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DescribeLogGroupsRequest,
          _i3.DescribeLogGroupsResponse,
          _i3.DescribeLogGroupsResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DescribeLogGroupsRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/';
      });
  @override
  int successCode([_i3.DescribeLogGroupsResponse? output]) => 200;
  @override
  _i3.DescribeLogGroupsResponse buildOutput(
    _i3.DescribeLogGroupsResponse payload,
    _i9.AWSBaseHttpResponse response,
  ) =>
      _i3.DescribeLogGroupsResponse.fromResponse(
        payload,
        response,
      );
  @override
  List<_i1.SmithyError> get errorTypes => const [
        ...
        _i1.SmithyError<_i12.ServiceUnavailableException,
  ...
  @override
  String get runtimeTypeName => 'DescribeLogGroups';
  @override
  ...
  @override
  _i1.SmithyOperation<_i3.DescribeLogGroupsResponse> run(
    _i2.DescribeLogGroupsRequest input, {
  ...
  @override
  String? getToken(_i3.DescribeLogGroupsResponse output) => output.nextToken;
  @override
  _i4.BuiltList<_i5.LogGroup> getItems(_i3.DescribeLogGroupsResponse output) =>
      output.logGroups ?? _i4.BuiltList();
  @override
  _i2.DescribeLogGroupsRequest rebuildInput(
    _i2.DescribeLogGroupsRequest input,
    String token,
    int? pageSize,
  ) =>
