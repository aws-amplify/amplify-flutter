...
library amplify_analytics_pinpoint_dart.pinpoint.operation.get_user_profiles_batch_operation;
...
class GetUserProfilesBatchOperation extends _i1.HttpOperation<
    _i2.UserProfilesGetRequest,
    _i3.GetUserProfilesBatchRequest,
    _i4.UserProfilesResponse,
    _i5.GetUserProfilesBatchResponse> {
  GetUserProfilesBatchOperation(
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i3.GetUserProfilesBatchRequest,
          _i4.UserProfilesResponse,
          _i5.GetUserProfilesBatchResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i3.GetUserProfilesBatchRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/v1/apps/{ApplicationId}/user-profiles/collection';
      });
  @override
  int successCode([_i5.GetUserProfilesBatchResponse? output]) => 200;
  @override
  _i5.GetUserProfilesBatchResponse buildOutput(
          _i4.UserProfilesResponse payload, _i9.AWSBaseHttpResponse response) =>
      _i5.GetUserProfilesBatchResponse.fromResponse(payload, response);
  @override
  ...
  @override
  _i18.Future<_i5.GetUserProfilesBatchResponse> run(
      _i3.GetUserProfilesBatchRequest input,
