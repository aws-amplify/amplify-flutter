...
library amplify_analytics_pinpoint_dart.pinpoint.model.alignment;

import 'package:smithy/smithy.dart' as _i1;

class Alignment extends _i1.SmithyEnum<Alignment> {
  const Alignment._(int index, String name, String value)
  ...
  static const List<_i1.SmithySerializer<Alignment>> serializers = [
    _i1.SmithyEnumSerializer('Alignment',
        values: values,
