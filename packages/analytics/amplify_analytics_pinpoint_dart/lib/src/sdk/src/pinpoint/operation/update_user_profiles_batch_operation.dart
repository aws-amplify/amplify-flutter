...
library amplify_analytics_pinpoint_dart.pinpoint.operation.update_user_profiles_batch_operation;
...
class UpdateUserProfilesBatchOperation extends _i1.HttpOperation<
    _i2.UserProfilesUpdateRequest,
    _i3.UpdateUserProfilesBatchRequest,
    _i4.UserProfilesUpdateResponse,
    _i5.UpdateUserProfilesBatchResponse> {
  UpdateUserProfilesBatchOperation(
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i3.UpdateUserProfilesBatchRequest,
          _i4.UserProfilesUpdateResponse,
          _i5.UpdateUserProfilesBatchResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i3.UpdateUserProfilesBatchRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'POST';
        b.path = r'/v1/apps/{ApplicationId}/user-profiles';
      });
  @override
  int successCode([_i5.UpdateUserProfilesBatchResponse? output]) => 200;
  @override
  _i5.UpdateUserProfilesBatchResponse buildOutput(
          _i4.UserProfilesUpdateResponse payload,
          _i9.AWSStreamedHttpResponse response) =>
      _i5.UpdateUserProfilesBatchResponse.fromResponse(payload, response);
  @override
  ...
  @override
  _i18.Future<_i5.UpdateUserProfilesBatchResponse> run(
      _i3.UpdateUserProfilesBatchRequest input,
