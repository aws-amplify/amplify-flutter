...
abstract class PayloadTooLargeException
  ...
  /// Provides information about an API request or response.
  factory PayloadTooLargeException({
    String? message,
    String? requestId,
  }) {
    return _$PayloadTooLargeException._(
      message: message,
      requestId: requestId,
    );
  }
...
class PayloadTooLargeExceptionRestJson1Serializer
    extends _i2.StructuredSmithySerializer<PayloadTooLargeException> {
  const PayloadTooLargeExceptionRestJson1Serializer()
