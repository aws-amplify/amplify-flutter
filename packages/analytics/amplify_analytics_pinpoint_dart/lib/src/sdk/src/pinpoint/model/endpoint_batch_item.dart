...
library amplify_analytics_pinpoint_dart.pinpoint.model.endpoint_batch_item;
...
abstract class EndpointBatchItem
  ...
  static const List<_i7.SmithySerializer> serializers = [
    _EndpointBatchItemRestJson1Serializer()
  ];
...
class _EndpointBatchItemRestJson1Serializer
    extends _i7.StructuredSmithySerializer<EndpointBatchItem> {
  const _EndpointBatchItemRestJson1Serializer() : super('EndpointBatchItem');
