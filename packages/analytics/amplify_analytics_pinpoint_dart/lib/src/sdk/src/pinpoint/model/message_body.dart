...
library amplify_analytics_pinpoint_dart.pinpoint.model.message_body;
...
abstract class MessageBody
  ...
  /// Provides information about an API request or response.
  factory MessageBody({String? message, String? requestId}) {
    return _$MessageBody._(message: message, requestId: requestId);
  }
  ...
  static const List<_i2.SmithySerializer> serializers = [
    _MessageBodyRestJson1Serializer()
  ];
...
class _MessageBodyRestJson1Serializer
    extends _i2.StructuredSmithySerializer<MessageBody> {
  const _MessageBodyRestJson1Serializer() : super('MessageBody');

  @override
  Iterable<Type> get types => const [MessageBody, _$MessageBody];
  @override
  Iterable<_i2.ShapeId> get supportedProtocols =>
      const [_i2.ShapeId(namespace: 'aws.protocols', shape: 'restJson1')];
  @override
  MessageBody deserialize(Serializers serializers, Iterable<Object?> serialized,
