...
library amplify_analytics_pinpoint_dart.pinpoint.model.method_not_allowed_exception;
...
abstract class MethodNotAllowedException
  ...
  /// Provides information about an API request or response.
  factory MethodNotAllowedException({String? message, String? requestId}) {
  ...
  static const List<_i2.SmithySerializer> serializers = [
    _MethodNotAllowedExceptionRestJson1Serializer()
  ];
  ...
  _i2.ShapeId get shapeId => const _i2.ShapeId(
      namespace: 'com.amazonaws.pinpoint', shape: 'MethodNotAllowedException');
  @override
...
class _MethodNotAllowedExceptionRestJson1Serializer
    extends _i2.StructuredSmithySerializer<MethodNotAllowedException> {
  const _MethodNotAllowedExceptionRestJson1Serializer()
      : super('MethodNotAllowedException');

  @override
  Iterable<Type> get types =>
      const [MethodNotAllowedException, _$MethodNotAllowedException];
  @override
