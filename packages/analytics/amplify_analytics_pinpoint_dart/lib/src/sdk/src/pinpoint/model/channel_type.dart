...
library amplify_analytics_pinpoint_dart.pinpoint.model.channel_type;

import 'package:smithy/smithy.dart' as _i1;

class ChannelType extends _i1.SmithyEnum<ChannelType> {
  const ChannelType._(int index, String name, String value)
  ...
  static const apnsVoipSandbox =
      ChannelType._(4, 'APNS_VOIP_SANDBOX', 'APNS_VOIP_SANDBOX');
  ...
  static const List<_i1.SmithySerializer<ChannelType>> serializers = [
    _i1.SmithyEnumSerializer('ChannelType',
        values: values,
