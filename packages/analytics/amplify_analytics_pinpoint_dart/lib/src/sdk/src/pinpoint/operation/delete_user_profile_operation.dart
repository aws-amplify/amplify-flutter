...
library amplify_analytics_pinpoint_dart.pinpoint.operation.delete_user_profile_operation;
...
class DeleteUserProfileOperation extends _i1.HttpOperation<
    _i2.DeleteUserProfileRequestPayload,
    _i2.DeleteUserProfileRequest,
    _i3.UserProfileUpdateResponse,
    _i4.DeleteUserProfileResponse> {
  ...
  late final List<
      _i1.HttpProtocol<
          ...
          _i2.DeleteUserProfileRequest,
          _i3.UserProfileUpdateResponse,
          _i4.DeleteUserProfileResponse>> protocols = [
  ...
  @override
  _i1.HttpRequest buildRequest(_i2.DeleteUserProfileRequest input) =>
      _i1.HttpRequest((b) {
        b.method = 'DELETE';
        b.path = r'/v1/apps/{ApplicationId}/user-profiles/{UserId}';
        if (input.deleteEndpoints != null) {
          b.queryParameters
              .add('delete-endpoints', input.deleteEndpoints!.toString());
        }
      });
  @override
  int successCode([_i4.DeleteUserProfileResponse? output]) => 200;
  @override
  _i4.DeleteUserProfileResponse buildOutput(
          _i3.UserProfileUpdateResponse payload,
          _i8.AWSBaseHttpResponse response) =>
      _i4.DeleteUserProfileResponse.fromResponse(payload, response);
  @override
  ...
  @override
  _i1.Future<SmithyOperation<_i4.DeleteUserProfileResponse>> run(
      _i2.DeleteUserProfileRequest input,
