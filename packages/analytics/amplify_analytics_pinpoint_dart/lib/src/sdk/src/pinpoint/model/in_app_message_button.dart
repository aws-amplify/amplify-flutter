...
library amplify_analytics_pinpoint_dart.pinpoint.model.in_app_message_button;
...
abstract class InAppMessageButton
  ...
  factory InAppMessageButton(
    ...
    return _$InAppMessageButton._(
        android: android, defaultConfig: defaultConfig, ios: ios, web: web);
  }
  ...
  static const List<_i4.SmithySerializer> serializers = [
    _InAppMessageButtonRestJson1Serializer()
  ];
  ...
  String toString() {
    ...
    helper.add('android', android);
    helper.add('defaultConfig', defaultConfig);
    helper.add('ios', ios);
    helper.add('web', web);
...
class _InAppMessageButtonRestJson1Serializer
    extends _i4.StructuredSmithySerializer<InAppMessageButton> {
  const _InAppMessageButtonRestJson1Serializer() : super('InAppMessageButton');
        ...
        case 'Android':
          if (value != null) {
            result.android.replace((serializers.deserialize(value,
                    specifiedType:
                        const FullType(_i2.OverrideButtonConfiguration))
                as _i2.OverrideButtonConfiguration));
          }
          break;
        case 'DefaultConfig':
          if (value != null) {
            result.defaultConfig.replace((serializers.deserialize(value,
                    specifiedType:
                        const FullType(_i3.DefaultButtonConfiguration))
  ...
  Iterable<Object?> serialize(Serializers serializers, Object? object,
    ...
    if (payload.android != null) {
      result
        ..add('Android')
        ..add(serializers.serialize(payload.android!,
            specifiedType: const FullType(_i2.OverrideButtonConfiguration)));
    }
    if (payload.defaultConfig != null) {
      result
        ..add('DefaultConfig')
        ..add(serializers.serialize(payload.defaultConfig!,
            specifiedType: const FullType(_i3.DefaultButtonConfiguration)));
    }
    if (payload.ios != null) {
      result
        ..add('IOS')
        ..add(serializers.serialize(payload.ios!,
            specifiedType: const FullType(_i2.OverrideButtonConfiguration)));
    }
    if (payload.web != null) {
      result
        ..add('Web')
        ..add(serializers.serialize(payload.web!,
            specifiedType: const FullType(_i2.OverrideButtonConfiguration)));
    }
    return result;
  }
