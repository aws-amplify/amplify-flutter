...
TestEvent _$TestEventFromJson(Map<String, dynamic> json) => TestEvent(
      ...
      eventTimestamp: const _DateTimeSerializer()
          .fromJson((json['event_timestamp'] as num).toInt()),
      arrivalTimestamp: const _DateTimeSerializer()
          .fromJson((json['arrival_timestamp'] as num).toInt()),
...
TestSession _$TestSessionFromJson(Map<String, dynamic> json) => TestSession(
      ...
      startTimestamp: const _DateTimeSerializer()
          .fromJson((json['start_timestamp'] as num).toInt()),
