...
class AmplifyClass extends PlatformInterface implements AmplifyFlutterDart {
  ...
  /// to check the configuration state by calling `Amplify.isConfigured`
  @override
  Future<void> addPlugins(List<AmplifyCategoryInterface> plugins) =>
  ...
  /// MethodChannel is default _instance
