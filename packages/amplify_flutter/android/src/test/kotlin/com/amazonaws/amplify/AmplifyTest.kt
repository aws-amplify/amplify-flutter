...
@RunWith(RobolectricTestRunner::class) class AmplifyTest {
    ...
    @Test fun configure_throwExceptionOnSecondCall() {
        // Setup
        val arguments: HashMap<String, Any> =
            hashMapOf("version" to "1", "configuration" to "{\"testKey\": \"test value\"}")
