...
void main() {
  ...
  test('CredentialsProvider.CognitoIdentity should be instantiated', () async {
    ...
    var credentialProvider = amplify.config.auth!.awsCognitoAuthPlugin!
  ...
  test('CognitoUserPool should be instantiated', () async {
    await amplify.configure(allResources);
    var userpool =
        amplify.config.auth!.awsCognitoAuthPlugin!.userPool!['Default'];
  ...
  test('Auth block should be instantiated', () async {
    await amplify.configure(allResources);
    var auth = amplify.config.auth!.awsCognitoAuthPlugin!.auth!['Default'];
  ...
  test('AppSync should be instantiated', () async {
    await amplify.configure(allResources);
    var appsync =
        amplify.config.auth!.awsCognitoAuthPlugin!.appSync!['Default'];
  ...
  test('S3TransferUtility should be instantiated', () async {
    await amplify.configure(allResources);
    var s3 = amplify
        .config.auth!.awsCognitoAuthPlugin!.s3TransferUtility!['Default'];
  ...
  test('CredentialsProvider.CognitoIdentity should be null', () async {
    ...
    var credentialProvider =
        amplify.config.auth!.awsCognitoAuthPlugin!.credentialProvider;
  ...
  test('AppSync should be null', () async {
    await amplify.configure(userpoolOnly);
    var appsync = amplify.config.auth!.awsCognitoAuthPlugin!.appSync;
    expect(appsync, null);
  });

  test('PinpointAnalytics should be null', () async {
    await amplify.configure(userpoolOnly);
    var pinpoint = amplify.config.auth!.awsCognitoAuthPlugin!.pinpointAnalytics;
    expect(pinpoint, null);
  });

  test('PinpointTargeting should be null', () async {
    await amplify.configure(userpoolOnly);
    var pinpoint = amplify.config.auth!.awsCognitoAuthPlugin!.pinpointTargeting;
    expect(pinpoint, null);
  });

  test('S3TransferUtility should be null', () async {
    await amplify.configure(userpoolOnly);
    var s3 = amplify.config.auth!.awsCognitoAuthPlugin!.s3TransferUtility;
    expect(s3, null);
  });
}
