        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t3 = type$.String;
              category = A.IterableExtension_firstWhereOrNull(A._setArrayType(["canaries", "analytics", "api", "auth", "authenticator", "core", "datastore", "db_common", "push", "secure_storage", "storage", "aws_common", "aws_signature_v4", "smithy", "worker_bee", "amplify_flutter", "amplify_foundation_dart_bridge", "amplify_foundation_dart", "amplify_lints", "amplify_native_legacy_wrapper", "kinesis", "event_enrichment", "connect_client", "pub_server"], t2), B.JSString_methods.get$contains(workingDirectory), t3);
              if (category == null)
