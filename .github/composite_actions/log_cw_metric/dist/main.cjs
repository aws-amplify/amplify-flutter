...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    logMetric() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        metricName, testType, workingDirectory, category, t5, t6, framework, flutterDartChannel, dartVersion, flutterVersion, dartCompiler, platform, platformVersion, value, cloudArgs, t1, t2, jobStatus, inputValue, matrixRawInput, matrixValues, t3, t4, jobIdentifier;
  ...
  (function installTearOffs() {
    ...
    _instance(J.JSString.prototype, "get$contains", 1, 1, null, ["call$2", "call$1"], ["contains$2", "contains$1"], 37, 0, 0);
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 68, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 71, 0);
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 72, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 73, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 74, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 75, 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 27);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 60, 0, 0);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Future<~>()", "Trace()", "Frame()", "Frame(String)", "Null()", "Null(@)", "String(String)", "~(~())", "~(Uint8List,String,int)", "@(@)", "Null(Object,StackTrace)", "~(Object?)", "@()", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "Trace(String)", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "~(@)", "String(Frame)", "@(String)", "String(Match)", "int(Frame)", "~(String)", "~(@,StackTrace?)", "Null(@,@)", "Object?(Object?)", "Future<0&>()", "Future<~>(Object,Chain)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "bool(Pattern[int])", "~(List<int>)", "Uint8List(@,@)", "@(@,String)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "Null(~())", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "int(int,int)", "List<Frame>(Trace)", "int(Trace)", "0^(0^,0^)<num>", "String(Trace)", "~(String,int?)", "~(String,int)", "Frame(String,String)", "_LineSplitterEventSink(EventSink<String>)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "~(Object?,Object?)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "~(@,@)", "Chain()", "String?(String)", "String(MapEntry<String,String>)", "Null(@,StackTrace)", "Future<0^>([0^/?])<Object?>", "~(Object?[Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "~(int,@)", "_Future<@>(@)", "0&(JSObject)"],
