...
(function dartProgram() {
  ...
  (function installTearOffs() {
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 41);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Trace()", "Frame()", "Frame(String)", "Null()", "~(@)", "Future<~>()", "Null(@)", "~(~())", "String(String)", "String(Frame)", "Null(Object,StackTrace)", "~(Object?)", "~(@,@)", "@()", "@(@)", "~(Uint8List,String,int)", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "int(Frame)", "String(Match)", "~(String,@)", "@(String)", "Trace(String)", "~(String)", "Object?(Object?)", "Future<Null>()", "Future<0&>()", "@(@,String)", "Future<~>(Object,Chain)", "GithubJob(@)", "GithubStep(@)", "~(Uint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "~(@,StackTrace?)", "~(List<int>)", "0&(JSObject)", "Uint8List(@,@)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "int(int,int)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "Null(@,StackTrace)", "List<Frame>(Trace)", "int(Trace)", "~(String,int?)", "String(Trace)", "0^(0^,0^)<num>", "~(int,@)", "Frame(String,String)", "~(String,int)", "~(Symbol0,@)", "_LineSplitterEventSink(EventSink<String>)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "Chain()", "String?(String)", "String(MapEntry<String,String>)", "bool(GithubJob)", "0&()", "String(GithubJob)", "bool(GithubStep)", "Null(@,@)", "Future<0^>([0^/?])<Object?>", "~(Object?[Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "~(Object?,Object?)", "Null(~())", "_Future<@>(@)"],
