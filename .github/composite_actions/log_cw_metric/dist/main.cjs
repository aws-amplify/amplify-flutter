...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t4 = dimensions.$ti._eval$1("LinkedHashMapEntriesIterable<1,2>");
  ...
  A.JsLinkedHashMap.prototype = {
    ...
    get$values() {
      return new A.LinkedHashMapValuesIterable(this, this.$ti._eval$1("LinkedHashMapValuesIterable<2>"));
    },
    containsKey$1(key) {
  ...
  (function installTearOffs() {
    ...
    _instance(J.JSString.prototype, "get$contains", 1, 1, null, ["call$2", "call$1"], ["contains$2", "contains$1"], 34, 0, 0);
    ...
    _instance(_, "get$_registerBinaryCallback", 0, 4, null, ["call$3$4", "call$4"], ["_registerBinaryCallback$3$4", "_registerBinaryCallback$4"], 18, 0, 0);
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 57, 0, 0);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Future<~>()", "Frame()", "Trace()", "Frame(String)", "Null()", "Null(@)", "~(~())", "String(String)", "Trace(String)", "@(String)", "~(@)", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "@(@)", "Null(Object,StackTrace)", "~(Object?)", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "@()", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "String(Frame)", "String(Match)", "int(Frame)", "~(String)", "Object?(Object?)", "Future<0&>()", "Future<~>(Object,Chain)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "bool(Pattern[int])", "~(List<int>)", "0&(JSObject)", "~(@,StackTrace?)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "int(int,int)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "~(String,int?)", "List<Frame>(Trace)", "int(Trace)", "0^(0^,0^)<num>", "String(Trace)", "~(String,int)", "_LineSplitterEventSink(EventSink<String>)", "Frame(String,String)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "~(Object?,Object?)", "~(@,@)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "~(int,@)", "Chain()", "String?(String)", "String(MapEntry<String,String>)", "Null(@,StackTrace)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Null(~())", "@(@,String)", "Null(@,@)"],
