        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t4 = type$.String;
              category = A.IterableExtension_firstWhereOrNull(A._setArrayType(["canaries", "analytics", "api", "auth", "authenticator", "core", "datastore", "db_common", "logging", "push", "secure_storage", "storage", "aws_common", "aws_signature_v4", "smithy", "worker_bee", "amplify_flutter", "amplify_lints", "amplify_native_legacy_wrapper", "pub_server"], t3), B.JSString_methods.get$contains(workingDirectory), t4);
              if (category == null)
