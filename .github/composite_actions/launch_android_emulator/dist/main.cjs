...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ChildProcess_execSync(_this, command, args, echoOutput, environment, includeParentEnvironment, runInShell, workingDirectory) {
      ...
      try {
        ...
        J.add$1$ax(t4, null);
        J.add$1$ax(t4, null);
        stdout = A.callMethod(_this, "execSync", [t1, {cwd: workingDirectory, env: t2, stdio: type$.JSArray_nullable_Object._as(t4), shell: null, encoding: "buffer"}], type$.nullable_NativeUint8List);
        t1 = stdout;
        if (t1 == null)
          t1 = null;
        if (t1 == null)
    ...
    EventEmitter_once(_this, eventName, $T) {
      var t1 = new A._Future($.Zone__current, $T._eval$1("_Future<0>"));
      A.callMethod(_this, "once", [eventName, type$.JavaScriptFunction._as(A.allowInterop(new A.EventEmitter_once_closure(new A._AsyncCompleter(t1, $T._eval$1("_AsyncCompleter<0>")), $T), type$.Function))], type$.void);
      return t1;
    },
    ...
    Process_get_env(_this) {
      ...
      t1 = type$.JSObject;
      t2 = A.callMethod(self.Object, "getOwnPropertyNames", [t1._as(_this.env)], type$.JSArray_nullable_Object);
  ...
  A._StreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      subscription = new A._ControllerSubscription(_this, t5, t6, t2.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t4), t2, t3, t1._eval$1("_ControllerSubscription<1>"));
  ...
  A._Utf8StringSinkAdapter.prototype = {
    ...
    addSlice$4(codeUnits, startIndex, endIndex, isLast) {
      this._stringSink._contents += this._decoder._convertGeneral$4(type$.List_int._as(codeUnits), startIndex, endIndex, false);
      if (isLast)
        this.close$0();
    }
  };
  A._Utf8ConversionSink.prototype = {
    ...
    addSlice$4(chunk, startIndex, endIndex, isLast) {
      var accumulated, _this = this,
        t1 = _this._buffer,
        t2 = t1._contents += _this._decoder._convertGeneral$4(type$.List_int._as(chunk), startIndex, endIndex, false);
      if (t2.length !== 0) {
        accumulated = t2.charCodeAt(0) == 0 ? t2 : t2;
  ...
  A.NodeReadableStream_get_stream_closure.prototype = {
    call$0() {
      var _this = this,
        t1 = _this._this,
        t2 = type$.void;
      A.callMethod(t1, "addListener", ["data", type$.JavaScriptFunction._as(A.allowInterop(_this.onData, type$.Function))], t2);
  ...
  A.NodeReadableStream_get_stream_closure0.prototype = {
    call$0() {
      return A.callMethod(this._this, "removeListener", ["data", type$.JavaScriptFunction._as(A.allowInterop(this.onData, type$.Function))], type$.void);
    },
    $signature: 0
  };
  ...
  A.NodeProcess.prototype = {
    ...
    _init$body$NodeProcess() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t2, t3, _0_0, t4, t5, _1_0, _2_0, t1;
  ...
  A.NodeProcess__init_closure.prototype = {
    call$1(chunk) {
      type$.List_int._as(chunk);
      A.callMethod(this._box_0.stdin, "write", [new Uint8Array(A._ensureNativeList(chunk))], type$.void);
    },
    $signature: 54
  };
  ...
  A.MultiSectionMapping.prototype = {
    MultiSectionMapping$fromJson$3$mapUrl(sections, otherMaps, mapUrl) {
      ...
      for (t1 = J.cast$1$0$ax(sections, type$.Map_dynamic_dynamic), t2 = A._instanceType(t1), t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListBase.E>")), t3 = this._maps, t4 = this._parser$_lineStart, t5 = this._columnStart, t6 = type$.nullable_Map_dynamic_dynamic, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
