...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Record_3_error_stackTrace_success: function _Record_3_error_stackTrace_success(t0, t1, t2) {
      this._0 = t0;
      this._1 = t1;
      this._2 = t2;
    },
    ...
    Future_any(futures, $T) {
      ...
      for (t2 = futures.length, t3 = type$.void, _i = 0; _i < futures.length; futures.length === t2 || (0, A.throwConcurrentModificationError)(futures), ++_i)
        futures[_i].then$1$2$onError(onValue, onError, t3);
      return t1;
    },
    ...
    _rootFork($self, $parent, zone, specification, zoneValues) {
      var t1, valueMap, _3_0, _4_0, _5_0, _6_0, _12_0;
      if (zoneValues != null) {
        t1 = type$.nullable_Object;
        valueMap = A.HashMap_HashMap(t1, t1);
      ...
      if (specification != null) {
        _3_0 = specification.registerCallback;
        if (_3_0 != null)
          t1._async$_registerCallback = new A._ZoneRegisterCallback(t1, _3_0);
        _4_0 = specification.registerUnaryCallback;
        if (_4_0 != null)
          t1._async$_registerUnaryCallback = new A._ZoneRegisterUnaryCallback(t1, _4_0);
        _5_0 = specification.registerBinaryCallback;
        if (_5_0 != null)
          t1._async$_registerBinaryCallback = new A._ZoneRegisterBinaryCallback(t1, _5_0);
        _6_0 = specification.errorCallback;
        if (_6_0 != null)
          t1._async$_errorCallback = new A._ZoneErrorCallback(t1, _6_0);
        _12_0 = specification.handleUncaughtError;
        if (_12_0 != null)
          t1._async$_handleUncaughtError = new A._ZoneHandleUncaughtError(t1, _12_0);
      }
      if (valueMap != null)
        t1._zoneValues = new A._ZoneValues(t1, valueMap);
      return t1;
    },
    ...
    _LineSplitterEventSink___new_tearOff(eventSink) {
      type$.EventSink_String._as(eventSink);
      return new A._LineSplitterEventSink(eventSink, new A._StringAdapterSink(eventSink));
    },
    ...
    SdkManager__sdkmanager(args) {
      return A.SdkManager__sdkmanager$body(args);
    },
    SdkManager__sdkmanager$body(args) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.ProcessResult),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], error, t3, exception, attempt, t1, t2, $async$exception;
      var $async$SdkManager__sdkmanager = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1) {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$handler = 6;
              $async$goto = 9;
              return A._asyncAwait($.$get$SdkManager__sdkmanagerTool().call$1(args), $async$SdkManager__sdkmanager);
            case 9:
              // returning from await.
              t3 = $async$result;
            ...
            case 6:
              ...
              A._asJSObject(t1.core).warning("sdkmanager " + B.JSArray_methods.join$1(args, " ") + " failed (attempt " + A.S(attempt) + "/3), retrying in 5s...\n" + A.S(error));
              $async$goto = 10;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_5000000, t2), $async$SdkManager__sdkmanager);
            case 10:
              // returning from await.
              // goto after finally
              $async$goto = 8;
      ...
      return A._asyncStartSync($async$SdkManager__sdkmanager, $async$completer);
    },
    ...
    SdkManager__ensureBuildTools_closure5: function SdkManager__ensureBuildTools_closure5() {
    },
    SdkManager__ensureBuildTools_closure6: function SdkManager__ensureBuildTools_closure6(t0) {
      this.targetTriplet = t0;
    },
    AndroidAbi_parse(value) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_Lmb, new A.AndroidAbi_parse_closure(value), new A.AndroidAbi_parse_closure0(value));
    },
    AndroidAbi_forArch(arch) {
      var t1;
      switch (arch.index) {
        case 1:
          t1 = B.AndroidAbi_x86_64_1_x86_64;
          break;
        case 0:
          t1 = B.AndroidAbi_gFU;
          break;
    ...
    AndroidAbi_allAbis() {
      ...
      t1 = A.List_List$_of(new A.MappedListIterable(B.List_Lmb, type$.String_Function_AndroidAbi._as(new A.AndroidAbi_allAbis_closure()), t1), t1._eval$1("ListIterable.E"));
      return t1;
    },
    AndroidApiLevel_parse(apiLevel) {
      ...
      if (levelInt == null)
        t1.call$0();
      return B.JSArray_methods.firstWhere$2$orElse(B.List_qUS, new A.AndroidApiLevel_parse_closure(levelInt), t1);
    },
    AndroidApiLevel_allApiLevels() {
      var t1 = type$.MappedListIterable_AndroidApiLevel_int;
      t1 = A.List_List$_of(new A.MappedListIterable(B.List_qUS, type$.int_Function_AndroidApiLevel._as(new A.AndroidApiLevel_allApiLevels_closure()), t1), t1._eval$1("ListIterable.E"));
      return t1;
    },
    AndroidSystemImageTarget_parse(target) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_8Vc, new A.AndroidSystemImageTarget_parse_closure(target), new A.AndroidSystemImageTarget_parse_closure0(target));
    },
    AndroidSystemImageTarget_allTags() {
      var t1 = type$.MappedListIterable_AndroidSystemImageTarget_String;
      t1 = A.List_List$_of(new A.MappedListIterable(B.List_8Vc, type$.String_Function_AndroidSystemImageTarget._as(new A.AndroidSystemImageTarget_allTags_closure()), t1), t1._eval$1("ListIterable.E"));
      return t1;
    },
    AndroidAbi: function AndroidAbi(t0, t1, t2) {
      this.abi = t0;
      this.index = t1;
      this._name = t2;
    },
    ...
    AndroidApiLevel: function AndroidApiLevel(t0, t1, t2) {
      this.level = t0;
      this.index = t1;
      this._name = t2;
    },
    ...
    AndroidSystemImageTarget: function AndroidSystemImageTarget(t0, t1, t2) {
      this.tag = t0;
      this.index = t1;
      this._name = t2;
    },
    ...
    ChildProcess_execSync(_this, command, args, echoOutput, environment, includeParentEnvironment, runInShell, workingDirectory) {
      ...
      try {
        ...
        if (t3 != null)
          J.addAll$1$ax(t2, t3);
        J.addAll$1$ax(t2, A.Process_get_env(A._asJSObject(init.G.process)));
        t2 = A._asJSObject(A.jsify(t2));
        t4 = [null];
        J.add$1$ax(t4, null);
        J.add$1$ax(t4, null);
    ...
    ChildProcess_spawn(_this, command, args, environment, includeParentEnvironment, mode, runInShell, stdin, workingDirectory) {
      ...
      t2 = A.List_List$_of(new A.MappedListIterable(args, t2._eval$1("String(1)")._as(new A.ChildProcess_spawn_closure()), t3), t3._eval$1("ListIterable.E"));
      t3 = type$.String;
      t3 = A.LinkedHashMap_LinkedHashMap$_empty(t3, t3);
      t3.addAll$1(0, A.Process_get_env(A._asJSObject(init.G.process)));
      t3 = A._asJSObject(A.jsify(t3));
      t4 = mode === B.ProcessStartMode_2 || mode === B.ProcessStartMode_3;
      t1 = A._setArrayType([stdin == null ? t1 : stdin, t1, t1], type$.JSArray_Object);
      return A._asJSObject(_this.spawn(command, t2, {cwd: workingDirectory, env: t3, stdio: t1, detached: t4, shell: null}));
    },
    ...
    EventEmitter_once(_this, eventName, $T) {
      var result,
        t1 = new A._Future($.Zone__current, $T._eval$1("_Future<0>")),
        t2 = new A.EventEmitter_once_closure(new A._AsyncCompleter(t1, $T._eval$1("_AsyncCompleter<0>")), $T);
    ...
    OS: function OS(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    Arch: function Arch(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    ShellScript_start(_this) {
      var running = new A.RunningScript(),
        t1 = A.ShellScript__run(_this, running);
    ...
    parseJson(map, mapUrl, otherMaps) {
      ...
      if (map.containsKey$1(_s8_)) {
        if (map.containsKey$1("mappings") || map.containsKey$1("sources") || map.containsKey$1("names"))
          throw A.wrapException(B.FormatException_BnX);
    ...
    SingleMapping$fromJson(map, mapUrl) {
      var t8,
        t1 = map._source,
        t2 = map.$ti._eval$1("4?"),
        t3 = A._asStringQ(t2._as(t1.$index(0, "file"))),
        t4 = type$.List_dynamic,
        t5 = type$.String,
        t6 = A.List_List$from(t4._as(t2._as(t1.$index(0, "sources"))), true, t5),
        t7 = type$.nullable_List_dynamic._as(t2._as(t1.$index(0, "names")));
      t7 = A.List_List$from(t7 == null ? [] : t7, true, t5);
      t4 = A.List_List$filled(J.get$length$asx(t4._as(t2._as(t1.$index(0, "sources")))), null, false, type$.nullable_SourceFile);
      t1 = A._asStringQ(t2._as(t1.$index(0, "sourceRoot")));
      t2 = A._setArrayType([], type$.JSArray_TargetLineEntry);
      t8 = typeof mapUrl == "string" ? A.Uri_parse(mapUrl) : type$.nullable_Uri._as(mapUrl);
      t5 = new A.SingleMapping(t6, t7, t4, t2, t3, t1, t8, A.LinkedHashMap_LinkedHashMap$_empty(t5, type$.dynamic));
      t5.SingleMapping$fromJson$2$mapUrl(map, mapUrl);
      return t5;
    },
    ...
    Chain_capture(callback, onError, $T) {
      ...
      return A.runZoned(new A.Chain_capture_closure(callback, $T), new A.ZoneSpecification(spec.get$_handleUncaughtError(), _null, _null, _null, spec.get$_registerCallback(), spec.get$_registerUnaryCallback(), spec.get$_registerBinaryCallback(), spec.get$_errorCallback(), _null, _null, _null, _null, _null), t1, $T);
    },
    ...
    _action() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], launchResult, avdManager, e, st, t3, t4, t5, t6, t7, lastError, attempt, t8, t9, t10, exception, testResult, t1, apiLevel, target, abi, inputValue, script, t2, maxRetries, retryTimeoutMinutes, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              apiLevel = A.Core_getTypedInput(A._asJSObject(t1.core), "api-level", null, A.types_AndroidApiLevel_parse$closure(), type$.AndroidApiLevel);
              target = A.Core_getTypedInput(A._asJSObject(t1.core), "target", null, A.types_AndroidSystemImageTarget_parse$closure(), type$.AndroidSystemImageTarget);
              abi = A.Core_getTypedInput(A._asJSObject(t1.core), "abi", A.AndroidAbi_forArch(A.Process_get_arch(A._asJSObject(t1.process))), A.types_AndroidAbi_parse$closure(), type$.AndroidAbi);
              inputValue = A._asString(A._asJSObject(t1.core).getInput("script"));
              script = inputValue.length === 0 ? A.throwExpression(A.StateError$('Input "script" was required but no value was passed')) : inputValue;
              t2 = type$.int;
              maxRetries = A.Core_getTypedInput(A._asJSObject(t1.core), "max-retries", 1, A.core_int_parse$closure(), t2);
              retryTimeoutMinutes = A.Core_getTypedInput(A._asJSObject(t1.core), "retry-timeout-minutes", 30, A.core_int_parse$closure(), t2);
              $async$goto = 3;
              return A._asyncAwait(new A.SdkManager(apiLevel, target, abi).ensureSdk$0(), $async$_action);
            case 3:
              // returning from await.
              t2 = A.S(retryTimeoutMinutes), t3 = "\ud83d\udcdc Running tests (timeout: " + t2 + " min)...", t4 = type$._AttemptResult, t5 = A.S(maxRetries), t2 = "   Timeout: " + t2 + " minutes", t6 = type$.void, t7 = type$.nullable_StackTrace, lastError = null, attempt = 1;
            case 4:
              // for condition
              ...
              t8 = Date.now();
              t9 = A._asJSObject(t1.core);
              t9.info("");
              t9.info(string$.u2550_____);
              t10 = "" + attempt;
              t9.info("\ud83d\ude80 ATTEMPT " + t10 + " OF " + t5 + " - STARTING");
              t9.info(t2);
              t9.info("   Started at: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
              t9.info(string$.u2550_____);
              t9.info("");
              launchResult = null;
              $async$handler = 8;
              avdManager = new A.AvdManager(apiLevel, target, abi, "test");
              $async$goto = 11;
              return A._asyncAwait(avdManager.launchEmulator$0(), $async$_action);
            case 11:
              // returning from await.
              A._asJSObject(t1.core).info("\u2705 Emulator launched successfully");
              launchResult = new A._Record_3_error_stackTrace_success(null, null, true);
              $async$handler = 2;
              // goto after finally
              $async$goto = 10;
              break;
            case 8:
              ...
              A._asJSObject(t1.core).warning("\u274c Emulator launch failed: " + A.S(e));
              launchResult = new A._Record_3_error_stackTrace_success(e, st, false);
              // goto after finally
              $async$goto = 10;
              break;
            case 7:
            ...
            case 10:
              // after finally
              $async$goto = !launchResult._2 ? 12 : 13;
              break;
            case 12:
              // then
              lastError = launchResult._0;
              t7._as(launchResult._1);
              t8 = A._asJSObject(t1.core);
              t8.warning("");
              t8.warning(string$.u2550_____);
              t8.warning("\u274c ATTEMPT " + t10 + " FAILED - Emulator launch failed");
              t8.warning("   Error: " + A.S(launchResult._0));
              t8.warning("   Time: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
              t8.warning(string$.u2550_____);
              t8.warning("");
              $async$goto = attempt < maxRetries ? 14 : 15;
              break;
            case 14:
              // then
              $async$goto = 16;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "\ud83e\uddf9 Attempt " + t10 + ": Cleanup before retry " + (attempt + 1), A.launch_android_emulator___cleanupAndWait$closure(), t6), $async$_action);
            case 16:
              // returning from await.
            case 15:
              // join
            ...
            case 13:
              ...
              t9.info("");
              $async$goto = 17;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "\u25b6\ufe0f Attempt " + t10 + ": Run tests", new A._action_closure(retryTimeoutMinutes, attempt, script), t4), $async$_action);
            case 17:
              // returning from await.
              testResult = $async$result;
              t8 = 1000 * (Date.now() - t8);
              if (testResult.success) {
                t2 = A._asJSObject(t1.core);
                t2.info("");
                t2.info(string$.u2550_____);
                t2.info("\u2705 ATTEMPT " + t10 + " SUCCEEDED");
                t2.info("   Duration: " + B.JSInt_methods._tdivFast$1(t8, 60000000) + " minutes " + B.JSInt_methods.$mod(B.JSInt_methods._tdivFast$1(t8, 1000000), 60) + " seconds");
                t2.info("   Finished at: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
                t2.info(string$.u2550_____);
                t2.info("");
                // goto return
                $async$goto = 1;
              ...
              if (testResult.timedOut) {
                t9 = A._asJSObject(t1.core);
                t9.warning("");
                t9.warning(string$.u2550_____);
                t9.warning("\u23f0 ATTEMPT " + t10 + " TIMED OUT");
                t9.warning("   Duration: " + B.JSInt_methods._tdivFast$1(t8, 60000000) + " minutes " + B.JSInt_methods.$mod(B.JSInt_methods._tdivFast$1(t8, 1000000), 60) + " seconds");
                t9.warning("   Time: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
                t9.warning(string$.u2550_____);
                t9.warning("");
              } else {
                t9 = A._asJSObject(t1.core);
                t9.warning("");
                t9.warning(string$.u2550_____);
                t9.warning("\u274c ATTEMPT " + t10 + " FAILED - Tests failed");
                t9.warning("   Error: " + A.S(lastError));
                t9.warning("   Duration: " + B.JSInt_methods._tdivFast$1(t8, 60000000) + " minutes " + B.JSInt_methods.$mod(B.JSInt_methods._tdivFast$1(t8, 1000000), 60) + " seconds");
                t9.warning("   Time: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
                t9.warning(string$.u2550_____);
                t9.warning("");
              }
              $async$goto = attempt < maxRetries ? 18 : 19;
              break;
            case 18:
              // then
              $async$goto = 20;
            ...
            case 6:
              // after for
              t1 = A._asJSObject(t1.core);
              t1.error("");
              t1.error("\u2554\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2557");
              t1.error("\u2551  \u274c ALL " + t5 + " ATTEMPTS FAILED                               ");
              t1.error("\u2551  Last error: " + A.S(lastError));
              t1.error("\u2551  Time: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
              t1.error("\u255a\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u2550\u255d");
              t1.error("");
              A.Core_setFailed(t1, "All " + t5 + " attempts failed. Last error: " + A.S(lastError));
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
            case 2:
    ...
    _runTestsWithTimeout(attempt, script, timeout) {
      return A._runTestsWithTimeout$body(attempt, script, timeout);
    },
    _runTestsWithTimeout$body(attempt, script, timeout) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$._AttemptResult),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], duration, e, st, duration0, e0, st0, duration1, t1, exception, startTime, runningScript, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              runningScript = A.ShellScript_start(script);
              $async$handler = 4;
            ...
            case 7:
              ...
              A._asJSObject(init.G.core).info("\u23f1\ufe0f  Tests completed in " + B.JSInt_methods._tdivFast$1(duration.inMicroseconds, 60000000) + " minutes " + B.JSInt_methods.$mod(B.JSInt_methods._tdivFast$1(duration.inMicroseconds, 1000000), 60) + " seconds");
              $async$returnValue = new A._AttemptResult(true, false, null, null);
              // goto return
              $async$goto = 1;
              break;
              $async$handler = 2;
            ...
            case 4:
              ...
              if (t1 instanceof A.TimeoutException) {
                ...
                t1.warning("\u23f0  Attempt exceeded " + B.JSInt_methods._tdivFast$1(timeout.inMicroseconds, 60000000) + " minute limit");
      ...
      return A._asyncStartSync($async$_runTestsWithTimeout, $async$completer);
    },
    _cleanupAndWait() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, t2;
      var $async$_cleanupAndWait = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = init.G;
              t2 = A._asJSObject(t1.core);
              t2.info("\ud83d\udd04 Preparing for next retry...");
              t2.info("   Cleaning up before next attempt...");
              $async$goto = 2;
              return A._asyncAwait(A._cleanupEmulator(), $async$_cleanupAndWait);
            case 2:
              // returning from await.
              A._asJSObject(t1.core).info("   Waiting 10 seconds before next attempt...");
              $async$goto = 3;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_10000000, type$.void), $async$_cleanupAndWait);
            case 3:
              // returning from await.
              A._asJSObject(t1.core).info("   Ready for next attempt");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$_cleanupAndWait, $async$completer);
    },
    _cleanupEmulator() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$handler = 1, $async$errorStack = [], e, e0, e1, e2, e3, e4, t2, exception, t1, $async$exception, $async$exception1, $async$exception2, $async$exception3, $async$exception4, $async$exception5;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 3;
              t2 = A.ShellScript_start("adb emu kill 2>/dev/null || true").__RunningScript__future_F;
              t2 === $ && A.throwLateFieldNI("_future");
              $async$goto = 6;
            ...
            case 3:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              A._asJSObject(t1.core).warning("   \u26a0 Failed to kill emulator via adb: " + A.S(e));
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
            ...
            case 5:
              ...
              $async$handler = 8;
              t2 = A.ShellScript_start("pkill -9 qemu-system 2>/dev/null || true").__RunningScript__future_F;
              t2 === $ && A.throwLateFieldNI("_future");
              $async$goto = 11;
              return A._asyncAwait(t2, $async$_cleanupEmulator);
            case 11:
            ...
            case 8:
              ...
              A._asJSObject(t1.core).warning("   \u26a0 Failed to kill qemu-system: " + A.S(e0));
              // goto after finally
              $async$goto = 10;
              break;
            case 7:
            ...
            case 10:
              ...
              $async$handler = 13;
              t2 = A.ShellScript_start("pkill -9 emulator 2>/dev/null || true").__RunningScript__future_F;
              t2 === $ && A.throwLateFieldNI("_future");
              $async$goto = 16;
              return A._asyncAwait(t2, $async$_cleanupEmulator);
            case 16:
            ...
            case 13:
              ...
              A._asJSObject(t1.core).warning("   \u26a0 Failed to kill emulator process: " + A.S(e1));
              // goto after finally
              $async$goto = 15;
              break;
            case 12:
            ...
            case 15:
              ...
              $async$handler = 18;
              t2 = A.ShellScript_start("adb kill-server 2>/dev/null || true").__RunningScript__future_F;
              t2 === $ && A.throwLateFieldNI("_future");
              $async$goto = 21;
              return A._asyncAwait(t2, $async$_cleanupEmulator);
            case 21:
            ...
            case 18:
              ...
              A._asJSObject(t1.core).warning("   \u26a0 Failed to kill adb server: " + A.S(e2));
              // goto after finally
              $async$goto = 20;
              break;
            case 17:
            ...
            case 26:
              ...
              $async$handler = 29;
              t2 = A.ShellScript_start("df -h . | tail -1").__RunningScript__future_F;
              t2 === $ && A.throwLateFieldNI("_future");
              $async$goto = 32;
              return A._asyncAwait(t2, $async$_cleanupEmulator);
            case 32:
      ...
      return A._asyncStartSync($async$_cleanupEmulator, $async$completer);
    },
    _action_closure: function _action_closure(t0, t1, t2) {
      this.retryTimeoutMinutes = t0;
      this.attempt = t1;
      this.script = t2;
    },
    _AttemptResult: function _AttemptResult(t0, t1, t2, t3) {
      var _ = this;
      _.success = t0;
      _.timedOut = t1;
      _.error = t2;
    ...
    Core_withGroup$body(_this, $name, action, $R, $async$type) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], t1;
    ...
    Core_setFailed(_this, error) {
      ...
      A.Process_exit(A._asJSObject(init.G.process), 1);
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(_this.downloadTool(url)), type$.nullable_Object), $async$ToolCache_downloadTool);
            case 3:
              // returning from await.
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(_this.extractZip(file, dest)), type$.nullable_Object), $async$ToolCache_extractZip);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1._asString($async$result);
              // goto return
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(_this.cacheDir(sourceDir, tool, version, null)), type$.nullable_Object), $async$ToolCache_cacheDir);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1._asString($async$result);
              // goto return
    ...
    FileSystem_withTempDir$body(_this, prefix, fn, $R, $async$type) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter($async$type),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$next = [], t1, tempDir;
      var $async$FileSystem_withTempDir = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              tempDir = A._asString(_this.mkdtempSync(A.join(A._asString(A._asJSObject(init.G.os).tmpdir()), prefix, null, null)));
              $async$handler = 3;
              $async$goto = 6;
    ...
    Process_get_env(_this) {
      ...
      t1 = type$.JSArray_nullable_Object._as(init.G.Object.getOwnPropertyNames(A._asJSObject(_this.env)));
      t1 = B.JSArray_methods.get$iterator(t1);
      while (t1.moveNext$0()) {
        $name = A._asString(t1.get$current());
        value = A._asStringQ(A._asJSObject(_this.env)[$name]);
        if (value == null)
          value = null;
        if (value == null)
          continue;
    ...
    Process_getEnv(_this, variable) {
      var t1 = A._asStringQ(A._asJSObject(_this.env)[variable]);
    ...
    binarySearch(list, matches, $T) {
      ...
      if (list.length === 0)
        return -1;
      if (matches.call$1(B.JSArray_methods.get$first(list)))
        return 0;
      if (!matches.call$1(B.JSArray_methods.get$last(list)))
        return list.length;
      max = list.length - 1;
      for (min = 0; min < max;) {
  ...
  A._Record_3_error_stackTrace_success.prototype = {$recipe: "+error,stackTrace,success(1,2,3)", $shape: 1};
  ...
  A._SinkTransformerStreamSubscription.prototype = {
    ...
    _handleData$1(data) {
      ...
      this.$ti._precomputed1._as(data);
      try {
        t1 = this.___SinkTransformerStreamSubscription__transformerSink_A;
  ...
  A._BoundSinkStream.prototype = {
    listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, onError) {
      ...
      t4 = onError != null ? 32 : 0;
      t5 = type$.void;
      t6 = t2.registerUnaryCallback$2$1(onData, t5, t1._rest[1]);
      t7 = A._BufferingStreamSubscription__registerErrorHandler(t2, onError);
      subscription = new A._SinkTransformerStreamSubscription(t6, t7, t2.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t5), t2, t3 | t4, t1._eval$1("_SinkTransformerStreamSubscription<1,2>"));
  ...
  A._CustomZone.prototype = {
    ...
    $index(_, key) {
      var map, result,
        variables = this._zoneValues;
      if (variables === B._ZoneValues__RootZone_Map_empty)
        return null;
      map = variables.map;
      result = map.$index(0, key);
      return result != null || map.containsKey$1(key) ? result : this._recursiveLookup$2(variables, key);
    },
    _recursiveLookup$2(variables, key) {
      var cursor, result, map;
      for (cursor = variables, result = null;;) {
        cursor = cursor.zone.get$parent().get$_zoneValues();
        if (cursor === B._ZoneValues__RootZone_Map_empty)
          break;
        map = cursor.map;
        result = map.$index(0, key);
        if (result != null || map.containsKey$1(key)) {
          variables.map.$indexSet(0, key, result);
          break;
        }
      }
      return result;
  ...
  A.LineSplitter.prototype = {
    bind$1(stream) {
      return new A._BoundSinkStream(A.convert__LineSplitterEventSink___new_tearOff$closure(), type$.Stream_String._as(stream), type$._BoundSinkStream_dynamic_String);
    }
  };
  ...
  A._Uri__makePath_closure.prototype = {
    call$1(s) {
      return A._Uri__uriEncode(64, A._asString(s), B.Utf8Codec_false, false);
    },
    $signature: 11
  };
  A.UriData.prototype = {
  ...
  A._SimpleUri.prototype = {
    ...
    get$port() {
      ...
      if (_this.get$hasPort())
        return A.int_parse(B.JSString_methods.substring$2(_this._uri, _this._portStart + 1, _this._pathStart), null, null);
      t1 = _this._schemeEnd;
  ...
  A._StreamSinkImpl__controller_closure0.prototype = {
    call$2(error, stackTrace) {
      ...
      if (t1._isBound) {
        ...
        t2.toString;
        t3 = error == null ? A._asObject(error) : error;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              ...
              t1 = init.G;
              $async$goto = 3;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Clean up (Success)", new A.wrapMain__closure0(), type$.void), $async$call$0);
            case 3:
              // returning from await.
              A.Process_exit(A._asJSObject(t1.process), 0);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.wrapMain_closure0.prototype = {
    call$2(error, chain) {
      return this.$call$body$wrapMain_closure(A._asObject(error), type$.Chain._as(chain));
    },
    $call$body$wrapMain_closure(error, chain) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, mappedStackChain, t2;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              mappedStackChain = A.mapStackTrace(A.parseJson(type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(A._asString(A._asJSObject(t1.fs).readFileSync(A.join(A._asString(t1.__dirname), "main.cjs.map", null, null), "utf8")), null)), null, null), chain, false, null, null);
              t2 = A._asJSObject(t1.core);
              t2.error(J.toString$0$(error));
              t2.error(mappedStackChain.toString$0(0));
              t2.error(chain.toString$0(0));
              $async$goto = 2;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Clean up (Failure)", new A.wrapMain__closure(), type$.void), $async$call$2);
            case 2:
              // returning from await.
              A.Core_setFailed(A._asJSObject(t1.core), "Action failed with error: " + A.S(error));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      ...
      var $async$runTearDowns$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              // returning from await.
              A._asJSObject(init.G.core).info("Clean up completed");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = A.List_List$_of(args, type$.String);
              ...
              $label0$0: {
                if (type$.List_dynamic._is(_0_0) && _0_0.length >= 1) {
                  if (0 >= _0_0.length) {
                  ...
                  t2 = A.ChildProcess_spawn(A._asJSObject(init.G.childProcess), exe, args, null, true, B.ProcessStartMode_0, false, null, null);
                  break $label0$0;
                }
                t2 = null;
                break $label0$0;
  ...
  A.AvdManager.prototype = {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2 = init.G;
              $async$goto = A._asBool(A._asJSObject(t2.fs).existsSync(avdPath)) ? 2 : 4;
              break;
            case 2:
              // then
              A._asJSObject(t2.core).info("Existing emulator found in cache. Skipping creation.");
              // goto join
              $async$goto = 3;
              break;
            case 4:
              // else
              A._asJSObject(t2.core).info("No emulator found in cache. Creating new one.");
              $async$goto = 5;
            ...
            case 3:
              // join
              $async$goto = 6;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t2.core), "Start ADB server", new A.AvdManager_launchEmulator_closure(), type$.ProcessResult), $async$launchEmulator$0);
            case 6:
              // returning from await.
              A._asJSObject(t2.core).info('Starting emulator "' + t1 + '": ' + avdPath);
              $async$goto = 7;
            ...
            case 9:
              // returning from await.
              A._asJSObject(t2.core).info("Emulator booted successfully");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
    ...
    _createEmulator$0() {
      return A.Core_withGroup(A._asJSObject(init.G.core), "Create emulator", new A.AvdManager__createEmulator_closure(this), type$.void);
    },
    _startEmulator$0() {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              if (A.Process_get_platform(A._asJSObject(t1.process)) !== B.OS_1) {
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = 3;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Check Hardware Acceleration", new A.AvdManager__enableKvm_closure(), type$.bool), $async$_enableKvm$0);
            case 3:
              // returning from await.
              if ($async$result) {
                $async$returnValue = A._asJSObject(t1.core).info("Hardware Acceleration is available");
                // goto return
                $async$goto = 1;
                break;
              }
              A._asJSObject(t1.core).warning("Hardware Acceleration is not available. Enabling...");
              $async$goto = 4;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Enable KVM", new A.AvdManager__enableKvm_closure0(), type$.Null), $async$_enableKvm$0);
            case 4:
              // returning from await.
              $async$goto = 5;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Verify Hardware Acceleration", new A.AvdManager__enableKvm_closure1(), type$.ProcessResult), $async$_enableKvm$0);
            case 5:
              // returning from await.
            case 1:
              // return
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(init.G.core), "Wait for AVD to boot", new A.AvdManager__waitForBoot_closure(20), type$.Null), $async$_waitForBoot$0);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait($.$get$AvdManager__avdmanager().call$2$stdinCmd(A._setArrayType(["--clear-cache", "create", "avd", "-n", t1.name, "-k", "system-images;android-" + t2 + ";" + t3 + ";" + t4], type$.JSArray_String), "echo n"), $async$call$0);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
      ...
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              startAvdArgs = A._setArrayType(["-avd", $async$self.$this.name, "-port", "5554", "-no-window", "-noaudio", "-no-boot-anim", "-restart-when-stalled", "-accel", "on", "-no-snapshot", "-wipe-data", "-verbose"], type$.JSArray_String);
            ...
            case 3:
              ...
              A._asJSObject(init.G.core).info("Emulator started with args: " + A.S(startAvdArgs));
      ...
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = A.ShellScript_start('echo \'KERNEL=="kvm", GROUP="kvm", MODE="0666", OPTIONS+="static_node=kvm"\' | sudo tee /etc/udev/rules.d/99-kvm4all.rules').__RunningScript__future_F;
              t1 === $ && A.throwLateFieldNI("_future");
              $async$goto = 2;
            ...
            case 2:
              ...
              A._asJSObject(init.G.core).info("KVM enabled for user");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      ...
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              A._asJSObject(init.G.core).info(e.toString$0(0));
              t1 = $.$get$AvdManager__adb();
              t2 = type$.JSArray_String;
              $async$goto = 2;
              return A._asyncAwait(t1.call$1(A._setArrayType(["kill-server"], t2)), $async$call$1);
            case 2:
              // returning from await.
              $async$goto = 3;
              return A._asyncAwait(t1.call$1(A._setArrayType(["start-server"], t2)), $async$call$1);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(t1.call$1(A._setArrayType(["devices", "-l"], t2)), $async$call$1);
            case 4:
              // returning from await.
              devices = $async$result;
              if (devices.exitCode !== 0)
                throw A.wrapException(A.ProcessException$("adb", A._setArrayType(["devices", "-l"], t2), A._asString(devices.stderr), 0));
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 2:
              ...
              A._asJSObject(init.G.core).info("Emulator booted");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = init.G;
              t2 = A._asJSObject(t1.core);
              t2.addPath(A.join($.$get$SdkManager__cmdlineToolsPath(), "bin", null, null));
              t2.addPath(A.join($.$get$androidHome(), "platform-tools", null, null));
              t2.exportVariable("ANDROID_AVD_HOME", $.$get$androidAvdHome());
              $async$goto = 2;
              return A._asyncAwait($async$self._ensureCmdlineTools$0(), $async$ensureSdk$0);
            case 2:
              // returning from await.
              t2 = type$.ProcessResult;
              $async$goto = 3;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Upgrade existing packages", new A.SdkManager_ensureSdk_closure(), t2), $async$ensureSdk$0);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Accept all licenses", new A.SdkManager_ensureSdk_closure0(), t2), $async$ensureSdk$0);
            case 4:
              // returning from await.
              $async$goto = 5;
      ...
      var $async$_ensureCmdlineTools$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$returnValue = A.Core_withGroup(A._asJSObject(init.G.core), "Install cmdline-tools", new A.SdkManager__ensureCmdlineTools_closure(), type$.void);
              // goto return
              $async$goto = 1;
              break;
            case 1:
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 2;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "List available tools", new A.SdkManager__ensureBuildTools_closure(), type$.ProcessResult), $async$_ensureBuildTools$0);
            case 2:
              // returning from await.
              t2 = $async$temp1._asString($async$result.stdout);
              t3 = type$._LineSplitIterable;
              buildToolsPackage = B.JSArray_methods.get$first(B.JSString_methods.split$1(A.MappedIterable_MappedIterable(new A._LineSplitIterable(t2, 0, A.RangeError_checkValidRange(0, null, t2.length)), t3._eval$1("String(Iterable.E)")._as(new A.SdkManager__ensureBuildTools_closure0()), t3._eval$1("Iterable.E"), type$.String).firstWhere$1(0, new A.SdkManager__ensureBuildTools_closure1()), A.RegExp_RegExp("\\s+", false)));
              t3 = type$.Null;
              $async$goto = 3;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Install/update build tools (" + buildToolsPackage + ")", new A.SdkManager__ensureBuildTools_closure2(buildToolsPackage), t3), $async$_ensureBuildTools$0);
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Install/update platform tools", new A.SdkManager__ensureBuildTools_closure3(), t3), $async$_ensureBuildTools$0);
            case 4:
              // returning from await.
              $async$goto = 5;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Install/update Android platform (36)", new A.SdkManager__ensureBuildTools_closure4(), t3), $async$_ensureBuildTools$0);
            case 5:
              // returning from await.
              $async$goto = 6;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Install/update emulator", new A.SdkManager__ensureBuildTools_closure5(), t3), $async$_ensureBuildTools$0);
            case 6:
              // returning from await.
              targetTriplet = $async$self.apiLevel.toString$0(0) + ";" + $async$self.target.toString$0(0) + ";" + $async$self.abi.toString$0(0);
              $async$goto = 7;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Install/update system images (" + targetTriplet + ")", new A.SdkManager__ensureBuildTools_closure6(targetTriplet), t3), $async$_ensureBuildTools$0);
            case 7:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.SdkManager_ensureSdk_closure.prototype = {
    call$0() {
      return A.SdkManager__sdkmanager(A._setArrayType(["--update"], type$.JSArray_String));
    },
    $signature: 5
  };
  A.SdkManager_ensureSdk_closure0.prototype = {
    call$0() {
      return A.SdkManager__sdkmanager(A._setArrayType(["--licenses"], type$.JSArray_String));
    },
    $signature: 5
  };
  A.SdkManager__ensureCmdlineTools_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, _0_0, downloadUrl, downloadPath, extractPath, toolCachePath, t1, t2, t3;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              t2 = A._asJSObject(t1.fs);
              t3 = $.$get$SdkManager__cmdlineToolsPath();
              if (A._asBool(t2.existsSync(t3))) {
                A._asJSObject(t1.core).info("Found existing cmdline-tools installation");
                // goto return
                $async$goto = 1;
                break;
              }
              _0_0 = A.ToolCache_find(A._asJSObject(t1.toolCache), "cmdline-tools", "11076708");
              if (_0_0 != null) {
                A._asJSObject(t1.core).info("Found cached cmdline-tools install: " + _0_0);
                // goto return
                $async$goto = 1;
                break;
              }
              switch (A.Process_get_platform(A._asJSObject(t1.process)).index) {
                case 1:
                  t2 = "linux";
                  break;
                case 0:
              ...
              downloadUrl = "https://dl.google.com/android/repository/commandlinetools-" + t2 + "-11076708_latest.zip";
              A._asJSObject(t1.core).info("Downloading cmdline-tools from " + downloadUrl);
              $async$goto = 3;
              return A._asyncAwait(A.ToolCache_downloadTool(A._asJSObject(t1.toolCache), downloadUrl), $async$call$0);
            case 3:
              // returning from await.
              downloadPath = $async$result;
              A._asJSObject(t1.core).info("Downloaded cmdline-tools to " + downloadPath);
              $async$goto = 4;
              return A._asyncAwait(A.ToolCache_extractZip(A._asJSObject(t1.toolCache), downloadPath, t3), $async$call$0);
            case 4:
              // returning from await.
              extractPath = $async$result;
              A._asJSObject(t1.core).info("Extracted cmdline-tools to " + extractPath);
              $async$goto = 5;
              return A._asyncAwait(A.ToolCache_cacheDir(A._asJSObject(t1.toolCache), extractPath, "cmdline-tools", "11076708"), $async$call$0);
            case 5:
              // returning from await.
              toolCachePath = $async$result;
              A._asJSObject(t1.core).info("Installed cmdline-tools to " + toolCachePath);
            case 1:
              // return
              return A._asyncReturn($async$returnValue, $async$completer);
          }
  ...
  A.SdkManager__ensureBuildTools_closure.prototype = {
    call$0() {
      return A.SdkManager__sdkmanager(A._setArrayType(["--list"], type$.JSArray_String));
    },
    $signature: 5
  };
  ...
  A.SdkManager__ensureBuildTools_closure1.prototype = {
    call$1(line) {
      return B.JSString_methods.startsWith$1(A._asString(line), "build-tools;36");
    },
    $signature: 1
  };
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A.SdkManager__sdkmanager(A._setArrayType([t1], type$.JSArray_String)), $async$call$0);
            case 2:
              // returning from await.
              A._asJSObject(init.G.core).info("Successfully installed " + t1);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.SdkManager__sdkmanager(A._setArrayType(["platform-tools"], type$.JSArray_String)), $async$call$0);
            case 2:
              // returning from await.
              A._asJSObject(init.G.core).info("Successfully installed platform-tools");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.SdkManager__sdkmanager(A._setArrayType(["platforms;android-36"], type$.JSArray_String)), $async$call$0);
            case 2:
              // returning from await.
              A._asJSObject(init.G.core).info("Successfully installed platforms;android-36");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.SdkManager__sdkmanager(A._setArrayType(["emulator"], type$.JSArray_String)), $async$call$0);
            case 2:
              // returning from await.
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A.SdkManager__sdkmanager(A._setArrayType([packageName], type$.JSArray_String)), $async$call$0);
            case 2:
              // returning from await.
              A._asJSObject(init.G.core).info("Successfully installed " + packageName);
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.NodeReadableStream_get_stream_closure.prototype = {
    call$0() {
      var t2, _this = this,
        t1 = _this._this;
      t1.addListener("data", A._functionToJS1(_this.onData));
      t2 = type$.void;
  ...
  A.NodeReadableStream_get_stream_closure0.prototype = {
    call$0() {
      return this._this.removeListener("data", A._functionToJS1(this.onData));
    },
    $signature: 0
  };
  ...
  A.NodeProcessManager.prototype = {
    ...
    runSync$1(command) {
      ...
      result = A.ChildProcess_execSync(A._asJSObject(init.G.childProcess), executable, args, false, _null, true, false, _null);
      t1 = type$.Uint8List;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.List_int;
              nodeProcess = new A.NodeProcess(executable, args, A.ChildProcess_spawn(t1, executable, args, environment, true, mode, false, pipe == null ? null : A._asJSObjectQ(pipe.stdout), workingDirectory), A.StreamController_StreamController(true, t2), A.StreamController_StreamController(true, t2), A.StreamController_StreamController(true, t2));
              $async$goto = 3;
      ...
      var $async$close$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self._activeProcesses;
              t1 = new A.LinkedHashMapValueIterator(t1, t1._modifications, t1._first, A._instanceType(t1)._eval$1("LinkedHashMapValueIterator<2>"));
              for (0; t1.moveNext$0();)
                t1.__js_helper$_current.close$0()._ignore$0();
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  A.NodeProcess.prototype = {
    _init$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t3, t4, _1_0, _2_0, t1, _0_0, t2;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              _0_0 = A._asJSObjectQ(t1.stdin);
              t2 = {};
              t2.stdin = null;
              if (_0_0 != null) {
                t2.stdin = _0_0;
                t3 = $async$self._stdin;
                t4 = A._instanceType(t3);
                $async$self._stdinSink = new A._IOSinkImpl(B.Utf8Codec_false, new A._StreamSinkWrapper(t3, t4._eval$1("_StreamSinkWrapper<1>")), new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_dynamic), type$._AsyncCompleter_dynamic));
                $async$self._stdinSub = new A._ControllerStream(t3, t4._eval$1("_ControllerStream<1>")).listen$1(new A.NodeProcess__init_closure(t2));
              }
              _1_0 = A._asJSObjectQ(t1.stdout);
              t2 = $async$self._stdout;
              if (_1_0 != null)
                A.StreamForward_forward(A.NodeReadableStream_get_stream(_1_0), t2, type$.List_int);
              else
                t2.close$0();
              _2_0 = A._asJSObjectQ(t1.stderr);
              t2 = $async$self._stderr;
              if (_2_0 != null)
                A.StreamForward_forward(A.NodeReadableStream_get_stream(_2_0), t2, type$.List_int);
              else
                t2.close$0();
              $async$goto = 2;
              return A._asyncAwait(A.Future_any(A._setArrayType([A.EventEmitter_once(t1, "spawn", type$.nullable_Object), A.EventEmitter_once(t1, "error", type$.JSObject).then$1$1(new A.NodeProcess__init_closure0($async$self), type$.Never)], type$.JSArray_Future_void), type$.void), $async$_init$0);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.RunningScript.prototype = {
    kill$0() {
      ...
      if (process == null)
        return;
      t1 = A.ShellScript_start("pkill -KILL -P " + process.get$pid() + " 2>/dev/null || true").__RunningScript__future_F;
      t1 === $ && A.throwLateFieldNI("_future");
      t2 = type$.void;
  ...
  A.Context.prototype = {
    ...
    _isWithinOrEqualsFast$2($parent, child) {
      ...
      for (;;) {
        ...
        c$0: {
          ...
          if (_this._pathDirection$2(child, childIndex) !== B._PathDirection_Wme)
            return B._PathRelation_inconclusive;
          if (_this._pathDirection$2($parent, parentIndex) !== B._PathDirection_Wme)
            return B._PathRelation_inconclusive;
          return B._PathRelation_different;
        }
      }
      if (childIndex === t3) {
        ...
        if (direction === B._PathDirection_dMN)
          return B._PathRelation_equal;
        return direction === B._PathDirection_vgO ? B._PathRelation_inconclusive : B._PathRelation_different;
      }
      direction = _this._pathDirection$2(child, childIndex);
      if (direction === B._PathDirection_dMN)
        return B._PathRelation_equal;
      if (direction === B._PathDirection_vgO)
        return B._PathRelation_inconclusive;
      if (!(childIndex >= 0 && childIndex < t3))
        return A.ioore(child, childIndex);
    ...
    _pathDirection$2(path, index) {
      ...
      if (depth < 0)
        return B._PathDirection_vgO;
      if (depth === 0)
        return B._PathDirection_dMN;
      if (reachedRoot)
        return B._PathDirection_6kc;
      return B._PathDirection_Wme;
    },
    toUri$1(path) {
      var t2,
        t1 = this.style;
  ...
  A.RetryOptions.prototype = {
    delay$1(attempt) {
      ...
      t1 = B.JSNumber_methods.round$0(B.JSNumber_methods.round$0(this.delayFactor.inMicroseconds * Math.pow(2, Math.min(attempt, 31))) * (this.randomizationFactor * (t1 * 2 - 1) + 1));
      delay = new A.Duration(t1);
      t2 = this.maxDelay;
      return t1 < t2.inMicroseconds ? delay : t2;
    },
    ...
    retry$body$RetryOptions(fn, onRetry, retryIf, $T, $async$type) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter($async$type),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], $async$self = this, e, t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, exception, attempt, $async$exception;
  ...
  A.MultiSectionMapping.prototype = {
    MultiSectionMapping$fromJson$3$mapUrl(sections, otherMaps, mapUrl) {
      var t1, t2, t3, t4, t5, t6, t7, offset, line, column, url, map;
      for (t1 = J.cast$1$0$ax(sections, type$.Map_dynamic_dynamic), t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListBase.E>")), t3 = this._maps, t4 = this._parser$_lineStart, t5 = this._columnStart, t6 = type$.nullable_Map_dynamic_dynamic, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        ...
        if (offset == null)
          throw A.wrapException(B.FormatException_L64);
        line = A._asIntQ(offset.$index(0, "line"));
        if (line == null)
          throw A.wrapException(B.FormatException_fmJ);
        column = A._asIntQ(offset.$index(0, "column"));
        if (column == null)
          throw A.wrapException(B.FormatException_Uzo);
        ...
        t7 = url != null;
        if (t7 && map != null)
          throw A.wrapException(B.FormatException_3no);
        else if (t7) {
          t7 = A.FormatException$("section contains refers to " + url + ', but no map was given for it. Make sure a map is passed in "otherMaps"', null, null);
          throw A.wrapException(t7);
        } else if (map != null)
          B.JSArray_methods.add$1(t3, A.parseJson(map, mapUrl, otherMaps));
        else
          throw A.wrapException(B.FormatException_jwv);
      }
      if (t4.length === 0)
        throw A.wrapException(B.FormatException_rHr);
    },
  ...
  A.SingleMapping.prototype = {
    SingleMapping$fromJson$2$mapUrl(map, mapUrl) {
      var t6, source, t7, t8, t9, tokenizer, entries, line, column, srcUrlId, srcLine, srcColumn, srcNameId, _this = this,
        _s14_ = "sourcesContent",
        _null = null,
        t1 = map._source,
        t2 = map.$ti._eval$1("4?"),
        sourcesContent = t2._as(t1.$index(0, _s14_)) == null ? B.List_empty1 : A.List_List$from(type$.List_dynamic._as(t2._as(t1.$index(0, _s14_))), true, type$.nullable_String),
        t3 = _this.files,
        t4 = _this.urls,
        t5 = type$.JSArray_int,
        i = 0;
      for (;;) {
        t6 = t4.length;
        if (!(i < t6 && i < sourcesContent.length))
          break;
        c$0: {
      ...
      t1 = A._asString(t2._as(t1.$index(0, "mappings")));
      t2 = t1.length;
  ...
  A.Frame_Frame$parseV8_closure.prototype = {
    call$0() {
      ...
      if (match != null) {
        ...
        t2.toString;
        functionOffset = A.int_parse(t2, _null, 16);
        if (!(member == null))
          t1 = member;
  ...
  A.Frame_Frame$parseV8_closure_parseJsLocation.prototype = {
    call$2($location, member) {
      ...
      t2 = t1[2];
      t2.toString;
      line = A.int_parse(t2, _null, _null);
      if (3 >= t1.length)
        return A.ioore(t1, 3);
      columnMatch = t1[3];
    ...
    call$0() {
      ...
      if (match != null) {
        ...
        if (t1 == null || t1 === "")
          ...
          t1 = t1;
          t1.toString;
          column = A.int_parse(t1, _null, _null);
        }
      ...
      if (match != null) {
        ...
        t3.toString;
        functionOffset = A.int_parse(t3, _null, 16);
        if (!(t1.length !== 0))
          t1 = t2;
        return new A.Frame(uri, 1, functionOffset + 1, t1);
      }
  ...
  A.Frame_Frame$parseFriendly_closure.prototype = {
    call$0() {
      ...
      if (t2 == null)
        ...
        t2 = t2;
        t2.toString;
        column = A.int_parse(t2, _null, _null);
      }
      if (4 >= t1.length)
        return A.ioore(t1, 4);
  ...
  A.StackZoneSpecification.prototype = {
    ...
    _handleUncaughtError$5($self, $parent, zone, error, stackTrace) {
      var stackChain, newError, newStackTrace, t1, t2, exception;
      if (J.$eq$($.Zone__current.$index(0, $.$get$StackZoneSpecification_disableKey()), true)) {
      ...
      if (t1 == null) {
        $parent._delegationTarget._processUncaughtError$3(zone, error, type$.StackTrace._as(stackChain));
        return;
      }
      try {
        t2 = $self.get$parent();
        t2.runBinary$3$3(t1, error, stackChain, type$.void, type$.Object, type$.Chain);
      } catch (exception) {
    ...
    _errorCallback$5($self, $parent, zone, error, stackTrace) {
      var t2, t3, asyncError, _this = this,
        t1 = type$.Zone;
      t1._as($self);
      type$.ZoneDelegate._as($parent);
      t1._as(zone);
  ...
  A._action_closure.prototype = {
    call$0() {
      return A._runTestsWithTimeout(this.attempt, this.script, A.Duration$(0, 0, this.retryTimeoutMinutes));
    },
    $signature: 69
  };
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 75, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 18, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 76, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 77, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 78, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 79, 0);
    ...
    var _;
    _instance_1_u(_ = A._StreamController.prototype, "get$_async$_add", "_async$_add$1", 20);
    ...
    _static_1(A, "convert__LineSplitterEventSink___new_tearOff$closure", "_LineSplitterEventSink___new_tearOff", 81);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 29);
    _static(A, "math__max$closure", 2, null, ["call$1$2", "call$2"], ["max", function(a, b) {
      return A.max(a, b, type$.num);
    }], 83, 0);
    _static_1(A, "types_AndroidAbi_parse$closure", "AndroidAbi_parse", 84);
    _static_1(A, "types_AndroidApiLevel_parse$closure", "AndroidApiLevel_parse", 85);
    _static_1(A, "types_AndroidSystemImageTarget_parse$closure", "AndroidSystemImageTarget_parse", 86);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 66, 0, 0);
    _instance(_, "get$_errorCallback", 0, 5, null, ["call$5"], ["_errorCallback$5"], 18, 0, 0);
    _static_1(A, "trace_Trace___parseVM_tearOff$closure", "Trace___parseVM_tearOff", 22);
    _static_1(A, "trace_Trace___parseFriendly_tearOff$closure", "Trace___parseFriendly_tearOff", 22);
  ...
  (function inheritance() {
    ...
    _inherit(A._Record_3_error_stackTrace_success, A._Record3);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      _AttemptResult: findType("_AttemptResult"),
  ...
  (function constants() {
    ...
    B.AndroidAbi_gFU = new A.AndroidAbi("arm64-v8a", 2, "arm64");
    B.AndroidAbi_x86_64_1_x86_64 = new A.AndroidAbi("x86_64", 1, "x86_64");
    B.Arch_0 = new A.Arch(0, "arm64");
    B.Arch_1 = new A.Arch(1, "x64");
...
;
    ...
    B.FormatException_Uzo = new A.FormatException("offset missing column", null, null);
    B.FormatException_fmJ = new A.FormatException("offset missing line", null, null);
    B.FormatException_jwv = new A.FormatException("section missing url or map", null, null);
    B.FormatException_rHr = new A.FormatException("expected at least one section", null, null);
    B.JsonDecoder_null = new A.JsonDecoder(null);
    B.List_3Rp = makeConstList(["normal", "inheritStdio", "detached", "detachedWithStdio"], type$.JSArray_String);
    B.AndroidSystemImageTarget_default_0_default$ = new A.AndroidSystemImageTarget("default", 0, "default$");
    B.AndroidSystemImageTarget_google_apis_1_googleApis = new A.AndroidSystemImageTarget("google_apis", 1, "googleApis");
    B.AndroidSystemImageTarget_8dB = new A.AndroidSystemImageTarget("google_apis_playstore", 2, "googleApisPlaystore");
    B.List_8Vc = makeConstList([B.AndroidSystemImageTarget_default_0_default$, B.AndroidSystemImageTarget_google_apis_1_googleApis, B.AndroidSystemImageTarget_8dB], A.findType("JSArray<AndroidSystemImageTarget>"));
    B.AndroidAbi_x86_0_x86 = new A.AndroidAbi("x86", 0, "x86");
    B.List_Lmb = makeConstList([B.AndroidAbi_x86_0_x86, B.AndroidAbi_x86_64_1_x86_64, B.AndroidAbi_gFU], A.findType("JSArray<AndroidAbi>"));
    B.List_empty = makeConstList([], type$.JSArray_String);
    B.List_empty0 = makeConstList([], type$.JSArray_int);
    B.List_empty1 = makeConstList([], type$.JSArray_nullable_String);
    B.AndroidApiLevel_35_0_api_35 = new A.AndroidApiLevel(35, 0, "api_35");
    B.AndroidApiLevel_34_1_api_34 = new A.AndroidApiLevel(34, 1, "api_34");
    B.AndroidApiLevel_33_2_api_33 = new A.AndroidApiLevel(33, 2, "api_33");
    B.AndroidApiLevel_32_3_api_32 = new A.AndroidApiLevel(32, 3, "api_32");
    B.AndroidApiLevel_31_4_api_31 = new A.AndroidApiLevel(31, 4, "api_31");
    B.AndroidApiLevel_30_5_api_30 = new A.AndroidApiLevel(30, 5, "api_30");
    B.AndroidApiLevel_29_6_api_29 = new A.AndroidApiLevel(29, 6, "api_29");
    B.AndroidApiLevel_28_7_api_28 = new A.AndroidApiLevel(28, 7, "api_28");
    B.AndroidApiLevel_27_8_api_27 = new A.AndroidApiLevel(27, 8, "api_27");
    B.AndroidApiLevel_26_9_api_26 = new A.AndroidApiLevel(26, 9, "api_26");
    B.AndroidApiLevel_25_10_api_25 = new A.AndroidApiLevel(25, 10, "api_25");
    B.AndroidApiLevel_24_11_api_24 = new A.AndroidApiLevel(24, 11, "api_24");
    B.List_qUS = makeConstList([B.AndroidApiLevel_35_0_api_35, B.AndroidApiLevel_34_1_api_34, B.AndroidApiLevel_33_2_api_33, B.AndroidApiLevel_32_3_api_32, B.AndroidApiLevel_31_4_api_31, B.AndroidApiLevel_30_5_api_30, B.AndroidApiLevel_29_6_api_29, B.AndroidApiLevel_28_7_api_28, B.AndroidApiLevel_27_8_api_27, B.AndroidApiLevel_26_9_api_26, B.AndroidApiLevel_25_10_api_25, B.AndroidApiLevel_24_11_api_24], A.findType("JSArray<AndroidApiLevel>"));
    B.OS_0 = new A.OS(0, "macOS");
    B.OS_1 = new A.OS(1, "linux");
    ...
    B._PathDirection_6kc = new A._PathDirection("reaches root");
    B._PathDirection_Wme = new A._PathDirection("below root");
    B._PathDirection_dMN = new A._PathDirection("at root");
    B._PathDirection_vgO = new A._PathDirection("above root");
    ...
    B.Object_empty = {};
    B.Map_empty = new A.ConstantStringMap(B.Object_empty, [], A.findType("ConstantStringMap<Object?,Object?>"));
    B._ZoneValues__RootZone_Map_empty = new A._ZoneValues(B.C__RootZone, B.Map_empty);
  })();
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "SdkManager__sdkmanagerTool", "$get$SdkManager__sdkmanagerTool", () => {
      var t1 = A._setArrayType(["--channel=0"], type$.JSArray_String);
      if (A._callMethodUnchecked0(A.getProperty(A.staticInteropGlobalContext(), "core", type$.JSObject), "isDebug", type$.bool))
        t1.push("--verbose");
