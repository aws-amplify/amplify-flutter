...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Future_wait(futures, $T) {
      var handleError, future, pos, e, st, t2, t3, exception, _0_0, _box_0 = {}, cleanUp = null,
        eagerError = false,
    ...
    AndroidApiLevel_parse(apiLevel) {
      ...
      if (levelInt == null)
        t1.call$0();
      return B.JSArray_methods.firstWhere$2$orElse(B.List_cYB, new A.AndroidApiLevel_parse_closure(levelInt), t1);
    },
    AndroidApiLevel_allApiLevels() {
      var t1 = type$.MappedListIterable_AndroidApiLevel_int;
      return A.List_List$of(new A.MappedListIterable(B.List_cYB, type$.int_Function_AndroidApiLevel._as(new A.AndroidApiLevel_allApiLevels_closure()), t1), true, t1._eval$1("ListIterable.E"));
    },
    ...
    parseJson(map, mapUrl, otherMaps) {
      ...
      if (map.containsKey$1(_s8_)) {
        if (map.containsKey$1("mappings") || map.containsKey$1("sources") || map.containsKey$1("names"))
          throw A.wrapException(B.FormatException_61L);
  ...
  A._BufferCachingBase64Encoder.prototype = {
    createBuffer$1(bufferLength) {
      ...
      return J.asUint8List$2$x((buffer && B.NativeUint8List_methods).get$buffer(buffer), buffer.byteOffset, bufferLength);
    }
  };
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              ...
              buildToolsPackage = B.JSArray_methods.get$first(B.JSString_methods.split$1(A.MappedIterable_MappedIterable(new A._LineSplitIterable(t3, 0, A.RangeError_checkValidRange(0, null, t3.length)), t4._eval$1("String(Iterable.E)")._as(new A.SdkManager__ensureBuildTools_closure0()), t4._eval$1("Iterable.E"), type$.String).firstWhere$1(0, new A.SdkManager__ensureBuildTools_closure1()), A.RegExp_RegExp("\\s+", false)));
              t4 = type$.Null;
              $async$goto = 3;
            ...
            case 4:
              // returning from await.
              $async$goto = 5;
              return A._asyncAwait(A.Core_withGroup(t2._as(t1.core), "Install/update Android platform (35)", new A.SdkManager__ensureBuildTools_closure4(), t4), $async$_ensureBuildTools$0);
            case 5:
              // returning from await.
      ...
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 2:
              // returning from await.
              type$.JSObject._as(self.core).info("Successfully installed platforms;android-35");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      ...
      var $async$close$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              for (t1 = $async$self._activeProcesses.get$values(), t2 = A._instanceType(t1), t1 = new A.MappedIterator(J.get$iterator$ax(t1.__internal$_iterable), t1._f, t2._eval$1("MappedIterator<1,2>")), t2 = t2._rest[1]; t1.moveNext$0();) {
                t3 = t1.__internal$_current;
  ...
  A.MultiSectionMapping.prototype = {
    MultiSectionMapping$fromJson$3$mapUrl(sections, otherMaps, mapUrl) {
      ...
      for (t1 = J.cast$1$0$ax(sections, type$.Map_dynamic_dynamic), t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListBase.E>")), t3 = this._maps, t4 = this._parser$_lineStart, t5 = this._columnStart, t6 = type$.nullable_Map_dynamic_dynamic, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
        ...
        if (offset == null)
          throw A.wrapException(B.FormatException_aXU);
        line = A._asIntQ(offset.$index(0, "line"));
        if (line == null)
          throw A.wrapException(B.FormatException_p2l);
        column = A._asIntQ(offset.$index(0, "column"));
        if (column == null)
          throw A.wrapException(B.FormatException_43h);
        ...
        t7 = url != null;
        if (t7 && map != null)
          throw A.wrapException(B.FormatException_Mqd);
        else if (t7) {
          ...
          throw A.wrapException(B.FormatException_ooA);
      }
      if (t4.length === 0)
        throw A.wrapException(B.FormatException_KjO);
    },
  ...
  A.StackZoneSpecification.prototype = {
    ...
    _handleUncaughtError$5($self, $parent, zone, error, stackTrace) {
      var stackChain, newError, newStackTrace, t2, t3, t4, exception,
        t1 = type$.Object;
      t1._as(error);
      t2 = type$.StackTrace;
      t2._as(stackTrace);
      ...
      try {
        t4 = $self.get$parent();
        t4.runBinary$3$3(t3, error, stackChain, type$.void, t1, type$.Chain);
      } catch (exception) {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async_Future___value_tearOff$closure", 0, null, ["call$1$1", "call$0", "call$1$0", "call$1"], ["Future___value_tearOff", function() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 79, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 82, 0);
    ...
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 87, 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 74);
    _static(A, "math__max$closure", 2, null, ["call$1$2", "call$2"], ["max", function(a, b) {
      return A.max(a, b, type$.num);
    }], 88, 0);
    _static_1(A, "types_AndroidAbi_parse$closure", "AndroidAbi_parse", 89);
    _static_1(A, "types_AndroidApiLevel_parse$closure", "AndroidApiLevel_parse", 90);
    _static_1(A, "types_AndroidSystemImageTarget_parse$closure", "AndroidSystemImageTarget_parse", 91);
    ...
    _instance(_ = A.StackZoneSpecification.prototype, "get$_registerCallback", 0, 4, null, ["call$1$4", "call$4"], ["_registerCallback$1$4", "_registerCallback$4"], 24, 0, 0);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 73, 0, 0);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.CastMap_forEach_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A.Future_wait_handleError, A.Future_any_onError, A._Future__chainForeignFuture_closure0, A.HashMap_HashMap$from_closure, A.MapBase_mapToString_closure, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A._createTables_build, A._StreamSinkImpl__controller_closure0, A.wrapMain_closure0, A.StreamForward_forward_closure1, A.SingleMapping$fromJson_closure, A.Frame_Frame$parseV8_closure_parseJsLocation, A.StackZoneSpecification__registerBinaryCallback_closure]);
    _inheritMany(A.Error, [A.LateError, A.TypeError, A.JsNoSuchMethodError, A.UnknownJsTypeError, A._CyclicInitializationError, A.RuntimeError, A.AssertionError, A._Error, A.ArgumentError, A.UnsupportedError, A.UnimplementedError, A.StateError, A.ConcurrentModificationError, A._UnreachableError]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "Future<~>()", "Future<Null>()", "~(Object,StackTrace)", "Future<ProcessResult>()", "Trace()", "Frame()", "Frame(String)", "Null()", "~(@)", "String(String)", "Null(@)", "0&()", "~(~())", "Null(Object,StackTrace)", "~(Object?)", "@()", "~(Uint8List,String,int)", "~(String)", "String(Match)", "Trace(String)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(@,@)", "Future<0&>()", "Future<~>(Object,Chain)", "@(@,String)", "Future<Process>()", "Future<bool>()", "_Future<@>(@)", "bool(Exception)", "Future<~>(Exception)", "@(String)", "Future<Null>(String)", "bool(AndroidAbi)", "@(@)", "String(AndroidAbi)", "bool(AndroidApiLevel)", "int(AndroidApiLevel)", "bool(AndroidSystemImageTarget)", "String(AndroidSystemImageTarget)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "~(Object?,Object?)", "~(List<int>)", "0&(JSObject)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "Null(@,StackTrace)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "_LineSplitterEventSink(EventSink<String>)", "List<Frame>(Trace)", "int(Trace)", "~(String,int)", "String(Trace)", "~(String,int?)", "int(int,int)", "Frame(String,String)", "~(int,@)", "Uint8List(@,@)", "Null(~())", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "~(@,StackTrace?)", "Chain()", "Null(@,@)", "Future<0^>([0^/?])<Object?>", "~(Object?[Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "0^(0^,0^)<num>", "AndroidAbi(String)", "AndroidApiLevel(String)", "AndroidSystemImageTarget(String)", "Object?(Object?)", "Map<String,int>()"],
...
;
    ...
    B.FormatException_43h = new A.FormatException("offset missing column", null, null);
    B.FormatException_61L = new A.FormatException('map containing "sections" cannot contain "mappings", "sources", or "names".', null, null);
    B.FormatException_KjO = new A.FormatException("expected at least one section", null, null);
    B.FormatException_Mqd = new A.FormatException("section can't use both url and map entries", null, null);
    B.FormatException_aXU = new A.FormatException("section missing offset", null, null);
    B.FormatException_ooA = new A.FormatException("section missing url or map", null, null);
    B.FormatException_p2l = new A.FormatException("offset missing line", null, null);
