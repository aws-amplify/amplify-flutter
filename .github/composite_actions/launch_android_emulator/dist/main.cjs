...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    AndroidAbi_parse(value) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_dmN, new A.AndroidAbi_parse_closure(value), new A.AndroidAbi_parse_closure0(value));
    },
    ...
    AndroidAbi_allAbis() {
      ...
      t1 = A.List_List$_of(new A.MappedListIterable(B.List_dmN, type$.String_Function_AndroidAbi._as(new A.AndroidAbi_allAbis_closure()), t1), t1._eval$1("ListIterable.E"));
      return t1;
    },
    AndroidApiLevel_parse(apiLevel) {
      ...
      if (levelInt == null)
        t1.call$0();
      return B.JSArray_methods.firstWhere$2$orElse(B.List_6IO, new A.AndroidApiLevel_parse_closure(levelInt), t1);
    },
    AndroidApiLevel_allApiLevels() {
      var t1 = type$.MappedListIterable_AndroidApiLevel_int;
      t1 = A.List_List$_of(new A.MappedListIterable(B.List_6IO, type$.int_Function_AndroidApiLevel._as(new A.AndroidApiLevel_allApiLevels_closure()), t1), t1._eval$1("ListIterable.E"));
      return t1;
    },
    AndroidSystemImageTarget_parse(target) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_zA4, new A.AndroidSystemImageTarget_parse_closure(target), new A.AndroidSystemImageTarget_parse_closure0(target));
    },
    AndroidSystemImageTarget_allTags() {
      var t1 = type$.MappedListIterable_AndroidSystemImageTarget_String;
      t1 = A.List_List$_of(new A.MappedListIterable(B.List_zA4, type$.String_Function_AndroidSystemImageTarget._as(new A.AndroidSystemImageTarget_allTags_closure()), t1), t1._eval$1("ListIterable.E"));
      return t1;
    },
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              // returning from await.
              $async$goto = 5;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Install/update Android platform (35)", new A.SdkManager__ensureBuildTools_closure4(), t3), $async$_ensureBuildTools$0);
            case 5:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              switch (A.Process_get_platform(A._asJSObject(t1.process))) {
                case B.OS_1:
                  t2 = "linux";
                  break;
                case B.OS_0:
  ...
  A.SdkManager__ensureBuildTools_closure1.prototype = {
    call$1(line) {
      return B.JSString_methods.startsWith$1(A._asString(line), "build-tools;35");
    },
    $signature: 1
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait($.$get$SdkManager__sdkmanager().call$1(A._setArrayType(["platforms;android-35"], type$.JSArray_String)), $async$call$0);
            case 2:
              // returning from await.
              A._asJSObject(init.G.core).info("Successfully installed platforms;android-35");
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 80, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 81, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 82, 0);
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 83, 0);
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 4);
    var _;
    _instance_1_u(_ = A._StreamController.prototype, "get$_add", "_add$1", 16);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 68);
    ...
    _instance_0_u(A.NodeProcessManager.prototype, "get$close", "close$0", 2);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 70, 0, 0);
    ...
    _static_0(A, "launch_android_emulator___action$closure", "_action", 2);
  })();
  (function inheritance() {
    ...
    _inheritMany(A.Closure2Args, [A.CastMap_forEach_closure, A.JsLinkedHashMap_addAll_closure, A.initHooks_closure0, A._awaitOnObject_closure0, A._wrapJsFunctionForAsync_closure, A.Future_wait_handleError, A.Future_any_onError, A._Future__propagateToListeners_handleWhenCompleteCallback_closure0, A.HashMap_HashMap$from_closure, A.MapBase_mapToString_closure, A.Uri__parseIPv4Address_error, A.Uri_parseIPv6Address_error, A.Uri_parseIPv6Address_parseHex, A._StreamSinkImpl__controller_closure0, A.wrapMain_closure0, A.StreamForward_forward_closure1, A.SingleMapping$fromJson_closure, A.Frame_Frame$parseV8_closure_parseJsLocation, A.StackZoneSpecification__registerBinaryCallback_closure]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "Future<~>()", "Future<Null>()", "~(Object,StackTrace)", "Trace()", "Future<ProcessResult>()", "Frame()", "Frame(String)", "Null()", "~(@)", "String(String)", "Null(@)", "0&()", "~(~())", "Null(Object,StackTrace)", "~(Object?)", "@()", "~(String)", "String(Match)", "Trace(String)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "Future<Process>()", "Null(~())", "@(@,String)", "Future<bool>()", "@(String)", "bool(Exception)", "Future<~>(Exception)", "~(@,@)", "Future<Null>(String)", "bool(AndroidAbi)", "@(@)", "String(AndroidAbi)", "bool(AndroidApiLevel)", "int(AndroidApiLevel)", "bool(AndroidSystemImageTarget)", "String(AndroidSystemImageTarget)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "Null(@,StackTrace)", "~(List<int>)", "0&(JSObject)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "_LineSplitterEventSink(EventSink<String>)", "List<Frame>(Trace)", "int(Trace)", "~(String,int)", "String(Trace)", "~(String,int?)", "int(int,int)", "Frame(String,String)", "~(int,@)", "~(@,StackTrace?)", "Null(@,@)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Object?(Object?)", "Chain()", "Future<0&>()", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "0^(0^,0^)<num>", "AndroidAbi(String)", "AndroidApiLevel(String)", "AndroidSystemImageTarget(String)", "Future<~>(Object,Chain)", "~(Object?,Object?)"],
  ...
  (function constants() {
    ...
    B.AndroidAbi_qEv = new A.AndroidAbi("arm64-v8a", "arm64");
...
;
    ...
    B.AndroidApiLevel_35_api_35 = new A.AndroidApiLevel(35, "api_35");
    ...
    B.AndroidSystemImageTarget_ssN = new A.AndroidSystemImageTarget("google_apis_playstore", "googleApisPlaystore");
    B.List_zA4 = makeConstList([B.AndroidSystemImageTarget_default_default$, B.AndroidSystemImageTarget_google_apis_googleApis, B.AndroidSystemImageTarget_ssN], A.findType("JSArray<AndroidSystemImageTarget>"));
