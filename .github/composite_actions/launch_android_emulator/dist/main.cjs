// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.2.0-191.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Future_wait(futures, $T) {
      var error, stackTrace, handleError, future, pos, e, st, t2, t3, exception, replacement, _box_0 = {}, cleanUp = null,
        eagerError = false,
    ...
    _ControllerSubscription$(_controller, onData, onError, onDone, cancelOnError, $T) {
      var t1 = $.Zone__current,
        ...
        t3 = type$.void,
        t4 = t1.registerUnaryCallback$2$1(onData, t3, $T),
        t5 = A._BufferingStreamSubscription__registerErrorHandler(t1, onError);
      return new A._ControllerSubscription(_controller, t4, t5, t1.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t3), t1, t2, $T._eval$1("_ControllerSubscription<0>"));
    },
    _AddStreamState$(controller, source, cancelOnError, $T) {
      ...
      return new A._AddStreamState(new A._Future(t1, type$._Future_dynamic), source.listen$4$cancelOnError$onDone$onError(t2, false, controller.get$_close(), t3), $T._eval$1("_AddStreamState<0>"));
    },
    ...
    AndroidAbi_parse(value) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_s6Q, new A.AndroidAbi_parse_closure(value), new A.AndroidAbi_parse_closure0(value));
    },
    ...
    AndroidAbi_allAbis() {
      ...
      return A.List_List$of(new A.MappedListIterable(B.List_s6Q, type$.String_Function_AndroidAbi._as(new A.AndroidAbi_allAbis_closure()), t1), true, t1._eval$1("ListIterable.E"));
    },
    AndroidApiLevel_parse(apiLevel) {
      ...
      if (levelInt == null)
        t1.call$0();
      return B.JSArray_methods.firstWhere$2$orElse(B.List_8TW, new A.AndroidApiLevel_parse_closure(levelInt), t1);
    },
    AndroidApiLevel_allApiLevels() {
      var t1 = type$.MappedListIterable_AndroidApiLevel_int;
      return A.List_List$of(new A.MappedListIterable(B.List_8TW, type$.int_Function_AndroidApiLevel._as(new A.AndroidApiLevel_allApiLevels_closure()), t1), true, t1._eval$1("ListIterable.E"));
    },
    AndroidSystemImageTarget_parse(target) {
      return B.JSArray_methods.firstWhere$2$orElse(B.List_7Lk, new A.AndroidSystemImageTarget_parse_closure(target), new A.AndroidSystemImageTarget_parse_closure0(target));
    },
    AndroidSystemImageTarget_allTags() {
      var t1 = type$.MappedListIterable_AndroidSystemImageTarget_String;
      return A.List_List$of(new A.MappedListIterable(B.List_7Lk, type$.String_Function_AndroidSystemImageTarget._as(new A.AndroidSystemImageTarget_allTags_closure()), t1), true, t1._eval$1("ListIterable.E"));
    },
    ...
    ChildProcess_spawn(_this, command, args, environment, includeParentEnvironment, mode, runInShell, stdin, workingDirectory) {
      ...
      childProc = A.callMethod(_this, "spawn", [command, t3, {cwd: workingDirectory, env: t2, stdio: t1, detached: t5, shell: null}], t4);
      childProc.setMaxListeners(0);
      t1 = type$.nullable_JSObject;
      t2 = t1._as(childProc.stdout);
      if (t2 != null)
        t2.setMaxListeners(0);
      t1 = t1._as(childProc.stderr);
      if (t1 != null)
        t1.setMaxListeners(0);
      return childProc;
    },
    NodeChildProcess_get_onError(_this) {
      var t2,
        t1 = $.$get$_errorEvents();
      A.Expando__checkType(_this);
      t2 = t1._jsWeakMap.get(_this);
      if (t2 == null) {
        t2 = A.EventEmitter_once(_this, "error", type$.JSObject);
    ...
    NodeReadableStream_get_stream(_this) {
      var controller = A.StreamController_StreamController$broadcast(true, type$.List_int),
        t1 = type$.Function,
        dataListener = A.allowInterop(new A.NodeReadableStream_get_stream_onData(controller), t1),
        errorListener = A.allowInterop(new A.NodeReadableStream_get_stream_onError(controller), t1),
        doneListener = A.allowInterop(new A.NodeReadableStream_get_stream_onDone(controller), t1);
      controller.set$onListen(new A.NodeReadableStream_get_stream_closure(_this, dataListener, errorListener, doneListener));
      controller.set$onCancel(new A.NodeReadableStream_get_stream_closure0(_this, dataListener, errorListener, doneListener));
    ...
    NodeReadableStream_get_stream_closure0: function NodeReadableStream_get_stream_closure0(t0, t1, t2, t3) {
      var _ = this;
      _._this = t0;
      _.dataListener = t1;
      _.errorListener = t2;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              // finally
              $async$handler = 2;
              A.callMethod(_this, "rmSync", [tempDir, {recursive: true}], type$.void);
              // goto the next finally handler
              $async$goto = $async$next.pop();
              break;
            case 5:
  ...
  A._BroadcastStreamController.prototype = {
    ...
    _subscribe$4(onData, onError, onDone, cancelOnError) {
      ...
      subscription = new A._BroadcastSubscription(_this, t5, t6, t2.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t4), t2, t3, t1);
      subscription.set$_previous(subscription);
      subscription.set$_async$_next(subscription);
      t1._as(subscription);
  ...
  A._BoundSinkStream.prototype = {
    listen$4$cancelOnError$onDone$onError(onData, cancelOnError, onDone, onError) {
      ...
      t5 = type$.void;
      t6 = t3.registerUnaryCallback$2$1(onData, t5, t2);
      t7 = A._BufferingStreamSubscription__registerErrorHandler(t3, onError);
      t2 = t1._eval$1("@<1>")._bind$1(t2);
      subscription = new A._SinkTransformerStreamSubscription(t6, t7, t3.registerCallback$1$1(onDone == null ? A.async___nullDoneHandler$closure() : onDone, t5), t3, t4, t2._eval$1("_SinkTransformerStreamSubscription<1,2>"));
  ...
  A.AvdManager__startEmulator_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.NodeProcess),
  ...
  A.SdkManager__ensureCmdlineTools_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, _0_0, toolCachePath, downloadUrl, downloadPath, extractPath, t1, t2, t3, t4;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (t3) {
                t2._as(t1.core).info("Found cached cmdline-tools install: " + A.S(toolCachePath));
                // goto return
                $async$goto = 1;
                break;
              }
  ...
  A.NodeReadableStream_get_stream_closure.prototype = {
    call$0() {
      var _this = this,
        t1 = _this._this;
      t1.addListener("data", _this.dataListener);
      t1.addListener("error", _this.errorListener);
      t1.addListener("close", _this.doneListener);
    },
    $signature: 0
  };
  A.NodeReadableStream_get_stream_closure0.prototype = {
    call$0() {
      var _this = this,
        t1 = _this._this;
      t1.removeListener("data", _this.dataListener);
      t1.removeListener("error", _this.errorListener);
      t1.removeListener("close", _this.doneListener);
    },
    $signature: 5
  };
  ...
  A.nodeProcessManager_closure.prototype = {
    call$0() {
      var pm = new A.NodeProcessManager(A.LinkedHashSet_LinkedHashSet$_empty(type$.NodeProcess)),
        t1 = $.$get$context0(),
  ...
  A.NodeProcessManager.prototype = {
    ...
    run$body$NodeProcessManager(command, echoOutput, pipe) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.ProcessResult),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, stdoutSub, stderrSub, exitCode, process, pid0, pid, stdout, stderr, t1, t2;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              pid0 = A._asIntQ(process.jsProcess.pid);
              pid = pid0 == null ? -1 : pid0;
    ...
    runSync$1(command) {
      var t1, _0_0, executable, args, result, _null = null;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.List_int;
              nodeProcess = new A.NodeProcess(executable, args, A.ChildProcess_spawn(t1, executable, args, environment, true, mode, false, pipe == null ? null : type$.nullable_JSObject._as(pipe.stdout), workingDirectory), A.StreamController_StreamController$broadcast(true, t2), A.StreamController_StreamController(true, t2), A.StreamController_StreamController(true, t2));
              $async$goto = 3;
            ...
            case 3:
              // returning from await.
              $async$self._activeProcesses.add$1(0, nodeProcess);
      ...
      var $async$close$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              for (t1 = $async$self._activeProcesses, t1 = A._LinkedHashSetIterator$(t1, t1._collection$_modifications, t1.$ti._precomputed1), t2 = t1.$ti._precomputed1; t1.moveNext$0();) {
                t3 = t1._collection$_current;
                (t3 == null ? t2._as(t3) : t3).close$0()._state |= 1;
              }
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
  ...
  A.NodeProcess.prototype = {
          ...
          switch ($async$goto) {
            case 0:
              ...
              if (t4) {
                ...
                $async$self.set$_stdinSub(new A._BroadcastStream(t4, t5._eval$1("_BroadcastStream<1>")).listen$1(new A.NodeProcess__init_closure(t1)));
              }
              ...
              if (t1)
                A.StreamForward_forward(A.NodeReadableStream_get_stream(stdout), t4, type$.List_int);
              else
                t4.close$0();
              ...
              if (t1)
                A.StreamForward_forward(A.NodeReadableStream_get_stream(stderr), t3, type$.List_int);
              else
                t3.close$0();
              t1 = $.$get$_spawnEvents();
              A.Expando__checkType(t2);
              t3 = t1._jsWeakMap.get(t2);
              if (t3 == null) {
                t3 = A.EventEmitter_once(t2, "spawn", type$.nullable_Object);
                t1.$indexSet(0, t2, t3);
                t1 = t3;
              } else
                t1 = t3;
              $async$goto = 2;
              return A._asyncAwait(A.Future_any(A._setArrayType([t1, A.NodeChildProcess_get_onError(t2).then$1$1(new A.NodeProcess__init_closure0($async$self), type$.Never)], type$.JSArray_Future_void), type$.void), $async$_init$0);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
    ...
    get$exitCode() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, exitCode, t2, t3, t4, t5, t1, _0_0;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t3 = t2._jsWeakMap.get(t1);
              if (t3 == null) {
                t3 = A.EventEmitter_once(t1, "close", type$.nullable_Object);
                t2.$indexSet(0, t1, t3);
                t2 = t3;
              } else
                t2 = t3;
              t3 = A.NodeChildProcess_get_onError(t1);
              t4 = $.$get$_exitEvents();
              A.Expando__checkType(t1);
              t5 = t4._jsWeakMap.get(t1);
              if (t5 == null) {
                t5 = A.EventEmitter_once(t1, "exit", type$.double);
                t4.$indexSet(0, t1, t5);
                t4 = t5;
              } else
                t4 = t5;
              $async$goto = 3;
              return A._asyncAwait(A.Future_any(A._setArrayType([t2, t3, t4], type$.JSArray_Future_void), type$.void), $async$get$exitCode);
            case 3:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = $async$self.jsProcess;
              A._asBool(t1.kill("SIGTERM"));
              t2 = $async$self._stdinSub;
              t2 = t2 == null ? null : t2.cancel$0();
              $async$goto = 2;
              return A._asyncAwait(t2 instanceof A._Future ? t2 : A._Future$value(t2, type$.void), $async$close$0);
            case 2:
              // returning from await.
              $async$self.set$_stdinSub(null);
              t2 = $async$self._stdinSink;
              t2 = t2 == null ? null : t2.close$0();
              t3 = type$.dynamic;
              $async$goto = 3;
              return A._asyncAwait(t2 instanceof A._Future ? t2 : A._Future$value(t2, t3), $async$close$0);
            case 3:
              // returning from await.
              $async$self._stdinSink = null;
              t2 = A._setArrayType([], type$.JSArray_Future_dynamic);
              t4 = $async$self._stdin;
              if ((t4._state & 4) === 0)
                t2.push(t4.close$0());
              t4 = $async$self._stdout;
              if ((t4._state & 4) === 0)
                t2.push(t4.close$0());
              t4 = $async$self._stderr;
              if ((t4._state & 4) === 0)
                t2.push(t4.close$0());
              $async$goto = 4;
              return A._asyncAwait(A.Future_wait(t2, t3), $async$close$0);
            case 4:
              // returning from await.
  ...
  A.MultiSectionMapping.prototype = {
    MultiSectionMapping$fromJson$3$mapUrl(sections, otherMaps, mapUrl) {
      ...
      for (t1 = J.cast$1$0$ax(sections, type$.Map_dynamic_dynamic), t2 = A._instanceType(t1), t1 = new A.ListIterator(t1, t1.get$length(t1), t2._eval$1("ListIterator<ListBase.E>")), t3 = this._maps, t4 = this._parser$_lineStart, t5 = this._columnStart, t6 = type$.nullable_Map_dynamic_dynamic, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 28, 0);
    ...
    _instance_1_u(_ = A._BroadcastStreamController.prototype, "get$_async$_add", "_async$_add$1", 13);
    ...
    _instance_1_u(_ = A._StreamController.prototype, "get$_async$_add", "_async$_add$1", 13);
    _instance_2_u(_, "get$_addError", "_addError$2", 3);
    _instance_0_u(_, "get$_close", "_close$0", 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 77);
    ...
    _instance_0_u(A.NodeProcessManager.prototype, "get$close", "close$0", 4);
    ...
    _instance(_ = A.StackZoneSpecification.prototype, "get$_registerCallback", 0, 4, null, ["call$1$4", "call$4"], ["_registerCallback$1$4", "_registerCallback$4"], 25, 0, 0);
    _instance(_, "get$_registerUnaryCallback", 0, 4, null, ["call$2$4", "call$4"], ["_registerUnaryCallback$2$4", "_registerUnaryCallback$4"], 26, 0, 0);
    _instance(_, "get$_registerBinaryCallback", 0, 4, null, ["call$3$4", "call$4"], ["_registerBinaryCallback$3$4", "_registerBinaryCallback$4"], 27, 0, 0);
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 74, 0, 0);
    _instance(_, "get$_errorCallback", 0, 5, null, ["call$5"], ["_errorCallback$5"], 28, 0, 0);
    ...
    _static_0(A, "launch_android_emulator___action$closure", "_action", 4);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "Future<Null>()", "~(Object,StackTrace)", "Future<~>()", "Null()", "Future<ProcessResult>()", "Trace()", "Frame()", "Frame(String)", "~(@)", "String(String)", "Null(@)", "~(Object?)", "0&()", "~(~())", "~(String,@)", "Null(Object,StackTrace)", "@()", "~(Uint8List,String,int)", "~(String)", "String(Match)", "Trace(String)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "_Future<@>(@)", "Object?(Object?)", "Future<0&>()", "@(@,String)", "Future<~>(Object,Chain)", "@(String)", "Future<NodeProcess>()", "Future<bool>()", "bool(Exception)", "Future<~>(Exception)", "@(@)", "bool(AndroidAbi)", "~(@,@)", "String(AndroidAbi)", "bool(AndroidApiLevel)", "int(AndroidApiLevel)", "bool(AndroidSystemImageTarget)", "String(AndroidSystemImageTarget)", "~(Uint8List)", "~(JSObject)", "~([Object?])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "~(Object?,Object?)", "~(List<int>)", "0&(JSObject)", "Future<Null>(String)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "Null(@,StackTrace)", "bool(TargetLineEntry)", "bool(TargetEntry)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "_LineSplitterEventSink(EventSink<String>)", "List<Frame>(Trace)", "int(Trace)", "~(Symbol0,@)", "String(Trace)", "~(String,int)", "~(String,int?)", "Frame(String,String)", "int(int,int)", "~(int,@)", "Uint8List(@,@)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Null(~())", "Chain()", "~(@,StackTrace?)", "Future<0^>([0^/?])<Object?>", "~(Object?[Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "0^(0^,0^)<num>", "AndroidAbi(String)", "AndroidApiLevel(String)", "AndroidSystemImageTarget(String)", "Null(@,@)", "Map<String,int>()"],
  ...
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"UnmodifiableListBase":1,"__CastListBase__CastIterableBase_ListMixin":2,"NativeTypedArray":1,"StreamTransformerBase":2,"_DelayedEvent":1,"_SetBase":1}'));
  var string$ = {
  ...
  (function constants() {
    ...
    B.AndroidAbi_A6D = new A.AndroidAbi("arm64-v8a", "arm64");
...
;
    ...
    B.AndroidSystemImageTarget_D34 = new A.AndroidSystemImageTarget("google_apis_playstore", "googleApisPlaystore");
    B.List_7Lk = A._setArrayType(makeConstList([B.AndroidSystemImageTarget_default_default$, B.AndroidSystemImageTarget_google_apis_googleApis, B.AndroidSystemImageTarget_D34]), A.findType("JSArray<AndroidSystemImageTarget>"));
    ...
    B.List_s6Q = A._setArrayType(makeConstList([B.AndroidAbi_x86_x86, B.AndroidAbi_x86_64_x86_64, B.AndroidAbi_A6D]), A.findType("JSArray<AndroidAbi>"));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "_spawnEvents", "$get$_spawnEvents", () => A.Expando$(null, A.findType("Future<~>")));
    _lazyFinal($, "_errorEvents", "$get$_errorEvents", () => A.Expando$(null, A.findType("Future<JSObject>")));
    _lazyFinal($, "_exitEvents", "$get$_exitEvents", () => A.Expando$(null, A.findType("Future<double>")));
    _lazyFinal($, "_closeEvents", "$get$_closeEvents", () => A.Expando$(null, A.findType("Future<~>")));
