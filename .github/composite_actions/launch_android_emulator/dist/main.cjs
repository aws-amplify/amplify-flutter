...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _action() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t1, apiLevel, target, abi, inputValue, script;
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              // returning from await.
              $async$goto = 4;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Running script", new A._action_closure(script), type$.void), $async$_action);
            case 4:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 73, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 76, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 15, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 77, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 78, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 79, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 80, 0);
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 81, 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 57);
    _static(A, "math__max$closure", 2, null, ["call$1$2", "call$2"], ["max", function(a, b) {
      return A.max(a, b, type$.num);
    }], 82, 0);
    _static_1(A, "types_AndroidAbi_parse$closure", "AndroidAbi_parse", 83);
    _static_1(A, "types_AndroidApiLevel_parse$closure", "AndroidApiLevel_parse", 84);
    _static_1(A, "types_AndroidSystemImageTarget_parse$closure", "AndroidSystemImageTarget_parse", 85);
    ...
    _instance(_ = A.StackZoneSpecification.prototype, "get$_registerCallback", 0, 4, null, ["call$1$4", "call$4"], ["_registerCallback$1$4", "_registerCallback$4"], 20, 0, 0);
    ...
    _instance(_, "get$_registerBinaryCallback", 0, 4, null, ["call$3$4", "call$4"], ["_registerBinaryCallback$3$4", "_registerBinaryCallback$4"], 16, 0, 0);
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 68, 0, 0);
    _instance(_, "get$_errorCallback", 0, 5, null, ["call$5"], ["_errorCallback$5"], 15, 0, 0);
    _static_1(A, "trace_Trace___parseVM_tearOff$closure", "Trace___parseVM_tearOff", 24);
    _static_1(A, "trace_Trace___parseFriendly_tearOff$closure", "Trace___parseFriendly_tearOff", 24);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "Future<Null>()", "Future<~>()", "~(Object,StackTrace)", "Trace()", "Future<ProcessResult>()", "Frame()", "Frame(String)", "~(@)", "String(String)", "Null()", "~(~())", "0&()", "Null(@)", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "Null(Object,StackTrace)", "~(Object?)", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "@()", "String(Frame)", "int(Frame)", "Trace(String)", "String(Match)", "~(String)", "Future<Process>()", "Future<bool>()", "Future<~>(Object,Chain)", "bool(Exception)", "Future<~>(Exception)", "Null(~())", "Future<Null>(String)", "bool(AndroidAbi)", "Future<0&>()", "String(AndroidAbi)", "bool(AndroidApiLevel)", "int(AndroidApiLevel)", "bool(AndroidSystemImageTarget)", "String(AndroidSystemImageTarget)", "~(NativeUint8List)", "~(JSObject)", "~(@,@)", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "Object?(Object?)", "~(List<int>)", "0&(JSObject)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "Null(@,@)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "~(@,StackTrace?)", "List<Frame>(Trace)", "int(Trace)", "0&(String,int?)", "String(Trace)", "_LineSplitterEventSink(EventSink<String>)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "Frame(String,String)", "~(Object?,Object?)", "@(String)", "@(@,String)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "~(int,@)", "Chain()", "Null(@,StackTrace)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "0^(0^,0^)<num>", "AndroidAbi(String)", "AndroidApiLevel(String)", "AndroidSystemImageTarget(String)", "@(@)", "~([@])"],
