...
(function dartProgram() {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 55, 0);
    ...
    _instance(_, "get$_registerUnaryCallback", 0, 4, null, ["call$2$4", "call$4"], ["_registerUnaryCallback$2$4", "_registerUnaryCallback$4"], 12, 0, 0);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 43, 0, 0);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "Trace()", "Frame()", "Future<~>()", "Frame(String)", "Null()", "~(@)", "String(String)", "~(~())", "Trace(String)", "Null(@)", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "@()", "~(NativeUint8List)", "String(Match)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "Future<String?>()", "Future<ExecResult>()", "Future<~>(Object,Chain)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "Null(Object,StackTrace)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "~(@,@)", "List<Frame>(Trace)", "int(Trace)", "~(Object?,Object?)", "String(Trace)", "@(@,String)", "~(String,int)", "Frame(String,String)", "~(String,int?)", "0^(0^,0^)<num>", "int(int,int)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Null(~())", "Chain()", "Future<0&>()", "Null(@,StackTrace)", "bool(Map<String,Object?>)", "Future<Null>()", "@(@)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "~(int,@)", "@(String)", "~(Object,StackTrace)"],
