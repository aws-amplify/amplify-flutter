...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Future_wait(futures, $T) {
      var handleError, future, pos, e, st, t2, t3, t4, t5, exception, error, stackTrace, replacement, _box_0 = {}, cleanUp = null,
        eagerError = false,
    ...
    Exec_exec$body(_this, commandLine, args, echoOutput) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, exitCode, exception, stdout, stderr, t1, t2, options, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              options = {listeners: {stdout: t2._as(A.allowInterop(new A.Exec_exec_closure(stdout), t1)), stderr: t2._as(A.allowInterop(new A.Exec_exec_closure0(stderr), t1))}, cwd: null, silent: !echoOutput, ignoreReturnCode: false};
              $async$handler = 4;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.Exec_exec(type$.JSObject._as(self.exec), "sudo", A._setArrayType(["xcrun", "simctl", "list", "runtimes", "&&", "sudo", "xcodes", "runtimes", "install", $async$self.iosVersion, "--no-color"], type$.JSArray_String), true), $async$call$0);
            case 2:
              // returning from await.
              if ($async$result.exitCode !== 0)
