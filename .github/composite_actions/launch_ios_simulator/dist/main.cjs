  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    Exec_exec$body(_this, commandLine, args, echoOutput) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, exitCode, t2, exception, stdout, stderr, t1, options, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = type$.Function;
              options = {listeners: {stdout: A.allowInterop(new A.Exec_exec_closure(stdout), t1), stderr: A.allowInterop(new A.Exec_exec_closure0(stderr), t1)}, cwd: null, silent: !echoOutput, ignoreReturnCode: false};
              $async$handler = 4;
