...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Future_wait(futures, $T) {
      var handleError, future, pos, e, st, t2, t3, t4, t5, exception, _0_0, _box_0 = {}, cleanUp = null,
        eagerError = false,
      ...
      try {
        for (t2 = futures.$ti, t3 = new A.ListIterator(futures, futures.get$length(0), t2._eval$1("ListIterator<ListIterable.E>")), t4 = type$.Null, t2 = t2._eval$1("ListIterable.E"); t3.moveNext$0();) {
          t5 = t3.__internal$_current;
          future = t5 == null ? t2._as(t5) : t5;
          pos = _box_0.remaining;
          future.then$1$2$onError(new A.Future_wait_closure(_box_0, pos, _future, $T, cleanUp, eagerError), handleError, t4);
          ++_box_0.remaining;
        }
        t2 = _box_0.remaining;
        if (t2 === 0) {
    ...
    Exec_exec$body(_this, commandLine, args, echoOutput) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$currentError, exitCode, t1, t2, exception, stdout, stderr, options, $async$exception;
    ...
    launch$body() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t2, t3, inputValue, iosVersionArg, iosVersion, t4, runtimeIdentifier, t1;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.Exec_exec(type$.JSObject._as(self.exec), "/bin/sh", A._setArrayType(["-c", "brew install xcodes"], type$.JSArray_String), true), $async$call$0);
            case 2:
              // returning from await.
              if ($async$result.exitCode !== 0)
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 55, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 58, 0);
    ...
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 63, 0);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 46, 0, 0);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "Trace()", "Frame()", "Future<~>()", "Frame(String)", "Null()", "~(@)", "String(String)", "~(~())", "Trace(String)", "Null(@)", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "@()", "~(Uint8List,String,int)", "~(NativeUint8List)", "String(Match)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "Future<String?>()", "Future<ExecResult>()", "Future<0&>()", "~(Object,StackTrace)", "@(String)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "_Future<@>(@)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "~(@,@)", "List<Frame>(Trace)", "int(Trace)", "~(Object?,Object?)", "String(Trace)", "@(@,String)", "~(String,int)", "Frame(String,String)", "~(String,int?)", "0^(0^,0^)<num>", "int(int,int)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Null(~())", "Chain()", "Uint8List(@,@)", "Null(@,StackTrace)", "bool(Map<String,Object?>)", "Future<Null>()", "@(@)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "~(int,@)", "Future<~>(Object,Chain)", "Null(Object,StackTrace)"],
...
;
    ...
    B.List_empty0 = A._setArrayType(makeConstList([]), type$.JSArray_nullable_String);
