...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Exec_exec$body(_this, commandLine, args, echoOutput) {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$handler = 2, $async$errorStack = [], jsExitCode, exitCode, t1, t2, exception, stdout, stderr, options, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              options = {listeners: {stdout: A._functionToJS1(new A.Exec_exec_closure(stdout)), stderr: A._functionToJS1(new A.Exec_exec_closure0(stderr))}, cwd: null, silent: !echoOutput, ignoreReturnCode: false};
              $async$handler = 4;
              t1 = A._arrayInstanceType(args);
              t2 = t1._eval$1("MappedListIterable<1,String>");
              t1 = A.List_List$_of(new A.MappedListIterable(args, t1._eval$1("String(1)")._as(new A.Exec_exec_closure1()), t2), t2._eval$1("ListIterable.E"));
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(_this.exec(commandLine, t1, options)), type$.nullable_Object), $async$Exec_exec);
            case 7:
              // returning from await.
              jsExitCode = $async$result;
              exitCode = A._asInt(A._asDouble(jsExitCode));
              t1 = stdout._contents;
              stderr.toString;
              $async$returnValue = new A.ExecResult(exitCode, t1.charCodeAt(0) == 0 ? t1 : t1);
              // goto return
              $async$goto = 1;
              break;
              $async$handler = 2;
    ...
    launch() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$errorStack = [], device, runtimeIdentifier, launchResult, e, st, script, t2, maxRetries, retryTimeoutMinutes, iosVersion, t3, t4, t5, t6, t7, lastError, attempt, t8, t9, t10, exception, testResult, t1, inputValue, iosVersionArg, $async$exception;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              inputValue = A._asString(A._asJSObject(t1.core).getInput("ios-version"));
              iosVersionArg = inputValue.length === 0 ? "" : inputValue;
              inputValue = A._asString(A._asJSObject(t1.core).getInput("device"));
              device = inputValue.length === 0 ? "iPhone 17 Pro Max" : inputValue;
              ...
              retryTimeoutMinutes = A.Core_getTypedInput(A._asJSObject(t1.core), "retry-timeout-minutes", 90, A.core_int_parse$closure(), t2);
              $async$goto = 3;
              return A._asyncAwait(A.installXcodes(), $async$launch);
            case 3:
              // returning from await.
              $async$goto = iosVersionArg === "latest" ? 4 : 6;
              break;
            case 4:
              // then
              $async$goto = 7;
            ...
            case 5:
              ...
              A._asJSObject(t1.core).info("Will launch simulator for " + iosVersion);
              t2 = type$.nullable_String;
              $async$goto = 8;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Check for existing runtime", new A.launch_closure(iosVersion), t2), $async$launch);
            case 8:
              // returning from await.
            ...
            case 9:
              // then
              A._asJSObject(t1.core).info("No runtime found for " + iosVersion);
              $async$goto = 11;
            ...
            case 10:
              // join
              $async$goto = 12;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Get runtime ID", new A.launch_closure0(iosVersion), t2), $async$launch);
            case 12:
              // returning from await.
              runtimeIdentifier = $async$result;
            ...
            case 13:
              ...
              $async$handler = 17;
              $async$goto = 20;
              return A._asyncAwait(A._launchSimulator(runtimeIdentifier, device), $async$launch);
            case 20:
              // returning from await.
              A._asJSObject(t1.core).info("\u2705 Simulator launched successfully");
            ...
            case 17:
              ...
              A._asJSObject(t1.core).warning("\u274c Simulator launch failed: " + A.S(e));
            ...
            case 19:
              // after finally
              $async$goto = !launchResult._2 ? 21 : 22;
              break;
            case 21:
              // then
              ...
              t8.warning("\u274c ATTEMPT " + t10 + " FAILED - Simulator launch failed");
              t8.warning("   Error: " + A.S(launchResult._0));
              t8.warning("   Time: " + new A.DateTime(Date.now(), 0, false).toUtc$0().toIso8601String$0());
              t8.warning(string$.u2550_____);
              t8.warning("");
              $async$goto = attempt < maxRetries ? 23 : 24;
              break;
            case 23:
              // then
              $async$goto = 25;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "\ud83e\uddf9 Attempt " + t10 + ": Cleanup before retry " + (attempt + 1), A.launch_ios_simulator___cleanupAndWait$closure(), t6), $async$launch);
            case 25:
              // returning from await.
            case 24:
              // join
            ...
            case 22:
              ...
              t9.info("");
              $async$goto = 26;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "\u25b6\ufe0f Attempt " + t10 + ": Run tests", new A.launch_closure1(retryTimeoutMinutes, attempt, script), t4), $async$launch);
            case 26:
              // returning from await.
              ...
              $async$goto = attempt < maxRetries ? 27 : 28;
              break;
            case 27:
              // then
              $async$goto = 29;
    ...
    _launchSimulator(runtimeIdentifier, device) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        t2, t1;
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              A._asJSObject(t1.core).info('Creating simulator with device "' + device + '" for runtime ' + runtimeIdentifier);
              t2 = type$.ExecResult;
              $async$goto = 2;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Create simulator", new A._launchSimulator_closure(device, runtimeIdentifier), t2), $async$_launchSimulator);
            case 2:
              // returning from await.
              if ($async$result.exitCode !== 0)
                throw A.wrapException(A.Exception_Exception("Could not create simulator"));
              $async$goto = 3;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Boot simulator", new A._launchSimulator_closure0(), t2), $async$_launchSimulator);
            case 3:
              // returning from await.
              if ($async$result.exitCode !== 0)
      ...
      return A._asyncStartSync($async$_launchSimulator, $async$completer);
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return A._asyncAwait(A._cleanupSimulator(), $async$_cleanupAndWait);
            case 2:
              // returning from await.
    ...
    _cleanupSimulator() {
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$exception = $async$errorStack.pop();
              e = A.unwrapException($async$exception);
              A._asJSObject(t1.core).warning("   \u26a0 Failed to shutdown simulator: " + A.S(e));
              // goto after finally
              $async$goto = 5;
              break;
            case 2:
            ...
            case 13:
              ...
              A._asJSObject(t1.core).warning("   \u26a0 Failed to kill Simulator.app: " + A.S(e1));
              // goto after finally
              $async$goto = 15;
              break;
            case 12:
            ...
            case 18:
              ...
              A._asJSObject(t1.core).warning("   \u26a0 Failed to kill launchd_sim: " + A.S(e2));
              // goto after finally
              $async$goto = 20;
              break;
            case 17:
            ...
            case 20:
              ...
              $async$goto = 22;
              return A._asyncAwait(A.Future_Future$delayed(B.Duration_5000000, type$.void), $async$_cleanupSimulator);
            case 22:
              // returning from await.
      ...
      return A._asyncStartSync($async$_cleanupSimulator, $async$completer);
    },
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.Exec_exec(A._asJSObject(init.G.exec), "xcrun", A._setArrayType(["simctl", "list", "runtimes", "-j"], type$.JSArray_String), false), $async$getRuntimeId);
            case 3:
              // returning from await.
    ...
    installXcodes() {
      return A.Core_withGroup(A._asJSObject(init.G.core), "Install xcodes", new A.installXcodes_closure(), type$.void);
    },
    getLatest() {
      var $async$goto = 0,
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return A._asyncAwait(A.Exec_exec(A._asJSObject(init.G.exec), "/bin/sh", A._setArrayType(["-c", 'xcodes runtimes | grep -e "iOS" | tail -n 1'], type$.JSArray_String), true), $async$getLatest);
            case 3:
              // returning from await.
      ...
      return A._asyncStartSync($async$getLatest, $async$completer);
    },
    ...
    launch_closure1: function launch_closure1(t0, t1, t2) {
    ...
    Core_getTypedInput(_this, $name, defaultValue, parse, $T) {
      var inputValue = A._asString(_this.getInput($name)),
      ...
      var $async$FileSystem_withTempDir = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              tempDir = A._asString(_this.mkdtempSync(A.join(A._asString(A._asJSObject(init.G.os).tmpdir()), prefix)));
              $async$handler = 3;
              $async$goto = 6;
    ...
    IterableExtension_firstWhereOrNull(_this, test, $T) {
      var t1, t2, element;
      for (t1 = _this.$ti, t2 = new A.ListIterator(_this, _this.get$length(0), t1._eval$1("ListIterator<ListBase.E>")), t1 = t1._eval$1("ListBase.E"); t2.moveNext$0();) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              t1 = init.G;
              mappedStackChain = A.mapStackTrace(A.parseJson(type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(A._asString(A._asJSObject(t1.fs).readFileSync(A.join(A._asString(t1.__dirname), "main.cjs.map"), "utf8")), null)), null, null), chain, false, null, null);
              t2 = A._asJSObject(t1.core);
  ...
  A.Exec_exec_closure.prototype = {
    call$1(buffer) {
      var t1 = this.stdout,
        t2 = B.Utf8Codec_false.decode$1(type$.NativeUint8List._as(buffer));
      t1._contents += t2;
      return null;
    },
    $signature: 12
        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              A._asJSObject(init.G.core).info("Found runtime ID: " + A.S(runtimeId));
  ...
  A._launchSimulator_closure.prototype = {
    call$0() {
      return A.Exec_exec(A._asJSObject(init.G.exec), "xcrun", A._setArrayType(["simctl", "create", "test", this.device, this.runtimeIdentifier], type$.JSArray_String), true);
    },
    $signature: 18
  };
  A._launchSimulator_closure0.prototype = {
    call$0() {
      return A.Exec_exec(A._asJSObject(init.G.exec), "xcrun", A._setArrayType(["simctl", "boot", "test"], type$.JSArray_String), true);
    },
    $signature: 18
  };
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.Exec_exec(A._asJSObject(init.G.exec), "brew", A._setArrayType(["install", "homebrew/core/xcodes", "aria2"], type$.JSArray_String), true), $async$call$0);
            case 2:
              // returning from await.
              if ($async$result.exitCode !== 0)
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.Exec_exec(A._asJSObject(init.G.exec), "sudo", A._setArrayType(["xcodes", "runtimes", "install", $async$self.iosVersion, "--no-color"], type$.JSArray_String), true), $async$call$0);
            case 2:
              // returning from await.
              if ($async$result.exitCode !== 0)
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 14, 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 47);
    ...
    _instance(_, "get$_registerUnaryCallback", 0, 4, null, ["call$2$4", "call$4"], ["_registerUnaryCallback$2$4", "_registerUnaryCallback$4"], 17, 0, 0);
    _instance(_, "get$_registerBinaryCallback", 0, 4, null, ["call$3$4", "call$4"], ["_registerBinaryCallback$3$4", "_registerBinaryCallback$4"], 15, 0, 0);
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 55, 0, 0);
    _instance(_, "get$_errorCallback", 0, 5, null, ["call$5"], ["_errorCallback$5"], 14, 0, 0);
    ...
    _static_0(A, "launch_ios_simulator__launch$closure", "launch", 2);
    _static_0(A, "launch_ios_simulator___cleanupAndWait$closure", "_cleanupAndWait", 2);
