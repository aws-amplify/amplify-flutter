...
(function dartProgram() {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 7;
              return A._asyncAwait(A.promiseToFuture(type$.JSObject._as(_this.exec.apply(_this, [commandLine, A.List_List$of(new A.MappedListIterable(args, t1._eval$1("String(1)")._as(new A.Exec_exec_closure1()), t2), true, t2._eval$1("ListIterable.E")), options])), type$.int), $async$Exec_exec);
            case 7:
              // returning from await.
  ...
  A.Exec_exec_closure.prototype = {
    call$1(buffer) {
      this.stdout._contents += B.C_Utf8Codec.decode$1(type$.NativeUint8List._as(buffer));
      return null;
    },
    $signature: 16
  };
  A.Exec_exec_closure0.prototype = {
    call$1(buffer) {
      this.stderr._contents += B.C_Utf8Codec.decode$1(type$.NativeUint8List._as(buffer));
      return null;
    },
    $signature: 16
  };
