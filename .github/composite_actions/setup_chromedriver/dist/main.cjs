...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ChromePlatform_fromOsArch(os, arch) {
      var _0_6_isSet, _0_6, _0_4, t1, _0_8, _0_4_isSet, _null = null;
      $label0$0: {
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 71, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 74, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 19, 0);
    ...
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 79, 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 37);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 64, 0, 0);
    _instance(_, "get$_errorCallback", 0, 5, null, ["call$5"], ["_errorCallback$5"], 19, 0, 0);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Future<~>()", "Trace()", "Frame()", "Frame(String)", "Null()", "~(@)", "Null(@)", "String(String)", "Future<String>()", "~(~())", "~(String)", "String(Match)", "~(@,@)", "@()", "~(Uint8List,String,int)", "Object?(Object?)", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "String(Frame)", "int(Frame)", "Trace(String)", "~(Object?)", "ChromeDownload(@)", "Null(Object,StackTrace)", "bool(ChromeVersion)", "Future<~>(Object,Chain)", "Future<0&>()", "int(ChromeVersion)", "bool(ChromeDownload)", "ChromeVersion(@)", "@(String)", "~(NativeUint8List)", "~(@,StackTrace?)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "Null(@,@)", "~(List<int>)", "0&(JSObject)", "@(@)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "~(JSObject)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "Null(@,StackTrace)", "List<Frame>(Trace)", "int(0^,0^)<Comparable<0^>>", "Uint8List(@,@)", "String(Trace)", "@(@,String)", "0^(0^,0^)<num>", "Frame(String,String)", "int(int,int)", "~(String,int?)", "~(String,int)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "_LineSplitterEventSink(EventSink<String>)", "Chain()", "Null(~())", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "Future<0^>([0^/?])<Object?>", "~(Object?[Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "_Future<@>(@)", "~(Object?,Object?)", "~(int,@)", "int(Trace)"],
