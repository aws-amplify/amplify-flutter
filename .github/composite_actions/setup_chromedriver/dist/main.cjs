...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _$ChromeDownloadFromJson(json) {
      return new A.ChromeDownload(A.$enumDecode(B.Map_lhL02, json.$index(0, "platform"), type$.ChromePlatform, type$.String), A._asString(json.$index(0, "url")));
    },
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 65, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 68, 0);
    ...
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 73, 0);
    _instance_2_u(A._Future.prototype, "get$_completeError", "_completeError$2", 2);
    var _;
    _instance_1_u(_ = A._StreamController.prototype, "get$_add", "_add$1", 28);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 43);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 59, 0, 0);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Future<~>()", "Trace()", "Frame()", "Frame(String)", "Null()", "~(@)", "Null(@)", "String(String)", "Future<String>()", "~(~())", "int(Frame)", "Trace(String)", "@()", "Object?(Object?)", "bool(ChromeVersion)", "ChromeDownload(@)", "~(@,@)", "~(String)", "String(Match)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "Null(Object,StackTrace)", "~(Object?)", "NodeProcessManager()", "_LineSplitterEventSink(EventSink<String>)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "0&(String,int?)", "@(@,String)", "~(List<int>)", "Future<~>(Object,Chain)", "@(@)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "~(@,StackTrace?)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "Null(@,StackTrace)", "List<Frame>(Trace)", "int(Trace)", "int(0^,0^)<Comparable<0^>>", "String(Trace)", "Null(@,@)", "~(int,@)", "0^(0^,0^)<num>", "~(Object?,Object?)", "Future<0&>()", "@(String)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "Chain()", "Null(~())", "int(ChromeVersion)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "bool(ChromeDownload)", "ChromeVersion(@)", "Frame(String,String)", "0&(JSObject)"],
...
;
    ...
    B.ChromePlatform_1 = new A.ChromePlatform(1, "macArm64");
    B.ChromePlatform_2 = new A.ChromePlatform(2, "macX64");
    ...
    B.ChromePlatform_3 = new A.ChromePlatform(3, "win32");
    B.ChromePlatform_4 = new A.ChromePlatform(4, "win64");
    B.Map_lhL02 = new A.GeneralConstantMap([B.ChromePlatform_0, "linux64", B.ChromePlatform_1, "mac-arm64", B.ChromePlatform_2, "mac-x64", B.ChromePlatform_3, "win32", B.ChromePlatform_4, "win64"], A.findType("GeneralConstantMap<ChromePlatform,String>"));
