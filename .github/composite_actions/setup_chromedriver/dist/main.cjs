...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _$ChromeDownloadFromJson(json) {
      return new A.ChromeDownload(A.$enumDecode(B.Map_G1Drw, json.$index(0, "platform"), type$.ChromePlatform, type$.String), A._asString(json.$index(0, "url")));
    },
  ...
  A._installChromedriver_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t3, versionResult, exitCode, _0_2, _0_4, version, t1, t2;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait($.$get$processManager().run$2$echoOutput(A._setArrayType([t3, "--version"], type$.JSArray_String), true), $async$call$0);
            case 3:
              // returning from await.
  ...
  (function installTearOffs() {
    ...
    _instance_1_u(_ = A._StreamSinkImpl.prototype, "get$_completeDoneValue", "_completeDoneValue$1", 6);
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 32);
    ...
    _static_0(A, "setup_chromedriver___installChromedriver$closure", "_installChromedriver", 7);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Trace()", "Frame()", "Null()", "~(@)", "Future<~>()", "Frame(String)", "Null(@)", "String(String)", "Future<String>()", "~(~())", "Trace(String)", "~(String,@)", "@(String)", "Null(Object,StackTrace)", "~(Object?)", "~(@,@)", "@()", "~(Uint8List,String,int)", "Object?(Object?)", "bool(ChromeVersion)", "ChromeDownload(@)", "~(String)", "String(Match)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(@,StackTrace?)", "Future<~>(Object,Chain)", "Null(@,StackTrace)", "int(ChromeVersion)", "bool(ChromeDownload)", "ChromeVersion(@)", "~(Object?,Object?)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "~(int,@)", "~(List<int>)", "0&(JSObject)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "_LineSplitterEventSink(EventSink<String>)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "~(Symbol0,@)", "int(0^,0^)<Comparable<0^>>", "int(Trace)", "~(String,int)", "String(Trace)", "~(String,int?)", "int(int,int)", "Frame(String,String)", "@(@)", "Uint8List(@,@)", "@(@,String)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Future<Null>()", "Chain()", "Null(@,@)", "_Future<@>(@)", "Future<0^>([0^/?])<Object?>", "~(Object?[Object?])", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Future<0&>()", "Null(~())", "0^(0^,0^)<num>", "List<Frame>(Trace)"],
...
;
    ...
    B.Map_G1Drw = new A.GeneralConstantMap([B.ChromePlatform_0, "linux64", B.ChromePlatform_1, "mac-arm64", B.ChromePlatform_2, "mac-x64", B.ChromePlatform_3, "win32", B.ChromePlatform_4, "win64"], A.findType("GeneralConstantMap<ChromePlatform,String>"));
    B.Object_empty = {};
