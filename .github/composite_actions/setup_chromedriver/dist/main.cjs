...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ChromePlatform_fromOsArch(os, arch) {
      var _0_6, t1, _0_4, _0_6_isSet, _0_4_isSet, _0_8, _null = null;
      $label0$0: {
        if (B.OS_1 === os) {
          _0_6 = B.Arch_1 === arch;
          t1 = _0_6;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = t1;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A.callMethod(_this, "getJson", [requestUrl, t1._as(A.jsify(B.Map_empty))], t1), t2), $async$HttpClient_getJson);
            case 3:
              // returning from await.
  ...
  A.MultiSectionMapping.prototype = {
    MultiSectionMapping$fromJson$3$mapUrl(sections, otherMaps, mapUrl) {
      ...
      for (t1 = J.cast$1$0$ax(sections, type$.Map_dynamic_dynamic), t2 = A._instanceType(t1), t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListBase.E>")), t3 = this._maps, t4 = this._lineStart, t5 = this._columnStart, t6 = type$.nullable_Map_dynamic_dynamic, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
