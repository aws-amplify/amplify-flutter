...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _Uri__uriDecode(text, start, end, encoding, plusToSpace) {
      ...
      return (encoding._allowMalformed ? B.Utf8Decoder_true : B.Utf8Decoder_false).convert$1(bytes);
    },
    ...
    ChromePlatform_fromOsArch(os, arch) {
      var _0_6_isSet, _0_6, t1, _0_4, _0_8, _0_4_isSet, _null = null;
      $label0$0: {
        _0_6_isSet = B.OS_1 === os;
        _0_6 = _null;
        if (_0_6_isSet) {
          _0_6 = B.Arch_1 === arch;
          t1 = _0_6;
        ...
        if (t1) {
          t1 = B.ChromePlatform_3;
          break $label0$0;
        }
        if (_0_8)
          t1 = B.Arch_0 === (_0_4_isSet ? _0_4 : arch);
        else
          t1 = false;
        if (t1) {
        ...
        t1 = A.throwExpression(A.UnsupportedError$("Unsupported OS/arch combo: " + new A._Record_2(os, arch).toString$0(0)));
      }
      return t1;
    },
    _$AllChromeDownloadsFromJson(json) {
      ...
      return new A.AllChromeDownloads(t1);
    },
    _$ChromeVersionDownloadsFromJson(json) {
      ...
      if (t2 != null) {
        ...
        A.List_List$_of(t2, t2.$ti._eval$1("ListIterable.E"));
      }
    ...
    _$ChromeDownloadFromJson(json) {
      return new A.ChromeDownload(A.$enumDecode(B.Map_ztHhK, json.$index(0, "platform"), type$.ChromePlatform, type$.String), A._asString(json.$index(0, "url")));
    },
    ...
    ChromePlatform: function ChromePlatform(t0, t1) {
      this.index = t0;
      this._name = t1;
    },
    ...
    main() {
      return A.wrapMain(A.setup_chromedriver___installChromedriver$closure());
    },
    _installChromedriver() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, chromeDriverUrl, installPath, t1, t2, chromeVersion, cachedPath;
      var $async$_installChromedriver = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.String;
              $async$goto = 3;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Getting Chrome version", new A._installChromedriver_closure(), t2), $async$_installChromedriver);
            case 3:
              // returning from await.
              chromeVersion = $async$result;
              cachedPath = A.ToolCache_find(A._asJSObject(t1.toolCache), "chromedriver", chromeVersion);
              if (cachedPath != null) {
                A._asJSObject(t1.core).info("Found cached install: " + cachedPath);
                $async$returnValue = A._asJSObject(t1.core).addPath(cachedPath);
                // goto return
                $async$goto = 1;
                break;
              }
              A._asJSObject(t1.core).info("ChromeDriver not found in cache.");
              $async$goto = 4;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Get ChromeDriver URL", new A._installChromedriver_closure0(chromeVersion), t2), $async$_installChromedriver);
            case 4:
              // returning from await.
              chromeDriverUrl = $async$result;
              $async$goto = 5;
              return A._asyncAwait(A.Core_withGroup(A._asJSObject(t1.core), "Download ChromeDriver", new A._installChromedriver_closure1(chromeDriverUrl, chromeVersion), t2), $async$_installChromedriver);
            case 5:
              // returning from await.
      ...
      return A._asyncStartSync($async$_installChromedriver, $async$completer);
    },
    _installChromedriver_closure: function _installChromedriver_closure() {
    },
    _installChromedriver_closure0: function _installChromedriver_closure0(t0) {
      this.chromeVersion = t0;
    },
    _installChromedriver_closure1: function _installChromedriver_closure1(t0, t1) {
      ...
      var $async$HttpClient_getJson = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              // Function start
              jsHeaders = A._asJSObject(new init.G.Headers());
              for (t1 = B.Map_empty.get$entries(), t2 = t1.$ti, t1 = new A._SyncStarIterator(t1._outerHelper(), t2._eval$1("_SyncStarIterator<1>")), t2 = t2._precomputed1; t1.moveNext$0();) {
                t3 = t1._async$_current;
                if (t3 == null)
                  t3 = t2._as(t3);
                jsHeaders.append(t3.key, t3.value);
              }
              t1 = type$.nullable_Object;
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(_this.getJson(requestUrl, jsHeaders)), t1), $async$HttpClient_getJson);
            case 3:
              // returning from await.
              result = $async$temp1._asJSObject($async$result);
              if (A._asInt(result.statusCode) !== 200)
                throw A.wrapException(A.Exception_Exception("Could not fetch " + requestUrl));
              t2 = A._asJSObjectQ(result.result);
              t2.toString;
              $async$returnValue = type$.Map_dynamic_dynamic._as(A.dartify(t2)).cast$2$0(0, type$.String, t1);
              // goto return
              $async$goto = 1;
              break;
            case 1:
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp1 = A;
              $async$goto = 3;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(_this.extractZip(file, null)), type$.nullable_Object), $async$ToolCache_extractZip);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1._asString($async$result);
              // goto return
    ...
    mergeSortBy(elements, keyOf, compare, $E, $K) {
      ...
      middle = B.JSInt_methods._shrOtherPositive$1(end, 1);
      secondLength = end - middle;
      scratchSpace = B.JSArray_methods.sublist$2(elements, 0, secondLength);
      A._mergeSort(elements, keyOf, compare, middle, end, scratchSpace, 0, $E, $K);
      A._mergeSort(elements, keyOf, compare, 0, middle, elements, secondLength, $E, $K);
      A._merge(keyOf, compare, elements, secondLength, end, scratchSpace, 0, secondLength, elements, 0, $E, $K);
    },
    ...
    _merge(keyOf, compare, firstList, firstStart, firstEnd, secondList, secondStart, secondEnd, target, targetOffset, $E, $K) {
      ...
      for (;; targetOffset = targetOffset0) {
    ...
    $enumDecode(enumValues, source, $K, $V) {
      ...
      for (t1 = enumValues.get$entries(), t2 = t1.$ti, t1 = new A._SyncStarIterator(t1._outerHelper(), t2._eval$1("_SyncStarIterator<1>")), t2 = t2._precomputed1; t1.moveNext$0();) {
        t3 = t1._async$_current;
        if (t3 == null)
          t3 = t2._as(t3);
        if (J.$eq$(t3.value, source))
          return t3.key;
      }
  ...
  A.wrapMain__closure0.prototype = {
    call$0() {
      return $.$get$context().runTearDowns$1(B.ActionResult_0);
    },
    $signature: 3
  };
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t3 = A._asString(t1.__dirname);
              mappedStackChain = A.mapStackTrace(A.parseJson(type$.Map_dynamic_dynamic._as(B.C_JsonCodec.decode$2$reviver(A._asString(t2.readFileSync($.$get$context0().join$16(0, t3, "main.cjs.map", null, null, null, null, null, null, null, null, null, null, null, null, null, null), "utf8")), null)), null, null), chain, false, null, null);
              t3 = A._asJSObject(t1.core);
  ...
  A.wrapMain__closure.prototype = {
    call$0() {
      return $.$get$context().runTearDowns$1(B.ActionResult_1);
    },
    $signature: 3
  };
  ...
  A.AllChromeDownloads.prototype = {
    chromeDriverUrl$2(version, platform) {
      ...
      if (url == null) {
        ...
        t4 = type$.num;
        t1 = A.List_List$_of(new A.WhereIterable(t1, t3._eval$1("bool(1)")._as(new A.AllChromeDownloads_chromeDriverUrl_closure0(B.JSArray_methods.join$1(B.JSArray_methods.sublist$2(A._setArrayType(version.split("."), type$.JSArray_String), 0, 3), "."))), t3._eval$1("WhereIterable<1>")), t2);
        A.mergeSortBy(t1, new A.AllChromeDownloads_chromeDriverUrl_closure1(), A.instantiate1(A.utils__compareComparable$closure(), t4), t2, t4);
        latestChromeVersion = A.IterableExtension_get_lastOrNull(t1, t2);
  ...
  A.AllChromeDownloads_chromeDriverUrl_closure1.prototype = {
    call$1(v) {
      return A.int_parse(B.JSArray_methods.get$last(type$.ChromeVersion._as(v).version.split(".")), null);
    },
    $signature: 38
  };
  ...
  A.NodeProcess__init_closure0.prototype = {
    call$1(error) {
      var t1 = this.$this;
      return A.throwExpression(new A.ProcessException(t1.executable, t1.$arguments, "Error spawning subprocess: " + A.S(A._asJSObject(error))));
    },
    $signature: 37
  };
  A.OS.prototype = {
  ...
  A.MultiSectionMapping.prototype = {
    MultiSectionMapping$fromJson$3$mapUrl(sections, otherMaps, mapUrl) {
      ...
      for (t1 = J.cast$1$0$ax(sections, type$.Map_dynamic_dynamic), t2 = t1.$ti, t1 = new A.ListIterator(t1, t1.get$length(0), t2._eval$1("ListIterator<ListBase.E>")), t3 = this._maps, t4 = this._lineStart, t5 = this._columnStart, t6 = type$.nullable_Map_dynamic_dynamic, t2 = t2._eval$1("ListBase.E"); t1.moveNext$0();) {
  ...
  A.SingleMapping.prototype = {
    SingleMapping$fromJson$2$mapUrl(map, mapUrl) {
      var t6, source, t7, t8, t9, tokenizer, entries, line, column, srcUrlId, srcLine, srcColumn, srcNameId, _this = this,
        ...
        t1 = map._source,
        t2 = map.$ti._eval$1("4?"),
        sourcesContent = t2._as(t1.$index(0, _s14_)) == null ? B.List_empty2 : A.List_List$from(type$.List_dynamic._as(t2._as(t1.$index(0, _s14_))), true, type$.nullable_String),
        t3 = _this.files,
        t4 = _this.urls,
        t5 = type$.JSArray_int,
        i = 0;
  ...
  A._installChromedriver_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        $async$returnValue, t2, versionResult, exitCode, _0_2, _0_4, version, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 3;
              return A._asyncAwait($.$get$processManager().run$2$echoOutput(A._setArrayType([t2, "--version"], type$.JSArray_String), true), $async$call$0);
            case 3:
              // returning from await.
              versionResult = $async$result;
              exitCode = versionResult.exitCode;
              _0_2 = versionResult.stdout;
              _0_4 = versionResult.stderr;
              if (exitCode !== 0)
                throw A.wrapException(A.Exception_Exception(_0_4));
              version = B.JSArray_methods.get$last(B.JSString_methods.trim$0(_0_2).split(" "));
              A._asJSObject(t1.core).info("Found local Chrome version: " + version);
  ...
  A._installChromedriver_closure0.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              A._asJSObject(t1.core).info("Getting URL for ChromeDriver " + t2);
              $async$goto = 3;
              return A._asyncAwait(A.HttpClient_getJson(A._asJSObject(new t1.HttpClient()), "https://googlechromelabs.github.io/chrome-for-testing/known-good-versions-with-downloads.json"), $async$call$0);
            case 3:
              // returning from await.
              allChromeDownloadsJson = $async$result;
              A._asJSObject(t1.core).debug("Got JSON: " + allChromeDownloadsJson.toString$0(0));
              $async$returnValue = A._$AllChromeDownloadsFromJson(allChromeDownloadsJson).chromeDriverUrl$2(t2, A.ChromePlatform_fromOsArch(A.Process_get_platform(A._asJSObject(t1.process)), A.Process_get_arch(A._asJSObject(t1.process))));
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A._installChromedriver_closure1.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.String),
        ...
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              A._asJSObject(t1.core).info("Downloading ChromeDriver: " + t2);
              $async$goto = 3;
              return A._asyncAwait(A.ToolCache_downloadTool(A._asJSObject(t1.toolCache), t2), $async$call$0);
            case 3:
              // returning from await.
              downloadPath = $async$result;
              A._asJSObject(t1.core).info("Downloaded ChromeDriver to: " + downloadPath);
              $async$goto = 4;
              return A._asyncAwait(A.ToolCache_extractZip(A._asJSObject(t1.toolCache), downloadPath), $async$call$0);
            case 4:
              // returning from await.
              extractPath = $async$result;
              A._asJSObject(t1.core).info("Extracted ChromeDriver to: " + extractPath);
              $async$returnValue = A.ToolCache_cacheDir(A._asJSObject(t1.toolCache), extractPath, "chromedriver", $async$self.chromeVersion);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 64, 0);
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 67, 0);
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 68, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 69, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 70, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 71, 0);
    ...
    var _;
    _instance_1_u(_ = A._StreamController.prototype, "get$_add", "_add$1", 26);
    ...
    _static_1(A, "convert__LineSplitterEventSink___new_tearOff$closure", "_LineSplitterEventSink___new_tearOff", 73);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 56);
    ...
    _instance(_ = A.StackZoneSpecification.prototype, "get$_registerCallback", 0, 4, null, ["call$1$4", "call$4"], ["_registerCallback$1$4", "_registerCallback$4"], 14, 0, 0);
    ...
    _instance(_, "get$_registerBinaryCallback", 0, 4, null, ["call$3$4", "call$4"], ["_registerBinaryCallback$3$4", "_registerBinaryCallback$4"], 19, 0, 0);
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 58, 0, 0);
    ...
    _static_0(A, "setup_chromedriver___installChromedriver$closure", "_installChromedriver", 3);
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.ActionResult, A.ChromePlatform, A.OS, A.Arch]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Future<~>()", "Trace()", "Frame()", "Frame(String)", "Null()", "~(@)", "Null(@)", "String(String)", "Future<String>()", "~(~())", "bool(ChromeVersion)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "@()", "Object?(Object?)", "~(String)", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "String(Frame)", "Trace(String)", "int(Frame)", "Null(Object,StackTrace)", "String(Match)", "~(Object?)", "~(@,@)", "ChromeDownload(@)", "ChromeVersion(@)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "bool(ChromeDownload)", "~(List<int>)", "0&(JSObject)", "int(ChromeVersion)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "@(@)", "~(String,@)", "bool(TargetLineEntry)", "Future<~>(Object,Chain)", "Map<String,int>()", "Null(@,StackTrace)", "List<Frame>(Trace)", "int(Trace)", "Future<0&>()", "int(0^,0^)<Comparable<0^>>", "Null(@,@)", "~(int,@)", "Frame(String,String)", "0^(0^,0^)<num>", "~(@,StackTrace?)", "@(String)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "0&(String,int?)", "Chain()", "Null(~())", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "_LineSplitterEventSink(EventSink<String>)", "@(@,String)", "~(Object?,Object?)", "bool(TargetEntry)", "String(Trace)"],
...
;
    ...
    B.ChromePlatform_0 = new A.ChromePlatform(0, "linux64");
    B.ChromePlatform_2 = new A.ChromePlatform(2, "macArm64");
    B.ChromePlatform_3 = new A.ChromePlatform(3, "macX64");
    ...
    B.List_empty = makeConstList([], A.findType("JSArray<ChromeDownload>"));
    B.List_empty0 = makeConstList([], type$.JSArray_String);
    B.List_empty1 = makeConstList([], type$.JSArray_int);
    ...
    B.ChromePlatform_1 = new A.ChromePlatform(1, "linuxArm64");
    B.ChromePlatform_4 = new A.ChromePlatform(4, "win32");
    B.ChromePlatform_5 = new A.ChromePlatform(5, "win64");
    B.Map_ztHhK = new A.GeneralConstantMap([B.ChromePlatform_0, "linux64", B.ChromePlatform_1, "linux-arm64", B.ChromePlatform_2, "mac-arm64", B.ChromePlatform_3, "mac-x64", B.ChromePlatform_4, "win32", B.ChromePlatform_5, "win64"], A.findType("GeneralConstantMap<ChromePlatform,String>"));
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "context", "$get$context", () => {
    ...
    _lazyFinal($, "context0", "$get$context0", () => new A.Context($.$get$Style_platform(), null));
