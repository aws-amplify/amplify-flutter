...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    ChromePlatform_fromOsArch(os, arch) {
      var _0_6_isSet, _0_6, t1, _0_4, _0_8, _0_4_isSet;
      $label0$0: {
    ...
    _$ChromeDownloadFromJson(json) {
      return new A.ChromeDownload(A.$enumDecode(B.Map_qWM5O, json.$index(0, "platform"), type$.ChromePlatform, type$.String), A._asString(json.$index(0, "url")));
    },
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootRunBinary$closure", 6, null, ["call$3$6"], ["_rootRunBinary"], 70, 0);
    ...
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 71, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 72, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 73, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 74, 0);
    ...
    _instance_2_u(_, "get$_completeDoneError", "_completeDoneError$2", 59);
    ...
    _instance(_, "get$_handleUncaughtError", 0, 5, null, ["call$5"], ["_handleUncaughtError$5"], 61, 0, 0);
    _instance(_, "get$_errorCallback", 0, 5, null, ["call$5"], ["_errorCallback$5"], 28, 0, 0);
    _static_1(A, "trace_Trace___parseVM_tearOff$closure", "Trace___parseVM_tearOff", 13);
    _static_1(A, "trace_Trace___parseFriendly_tearOff$closure", "Trace___parseFriendly_tearOff", 13);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "bool(String)", "~(Object,StackTrace)", "Future<~>()", "Trace()", "Frame()", "Null()", "~(@)", "Frame(String)", "Null(@)", "String(String)", "Future<String>()", "~(~())", "Trace(String)", "Null(Object,StackTrace)", "~(Object?)", "~(@,@)", "@()", "Object?(Object?)", "bool(ChromeVersion)", "ChromeDownload(@)", "~(String)", "String(Match)", "int(Frame)", "String(Frame)", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "Future<0&>()", "bool(ChromeDownload)", "ChromeVersion(@)", "@(@)", "~(NativeUint8List)", "~(JSObject)", "~([@])", "Null([Object?,Object?,Object?])", "NodeProcessManager()", "~(Object?,Object?)", "~(List<int>)", "0&(JSObject)", "Null(@,StackTrace)", "String(String?)", "Trace(Trace)", "Frame?(Frame)", "_ConverterStreamEventSink<@,@>(EventSink<@>)", "~(String,@)", "bool(TargetLineEntry)", "bool(TargetEntry)", "Map<String,int>()", "_LineSplitterEventSink(EventSink<String>)", "List<Frame>(Trace)", "int(0^,0^)<Comparable<0^>>", "~(String,int)", "String(Trace)", "~(String,int?)", "int(int,int)", "Frame(String,String)", "~(int,@)", "~(@,StackTrace?)", "Null(@,@)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Null(~())", "Chain()", "@(@,String)", "Future<~>(Object,Chain)", "Future<0^>([0^/?])<Object?>", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "@(String)", "int(ChromeVersion)", "0^(0^,0^)<num>", "int(Trace)"],
...
;
    ...
    B.Map_qWM5O = new A.GeneralConstantMap([B.ChromePlatform_0, "linux64", B.ChromePlatform_1, "mac-arm64", B.ChromePlatform_2, "mac-x64", B.ChromePlatform_3, "win32", B.ChromePlatform_4, "win64"], A.findType("GeneralConstantMap<ChromePlatform,String>"));
