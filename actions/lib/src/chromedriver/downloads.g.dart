...
ChromeVersionDownloads _$ChromeVersionDownloadsFromJson(
  Map json,
) => ChromeVersionDownloads(
  chrome:
      (json['chrome'] as List<dynamic>?)
          ?.map(
            (e) => ChromeDownload.fromJson(Map<String, Object?>.from(e as Map)),
          )
          .toList() ??
      const [],
  chromedriver:
      (json['chromedriver'] as List<dynamic>?)
          ?.map(
            (e) => ChromeDownload.fromJson(Map<String, Object?>.from(e as Map)),
          )
          .toList() ??
