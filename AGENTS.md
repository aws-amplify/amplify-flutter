...
- `version.dart` files (typically `lib/src/version.dart`) MUST always be autogenerated via [`build_version`](https://pub.dev/packages/build_version) — never edit them by hand
...
- Regenerate after version bumps with `dart run build_runner build`
